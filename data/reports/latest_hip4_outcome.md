...
- Spain [Yes] symbol `#4500` underlying `n/a` prob `1.0` price_source `allMids` vol24h `0.0` oi `0.0`
...
- Saudi Arabia [No] symbol `#4521` underlying `n/a` prob `0.9989` price_source `allMids` vol24h `0.0` oi `0.0`
...
- Draw [No] symbol `#4511` underlying `n/a` prob `0.9974` price_source `allMids` vol24h `0.0` oi `0.0`
