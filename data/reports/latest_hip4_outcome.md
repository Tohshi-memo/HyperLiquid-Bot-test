...
- Spain [Yes] symbol `#4500` underlying `n/a` prob `0.9992` price_source `allMids` vol24h `0.0` oi `0.0`
...
- Draw [No] symbol `#4511` underlying `n/a` prob `0.9986` price_source `allMids` vol24h `0.0` oi `0.0`
