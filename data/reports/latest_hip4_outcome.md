...
- template:sportsContestParticipant2 [No] symbol `#27741` underlying `n/a` prob `0.985` price_source `allMids` vol24h `0.0` oi `0.0`
...
- Recurring [Yes] symbol `#26420` underlying `ETH` prob `0.925` price_source `allMids` vol24h `0.0` oi `0.0`
