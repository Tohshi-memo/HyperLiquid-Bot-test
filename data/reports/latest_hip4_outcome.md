...
- Draw [Yes] symbol `#4550` underlying `n/a` prob `0.9998` price_source `allMids` vol24h `0.0` oi `0.0`
...
- Iran [No] symbol `#4561` underlying `n/a` prob `0.9995` price_source `allMids` vol24h `0.0` oi `0.0`
