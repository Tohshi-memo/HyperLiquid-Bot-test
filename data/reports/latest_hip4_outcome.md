...
- 2026 NBA Finals champion [San Antonio] symbol `#1420` underlying `n/a` prob `0.2145` price_source `allMids` vol24h `0.0` oi `0.0`
- 2026 NBA Finals champion [New York] symbol `#1421` underlying `n/a` prob `0.7855` price_source `allMids` vol24h `0.0` oi `0.0`
