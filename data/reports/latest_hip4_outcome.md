...
- template:binaryPrice [template:Yes] symbol `#33260` underlying `n/a` prob `0.9841` price_source `allMids` vol24h `0.0` oi `0.0`
...
- template:binaryPrice [template:No] symbol `#33251` underlying `n/a` prob `0.9537` price_source `allMids` vol24h `0.0` oi `0.0`
