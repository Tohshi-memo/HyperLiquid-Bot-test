...
- Draw [No] symbol `#3991` underlying `n/a` prob `0.9994` price_source `allMids` vol24h `0.0` oi `0.0`
...
- Recurring [Yes] symbol `#4650` underlying `BTC` prob `0.9978` price_source `allMids` vol24h `0.0` oi `0.0`
...
- Colombia [No] symbol `#1811` underlying `n/a` prob `0.9818` price_source `allMids` vol24h `0.0` oi `0.0`
