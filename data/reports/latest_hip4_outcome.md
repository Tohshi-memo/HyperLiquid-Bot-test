...
- template:binaryPrice [template:Yes] symbol `#33260` underlying `n/a` prob `0.9867` price_source `allMids` vol24h `0.0` oi `0.0`
...
- template:sportsContestWinner [template:{shortNameB}] symbol `#49101` underlying `n/a` prob `0.9499` price_source `allMids` vol24h `0.0` oi `0.0`
...
- template:priceTouch [template:No] symbol `#12121` underlying `n/a` prob `0.9859` price_source `allMids` vol24h `0.0` oi `0.0`
- template:priceTouch [template:Yes] symbol `#12130` underlying `n/a` prob `0.0732` price_source `allMids` vol24h `0.0` oi `0.0`
- template:priceTouch [template:No] symbol `#12131` underlying `n/a` prob `0.9268` price_source `allMids` vol24h `0.0` oi `0.0`
