...
- template:priceTouch [template:No] symbol `#12131` underlying `n/a` prob `0.8507` price_source `allMids` vol24h `0.0` oi `0.0`
- template:priceTouch [template:Yes] symbol `#12140` underlying `n/a` prob `0.3438` price_source `allMids` vol24h `0.0` oi `0.0`
- template:priceTouch [template:No] symbol `#12141` underlying `n/a` prob `0.6562` price_source `allMids` vol24h `0.0` oi `0.0`
- template:priceTouch [template:Yes] symbol `#12150` underlying `n/a` prob `0.354` price_source `allMids` vol24h `0.0` oi `0.0`
- template:priceTouch [template:No] symbol `#12151` underlying `n/a` prob `0.646` price_source `allMids` vol24h `0.0` oi `0.0`
