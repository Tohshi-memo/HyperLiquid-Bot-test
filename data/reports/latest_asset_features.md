...
- `@160` unknown price `0.001413` 4h `2.0217` vol `0.0` relationship `market_context_high->@160_24h`
- `@256` unknown price `0.043017` 4h `0.594` vol `0.0` relationship `market_context_high->@256_24h`
- `@4` unknown price `4.1222` 4h `-1.7834` vol `0.0` relationship `market_context_high->@4_24h`
- `GRASS` crypto_alt price `0.54505` 4h `2.3587` vol `4137838.9` relationship `market_context_high->GRASS_24h`
