...
- `@703` unknown price `780.73` 4h `0.0615` vol `0.0` relationship `market_context_high->@703_24h`
- `@3` unknown price `0.0055003` 4h `0.0` vol `0.0` relationship `risk_on_high->@3_24h`
- `@708` unknown price `21.8198` 4h `0.4859` vol `0.0` relationship `news_risk_high->@708_24h`
...
- `@704` unknown price `733.74` 4h `0.0607` vol `0.0` relationship `market_context_high->@704_24h`
- `@705` unknown price `168.035` 4h `0.4033` vol `0.0` relationship `market_context_high->@705_24h`
...
- `CASHCAT` crypto_alt price `0.11545` 4h `-3.6431` vol `8075262.66` relationship `news_risk_high->CASHCAT_24h`
...
- `@706` unknown price `979.76` 4h `0.3071` vol `0.0` relationship `market_context_high->@706_24h`
...
- `xyz:CRWV` equity price `105.37` 4h `0.0617` vol `429156.06` relationship `risk_on_high->xyz:CRWV_24h`
- `xyz:NBIS` equity price `277.195` 4h `0.1463` vol `4660896.21` relationship `news_risk_high->xyz:NBIS_24h`
