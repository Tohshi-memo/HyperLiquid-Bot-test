...
- `market_context_high->crypto_alt_24h` score `-0.1846` n `75` status `ready` deltaP `5.6597` edge `0.0806` maxDD `-4.3596`
...
- `market_context_high->commodity_24h` score `-4.0433` n `75` status `ready` deltaP `9.3542` edge `-0.0451` maxDD `-33.1843`
