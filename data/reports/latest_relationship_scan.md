...
- `news_risk_high->commodity_1h` score `0.3984` n `53` status `ready` deltaP `10.5271` edge `-0.0057` maxDD `-0.5024`
...
- `news_risk_high->crypto_alt_24h` score `-0.7254` n `51` status `ready` deltaP `21.0069` edge `-0.2005` maxDD `0.0`
