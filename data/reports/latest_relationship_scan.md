...
- `market_context_high->equity_4h` score `0.73` n `105` status `ready` deltaP `8.2463` edge `0.1688` maxDD `-8.3685`
- `market_context_high->equity_1h` score `0.5666` n `105` status `ready` deltaP `10.067` edge `0.0616` maxDD `-3.1861`
- `market_context_high->index_1h` score `0.3826` n `105` status `ready` deltaP `11.0066` edge `0.0072` maxDD `-0.5622`
...
- `market_context_high->unknown_1h` score `-0.5165` n `105` status `ready` deltaP `6.882` edge `-0.0662` maxDD `-0.4843`
- `market_context_high->crypto_alt_1h` score `-0.5306` n `105` status `ready` deltaP `1.1007` edge `0.0048` maxDD `-2.413`
- `market_context_high->crypto_major_1h` score `-0.7093` n `105` status `ready` deltaP `1.5369` edge `-0.0167` maxDD `-2.7581`
...
- `market_context_high->crypto_alt_4h` score `-1.5738` n `105` status `ready` deltaP `4.2814` edge `-0.0327` maxDD `-5.4926`
- `market_context_high->crypto_major_4h` score `-1.9707` n `105` status `ready` deltaP `6.8351` edge `-0.1077` maxDD `-3.1677`
