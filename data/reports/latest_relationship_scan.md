...
- `news_risk_high->unknown_4h` score `14.0282` n `51` status `ready` deltaP `25.1733` edge `1.0058` maxDD `-0.0348`
- `risk_on_high->unknown_1h` score `4.8001` n `33` status `ready` deltaP `-9.5264` edge `0.7238` maxDD `-1.5916`
- `risk_on_and_context->unknown_1h` score `4.8001` n `33` status `ready` deltaP `-9.5264` edge `0.7238` maxDD `-1.5916`
- `news_risk_high->unknown_1h` score `3.4071` n `51` status `ready` deltaP `18.281` edge `0.1925` maxDD `-0.7693`
...
- `market_context_high->unknown_1h` score `1.1353` n `128` status `ready` deltaP `6.2406` edge `0.0979` maxDD `-1.5916`
- `market_context_high->crypto_alt_4h` score `1.1229` n `128` status `ready` deltaP `8.9558` edge `0.1803` maxDD `-7.0478`
...
- `market_context_high->unknown_4h` score `0.5502` n `128` status `ready` deltaP `20.8841` edge `-0.0762` maxDD `-0.3741`
- `market_context_high->commodity_24h` score `0.5454` n `112` status `ready` deltaP `-1.1657` edge `0.1007` maxDD `-0.7984`
