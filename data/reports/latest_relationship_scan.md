...
- `market_context_high->equity_4h` score `2.3061` n `96` status `ready` deltaP `11.7632` edge `0.2026` maxDD `-2.4411`
- `market_context_high->equity_1h` score `1.9663` n `96` status `ready` deltaP `15.8995` edge `0.088` maxDD `-0.4112`
- `market_context_high->index_1h` score `1.0013` n `96` status `ready` deltaP `16.6604` edge `0.0111` maxDD `-0.0982`
- `market_context_high->metal_4h` score `0.6143` n `96` status `ready` deltaP `14.126` edge `0.0146` maxDD `-1.273`
- `market_context_high->commodity_24h` score `0.2972` n `96` status `ready` deltaP `6.4236` edge `0.1786` maxDD `-4.666`
...
- `market_context_high->crypto_major_24h` score `-0.0799` n `96` status `ready` deltaP `3.125` edge `0.0933` maxDD `-4.9964`
...
- `market_context_high->commodity_4h` score `-0.6934` n `96` status `ready` deltaP `-0.94` edge `0.0024` maxDD `-2.4692`
