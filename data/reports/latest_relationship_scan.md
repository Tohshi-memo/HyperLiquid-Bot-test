...
- `market_context_high->equity_4h` score `0.4543` n `105` status `ready` deltaP `6.5694` edge `0.157` maxDD `-8.3685`
...
- `market_context_high->unknown_1h` score `-0.1892` n `105` status `ready` deltaP `8.8281` edge `-0.0519` maxDD `-0.4843`
...
- `market_context_high->crypto_alt_1h` score `-0.5727` n `105` status `ready` deltaP `0.8013` edge `0.0014` maxDD `-2.413`
...
- `market_context_high->crypto_alt_4h` score `-1.6648` n `105` status `ready` deltaP `4.4338` edge `-0.0413` maxDD `-5.4926`
- `market_context_high->crypto_major_4h` score `-2.0083` n `105` status `ready` deltaP `6.5302` edge `-0.1088` maxDD `-3.1677`
