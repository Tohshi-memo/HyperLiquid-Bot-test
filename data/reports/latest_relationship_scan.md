...
- `news_risk_high->crypto_alt_24h` score `12.5694` n `32` status `ready` deltaP `33.8542` edge `0.8365` maxDD `-0.5131`
...
- `market_context_high->unknown_1h` score `2.086` n `179` status `ready` deltaP `-4.8397` edge `0.2962` maxDD `-3.2083`
...
- `market_context_high->unknown_4h` score `0.2062` n `172` status `ready` deltaP `-15.6977` edge `0.3624` maxDD `-10.5788`
...
- `news_risk_high->unknown_1h` score `-0.584` n `38` status `ready` deltaP `4.4516` edge `-0.0412` maxDD `-0.9718`
