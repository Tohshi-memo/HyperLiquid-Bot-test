...
- `market_context_high->crypto_major_24h` score `3.3588` n `190` status `ready` deltaP `16.2189` edge `0.6258` maxDD `-29.6555`
- `market_context_high->equity_4h` score `2.836` n `193` status `ready` deltaP `13.3641` edge `0.3111` maxDD `-7.4425`
- `market_context_high->crypto_major_4h` score `2.4361` n `193` status `ready` deltaP `13.8838` edge `0.3397` maxDD `-14.0065`
- `market_context_high->crypto_alt_4h` score `2.0967` n `193` status `ready` deltaP `10.5609` edge `0.2684` maxDD `-9.46`
- `market_context_high->equity_24h` score `1.5273` n `190` status `ready` deltaP `10.7511` edge `0.5635` maxDD `-31.6316`
...
- `market_context_high->metal_1h` score `-0.381` n `193` status `ready` deltaP `3.1608` edge `0.0147` maxDD `-2.0682`
- `market_context_high->crypto_major_1h` score `-0.5398` n `193` status `ready` deltaP `2.2742` edge `0.0644` maxDD `-6.9639`
...
- `market_context_high->crypto_alt_24h` score `-7.2614` n `190` status `ready` deltaP `7.2442` edge `0.2163` maxDD `-54.2437`
