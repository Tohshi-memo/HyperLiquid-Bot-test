...
- `news_risk_high->unknown_4h` score `14.2594` n `51` status `ready` deltaP `25.7831` edge `1.021` maxDD `-0.0347`
- `risk_on_high->unknown_1h` score `4.8371` n `33` status `ready` deltaP `-8.9276` edge `0.7245` maxDD `-1.5876`
- `risk_on_and_context->unknown_1h` score `4.8371` n `33` status `ready` deltaP `-8.9276` edge `0.7245` maxDD `-1.5876`
- `news_risk_high->unknown_1h` score `3.4793` n `51` status `ready` deltaP `18.8798` edge `0.1945` maxDD `-0.7674`
...
- `market_context_high->crypto_alt_4h` score `1.3757` n `128` status `ready` deltaP `9.4131` edge `0.1987` maxDD `-7.0785`
- `market_context_high->unknown_1h` score `1.2102` n `128` status `ready` deltaP `6.8394` edge `0.1001` maxDD `-1.5876`
- `news_risk_high->fx_1h` score `1.1631` n `51` status `ready` deltaP `16.0972` edge `0.0066` maxDD `-0.0257`
- `market_context_high->unknown_4h` score `0.8151` n `128` status `ready` deltaP `21.4939` edge `-0.0582` maxDD `-0.3736`
