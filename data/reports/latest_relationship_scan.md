...
- `market_context_high->crypto_major_4h` score `1.9944` n `257` status `ready` deltaP `13.0469` edge `0.2376` maxDD `-8.3373`
- `market_context_high->equity_24h` score `1.1579` n `207` status `ready` deltaP `16.1761` edge `0.5485` maxDD `-31.6316`
- `market_context_high->crypto_alt_4h` score `1.0423` n `257` status `ready` deltaP `10.1346` edge `0.1802` maxDD `-7.5392`
- `market_context_high->equity_4h` score `0.2254` n `257` status `ready` deltaP `6.5323` edge `0.1391` maxDD `-7.4425`
- `market_context_high->crypto_alt_1h` score `-0.1986` n `269` status `ready` deltaP `3.1348` edge `0.0444` maxDD `-3.8812`
...
- `market_context_high->index_4h` score `-1.2943` n `257` status `ready` deltaP `-0.8767` edge `0.0076` maxDD `-3.0822`
- `market_context_high->index_24h` score `-2.7457` n `207` status `ready` deltaP `3.9779` edge `0.0306` maxDD `-17.731`
...
- `market_context_high->crypto_major_24h` score `-4.1311` n `207` status `ready` deltaP `5.5404` edge `0.0645` maxDD `-29.6555`
