...
- `market_context_high->index_1h` score `-0.632` n `237` status `ready` deltaP `1.2582` edge `0.0017` maxDD `-2.2895`
- `market_context_high->metal_1h` score `-0.6804` n `237` status `ready` deltaP `-1.4913` edge `-0.0005` maxDD `-2.1427`
...
- `market_context_high->commodity_4h` score `-1.6718` n `237` status `ready` deltaP `-4.4329` edge `-0.0358` maxDD `-5.5853`
- `market_context_high->index_4h` score `-1.7608` n `237` status `ready` deltaP `8.1243` edge `-0.01` maxDD `-12.2591`
...
- `market_context_high->crypto_major_4h` score `-3.2986` n `237` status `ready` deltaP `0.9378` edge `-0.0007` maxDD `-24.6094`
