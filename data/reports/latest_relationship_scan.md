...
- `market_context_high->commodity_4h` score `1.3552` n `138` status `ready` deltaP `15.7542` edge `0.0752` maxDD `-2.7169`
...
- `market_context_high->crypto_alt_1h` score `-1.9648` n `143` status `ready` deltaP `-10.433` edge `-0.03` maxDD `-2.4677`
- `market_context_high->equity_4h` score `-2.6633` n `138` status `ready` deltaP `-2.5075` edge `-0.0715` maxDD `-7.6983`
- `market_context_high->crypto_major_1h` score `-3.1927` n `143` status `ready` deltaP `-10.6874` edge `-0.0626` maxDD `-7.2436`
- `market_context_high->crypto_major_24h` score `-3.2299` n `103` status `ready` deltaP `6.2197` edge `-0.0612` maxDD `-14.2873`
- `market_context_high->crypto_alt_4h` score `-3.7897` n `138` status `ready` deltaP `-7.5844` edge `-0.0996` maxDD `-6.585`
