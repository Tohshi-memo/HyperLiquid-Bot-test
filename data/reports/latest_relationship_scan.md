...
- Price records: `672`
- Market context records: `2343`
- Flow alert records: `8633`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_major_24h` score `10.2489` n `138` status `ready` deltaP `19.5652` edge `1.1129` maxDD `-25.1408`
...
- `market_context_high->unknown_4h` score `5.4496` n `159` status `ready` deltaP `22.1554` edge `0.3674` maxDD `-1.8773`
...
- `market_context_high->crypto_alt_1h` score `1.7291` n `166` status `ready` deltaP `12.8147` edge `0.1774` maxDD `-6.1656`
- `market_context_high->crypto_major_1h` score `1.529` n `166` status `ready` deltaP `12.8147` edge `0.1614` maxDD `-4.2199`
