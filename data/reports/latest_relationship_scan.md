...
- `news_risk_high->equity_4h` score `5.9604` n `57` status `ready` deltaP `23.5345` edge `0.3995` maxDD `-3.4427`
- `news_risk_high->equity_1h` score `2.9944` n `61` status `ready` deltaP `21.2109` edge `0.139` maxDD `-1.1366`
- `news_risk_high->index_4h` score `2.1982` n `57` status `ready` deltaP `19.2662` edge `0.0738` maxDD `-0.191`
- `news_risk_high->crypto_alt_1h` score `1.5925` n `61` status `ready` deltaP `12.6018` edge `0.0921` maxDD `-1.1388`
- `news_risk_high->crypto_major_4h` score `1.2537` n `57` status `ready` deltaP `6.5255` edge `0.1866` maxDD `-2.8833`
- `news_risk_high->crypto_major_1h` score `1.2255` n `61` status `ready` deltaP `9.3084` edge `0.0798` maxDD `-1.1783`
- `news_risk_high->crypto_alt_4h` score `1.0651` n `57` status `ready` deltaP `15.0647` edge `0.1753` maxDD `-5.8012`
- `news_risk_high->fx_1h` score `0.5658` n `61` status `ready` deltaP `10.2213` edge `0.0071` maxDD `-0.2475`
- `news_risk_high->index_1h` score `0.5366` n `61` status `ready` deltaP `7.9611` edge `0.0205` maxDD `-0.3089`
- `news_risk_high->metal_4h` score `-0.0067` n `57` status `ready` deltaP `2.1047` edge `0.0322` maxDD `-0.7433`
...
- `news_risk_high->commodity_4h` score `-7.5687` n `57` status `ready` deltaP `-19.3463` edge `-0.171` maxDD `-13.1269`
...
- `news_risk_high->crypto_major_24h` score `-39.511` n `52` status `ready` deltaP `-27.4038` edge `-1.6574` maxDD `-103.8662`
