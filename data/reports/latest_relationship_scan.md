...
- `market_context_high->commodity_1h` score `1.0054` n `111` status `ready` deltaP `11.8628` edge `0.039` maxDD `-0.7439`
...
- `market_context_high->index_1h` score `-0.5581` n `111` status `ready` deltaP `-3.8881` edge `-0.0067` maxDD `-0.7809`
...
- `market_context_high->crypto_major_1h` score `-2.611` n `111` status `ready` deltaP `-8.4008` edge `-0.0566` maxDD `-5.0649`
- `market_context_high->crypto_major_24h` score `-3.4169` n `103` status `ready` deltaP `6.5669` edge `-0.0791` maxDD `-14.2873`
- `market_context_high->crypto_alt_24h` score `-3.8782` n `103` status `ready` deltaP `-12.4461` edge `-0.0959` maxDD `-4.5445`
