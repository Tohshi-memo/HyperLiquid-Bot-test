...
- `market_context_high->unknown_1h` score `22.0434` n `93` status `ready` deltaP `4.5667` edge `1.8566` maxDD `-1.674`
- `market_context_high->crypto_major_4h` score `6.2028` n `87` status `ready` deltaP `18.0964` edge `0.5448` maxDD `-7.8836`
- `market_context_high->unknown_24h` score `6.1643` n `74` status `ready` deltaP `29.467` edge `0.3515` maxDD `-1.4072`
- `market_context_high->crypto_alt_4h` score `5.16` n `87` status `ready` deltaP `12.5841` edge `0.4855` maxDD `-7.8181`
- `market_context_high->unknown_4h` score `1.5665` n `87` status `ready` deltaP `20.8894` edge `0.0935` maxDD `-5.5109`
...
- `market_context_high->commodity_1h` score `-0.3267` n `93` status `ready` deltaP `1.5582` edge `0.0137` maxDD `-1.278`
...
- `market_context_high->commodity_4h` score `-1.3148` n `87` status `ready` deltaP `3.4343` edge `-0.0072` maxDD `-5.021`
- `market_context_high->fx_1h` score `-1.7725` n `93` status `ready` deltaP `-12.1483` edge `-0.0057` maxDD `-0.5482`
- `market_context_high->commodity_24h` score `-4.013` n `74` status `ready` deltaP `7.1837` edge `-0.0515` maxDD `-27.5371`
