...
- `news_risk_high->equity_4h` score `5.5443` n `64` status `ready` deltaP `19.8933` edge `0.3891` maxDD `-3.4427`
- `news_risk_high->index_4h` score `1.8989` n `64` status `ready` deltaP `15.4345` edge `0.0744` maxDD `-0.191`
- `market_context_high->crypto_alt_4h` score `1.8665` n `61` status `ready` deltaP `13.0573` edge `0.1642` maxDD `-5.323`
- `news_risk_high->equity_1h` score `1.6582` n `64` status `ready` deltaP `15.8028` edge `0.0805` maxDD `-2.4803`
- `news_risk_high->crypto_major_4h` score `0.9801` n `64` status `ready` deltaP `6.2881` edge `0.1613` maxDD `-3.5385`
- `news_risk_high->crypto_alt_4h` score `0.6633` n `64` status `ready` deltaP `13.2622` edge `0.1358` maxDD `-5.8012`
...
- `news_risk_high->fx_4h` score `-0.0975` n `64` status `ready` deltaP `10.0991` edge `0.0203` maxDD `-0.6604`
...
- `market_context_high->fx_4h` score `-0.3323` n `61` status `ready` deltaP `6.0776` edge `0.0114` maxDD `-1.3685`
