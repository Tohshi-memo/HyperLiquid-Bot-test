...
- `market_context_high->equity_4h` score `8.4929` n `87` status `ready` deltaP `33.0302` edge `0.5355` maxDD `-2.5032`
- `market_context_high->metal_24h` score `8.3912` n `74` status `ready` deltaP `35.8752` edge `0.4601` maxDD `0.0`
- `market_context_high->commodity_24h` score `5.7431` n `74` status `ready` deltaP `37.0579` edge `0.347` maxDD `-6.2367`
- `market_context_high->index_4h` score `3.3173` n `87` status `ready` deltaP `31.893` edge `0.0826` maxDD `-0.5022`
- `market_context_high->index_24h` score `2.564` n `74` status `ready` deltaP `14.2934` edge `0.1854` maxDD `-1.3621`
- `market_context_high->equity_1h` score `2.512` n `87` status `ready` deltaP `16.073` edge `0.1455` maxDD `-2.1322`
...
- `market_context_high->crypto_major_4h` score `0.3474` n `87` status `ready` deltaP `7.3434` edge `0.1518` maxDD `-6.7444`
...
- `market_context_high->crypto_alt_1h` score `-0.3407` n `87` status `ready` deltaP `-0.2753` edge `0.0167` maxDD `-1.4603`
...
- `market_context_high->unknown_1h` score `-2.3434` n `87` status `ready` deltaP `4.269` edge `-0.1814` maxDD `-1.054`
