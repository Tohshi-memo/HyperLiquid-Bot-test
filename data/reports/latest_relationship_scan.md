...
- `market_context_high->equity_24h` score `16.5918` n `82` status `ready` deltaP `25.7749` edge `1.345` maxDD `-6.0681`
- `market_context_high->metal_24h` score `8.2437` n `82` status `ready` deltaP `37.7816` edge `0.4351` maxDD `0.0`
- `market_context_high->equity_4h` score `6.7477` n `91` status `ready` deltaP `24.8681` edge `0.4858` maxDD `-5.1426`
- `market_context_high->commodity_24h` score `3.5993` n `82` status `ready` deltaP `27.7058` edge `0.2685` maxDD `-6.5945`
- `market_context_high->metal_4h` score `2.8404` n `91` status `ready` deltaP `25.5511` edge `0.1286` maxDD `-0.979`
- `market_context_high->index_4h` score `2.6962` n `91` status `ready` deltaP `27.6103` edge `0.0766` maxDD `-0.8791`
...
- `market_context_high->index_24h` score `1.2488` n `82` status `ready` deltaP `10.2643` edge `0.1587` maxDD `-1.3621`
- `market_context_high->crypto_major_4h` score `1.197` n `91` status `ready` deltaP `11.7228` edge `0.1934` maxDD `-6.7444`
...
- `market_context_high->crypto_alt_1h` score `0.2117` n `91` status `ready` deltaP `4.394` edge `0.0411` maxDD `-1.4603`
...
- `market_context_high->unknown_1h` score `-1.7857` n `91` status `ready` deltaP `8.9903` edge `-0.1664` maxDD `-1.054`
