...
- `news_risk_high->unknown_24h` score `45.2154` n `53` status `ready` deltaP `11.6319` edge `3.6904` maxDD `0.0`
- `news_risk_high->unknown_4h` score `12.2476` n `53` status `ready` deltaP `25.2847` edge `0.862` maxDD `-0.1281`
- `news_risk_high->crypto_alt_24h` score `11.4585` n `53` status `ready` deltaP `32.6847` edge `0.7811` maxDD `-2.8629`
- `news_risk_high->equity_24h` score `6.865` n `53` status `ready` deltaP `29.2453` edge `0.4702` maxDD `-4.7801`
...
- `market_context_high->unknown_4h` score `2.8807` n `136` status `ready` deltaP `23.5922` edge `0.1236` maxDD `-0.5994`
- `news_risk_high->unknown_1h` score `2.801` n `53` status `ready` deltaP `15.7129` edge `0.1642` maxDD `-0.8426`
- `news_risk_high->metal_24h` score `1.8399` n `53` status `ready` deltaP `29.3632` edge `-0.0382` maxDD `-0.0053`
- `news_risk_high->equity_4h` score `1.7477` n `53` status `ready` deltaP `19.889` edge `0.0901` maxDD `-2.164`
- `news_risk_high->fx_1h` score `1.1297` n `53` status `ready` deltaP `15.7694` edge `0.006` maxDD `-0.0257`
- `market_context_high->unknown_1h` score `1.1135` n `137` status `ready` deltaP `11.9531` edge `0.058` maxDD `-1.5916`
- `news_risk_high->equity_1h` score `0.4365` n `53` status `ready` deltaP `12.9251` edge `0.0062` maxDD `-0.9128`
...
- `news_risk_high->metal_1h` score `-0.2282` n `53` status `ready` deltaP `1.4829` edge `-0.0063` maxDD `-0.1413`
