...
- `news_risk_high->crypto_major_1h` score `0.9369` n `30` status `ready` deltaP `11.2375` edge `0.0919` maxDD `-2.0691`
- `market_context_high->equity_4h` score `0.8143` n `220` status `ready` deltaP `7.5305` edge `0.1271` maxDD `-4.0887`
- `news_risk_high->crypto_alt_1h` score `0.2162` n `30` status `ready` deltaP `5.02` edge `0.0404` maxDD `-1.6923`
...
- `market_context_high->crypto_major_1h` score `-0.5222` n `221` status `ready` deltaP `4.0128` edge `0.0384` maxDD `-6.2348`
- `market_context_high->crypto_alt_1h` score `-0.6526` n `221` status `ready` deltaP `2.6519` edge `0.0321` maxDD `-6.6758`
...
- `market_context_high->crypto_major_4h` score `-2.0796` n `220` status `ready` deltaP `7.863` edge `0.1182` maxDD `-25.6458`
