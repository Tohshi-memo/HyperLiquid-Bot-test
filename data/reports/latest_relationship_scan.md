...
- `market_context_high->crypto_alt_1h` score `-0.4725` n `192` status `ready` deltaP `3.1718` edge `0.0159` maxDD `-3.7803`
- `market_context_high->commodity_1h` score `-0.6523` n `192` status `ready` deltaP `-1.2038` edge `-0.0073` maxDD `-2.1314`
- `market_context_high->index_1h` score `-0.7447` n `192` status `ready` deltaP `-3.1312` edge `-0.0017` maxDD `-0.832`
- `market_context_high->metal_1h` score `-0.8999` n `192` status `ready` deltaP `-6.6804` edge `-0.0066` maxDD `-1.8052`
- `market_context_high->fx_4h` score `-1.3563` n `185` status `ready` deltaP `5.2175` edge `-0.0023` maxDD `-2.1765`
- `market_context_high->commodity_4h` score `-1.3782` n `185` status `ready` deltaP `-2.4456` edge `-0.0114` maxDD `-5.5853`
- `market_context_high->equity_1h` score `-1.4488` n `192` status `ready` deltaP `1.0947` edge `-0.0201` maxDD `-4.301`
- `market_context_high->index_4h` score `-1.657` n `185` status `ready` deltaP `1.8375` edge `-0.0287` maxDD `-6.3458`
- `market_context_high->unknown_1h` score `-1.7909` n `192` status `ready` deltaP `-6.8301` edge `-0.0136` maxDD `-3.2083`
...
- `market_context_high->equity_4h` score `-5.0345` n `185` status `ready` deltaP `-0.81` edge `-0.1862` maxDD `-29.3079`
