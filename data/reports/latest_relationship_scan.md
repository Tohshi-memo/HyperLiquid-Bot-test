...
- Price records: `672`
- Market context records: `1749`
- Flow alert records: `6937`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->metal_24h` score `7.1675` n `162` status `ready` deltaP `26.8342` edge `0.661` maxDD `-12.7414`
...
- `market_context_high->unknown_24h` score `4.1751` n `162` status `ready` deltaP `15.1893` edge `0.7787` maxDD `-35.8966`
- `market_context_high->equity_4h` score `2.9524` n `196` status `ready` deltaP `15.807` edge `0.2501` maxDD `-5.0894`
- `market_context_high->equity_24h` score `2.887` n `162` status `ready` deltaP `17.3139` edge `0.615` maxDD `-33.1875`
...
- `market_context_high->crypto_major_24h` score `0.6551` n `162` status `ready` deltaP `19.6311` edge `0.7823` maxDD `-62.3533`
...
- `market_context_high->crypto_alt_24h` score `-0.4691` n `162` status `ready` deltaP `20.5073` edge `1.0051` maxDD `-88.8062`
