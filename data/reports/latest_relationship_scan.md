...
- `market_context_high->unknown_4h` score `6.3661` n `132` status `ready` deltaP `14.5279` edge `0.5547` maxDD `-4.6834`
...
- `market_context_high->equity_4h` score `-0.4599` n `132` status `ready` deltaP `7.1138` edge `0.0622` maxDD `-8.8203`
...
- `market_context_high->equity_1h` score `-0.9088` n `135` status `ready` deltaP `-1.2686` edge `-0.0174` maxDD `-5.2521`
...
- `market_context_high->crypto_alt_4h` score `-5.3955` n `132` status `ready` deltaP `2.282` edge `-0.0389` maxDD `-48.1101`
- `market_context_high->index_24h` score `-6.9142` n `120` status `ready` deltaP `-11.0764` edge `-0.1144` maxDD `-22.3683`
