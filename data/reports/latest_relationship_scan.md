...
- `news_risk_high->crypto_alt_24h` score `11.7461` n `32` status `ready` deltaP `30.2083` edge `0.7922` maxDD `-0.5131`
- `market_context_high->unknown_24h` score `8.4609` n `146` status `ready` deltaP `21.3304` edge `0.8929` maxDD `-15.0689`
...
- `news_risk_high->commodity_24h` score `4.1101` n `32` status `ready` deltaP `35.2431` edge `0.1281` maxDD `-0.3101`
- `news_risk_high->crypto_major_24h` score `3.2904` n `32` status `ready` deltaP `11.8056` edge `0.4211` maxDD `-4.2368`
...
- `market_context_high->equity_4h` score `-0.6315` n `192` status `ready` deltaP `6.4533` edge `0.0459` maxDD `-8.2573`
