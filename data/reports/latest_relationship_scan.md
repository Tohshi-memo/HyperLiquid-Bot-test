...
- Generated: `2026-07-15T19:52:46.779273+00:00`
- Price records: `672`
- Market context records: `6848`
...
- `market_context_high->unknown_24h` score `1.0613` n `176` status `ready` deltaP `-1.5467` edge `0.5216` maxDD `-12.3511`
...
- `market_context_high->crypto_alt_1h` score `-0.6156` n `223` status `ready` deltaP `1.7125` edge `0.0137` maxDD `-3.7803`
- `market_context_high->crypto_major_1h` score `-0.6454` n `223` status `ready` deltaP `3.6559` edge `0.012` maxDD `-4.2122`
- `market_context_high->commodity_1h` score `-0.6618` n `223` status `ready` deltaP `-1.8716` edge `-0.0039` maxDD `-2.1443`
- `market_context_high->index_1h` score `-0.8919` n `223` status `ready` deltaP `-2.9148` edge `-0.0038` maxDD `-2.2895`
...
- `market_context_high->crypto_major_4h` score `-3.0403` n `213` status `ready` deltaP `-0.5339` edge `-0.0535` maxDD `-16.9508`
- `market_context_high->crypto_alt_4h` score `-3.2013` n `213` status `ready` deltaP `-0.7472` edge `-0.0471` maxDD `-20.6678`
- `market_context_high->unknown_4h` score `-3.2031` n `213` status `ready` deltaP `-9.3253` edge `0.0318` maxDD `-10.2579`
