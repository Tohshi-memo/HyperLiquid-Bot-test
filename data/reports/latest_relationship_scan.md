...
- Price records: `672`
- Market context records: `807`
- Flow alert records: `2269`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_alt_24h` score `5.4313` n `149` status `ready` deltaP `7.1414` edge `0.4098` maxDD `-0.0508`
...
- `risk_on_high->index_4h` score `2.8301` n `33` status `ready` deltaP `17.318` edge `0.1292` maxDD `-0.038`
- `risk_on_and_context->index_4h` score `2.8301` n `33` status `ready` deltaP `17.318` edge `0.1292` maxDD `-0.038`
...
- `risk_on_high->crypto_alt_4h` score `2.6383` n `33` status `ready` deltaP `20.3298` edge `0.1048` maxDD `-0.6377`
- `risk_on_and_context->crypto_alt_4h` score `2.6383` n `33` status `ready` deltaP `20.3298` edge `0.1048` maxDD `-0.6377`
...
- `risk_on_high->commodity_4h` score `0.8509` n `33` status `ready` deltaP `5.8204` edge `0.1534` maxDD `-1.3162`
- `risk_on_and_context->commodity_4h` score `0.8509` n `33` status `ready` deltaP `5.8204` edge `0.1534` maxDD `-1.3162`
