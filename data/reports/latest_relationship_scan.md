...
- Price records: `672`
- Market context records: `1901`
- Flow alert records: `7370`
- Minimum samples: `30`
- Pattern count: `48`
...
- `market_context_high->crypto_alt_4h` score `7.4071` n `199` status `ready` deltaP `23.1186` edge `0.5776` maxDD `-5.1574`
- `market_context_high->crypto_major_4h` score `6.9021` n `199` status `ready` deltaP `27.8672` edge `0.514` maxDD `-4.9684`
- `market_context_high->unknown_4h` score `4.0125` n `199` status `ready` deltaP `17.5006` edge `0.4201` maxDD `-9.8581`
- `market_context_high->metal_24h` score `2.3942` n `183` status `ready` deltaP `17.808` edge `0.3234` maxDD `-12.7414`
...
- `market_context_high->crypto_alt_1h` score `0.4703` n `199` status `ready` deltaP `6.805` edge `0.1052` maxDD `-4.9097`
...
- `market_context_high->equity_1h` score `-0.0592` n `199` status `ready` deltaP `5.2862` edge `0.0392` maxDD `-2.6836`
- `market_context_high->equity_24h` score `-0.1624` n `183` status `ready` deltaP `9.0619` edge `0.4159` maxDD `-33.1875`
- `market_context_high->crypto_major_24h` score `-0.4026` n `183` status `ready` deltaP `17.8848` edge `0.7058` maxDD `-62.3533`
- `market_context_high->metal_1h` score `-0.4962` n `199` status `ready` deltaP `6.7305` edge `0.0251` maxDD `-6.3532`
...
- `market_context_high->metal_4h` score `-0.7636` n `199` status `ready` deltaP `11.9331` edge `0.126` maxDD `-12.5349`
- `market_context_high->unknown_1h` score `-0.7844` n `199` status `ready` deltaP `2.8383` edge `0.0109` maxDD `-3.6151`
