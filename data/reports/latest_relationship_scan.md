...
- `risk_on_high->fx_4h` score `1.0119` n `32` status `ready` deltaP `11.5091` edge `0.0217` maxDD `-0.1285`
- `risk_on_and_context->fx_4h` score `1.0119` n `32` status `ready` deltaP `11.5091` edge `0.0217` maxDD `-0.1285`
...
- `market_context_high->fx_4h` score `-0.1118` n `180` status `ready` deltaP `5.8841` edge `0.0069` maxDD `-0.504`
- `market_context_high->commodity_24h` score `-0.1398` n `166` status `ready` deltaP `6.9418` edge `0.0224` maxDD `-2.4263`
...
- `risk_on_high->equity_1h` score `-0.7006` n `32` status `ready` deltaP `-3.7612` edge `-0.0104` maxDD `-1.6811`
- `risk_on_and_context->equity_1h` score `-0.7006` n `32` status `ready` deltaP `-3.7612` edge `-0.0104` maxDD `-1.6811`
