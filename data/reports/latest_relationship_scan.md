...
- `news_risk_high->unknown_24h` score `4750.4028` n `64` status `ready` deltaP `37.1528` edge `395.6613` maxDD `-2.0332`
- `news_risk_high->equity_4h` score `5.9448` n `64` status `ready` deltaP `21.5701` edge `0.4113` maxDD `-3.4427`
...
- `market_context_high->crypto_alt_4h` score `1.678` n `62` status `ready` deltaP `12.141` edge `0.1546` maxDD `-5.323`
- `news_risk_high->crypto_major_4h` score `1.0177` n `64` status `ready` deltaP `6.4405` edge `0.1651` maxDD `-3.5385`
- `news_risk_high->crypto_alt_4h` score `0.4997` n `64` status `ready` deltaP `11.7378` edge `0.125` maxDD `-5.8012`
