...
- `risk_on_high->crypto_major_4h` score `16.7406` n `31` status `ready` deltaP `30.8517` edge `1.3016` maxDD `-5.9781`
- `risk_on_and_context->crypto_major_4h` score `16.7406` n `31` status `ready` deltaP `30.8517` edge `1.3016` maxDD `-5.9781`
...
- `market_context_high->equity_24h` score `6.2479` n `103` status `ready` deltaP `17.6595` edge `1.5249` maxDD `-53.663`
...
- `market_context_high->crypto_major_24h` score `1.4221` n `103` status `ready` deltaP `19.5961` edge `2.1216` maxDD `-152.2601`
...
- `risk_on_high->metal_1h` score `0.3134` n `32` status `ready` deltaP `6.25` edge `0.067` maxDD `-1.4793`
- `risk_on_and_context->metal_1h` score `0.3134` n `32` status `ready` deltaP `6.25` edge `0.067` maxDD `-1.4793`
