...
- `market_context_high->equity_24h` score `2.9556` n `103` status `ready` deltaP `4.5729` edge `0.5218` maxDD `-21.1456`
...
- `market_context_high->commodity_1h` score `1.0363` n `113` status `ready` deltaP `12.2331` edge `0.0391` maxDD `-0.7439`
...
- `market_context_high->metal_1h` score `-0.6805` n `113` status `ready` deltaP `-4.6738` edge `-0.0065` maxDD `-0.9664`
...
- `market_context_high->crypto_alt_1h` score `-2.0951` n `113` status `ready` deltaP `-12.4755` edge `-0.0285` maxDD `-2.3669`
- `market_context_high->equity_4h` score `-2.2248` n `104` status `ready` deltaP `0.1993` edge `-0.053` maxDD `-7.6983`
- `market_context_high->crypto_major_1h` score `-2.6785` n `113` status `ready` deltaP `-8.8827` edge `-0.0569` maxDD `-5.2338`
