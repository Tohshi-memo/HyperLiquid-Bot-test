...
- `market_context_high->index_24h` score `1.1772` n `81` status `ready` deltaP `7.0216` edge `0.2026` maxDD `-5.7715`
...
- `market_context_high->crypto_major_4h` score `-7.5748` n `103` status `ready` deltaP `-12.1196` edge `-0.2113` maxDD `-18.1307`
