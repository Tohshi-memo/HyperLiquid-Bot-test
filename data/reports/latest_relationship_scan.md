...
- `news_risk_high->unknown_24h` score `4751.5197` n `64` status `ready` deltaP `38.8889` edge `395.7428` maxDD `-2.0332`
- `news_risk_high->equity_4h` score `5.9754` n `64` status `ready` deltaP `22.0274` edge `0.4108` maxDD `-3.4427`
- `news_risk_high->index_4h` score `2.1762` n `64` status `ready` deltaP `18.3308` edge `0.0782` maxDD `-0.191`
- `market_context_high->crypto_alt_4h` score `1.9464` n `62` status `ready` deltaP `13.6654` edge `0.1668` maxDD `-5.323`
...
- `news_risk_high->crypto_alt_4h` score `0.6742` n `64` status `ready` deltaP `13.2622` edge `0.1372` maxDD `-5.8012`
- `news_risk_high->crypto_alt_1h` score `0.4376` n `64` status `ready` deltaP `8.1119` edge `0.0547` maxDD `-1.8813`
- `news_risk_high->crypto_major_1h` score `0.3734` n `64` status `ready` deltaP `7.2137` edge `0.051` maxDD `-2.0972`
...
- `market_context_high->crypto_alt_1h` score `-0.5392` n `62` status `ready` deltaP `-2.9264` edge `0.0131` maxDD `-3.0178`
