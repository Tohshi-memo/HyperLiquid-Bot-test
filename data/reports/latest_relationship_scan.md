...
- Price records: `672`
- Market context records: `1035`
- Flow alert records: `4888`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->equity_1h` score `-0.6549` n `183` status `ready` deltaP `-0.0925` edge `0.0217` maxDD `-4.3858`
- `market_context_high->commodity_1h` score `-0.6675` n `183` status `ready` deltaP `1.1788` edge `0.0173` maxDD `-3.7959`
- `market_context_high->fx_4h` score `-1.0105` n `182` status `ready` deltaP `1.9247` edge `0.0026` maxDD `-1.6381`
- `market_context_high->crypto_major_1h` score `-1.1308` n `183` status `ready` deltaP `5.678` edge `-0.0081` maxDD `-7.9187`
- `market_context_high->index_4h` score `-1.4112` n `182` status `ready` deltaP `-0.5193` edge `0.0335` maxDD `-6.1444`
- `market_context_high->crypto_alt_1h` score `-1.4377` n `183` status `ready` deltaP `-0.1529` edge `-0.0102` maxDD `-5.3538`
- `market_context_high->equity_4h` score `-1.5949` n `182` status `ready` deltaP `1.7991` edge `0.0703` maxDD `-10.5498`
- `market_context_high->metal_1h` score `-1.9785` n `183` status `ready` deltaP `2.3322` edge `-0.0356` maxDD `-7.2528`
- `market_context_high->crypto_alt_4h` score `-2.9845` n `182` status `ready` deltaP `0.8108` edge `0.0237` maxDD `-15.2248`
- `market_context_high->fx_24h` score `-3.1583` n `182` status `ready` deltaP `3.3944` edge `-0.0199` maxDD `-19.2774`
- `market_context_high->crypto_major_4h` score `-3.2189` n `182` status `ready` deltaP `7.359` edge `0.0533` maxDD `-22.648`
