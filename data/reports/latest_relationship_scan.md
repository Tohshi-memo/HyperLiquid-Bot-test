...
- `market_context_high->fx_1h` score `-0.338` n `253` status `ready` deltaP `0.7964` edge `-0.0001` maxDD `-0.5499`
...
- `news_risk_high->commodity_4h` score `-1.7708` n `30` status `ready` deltaP `-13.2723` edge `-0.051` maxDD `-2.3372`
- `market_context_high->fx_24h` score `-1.8132` n `228` status `ready` deltaP `4.8794` edge `0.0168` maxDD `-5.5435`
- `market_context_high->metal_4h` score `-1.9894` n `253` status `ready` deltaP `-4.014` edge `-0.0368` maxDD `-7.9859`
