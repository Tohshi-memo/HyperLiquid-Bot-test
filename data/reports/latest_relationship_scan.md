...
- `market_context_high->crypto_major_24h` score `2.6748` n `91` status `ready` deltaP `9.5086` edge `0.2803` maxDD `-4.9964`
- `market_context_high->commodity_24h` score `1.6009` n `91` status `ready` deltaP `18.5955` edge `0.2646` maxDD `-4.666`
- `market_context_high->equity_1h` score `1.3826` n `96` status `ready` deltaP `11.4085` edge `0.0693` maxDD `-0.4112`
...
- `market_context_high->crypto_major_4h` score `0.7424` n `96` status `ready` deltaP `9.3242` edge `0.1018` maxDD `-3.1677`
- `market_context_high->index_1h` score `0.7114` n `96` status `ready` deltaP `13.367` edge `0.0089` maxDD `-0.0982`
- `market_context_high->unknown_1h` score `0.4974` n `96` status `ready` deltaP `9.6557` edge `-0.0002` maxDD `-0.4843`
