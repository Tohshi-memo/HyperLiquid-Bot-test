...
- `market_context_high->unknown_24h` score `89.9763` n `150` status `ready` deltaP `-30.3194` edge `7.9914` maxDD `-9.6329`
- `risk_on_high->unknown_24h` score `32.9439` n `32` status `ready` deltaP `-44.4444` edge `4.5949` maxDD `-1.6689`
- `risk_on_and_context->unknown_24h` score `32.9439` n `32` status `ready` deltaP `-44.4444` edge `4.5949` maxDD `-1.6689`
- `news_risk_high->equity_24h` score `9.7822` n `36` status `ready` deltaP `10.0694` edge `0.786` maxDD `-1.0358`
...
- `news_risk_high->equity_1h` score `1.641` n `36` status `ready` deltaP `8.4332` edge `0.1124` maxDD `-0.5496`
