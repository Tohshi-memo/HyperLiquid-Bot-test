...
- Price records: `672`
- Market context records: `1983`
- Flow alert records: `7600`
- Minimum samples: `30`
- Pattern count: `80`
...
- `market_context_high->crypto_alt_4h` score `7.406` n `234` status `ready` deltaP `22.5649` edge `0.5812` maxDD `-5.1574`
- `market_context_high->crypto_major_4h` score `6.8648` n `234` status `ready` deltaP `26.3511` edge `0.521` maxDD `-4.9684`
...
- `market_context_high->metal_24h` score `1.8803` n `199` status `ready` deltaP `16.4392` edge `0.2897` maxDD `-12.7414`
...
- `market_context_high->crypto_major_1h` score `1.0411` n `234` status `ready` deltaP `9.7011` edge `0.1207` maxDD `-3.2225`
- `market_context_high->crypto_alt_1h` score `0.8135` n `234` status `ready` deltaP `8.3948` edge `0.1232` maxDD `-4.9097`
- `market_context_high->index_24h` score `0.5041` n `199` status `ready` deltaP `4.1922` edge `0.1369` maxDD `-4.1604`
- `market_context_high->crypto_major_24h` score `0.4089` n `199` status `ready` deltaP `19.6591` edge `0.7616` maxDD `-62.3533`
...
- `market_context_high->equity_1h` score `-0.1905` n `234` status `ready` deltaP `4.2006` edge `0.0355` maxDD `-2.6836`
...
- `market_context_high->metal_1h` score `-1.3767` n `234` status `ready` deltaP `2.4989` edge `0.0022` maxDD `-6.3532`
- `market_context_high->unknown_1h` score `-1.4652` n `234` status `ready` deltaP `0.9584` edge `-0.0333` maxDD `-3.6151`
