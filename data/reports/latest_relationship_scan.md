...
- `market_context_high->unknown_24h` score `25.5162` n `109` status `ready` deltaP `3.7571` edge `2.1056` maxDD `-0.0104`
...
- `market_context_high->fx_1h` score `-0.0108` n `120` status `ready` deltaP `5.7036` edge `-0.0044` maxDD `-0.8012`
- `market_context_high->fx_4h` score `-0.3942` n `120` status `ready` deltaP `5.4545` edge `-0.0009` maxDD `-1.8797`
- `market_context_high->metal_1h` score `-0.5358` n `120` status `ready` deltaP `-1.9261` edge `-0.0064` maxDD `-1.6224`
...
- `market_context_high->index_24h` score `-1.2606` n `109` status `ready` deltaP `-3.0494` edge `0.0782` maxDD `-7.8922`
- `market_context_high->metal_4h` score `-1.2909` n `120` status `ready` deltaP `1.4394` edge `0.0063` maxDD `-3.211`
- `market_context_high->equity_1h` score `-1.3716` n `120` status `ready` deltaP `3.3483` edge `-0.0417` maxDD `-10.5179`
...
- `market_context_high->crypto_alt_24h` score `-3.0818` n `109` status `ready` deltaP `-6.6471` edge `-0.0682` maxDD `-4.5445`
