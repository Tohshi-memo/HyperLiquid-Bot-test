...
- `market_context_high->unknown_1h` score `-0.072` n `96` status `ready` deltaP `5.9132` edge `-0.0227` maxDD `-0.4843`
...
- `market_context_high->commodity_4h` score `-0.7423` n `96` status `ready` deltaP `-2.4644` edge `0.0063` maxDD `-2.4692`
...
- `market_context_high->crypto_major_4h` score `-1.9296` n `96` status `ready` deltaP `7.7998` edge `-0.1107` maxDD `-3.1677`
