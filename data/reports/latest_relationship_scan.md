...
- Price records: `672`
- Market context records: `1886`
- Flow alert records: `7329`
- Minimum samples: `30`
- Pattern count: `48`
...
- `market_context_high->unknown_4h` score `4.3445` n `199` status `ready` deltaP `18.1104` edge `0.4437` maxDD `-9.8581`
- `market_context_high->metal_24h` score `3.1986` n `183` status `ready` deltaP `18.5024` edge `0.3858` maxDD `-12.7414`
- `market_context_high->equity_4h` score `2.3634` n `199` status `ready` deltaP `14.4296` edge `0.2102` maxDD `-5.0894`
- `market_context_high->index_24h` score `1.8703` n `183` status `ready` deltaP `11.3844` edge `0.2028` maxDD `-4.1604`
- `market_context_high->unknown_24h` score `1.6656` n `183` status `ready` deltaP `12.8756` edge `0.585` maxDD `-35.8966`
...
- `market_context_high->equity_24h` score `0.0957` n `183` status `ready` deltaP `10.2772` edge `0.4293` maxDD `-33.1875`
- `market_context_high->equity_1h` score `-0.1431` n `199` status `ready` deltaP `4.5377` edge `0.0372` maxDD `-2.6836`
- `market_context_high->crypto_major_24h` score `-0.2361` n `183` status `ready` deltaP `18.4056` edge `0.7162` maxDD `-62.3533`
- `market_context_high->metal_1h` score `-0.4931` n `199` status `ready` deltaP `6.8802` edge `0.0245` maxDD `-6.3532`
- `market_context_high->unknown_1h` score `-0.5156` n `199` status `ready` deltaP `3.1377` edge `0.0313` maxDD `-3.6151`
