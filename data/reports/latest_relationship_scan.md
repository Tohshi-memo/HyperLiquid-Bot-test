...
- `market_context_high->unknown_1h` score `1.2744` n `133` status `ready` deltaP `8.5375` edge `0.072` maxDD `-0.4843`
...
- `market_context_high->crypto_alt_1h` score `-0.6668` n `133` status `ready` deltaP `0.4199` edge `0.0218` maxDD `-2.413`
...
- `market_context_high->crypto_major_1h` score `-1.1921` n `133` status `ready` deltaP `-1.2505` edge `-0.042` maxDD `-4.1996`
- `market_context_high->crypto_alt_4h` score `-1.3129` n `132` status `ready` deltaP `3.3721` edge `-0.0049` maxDD `-5.4926`
- `market_context_high->equity_4h` score `-1.8656` n `132` status `ready` deltaP `-2.319` edge `0.0568` maxDD `-16.1079`
- `market_context_high->fx_24h` score `-2.6423` n `105` status `ready` deltaP `-8.6558` edge `-0.0015` maxDD `-2.2121`
- `market_context_high->crypto_major_4h` score `-3.9257` n `132` status `ready` deltaP `-0.3973` edge `-0.2224` maxDD `-3.1677`
