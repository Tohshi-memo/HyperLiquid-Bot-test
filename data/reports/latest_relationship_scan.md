...
- `market_context_high->commodity_1h` score `-1.1235` n `149` status `ready` deltaP `-8.3219` edge `-0.0028` maxDD `-1.1941`
- `market_context_high->equity_4h` score `-1.6705` n `145` status `ready` deltaP `-0.4825` edge `0.0697` maxDD `-16.1188`
- `market_context_high->crypto_alt_4h` score `-2.1809` n `145` status `ready` deltaP `4.5564` edge `-0.0653` maxDD `-7.0785`
- `market_context_high->commodity_24h` score `-2.336` n `133` status `ready` deltaP `-6.6364` edge `0.0329` maxDD `-4.666`
- `market_context_high->crypto_alt_1h` score `-2.3865` n `149` status `ready` deltaP `-1.935` edge `-0.0365` maxDD `-7.9582`
- `market_context_high->crypto_major_1h` score `-3.4709` n `149` status `ready` deltaP `-4.7592` edge `-0.1098` maxDD `-7.8171`
- `market_context_high->index_24h` score `-4.4886` n `133` status `ready` deltaP `-8.6454` edge `-0.0371` maxDD `-21.1244`
- `market_context_high->crypto_major_4h` score `-5.438` n `145` status `ready` deltaP `0.0337` edge `-0.3204` maxDD `-5.6395`
