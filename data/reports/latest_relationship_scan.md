...
- `risk_on_high->unknown_1h` score `2.1718` n `107` status `ready` deltaP `4.5694` edge `0.2082` maxDD `-1.9475`
- `risk_on_and_context->unknown_1h` score `2.1718` n `107` status `ready` deltaP `4.5694` edge `0.2082` maxDD `-1.9475`
- `market_context_high->unknown_1h` score `2.0411` n `151` status `ready` deltaP `3.9319` edge `0.2069` maxDD `-2.042`
- `news_risk_high->unknown_1h` score `1.4439` n `60` status `ready` deltaP `2.6847` edge `0.1371` maxDD `-1.1072`
...
- `news_risk_high->commodity_4h` score `-0.0438` n `60` status `ready` deltaP `2.8354` edge `0.0114` maxDD `-0.8733`
