...
- `market_context_high->commodity_4h` score `0.6902` n `169` status `ready` deltaP `10.7662` edge `0.0572` maxDD `-2.7169`
- `market_context_high->commodity_1h` score `0.6693` n `180` status `ready` deltaP `9.3114` edge `0.028` maxDD `-0.7439`
...
- `market_context_high->metal_1h` score `-0.9518` n `180` status `ready` deltaP `-6.843` edge `-0.0128` maxDD `-2.0884`
...
- `market_context_high->crypto_alt_1h` score `-2.6309` n `180` status `ready` deltaP `-9.1084` edge `-0.04` maxDD `-6.4812`
...
- `market_context_high->crypto_alt_4h` score `-6.6378` n `169` status `ready` deltaP `-12.4116` edge `-0.1356` maxDD `-20.1177`
- `market_context_high->crypto_major_24h` score `-7.086` n `133` status `ready` deltaP `-15.2744` edge `-0.2295` maxDD `-33.5037`
- `market_context_high->crypto_alt_24h` score `-9.0797` n `133` status `ready` deltaP `-11.3433` edge `-0.2012` maxDD `-27.3857`
