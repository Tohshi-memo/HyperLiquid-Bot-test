...
- `news_risk_high->crypto_alt_24h` score `15.3618` n `32` status `ready` deltaP `43.2292` edge `1.0067` maxDD `-0.5131`
...
- `news_risk_high->crypto_major_1h` score `1.4772` n `32` status `ready` deltaP `14.5771` edge `0.1389` maxDD `-2.0691`
- `news_risk_high->crypto_alt_1h` score `0.9564` n `32` status `ready` deltaP `12.0696` edge `0.0883` maxDD `-1.6923`
- `market_context_high->unknown_1h` score `0.549` n `208` status `ready` deltaP `-4.9401` edge `0.1795` maxDD `-3.7317`
...
- `news_risk_high->unknown_1h` score `-1.0081` n `32` status `ready` deltaP `4.4349` edge `-0.0791` maxDD `-0.7581`
- `market_context_high->crypto_alt_1h` score `-1.045` n `208` status `ready` deltaP `4.1369` edge `0.0137` maxDD `-9.3536`
