...
- `market_context_high->equity_1h` score `-0.6944` n `285` status `ready` deltaP `2.4635` edge `0.0264` maxDD `-5.0555`
...
- `market_context_high->crypto_alt_1h` score `-0.9827` n `285` status `ready` deltaP `1.1861` edge `0.0306` maxDD `-5.6318`
...
- `market_context_high->crypto_alt_4h` score `-3.9577` n `285` status `ready` deltaP `5.6397` edge `0.1016` maxDD `-26.1874`
