...
- `market_context_high->crypto_alt_24h` score `17.5775` n `40` status `ready` deltaP `58.9236` edge `1.1117` maxDD `-2.1786`
- `market_context_high->commodity_24h` score `10.7946` n `40` status `ready` deltaP `51.3194` edge `0.5702` maxDD `-0.6889`
- `news_risk_high->equity_4h` score `4.7614` n `68` status `ready` deltaP `18.203` edge `0.3518` maxDD `-3.4427`
...
- `news_risk_high->equity_1h` score `0.7259` n `68` status `ready` deltaP `10.5407` edge `0.0725` maxDD `-2.916`
- `market_context_high->crypto_alt_4h` score `0.7091` n `40` status `ready` deltaP `9.1159` edge `0.1207` maxDD `-4.9116`
...
- `news_risk_high->crypto_alt_1h` score `0.124` n `68` status `ready` deltaP `6.9303` edge `0.0379` maxDD `-3.1233`
...
- `market_context_high->crypto_alt_1h` score `-0.384` n `40` status `ready` deltaP `1.0479` edge `0.0065` maxDD `-3.0178`
