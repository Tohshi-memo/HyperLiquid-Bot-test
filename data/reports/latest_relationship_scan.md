...
- `news_risk_high->unknown_24h` score `43.6187` n `51` status `ready` deltaP `2.0833` edge `3.621` maxDD `0.0`
- `news_risk_high->unknown_4h` score `12.4952` n `52` status `ready` deltaP `23.7453` edge `0.888` maxDD `-0.0695`
- `news_risk_high->equity_24h` score `9.408` n `51` status `ready` deltaP `35.2022` edge `0.6424` maxDD `-4.7801`
...
- `news_risk_high->equity_4h` score `2.2758` n `52` status `ready` deltaP `22.3499` edge `0.1177` maxDD `-2.164`
- `market_context_high->unknown_4h` score `2.0027` n `133` status `ready` deltaP `20.0727` edge `0.0739` maxDD `-0.5994`
- `news_risk_high->fx_1h` score `1.1513` n `53` status `ready` deltaP `15.9191` edge `0.0068` maxDD `-0.0257`
- `news_risk_high->equity_1h` score `0.6383` n `53` status `ready` deltaP `15.1706` edge `0.0171` maxDD `-0.9128`
...
- `news_risk_high->metal_4h` score `-0.2878` n `52` status `ready` deltaP `6.4845` edge `-0.0141` maxDD `-0.249`
...
- `market_context_high->metal_4h` score `-0.7281` n `133` status `ready` deltaP `6.0941` edge `-0.0376` maxDD `-2.4293`
