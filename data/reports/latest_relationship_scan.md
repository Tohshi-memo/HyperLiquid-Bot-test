...
- `news_risk_high->unknown_24h` score `6268.5461` n `52` status `ready` deltaP `44.0438` edge `522.1273` maxDD `-2.0332`
...
- `news_risk_high->crypto_major_4h` score `1.4007` n `61` status `ready` deltaP `7.9118` edge `0.1962` maxDD `-2.8833`
- `news_risk_high->crypto_alt_4h` score `1.3991` n `61` status `ready` deltaP `17.7079` edge `0.2005` maxDD `-5.8012`
...
- `news_risk_high->fx_4h` score `0.0404` n `61` status `ready` deltaP `11.6429` edge `0.0215` maxDD `-0.6604`
...
- `news_risk_high->crypto_major_24h` score `-40.6199` n `52` status `ready` deltaP `-31.0496` edge `-1.7255` maxDD `-103.8662`
