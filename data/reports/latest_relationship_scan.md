...
- `market_context_high->equity_24h` score `4.0257` n `93` status `ready` deltaP `2.6938` edge `0.6235` maxDD `-21.1456`
...
- `market_context_high->crypto_alt_1h` score `-1.917` n `103` status `ready` deltaP `-10.729` edge `-0.0253` maxDD `-2.3669`
- `market_context_high->crypto_major_1h` score `-2.4445` n `103` status `ready` deltaP `-7.8847` edge `-0.0515` maxDD `-4.6382`
- `market_context_high->crypto_major_24h` score `-2.8034` n `93` status `ready` deltaP `3.8866` edge `-0.1359` maxDD `-14.2873`
- `market_context_high->crypto_alt_24h` score `-3.2746` n `93` status `ready` deltaP `-16.6219` edge `-0.1647` maxDD `-4.5445`
- `market_context_high->crypto_alt_4h` score `-4.1504` n `103` status `ready` deltaP `-11.0363` edge `-0.1071` maxDD `-6.5487`
- `market_context_high->crypto_major_4h` score `-7.8267` n `103` status `ready` deltaP `-13.9489` edge `-0.2201` maxDD `-18.1307`
