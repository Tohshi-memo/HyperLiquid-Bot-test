...
- `news_risk_high->unknown_4h` score `365.6378` n `83` status `ready` deltaP `-21.6629` edge `30.7037` maxDD `-4.1571`
- `news_risk_high->crypto_alt_24h` score `24.4407` n `78` status `ready` deltaP `47.7698` edge `1.7573` maxDD `-1.4564`
- `news_risk_high->crypto_major_24h` score `21.0877` n `78` status `ready` deltaP `39.7303` edge `1.6395` maxDD `-9.098`
...
- `risk_on_high->fx_24h` score `2.3753` n `52` status `ready` deltaP `31.9311` edge `-0.0107` maxDD `-0.0054`
- `risk_on_and_context->fx_24h` score `2.3753` n `52` status `ready` deltaP `31.9311` edge `-0.0107` maxDD `-0.0054`
- `market_context_high->fx_24h` score `2.2404` n `149` status `ready` deltaP `29.1562` edge `0.0139` maxDD `-0.0593`
...
- `risk_on_high->crypto_alt_4h` score `0.5401` n `52` status `ready` deltaP `10.4597` edge `0.161` maxDD `-6.2526`
- `risk_on_and_context->crypto_alt_4h` score `0.5401` n `52` status `ready` deltaP `10.4597` edge `0.161` maxDD `-6.2526`
