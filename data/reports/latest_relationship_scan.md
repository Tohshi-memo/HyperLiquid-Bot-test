...
- `news_risk_high->unknown_4h` score `12.668` n `53` status `ready` deltaP `24.675` edge `0.9011` maxDD `-0.1281`
- `news_risk_high->equity_24h` score `7.0509` n `51` status `ready` deltaP `29.9939` edge `0.4807` maxDD `-4.7801`
- `news_risk_high->crypto_alt_24h` score `4.5183` n `51` status `ready` deltaP `27.6042` edge `0.1925` maxDD `0.0`
...
- `market_context_high->unknown_4h` score `2.7094` n `133` status `ready` deltaP `22.8166` edge `0.1145` maxDD `-0.5994`
