...
- `news_risk_high->equity_24h` score `7.5009` n `51` status `ready` deltaP `29.9939` edge `0.5182` maxDD `-4.7801`
- `news_risk_high->index_24h` score `4.0244` n `51` status `ready` deltaP `40.2676` edge `0.0821` maxDD `-0.2147`
- `news_risk_high->unknown_1h` score `3.2053` n `53` status `ready` deltaP `16.3117` edge `0.1939` maxDD `-0.8426`
...
- `news_risk_high->crypto_alt_24h` score `0.71` n `51` status `ready` deltaP `23.7847` edge `-0.0994` maxDD `0.0`
...
- `market_context_high->unknown_1h` score `0.1878` n `133` status `ready` deltaP `11.8713` edge `-0.0186` maxDD `-1.5916`
- `news_risk_high->metal_24h` score `0.17` n `51` status `ready` deltaP `25.4698` edge `-0.1514` maxDD `-0.0053`
