...
- `risk_on_high->unknown_4h` score `22.6591` n `140` status `ready` deltaP `5.3833` edge `1.9142` maxDD `-2.2797`
- `risk_on_and_context->unknown_4h` score `22.6591` n `140` status `ready` deltaP `5.3833` edge `1.9142` maxDD `-2.2797`
- `market_context_high->unknown_4h` score `10.7259` n `228` status `ready` deltaP `6.0976` edge `0.9262` maxDD `-2.8419`
- `news_risk_high->crypto_alt_24h` score `7.4831` n `37` status `ready` deltaP `25.1783` edge `0.4827` maxDD `-0.8236`
- `news_risk_high->commodity_24h` score `3.942` n `37` status `ready` deltaP `21.1806` edge `0.1873` maxDD `0.0`
- `news_risk_high->crypto_major_4h` score `3.657` n `37` status `ready` deltaP `17.1803` edge `0.2315` maxDD `-0.9693`
...
- `news_risk_high->crypto_major_1h` score `1.1655` n `37` status `ready` deltaP `6.1661` edge `0.0743` maxDD `-0.4628`
...
- `news_risk_high->crypto_alt_4h` score `0.6335` n `37` status `ready` deltaP `6.3983` edge `0.043` maxDD `-1.296`
...
- `risk_on_high->crypto_major_24h` score `0.1973` n `119` status `ready` deltaP `20.1433` edge `0.7654` maxDD `-56.9519`
- `risk_on_and_context->crypto_major_24h` score `0.1973` n `119` status `ready` deltaP `20.1433` edge `0.7654` maxDD `-56.9519`
