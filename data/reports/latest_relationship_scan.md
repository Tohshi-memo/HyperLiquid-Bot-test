...
- `market_context_high->unknown_1h` score `84.7999` n `47` status `ready` deltaP `10.116` edge `7.0063` maxDD `-0.2334`
...
- `market_context_high->equity_24h` score `25.0741` n `47` status `ready` deltaP `31.8114` edge `1.913` maxDD `-2.1786`
- `market_context_high->index_24h` score `7.9046` n `47` status `ready` deltaP `35.4573` edge `0.4353` maxDD `-0.3705`
- `news_risk_high->unknown_1h` score `6.9442` n `113` status `ready` deltaP `-4.2128` edge `0.6312` maxDD `-0.9543`
- `market_context_high->metal_24h` score `4.061` n `47` status `ready` deltaP `34.5375` edge `0.132` maxDD `-0.2401`
- `news_risk_high->crypto_alt_1h` score `3.3315` n `113` status `ready` deltaP `16.0895` edge `0.2194` maxDD `-1.5895`
...
- `news_risk_high->crypto_major_1h` score `2.5443` n `113` status `ready` deltaP `16.5651` edge `0.1451` maxDD `-1.8141`
...
- `news_risk_high->metal_1h` score `1.5719` n `113` status `ready` deltaP `20.1009` edge `0.0255` maxDD `-0.6142`
- `market_context_high->index_1h` score `1.0242` n `47` status `ready` deltaP `15.3586` edge `0.0108` maxDD `-0.2275`
- `market_context_high->equity_1h` score `0.9834` n `47` status `ready` deltaP `12.0652` edge `0.0418` maxDD `-1.5564`
