...
- `market_context_high->crypto_alt_4h` score `-0.1776` n `237` status `ready` deltaP `5.612` edge `0.1327` maxDD `-9.46`
...
- `market_context_high->crypto_alt_1h` score `-0.6525` n `237` status `ready` deltaP `1.137` edge `0.0342` maxDD `-5.0257`
- `market_context_high->crypto_major_1h` score `-0.6721` n `237` status `ready` deltaP `3.9813` edge `0.042` maxDD `-6.9639`
...
- `market_context_high->crypto_alt_24h` score `-13.1951` n `174` status `ready` deltaP `-4.2265` edge `-0.2017` maxDD `-54.2437`
