...
- Price records: `594`
- Market context records: `696`
- Flow alert records: `1968`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_alt_24h` score `6.6069` n `146` status `ready` deltaP `8.3512` edge `0.4997` maxDD `-0.0508`
...
- `market_context_high->commodity_1h` score `-0.5057` n `149` status `ready` deltaP `2.2356` edge `0.0404` maxDD `-3.7959`
- `market_context_high->index_1h` score `-0.5843` n `149` status `ready` deltaP `0.8464` edge `0.0048` maxDD `-2.8282`
...
- `market_context_high->unknown_1h` score `-1.2144` n `149` status `ready` deltaP `-4.3898` edge `-0.0116` maxDD `-2.1602`
...
- `market_context_high->index_4h` score `-1.6075` n `149` status `ready` deltaP `2.957` edge `-0.0014` maxDD `-6.5149`
...
- `market_context_high->equity_4h` score `-2.5913` n `149` status `ready` deltaP `-0.8757` edge `0.0051` maxDD `-10.5498`
...
- `market_context_high->commodity_4h` score `-3.8148` n `149` status `ready` deltaP `-6.2413` edge `0.0738` maxDD `-13.0076`
- `market_context_high->unknown_4h` score `-4.4225` n `149` status `ready` deltaP `2.3815` edge `-0.1966` maxDD `-8.3588`
