...
- `market_context_high->unknown_1h` score `84.1675` n `47` status `ready` deltaP `9.8166` edge `6.9556` maxDD `-0.2334`
- `market_context_high->crypto_major_24h` score `46.7405` n `47` status `ready` deltaP `30.4226` edge `3.7315` maxDD `-2.4756`
- `market_context_high->crypto_alt_24h` score `30.8668` n `47` status `ready` deltaP `24.782` edge `2.445` maxDD `-2.7051`
- `market_context_high->equity_24h` score `25.6049` n `47` status `ready` deltaP `33.7212` edge `1.9445` maxDD `-2.1786`
- `news_risk_high->unknown_1h` score `8.6445` n `114` status `ready` deltaP `-2.5948` edge `0.7621` maxDD `-0.9543`
...
- `news_risk_high->commodity_24h` score `3.4043` n `71` status `ready` deltaP `31.7121` edge `0.1071` maxDD `-1.7857`
- `news_risk_high->crypto_alt_1h` score `3.0111` n `114` status `ready` deltaP `15.4297` edge `0.199` maxDD `-1.7416`
...
- `news_risk_high->crypto_major_4h` score `0.9771` n `102` status `ready` deltaP `12.1622` edge `0.2135` maxDD `-13.719`
...
- `news_risk_high->crypto_alt_4h` score `0.8304` n `102` status `ready` deltaP `6.0198` edge `0.2742` maxDD `-15.9436`
