...
- `market_context_high->commodity_24h` score `0.7169` n `193` status `ready` deltaP `10.7796` edge `0.1747` maxDD `-5.2791`
- `market_context_high->unknown_24h` score `0.6485` n `193` status `ready` deltaP `-1.8126` edge `0.4282` maxDD `-12.3047`
- `market_context_high->crypto_major_1h` score `0.129` n `203` status `ready` deltaP `8.9636` edge `0.0511` maxDD `-4.2122`
- `market_context_high->crypto_alt_1h` score `-0.081` n `203` status `ready` deltaP `6.2011` edge `0.045` maxDD `-3.7803`
...
- `market_context_high->crypto_major_4h` score `-0.9784` n `203` status `ready` deltaP `11.1769` edge `0.1315` maxDD `-16.8495`
- `market_context_high->metal_1h` score `-1.0909` n `203` status `ready` deltaP `-2.758` edge `0.0016` maxDD `-1.5966`
- `market_context_high->crypto_alt_4h` score `-1.3542` n `203` status `ready` deltaP `7.8697` edge `0.1141` maxDD `-19.2145`
...
- `market_context_high->metal_24h` score `-5.9277` n `193` status `ready` deltaP `-3.168` edge `0.0228` maxDD `-24.5982`
- `market_context_high->fx_24h` score `-6.2587` n `193` status `ready` deltaP `-10.7813` edge `-0.0081` maxDD `-10.6603`
