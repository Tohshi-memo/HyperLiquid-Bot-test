...
- `market_context_high->crypto_major_24h` score `2.6475` n `92` status `ready` deltaP `8.9674` edge `0.2985` maxDD `-5.6792`
...
- `risk_on_high->crypto_major_1h` score `1.0875` n `35` status `ready` deltaP `12.1086` edge `0.0405` maxDD `-1.1144`
- `risk_on_and_context->crypto_major_1h` score `1.0875` n `35` status `ready` deltaP `12.1086` edge `0.0405` maxDD `-1.1144`
...
- `risk_on_high->commodity_4h` score `0.3237` n `35` status `ready` deltaP `2.4564` edge `0.0735` maxDD `-1.3651`
- `risk_on_and_context->commodity_4h` score `0.3237` n `35` status `ready` deltaP `2.4564` edge `0.0735` maxDD `-1.3651`
- `market_context_high->commodity_24h` score `0.308` n `92` status `ready` deltaP `17.8216` edge `0.104` maxDD `-4.666`
...
- `market_context_high->commodity_4h` score `0.2608` n `127` status `ready` deltaP `10.3754` edge `0.0493` maxDD `-2.4692`
