...
- `market_context_high->crypto_alt_4h` score `7.6606` n `230` status `ready` deltaP `23.4676` edge `0.5964` maxDD `-5.1574`
- `market_context_high->unknown_4h` score `3.3495` n `230` status `ready` deltaP `14.947` edge `0.3409` maxDD `-7.9138`
- `market_context_high->equity_4h` score `2.2631` n `230` status `ready` deltaP `14.0616` edge `0.2043` maxDD `-5.0894`
...
- `market_context_high->crypto_alt_1h` score `0.8656` n `230` status `ready` deltaP `8.4457` edge `0.1272` maxDD `-4.9097`
...
- `market_context_high->metal_1h` score `-0.9389` n `230` status `ready` deltaP `1.8316` edge `0.001` maxDD `-6.3532`
- `market_context_high->fx_4h` score `-1.2141` n `230` status `ready` deltaP `-9.4234` edge `-0.0041` maxDD `-1.0983`
- `market_context_high->unknown_1h` score `-1.3751` n `230` status `ready` deltaP `1.1898` edge `-0.0275` maxDD `-3.6022`
- `market_context_high->commodity_1h` score `-1.8994` n `230` status `ready` deltaP `1.7534` edge `0.0006` maxDD `-15.7972`
