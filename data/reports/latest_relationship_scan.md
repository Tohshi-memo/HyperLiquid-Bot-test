...
- `market_context_high->unknown_1h` score `1.2204` n `133` status `ready` deltaP `8.5375` edge `0.0675` maxDD `-0.4843`
- `market_context_high->index_1h` score `0.2067` n `133` status `ready` deltaP `11.205` edge `0.0049` maxDD `-0.9144`
- `market_context_high->unknown_4h` score `0.1866` n `133` status `ready` deltaP `21.7002` edge `-0.0852` maxDD `-0.5133`
...
- `market_context_high->crypto_alt_1h` score `-0.6644` n `133` status `ready` deltaP `0.7193` edge `0.02` maxDD `-2.413`
...
- `market_context_high->crypto_major_1h` score `-1.2303` n `133` status `ready` deltaP `-1.5499` edge `-0.0449` maxDD `-4.1996`
- `market_context_high->crypto_alt_4h` score `-1.2862` n `133` status `ready` deltaP `4.0506` edge `-0.0072` maxDD `-5.4926`
...
- `market_context_high->crypto_major_4h` score `-3.9253` n `133` status `ready` deltaP `0.0276` edge `-0.2252` maxDD `-3.1677`
