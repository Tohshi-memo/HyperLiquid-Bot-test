...
- `news_risk_high->crypto_major_24h` score `24.7061` n `98` status `ready` deltaP `12.7906` edge `2.6594` maxDD `-46.1999`
- `news_risk_high->crypto_alt_24h` score `20.2983` n `98` status `ready` deltaP `15.0935` edge `2.079` maxDD `-32.7147`
- `news_risk_high->crypto_alt_4h` score `4.6244` n `101` status `ready` deltaP `20.5958` edge `0.369` maxDD `-7.675`
- `news_risk_high->crypto_major_4h` score `3.7837` n `101` status `ready` deltaP `20.4434` edge `0.3048` maxDD `-8.0625`
- `news_risk_high->crypto_alt_1h` score `2.7414` n `101` status `ready` deltaP `16.5308` edge `0.1648` maxDD `-2.058`
- `news_risk_high->crypto_major_1h` score `2.0508` n `101` status `ready` deltaP `18.1775` edge `0.102` maxDD `-2.8494`
- `market_context_high->fx_1h` score `1.213` n `51` status `ready` deltaP `16.2469` edge `0.0107` maxDD `-0.1012`
- `market_context_high->commodity_4h` score `1.1932` n `43` status `ready` deltaP `27.2015` edge `0.0186` maxDD `-1.4245`
...
- `market_context_high->fx_4h` score `0.3938` n `43` status `ready` deltaP `10.848` edge `0.0064` maxDD `-0.2586`
...
- `market_context_high->index_1h` score `0.2179` n `51` status `ready` deltaP `5.0663` edge `0.0109` maxDD `-0.1211`
