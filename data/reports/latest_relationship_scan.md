...
- `market_context_high->unknown_4h` score `1.1365` n `123` status `ready` deltaP `22.002` edge `-0.0348` maxDD `-0.3736`
- `market_context_high->commodity_24h` score `1.1151` n `106` status `ready` deltaP `2.3356` edge `0.1204` maxDD `-0.7768`
- `market_context_high->crypto_alt_4h` score `0.9341` n `123` status `ready` deltaP `8.3333` edge `0.1691` maxDD `-7.0785`
