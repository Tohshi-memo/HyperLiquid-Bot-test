...
- `market_context_high->crypto_alt_24h` score `17.433` n `53` status `ready` deltaP `56.5776` edge `1.1153` maxDD `-2.1786`
- `news_risk_high->equity_4h` score `5.4965` n `65` status `ready` deltaP `19.4114` edge `0.3925` maxDD `-3.4427`
- `news_risk_high->index_4h` score `2.1426` n `65` status `ready` deltaP `18.954` edge `0.0762` maxDD `-0.2539`
- `market_context_high->commodity_24h` score `1.8552` n `53` status `ready` deltaP `28.3509` edge `0.2347` maxDD `-10.2019`
- `market_context_high->crypto_alt_4h` score `0.684` n `53` status `ready` deltaP `9.1953` edge `0.1221` maxDD `-5.323`
...
- `news_risk_high->crypto_alt_1h` score `0.1427` n `68` status `ready` deltaP `6.7806` edge `0.0413` maxDD `-3.1233`
...
- `news_risk_high->index_1h` score `-0.0676` n `68` status `ready` deltaP `2.316` edge `0.0082` maxDD `-0.5845`
...
- `news_risk_high->crypto_major_1h` score `-0.1586` n `68` status `ready` deltaP `2.5185` edge `0.0349` maxDD `-3.762`
- `news_risk_high->crypto_major_4h` score `-0.2494` n `65` status `ready` deltaP `3.9704` edge `0.1015` maxDD `-9.7953`
- `market_context_high->commodity_4h` score `-0.2746` n `53` status `ready` deltaP `3.4198` edge `0.0295` maxDD `-3.0005`
