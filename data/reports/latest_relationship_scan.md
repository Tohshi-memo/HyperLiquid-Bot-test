...
- `news_risk_high->unknown_4h` score `384.8138` n `83` status `ready` deltaP `-20.7483` edge `32.2956` maxDD `-4.1571`
- `news_risk_high->crypto_alt_24h` score `15.5303` n `83` status `ready` deltaP `36.6152` edge `1.188` maxDD `-9.3661`
- `news_risk_high->crypto_major_24h` score `14.2477` n `83` status `ready` deltaP `28.6814` edge `1.1956` maxDD `-13.2931`
- `news_risk_high->equity_24h` score `10.5354` n `83` status `ready` deltaP `37.9142` edge `0.8026` maxDD `-6.5262`
- `risk_on_high->commodity_24h` score `8.162` n `52` status `ready` deltaP `44.9653` edge `0.3804` maxDD `0.0`
- `risk_on_and_context->commodity_24h` score `8.162` n `52` status `ready` deltaP `44.9653` edge `0.3804` maxDD `0.0`
- `market_context_high->commodity_24h` score `6.8629` n `149` status `ready` deltaP `38.2539` edge `0.3694` maxDD `-0.8682`
