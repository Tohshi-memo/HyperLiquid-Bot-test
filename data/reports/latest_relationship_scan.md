...
- Price records: `672`
- Market context records: `1782`
- Flow alert records: `7026`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->metal_24h` score `7.1256` n `184` status `ready` deltaP `28.1401` edge `0.6488` maxDD `-12.7414`
...
- `market_context_high->crypto_major_4h` score `4.5016` n `194` status `ready` deltaP `22.935` edge `0.4628` maxDD `-10.9117`
- `market_context_high->unknown_4h` score `3.6898` n `194` status `ready` deltaP `15.4497` edge `0.4316` maxDD `-11.1695`
...
- `market_context_high->equity_24h` score `2.0111` n `184` status `ready` deltaP `16.1156` edge `0.55` maxDD `-33.1875`
- `market_context_high->unknown_24h` score `1.5694` n `184` status `ready` deltaP `13.4134` edge `0.5734` maxDD `-35.8966`
...
- `news_risk_high->unknown_4h` score `0.5077` n `30` status `ready` deltaP `10.7418` edge `0.0658` maxDD `-2.7857`
- `market_context_high->crypto_major_1h` score `0.1965` n `197` status `ready` deltaP `4.8482` edge `0.0914` maxDD `-3.9211`
- `market_context_high->equity_1h` score `0.0812` n `197` status `ready` deltaP `5.1924` edge `0.053` maxDD `-2.8014`
- `market_context_high->index_1h` score `-0.1548` n `197` status `ready` deltaP `4.3011` edge `0.0216` maxDD `-1.7205`
- `market_context_high->metal_4h` score `-0.1941` n `194` status `ready` deltaP `13.1695` edge `0.1565` maxDD `-12.5349`
