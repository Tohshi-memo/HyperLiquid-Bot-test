...
- `market_context_high->unknown_1h` score `-0.4682` n `152` status `ready` deltaP `-2.478` edge `0.0417` maxDD `-1.4688`
...
- `market_context_high->index_1h` score `-0.6538` n `152` status `ready` deltaP `2.5173` edge `-0.0048` maxDD `-2.3175`
...
- `market_context_high->commodity_4h` score `-2.166` n `140` status `ready` deltaP `-5.5749` edge `-0.0398` maxDD `-2.9494`
- `market_context_high->unknown_4h` score `-2.1696` n `140` status `ready` deltaP `-4.7387` edge `0.0198` maxDD `-5.1872`
...
- `market_context_high->index_4h` score `-3.9954` n `140` status `ready` deltaP `-1.912` edge `-0.0503` maxDD `-12.2591`
...
- `market_context_high->equity_4h` score `-13.9432` n `140` status `ready` deltaP `-1.8728` edge `-0.2551` maxDD `-64.5479`
