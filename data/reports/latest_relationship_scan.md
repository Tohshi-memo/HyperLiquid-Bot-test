...
- `market_context_high->crypto_major_24h` score `5.1793` n `77` status `ready` deltaP `19.0799` edge `0.4252` maxDD `-4.9964`
- `market_context_high->equity_24h` score `3.0064` n `77` status `ready` deltaP `16.9844` edge `0.1373` maxDD `0.0`
...
- `risk_on_high->crypto_major_1h` score `0.9305` n `35` status `ready` deltaP `11.2104` edge `0.0334` maxDD `-1.1144`
- `risk_on_and_context->crypto_major_1h` score `0.9305` n `35` status `ready` deltaP `11.2104` edge `0.0334` maxDD `-1.1144`
...
- `market_context_high->commodity_24h` score `0.1918` n `77` status `ready` deltaP `14.853` edge `0.1089` maxDD `-4.666`
