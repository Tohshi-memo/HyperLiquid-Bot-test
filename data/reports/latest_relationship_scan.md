...
- `risk_on_high->crypto_major_4h` score `5.9897` n `34` status `ready` deltaP `27.2328` edge `0.3559` maxDD `-0.7314`
- `risk_on_and_context->crypto_major_4h` score `5.9897` n `34` status `ready` deltaP `27.2328` edge `0.3559` maxDD `-0.7314`
...
- `market_context_high->crypto_major_1h` score `-0.7918` n `158` status `ready` deltaP `2.7496` edge `0.0212` maxDD `-7.6171`
