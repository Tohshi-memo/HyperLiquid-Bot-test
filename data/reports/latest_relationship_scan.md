...
- `risk_on_high->unknown_4h` score `7.3473` n `107` status `ready` deltaP `20.83` edge `0.5352` maxDD `-2.2768`
- `risk_on_and_context->unknown_4h` score `7.3473` n `107` status `ready` deltaP `20.83` edge `0.5352` maxDD `-2.2768`
- `market_context_high->unknown_4h` score `5.8939` n `151` status `ready` deltaP `17.1226` edge `0.4465` maxDD `-2.5597`
- `risk_on_high->unknown_1h` score `2.0927` n `107` status `ready` deltaP `4.27` edge `0.2036` maxDD `-1.9475`
- `risk_on_and_context->unknown_1h` score `2.0927` n `107` status `ready` deltaP `4.27` edge `0.2036` maxDD `-1.9475`
- `market_context_high->unknown_1h` score `1.9619` n `151` status `ready` deltaP `3.6325` edge `0.2023` maxDD `-2.042`
- `news_risk_high->unknown_1h` score `1.3824` n `59` status `ready` deltaP `1.7355` edge `0.1383` maxDD `-1.1072`
...
- `risk_on_high->index_1h` score `0.0504` n `107` status `ready` deltaP `7.3451` edge `0.002` maxDD `-0.5605`
- `risk_on_and_context->index_1h` score `0.0504` n `107` status `ready` deltaP `7.3451` edge `0.002` maxDD `-0.5605`
