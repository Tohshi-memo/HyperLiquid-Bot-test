...
- Generated: `2026-08-21T20:37:26.664299+00:00`
- Price records: `672`
...
- `market_context_high->unknown_4h` score `0.0758` n `133` status `ready` deltaP `21.3953` edge `-0.0924` maxDD `-0.5133`
...
- `market_context_high->crypto_alt_1h` score `-0.6164` n `133` status `ready` deltaP `0.869` edge `0.023` maxDD `-2.413`
...
- `market_context_high->crypto_alt_4h` score `-1.3274` n `133` status `ready` deltaP `3.7457` edge `-0.0086` maxDD `-5.4926`
