...
- `market_context_high->metal_1h` score `-0.647` n `146` status `ready` deltaP `-4.0603` edge `-0.0063` maxDD `-0.9664`
...
- `market_context_high->equity_1h` score `-1.0507` n `146` status `ready` deltaP `-1.5299` edge `0.0055` maxDD `-4.6286`
- `market_context_high->crypto_alt_1h` score `-1.9757` n `146` status `ready` deltaP `-10.3744` edge `-0.0313` maxDD `-2.4677`
- `market_context_high->equity_4h` score `-2.6034` n `143` status `ready` deltaP `-2.0286` edge `-0.0697` maxDD `-7.6983`
- `market_context_high->crypto_major_1h` score `-3.233` n `146` status `ready` deltaP `-11.3629` edge `-0.0612` maxDD `-7.2638`
...
- `market_context_high->crypto_alt_24h` score `-6.127` n `113` status `ready` deltaP `-17.5163` edge `-0.2495` maxDD `-4.5445`
