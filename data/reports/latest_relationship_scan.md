...
- `risk_on_high->crypto_major_4h` score `7.3037` n `36` status `ready` deltaP `39.0752` edge `0.3674` maxDD `-0.8742`
- `risk_on_and_context->crypto_major_4h` score `7.3037` n `36` status `ready` deltaP `39.0752` edge `0.3674` maxDD `-0.8742`
...
- `risk_on_high->crypto_alt_24h` score `2.2117` n `32` status `ready` deltaP `16.5728` edge `0.2659` maxDD `-5.0938`
- `risk_on_and_context->crypto_alt_24h` score `2.2117` n `32` status `ready` deltaP `16.5728` edge `0.2659` maxDD `-5.0938`
...
- `risk_on_high->equity_1h` score `0.4114` n `36` status `ready` deltaP `7.6577` edge `0.0394` maxDD `-1.3497`
- `risk_on_and_context->equity_1h` score `0.4114` n `36` status `ready` deltaP `7.6577` edge `0.0394` maxDD `-1.3497`
