...
- `market_context_high->crypto_alt_1h` score `-0.2139` n `146` status `ready` deltaP `2.0548` edge `0.0221` maxDD `-2.7243`
...
- `market_context_high->equity_1h` score `-0.4721` n `146` status `ready` deltaP `5.677` edge `0.053` maxDD `-7.7764`
- `market_context_high->metal_1h` score `-0.6715` n `146` status `ready` deltaP `0.6398` edge `0.0142` maxDD `-1.0307`
...
- `market_context_high->equity_24h` score `-1.0031` n `145` status `ready` deltaP `15.2349` edge `0.2604` maxDD `-34.5784`
- `market_context_high->crypto_alt_4h` score `-1.0207` n `146` status `ready` deltaP `2.8921` edge `0.0488` maxDD `-9.5815`
- `market_context_high->crypto_major_4h` score `-1.1399` n `146` status `ready` deltaP `9.4366` edge `0.0587` maxDD `-14.4206`
- `market_context_high->unknown_24h` score `-1.1605` n `146` status `ready` deltaP `6.4974` edge `-0.022` maxDD `-4.775`
- `market_context_high->unknown_1h` score `-1.4415` n `146` status `ready` deltaP `-0.3855` edge `-0.0552` maxDD `-1.3217`
- `market_context_high->equity_4h` score `-1.6098` n `146` status `ready` deltaP `1.6023` edge `0.1973` maxDD `-20.4824`
- `market_context_high->metal_4h` score `-1.7405` n `146` status `ready` deltaP `-2.8901` edge `0.0418` maxDD `-4.6535`
- `market_context_high->metal_24h` score `-2.2013` n `146` status `ready` deltaP `-3.2772` edge `0.0653` maxDD `-7.3868`
