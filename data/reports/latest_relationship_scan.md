...
- `news_risk_high->crypto_major_24h` score `22.8724` n `98` status `ready` deltaP `9.1447` edge `2.5309` maxDD `-46.1999`
- `news_risk_high->crypto_alt_24h` score `20.3096` n `98` status `ready` deltaP `14.9199` edge `2.0811` maxDD `-32.7147`
- `market_context_high->unknown_4h` score `14.2977` n `49` status `ready` deltaP `0.28` edge `1.2046` maxDD `-0.5326`
- `news_risk_high->crypto_alt_4h` score `5.9369` n `101` status `ready` deltaP `23.1873` edge `0.4611` maxDD `-7.675`
- `news_risk_high->crypto_major_4h` score `4.4996` n `101` status `ready` deltaP `21.9678` edge `0.3543` maxDD `-8.0625`
...
- `news_risk_high->crypto_alt_1h` score `3.0209` n `101` status `ready` deltaP `16.6805` edge `0.1871` maxDD `-2.058`
- `market_context_high->fx_4h` score `2.3096` n `49` status `ready` deltaP `29.9216` edge `0.0145` maxDD `-0.0543`
- `news_risk_high->crypto_major_1h` score `2.2379` n `101` status `ready` deltaP `18.4769` edge `0.1156` maxDD `-2.8494`
- `market_context_high->fx_24h` score `1.9228` n `38` status `ready` deltaP `20.2851` edge `0.0292` maxDD `-0.0027`
- `market_context_high->commodity_1h` score `1.5978` n `50` status `ready` deltaP `17.9042` edge `0.0413` maxDD `-0.2012`
...
- `news_risk_high->metal_24h` score `0.2148` n `98` status `ready` deltaP `15.5046` edge `0.0086` maxDD `-2.4203`
