...
- `market_context_high->crypto_alt_4h` score `0.3164` n `96` status `ready` deltaP `9.9085` edge `0.0873` maxDD `-5.4926`
- `market_context_high->equity_4h` score `0.0709` n `96` status `ready` deltaP `2.7693` edge `0.0779` maxDD `-2.5696`
...
- `market_context_high->unknown_24h` score `-0.2394` n `87` status `ready` deltaP `12.3309` edge `-0.0838` maxDD `-0.1352`
- `market_context_high->commodity_4h` score `-0.371` n `96` status `ready` deltaP `4.0905` edge `0.0102` maxDD `-2.4692`
- `market_context_high->crypto_alt_1h` score `-0.3893` n `96` status `ready` deltaP `1.9274` edge `0.0174` maxDD `-2.413`
...
- `market_context_high->commodity_1h` score `-0.8736` n `96` status `ready` deltaP `-7.4414` edge `-0.0058` maxDD `-1.1941`
