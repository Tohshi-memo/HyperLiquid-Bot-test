...
- `market_context_high->crypto_major_24h` score `2.2071` n `84` status `ready` deltaP `7.8918` edge `0.2521` maxDD `-4.9964`
...
- `market_context_high->crypto_major_4h` score `0.78` n `96` status `ready` deltaP `9.629` edge `0.1029` maxDD `-3.1677`
...
- `market_context_high->crypto_alt_1h` score `-0.3418` n `96` status `ready` deltaP `2.5262` edge `0.0195` maxDD `-2.413`
