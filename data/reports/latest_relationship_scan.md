...
- `news_risk_high->crypto_major_1h` score `0.9447` n `30` status `ready` deltaP `11.5369` edge `0.0909` maxDD `-2.0691`
- `news_risk_high->crypto_alt_1h` score `0.2575` n `30` status `ready` deltaP `5.1697` edge `0.0447` maxDD `-1.6923`
...
- `market_context_high->crypto_major_1h` score `-0.5287` n `229` status `ready` deltaP `3.6621` edge `0.0399` maxDD `-6.2348`
- `market_context_high->commodity_1h` score `-0.5488` n `229` status `ready` deltaP `-1.616` edge `-0.0025` maxDD `-1.9006`
- `market_context_high->index_1h` score `-0.5919` n `229` status `ready` deltaP `0.7178` edge `0.0041` maxDD `-0.7819`
- `market_context_high->crypto_alt_1h` score `-0.6058` n `229` status `ready` deltaP `2.6515` edge `0.0381` maxDD `-6.6758`
...
- `market_context_high->crypto_major_4h` score `-1.7045` n `226` status `ready` deltaP `8.9129` edge `0.1593` maxDD `-25.6458`
- `news_risk_high->commodity_4h` score `-1.8094` n `30` status `ready` deltaP `-13.7296` edge `-0.0529` maxDD `-2.3372`
...
- `market_context_high->commodity_4h` score `-2.4619` n `226` status `ready` deltaP `-2.3432` edge `-0.0182` maxDD `-6.3734`
