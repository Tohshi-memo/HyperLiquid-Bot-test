...
- Price records: `672`
- Market context records: `1730`
- Flow alert records: `6884`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->metal_24h` score `6.8285` n `148` status `ready` deltaP `25.7014` edge `0.6403` maxDD `-12.7414`
- `market_context_high->crypto_alt_4h` score `5.8449` n `196` status `ready` deltaP `20.8188` edge `0.5249` maxDD `-9.1295`
- `market_context_high->unknown_24h` score `5.425` n `148` status `ready` deltaP `16.623` edge `0.8733` maxDD `-35.8966`
...
- `market_context_high->equity_24h` score `2.1616` n `148` status `ready` deltaP `16.6464` edge `0.559` maxDD `-33.1875`
