...
- Price records: `672`
- Market context records: `1527`
- Flow alert records: `6307`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->metal_24h` score `13.6134` n `167` status `ready` deltaP `23.4905` edge `1.0779` maxDD `-6.3373`
- `market_context_high->crypto_alt_24h` score `11.6046` n `167` status `ready` deltaP `28.9328` edge `0.9758` maxDD `-15.1306`
...
- `market_context_high->equity_24h` score `2.5682` n `167` status `ready` deltaP `13.3359` edge `0.3578` maxDD `-14.2815`
- `market_context_high->fx_24h` score `0.9247` n `167` status `ready` deltaP `18.5192` edge `0.0585` maxDD `-1.3925`
- `market_context_high->equity_4h` score `0.1916` n `192` status `ready` deltaP `3.7348` edge `0.0956` maxDD `-5.0291`
...
- `market_context_high->crypto_alt_4h` score `-0.7469` n `192` status `ready` deltaP `10.0356` edge `0.1693` maxDD `-19.5565`
- `market_context_high->index_1h` score `-0.7548` n `199` status `ready` deltaP `-0.1241` edge `0.0011` maxDD `-1.7205`
- `market_context_high->metal_1h` score `-0.7602` n `199` status `ready` deltaP `4.9981` edge `0.0028` maxDD `-6.3532`
...
- `market_context_high->metal_4h` score `-1.3341` n `192` status `ready` deltaP `10.1118` edge `0.0906` maxDD `-12.5349`
- `market_context_high->index_4h` score `-1.507` n `192` status `ready` deltaP `-5.653` edge `0.021` maxDD `-3.7119`
- `market_context_high->fx_4h` score `-1.8606` n `192` status `ready` deltaP `-7.5838` edge `-0.0116` maxDD `-1.4313`
- `market_context_high->unknown_24h` score `-4.0714` n `167` status `ready` deltaP `-1.0676` edge `-0.0592` maxDD `-10.1706`
