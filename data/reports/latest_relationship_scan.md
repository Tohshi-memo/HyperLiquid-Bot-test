...
- `news_risk_high->equity_24h` score `13.1587` n `51` status `ready` deltaP `40.237` edge `0.9214` maxDD `-4.7801`
- `news_risk_high->unknown_4h` score `12.8631` n `51` status `ready` deltaP `24.2587` edge `0.9148` maxDD `-0.0348`
- `news_risk_high->index_24h` score `5.4232` n `51` status `ready` deltaP `48.9481` edge `0.1408` maxDD `-0.2147`
- `market_context_high->unknown_24h` score `4.8455` n `90` status `ready` deltaP `7.4652` edge `0.3833` maxDD `-0.6752`
- `news_risk_high->equity_4h` score `4.0072` n `51` status `ready` deltaP `27.5377` edge `0.2274` maxDD `-2.164`
...
- `news_risk_high->equity_1h` score `1.0192` n `51` status `ready` deltaP `18.7918` edge `0.0418` maxDD `-0.9128`
