...
- `market_context_high->crypto_major_1h` score `-0.8891` n `96` status `ready` deltaP `1.7839` edge `-0.0414` maxDD `-2.7581`
...
- `market_context_high->crypto_major_4h` score `-2.0769` n `96` status `ready` deltaP `7.0376` edge `-0.1179` maxDD `-3.1677`
