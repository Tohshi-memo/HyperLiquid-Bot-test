...
- `news_risk_high->crypto_alt_24h` score `13.8458` n `32` status `ready` deltaP `42.2194` edge `0.8871` maxDD `-0.5131`
...
- `news_risk_high->crypto_major_24h` score `3.0007` n `32` status `ready` deltaP `15.625` edge `0.3585` maxDD `-4.2368`
- `market_context_high->unknown_1h` score `2.367` n `192` status `ready` deltaP `2.8599` edge `0.279` maxDD `-3.7317`
...
- `market_context_high->unknown_4h` score `1.7364` n `192` status `ready` deltaP `0.1397` edge `0.397` maxDD `-11.925`
- `news_risk_high->crypto_major_1h` score `1.3937` n `32` status `ready` deltaP `14.4274` edge `0.1292` maxDD `-2.0691`
- `news_risk_high->crypto_alt_1h` score `0.8028` n `32` status `ready` deltaP `10.7223` edge `0.0776` maxDD `-1.6923`
- `market_context_high->metal_24h` score `-0.0579` n `192` status `ready` deltaP `19.8023` edge `0.1174` maxDD `-11.8809`
- `news_risk_high->index_24h` score `-0.1832` n `32` status `ready` deltaP `8.801` edge `0.005` maxDD `-2.3058`
- `market_context_high->fx_1h` score `-0.3252` n `192` status `ready` deltaP `0.6113` edge `-0.0012` maxDD `-0.5659`
- `market_context_high->metal_4h` score `-0.5515` n `192` status `ready` deltaP `4.281` edge `0.0195` maxDD `-3.4996`
...
- `market_context_high->crypto_alt_1h` score `-0.8609` n `192` status `ready` deltaP `4.9931` edge `0.0316` maxDD `-9.3536`
