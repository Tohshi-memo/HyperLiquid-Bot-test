...
- `news_risk_high->unknown_4h` score `366.118` n `83` status `ready` deltaP `-21.5105` edge `30.7427` maxDD `-4.1571`
- `news_risk_high->unknown_24h` score `38.7252` n `78` status `ready` deltaP `21.1806` edge `3.0859` maxDD `0.0`
- `news_risk_high->crypto_alt_24h` score `24.1839` n `78` status `ready` deltaP `47.7698` edge `1.7359` maxDD `-1.4564`
- `news_risk_high->crypto_major_24h` score `20.1721` n `78` status `ready` deltaP `39.7303` edge `1.5632` maxDD `-9.098`
...
- `news_risk_high->metal_24h` score `6.7304` n `78` status `ready` deltaP `38.4882` edge `0.3497` maxDD `-0.6334`
...
- `risk_on_high->crypto_alt_4h` score `0.2629` n `52` status `ready` deltaP `9.2402` edge `0.1336` maxDD `-6.2526`
- `risk_on_and_context->crypto_alt_4h` score `0.2629` n `52` status `ready` deltaP `9.2402` edge `0.1336` maxDD `-6.2526`
