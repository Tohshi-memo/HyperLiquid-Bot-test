...
- `market_context_high->crypto_alt_24h` score `16.7999` n `92` status `ready` deltaP `11.8207` edge `2.4667` maxDD `-22.6673`
...
- `market_context_high->commodity_4h` score `2.3953` n `127` status `ready` deltaP `16.2929` edge `0.1557` maxDD `-2.8438`
...
- `market_context_high->crypto_alt_1h` score `-0.7345` n `129` status `ready` deltaP `3.5847` edge `0.0949` maxDD `-14.7034`
...
- `market_context_high->fx_4h` score `-1.2201` n `127` status `ready` deltaP `-9.9685` edge `-0.0057` maxDD `-1.0742`
...
- `market_context_high->crypto_alt_4h` score `-2.972` n `127` status `ready` deltaP `18.2783` edge `0.3016` maxDD `-58.6918`
- `market_context_high->equity_4h` score `-3.4987` n `127` status `ready` deltaP `7.6075` edge `0.0132` maxDD `-35.3306`
