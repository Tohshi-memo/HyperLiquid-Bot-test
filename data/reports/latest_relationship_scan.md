...
- `market_context_high->commodity_24h` score `5.8573` n `82` status `ready` deltaP `38.1732` edge `0.2477` maxDD `-0.1266`
...
- `market_context_high->crypto_major_24h` score `-1.6621` n `82` status `ready` deltaP `-4.1836` edge `0.1122` maxDD `-17.4589`
- `market_context_high->fx_24h` score `-2.2006` n `82` status `ready` deltaP `-17.3823` edge `-0.0055` maxDD `-1.8596`
...
- `market_context_high->metal_24h` score `-2.2963` n `82` status `ready` deltaP `-13.5459` edge `0.0471` maxDD `-7.0954`
