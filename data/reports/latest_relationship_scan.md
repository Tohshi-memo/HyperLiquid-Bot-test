...
- `news_risk_high->equity_4h` score `6.3617` n `61` status `ready` deltaP `23.3907` edge `0.4339` maxDD `-3.4427`
...
- `news_risk_high->crypto_major_4h` score `0.9814` n `61` status `ready` deltaP `7.2996` edge `0.1738` maxDD `-5.0643`
- `market_context_high->crypto_alt_4h` score `0.62` n `53` status `ready` deltaP `9.0428` edge `0.1149` maxDD `-5.323`
- `news_risk_high->equity_1h` score `0.6074` n `68` status `ready` deltaP `8.5946` edge `0.0756` maxDD `-2.916`
- `news_risk_high->crypto_alt_4h` score `0.3148` n `61` status `ready` deltaP `11.4554` edge `0.1132` maxDD `-6.6032`
- `market_context_high->fx_4h` score `0.2383` n `53` status `ready` deltaP `14.1682` edge `0.0157` maxDD `-1.3685`
- `news_risk_high->fx_4h` score `0.2277` n `61` status `ready` deltaP `13.5496` edge `0.0244` maxDD `-0.6604`
- `news_risk_high->crypto_alt_1h` score `0.1544` n `68` status `ready` deltaP `7.08` edge `0.0408` maxDD `-3.1233`
- `news_risk_high->metal_4h` score `0.1458` n `61` status `ready` deltaP `4.7855` edge `0.0344` maxDD `-0.8085`
...
- `news_risk_high->crypto_major_1h` score `-0.1524` n `68` status `ready` deltaP `2.6682` edge `0.0347` maxDD `-3.762`
