...
- `news_risk_high->equity_24h` score `8.4131` n `32` status `ready` deltaP `7.9861` edge `0.6858` maxDD `-1.0358`
- `news_risk_high->equity_4h` score `6.8012` n `36` status `ready` deltaP `36.2805` edge `0.3249` maxDD `0.0`
...
- `risk_on_high->commodity_4h` score `2.6408` n `32` status `ready` deltaP `18.8262` edge `0.1128` maxDD `-0.1258`
- `risk_on_and_context->commodity_4h` score `2.6408` n `32` status `ready` deltaP `18.8262` edge `0.1128` maxDD `-0.1258`
- `news_risk_high->index_24h` score `2.4344` n `32` status `ready` deltaP `15.625` edge `0.0987` maxDD `0.0`
...
- `news_risk_high->equity_1h` score `1.46` n `36` status `ready` deltaP `7.2356` edge `0.1053` maxDD `-0.5496`
- `market_context_high->commodity_4h` score `1.4593` n `161` status `ready` deltaP `16.4776` edge `0.0756` maxDD `-2.1077`
- `risk_on_high->crypto_major_24h` score `1.2696` n `32` status `ready` deltaP `12.3264` edge `0.1962` maxDD `-6.2481`
- `risk_on_and_context->crypto_major_24h` score `1.2696` n `32` status `ready` deltaP `12.3264` edge `0.1962` maxDD `-6.2481`
