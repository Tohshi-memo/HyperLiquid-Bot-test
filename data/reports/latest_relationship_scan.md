...
- `news_risk_high->fx_1h` score `1.3057` n `51` status `ready` deltaP `17.7439` edge `0.0075` maxDD `-0.0257`
- `market_context_high->unknown_24h` score `1.2751` n `109` status `ready` deltaP `5.135` edge `0.1013` maxDD `-0.6752`
- `news_risk_high->equity_1h` score `0.9997` n `51` status `ready` deltaP `18.4924` edge `0.0413` maxDD `-0.9128`
...
- `market_context_high->fx_1h` score `-0.3921` n `130` status `ready` deltaP `3.3095` edge `0.0009` maxDD `-0.8587`
