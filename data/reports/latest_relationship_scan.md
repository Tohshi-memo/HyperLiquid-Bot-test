...
- Price records: `672`
- Market context records: `1714`
- Flow alert records: `6841`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->unknown_24h` score `6.4877` n `138` status `ready` deltaP `17.622` edge `0.9552` maxDD `-35.8966`
...
- `market_context_high->unknown_4h` score `3.1751` n `196` status `ready` deltaP `14.2514` edge `0.3967` maxDD `-11.1695`
- `market_context_high->equity_4h` score `2.9841` n `196` status `ready` deltaP `16.2643` edge `0.2497` maxDD `-5.0894`
...
- `market_context_high->crypto_major_1h` score `0.2232` n `196` status `ready` deltaP `5.0471` edge `0.0923` maxDD `-3.9211`
...
- `market_context_high->index_1h` score `-0.4898` n `196` status `ready` deltaP `0.773` edge `0.0172` maxDD `-1.7205`
...
- `market_context_high->unknown_1h` score `-1.4437` n `196` status `ready` deltaP `1.8361` edge `0.0144` maxDD `-7.7558`
