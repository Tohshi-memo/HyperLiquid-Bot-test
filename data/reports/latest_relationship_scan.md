...
- `market_context_high->unknown_1h` score `8.9336` n `202` status `ready` deltaP `-0.3261` edge `0.8097` maxDD `-2.0446`
...
- `market_context_high->metal_1h` score `-0.299` n `202` status `ready` deltaP `6.8729` edge `0.0015` maxDD `-2.1858`
