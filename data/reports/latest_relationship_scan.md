...
- `market_context_high->unknown_4h` score `37.942` n `149` status `ready` deltaP `-0.9208` edge `3.1913` maxDD `-0.5326`
- `news_risk_high->crypto_alt_24h` score `36.3077` n `40` status `ready` deltaP `34.0278` edge `2.9367` maxDD `-9.3661`
- `news_risk_high->crypto_major_24h` score `35.8924` n `40` status `ready` deltaP `14.2708` edge `3.0118` maxDD `-6.6058`
- `risk_on_high->unknown_4h` score `11.8207` n `52` status `ready` deltaP `-8.1614` edge `1.062` maxDD `-0.4694`
- `risk_on_and_context->unknown_4h` score `11.8207` n `52` status `ready` deltaP `-8.1614` edge `1.062` maxDD `-0.4694`
...
- `news_risk_high->equity_24h` score `5.7607` n `40` status `ready` deltaP `22.1875` edge `0.4291` maxDD `-3.4232`
...
- `news_risk_high->crypto_major_4h` score `2.327` n `85` status `ready` deltaP `18.1295` edge `0.3472` maxDD `-10.9113`
- `news_risk_high->equity_4h` score `1.9446` n `85` status `ready` deltaP `17.4964` edge `0.1354` maxDD `-4.1995`
- `news_risk_high->metal_24h` score `1.5588` n `40` status `ready` deltaP `11.4583` edge `0.0818` maxDD `-0.2629`
