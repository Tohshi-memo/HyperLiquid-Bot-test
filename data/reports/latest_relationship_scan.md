...
- Generated: `2026-06-04T22:10:06.198673+00:00`
- Price records: `672`
- Market context records: `2908`
...
- `market_context_high->crypto_alt_24h` score `11.8343` n `142` status `ready` deltaP `11.0354` edge `1.3043` maxDD `-22.6673`
...
- `market_context_high->index_24h` score `2.1934` n `142` status `ready` deltaP `10.2382` edge `0.2126` maxDD `-2.5127`
- `market_context_high->commodity_24h` score `1.7784` n `142` status `ready` deltaP `15.5516` edge `0.3539` maxDD `-12.4171`
- `market_context_high->index_4h` score `0.4696` n `142` status `ready` deltaP `13.1484` edge `0.0567` maxDD `-2.3986`
...
- `market_context_high->index_1h` score `-0.0695` n `142` status `ready` deltaP `3.7489` edge `0.0155` maxDD `-1.2855`
- `market_context_high->unknown_1h` score `-0.3109` n `142` status `ready` deltaP `4.1811` edge `0.0193` maxDD `-3.1801`
- `market_context_high->crypto_alt_4h` score `-0.4251` n `142` status `ready` deltaP `14.9476` edge `0.299` maxDD `-28.7261`
...
- `market_context_high->commodity_1h` score `-0.5929` n `142` status `ready` deltaP `-0.4322` edge `0.0022` maxDD `-4.3601`
- `market_context_high->crypto_major_1h` score `-0.6341` n `142` status `ready` deltaP `5.8721` edge `0.0665` maxDD `-9.622`
...
- `market_context_high->commodity_4h` score `-1.219` n `142` status `ready` deltaP `2.6` edge `0.0184` maxDD `-10.0279`
