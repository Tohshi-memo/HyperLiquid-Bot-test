...
- `market_context_high->unknown_24h` score `0.2823` n `189` status `ready` deltaP `-4.5107` edge `0.4625` maxDD `-14.0325`
...
- `market_context_high->commodity_4h` score `-1.3254` n `224` status `ready` deltaP `-1.7313` edge `-0.0094` maxDD `-5.5853`
...
- `market_context_high->index_4h` score `-1.914` n `224` status `ready` deltaP `5.0088` edge `-0.0208` maxDD `-11.3047`
- `market_context_high->metal_4h` score `-2.1741` n `224` status `ready` deltaP `2.6241` edge `0.0021` maxDD `-5.5324`
- `market_context_high->commodity_24h` score `-2.2666` n `189` status `ready` deltaP `0.2155` edge `-0.0035` maxDD `-5.2791`
...
- `market_context_high->equity_4h` score `-7.1545` n `224` status `ready` deltaP `2.4064` edge `-0.1388` maxDD `-56.5591`
- `market_context_high->metal_24h` score `-8.3658` n `189` status `ready` deltaP `-13.6613` edge `-0.1223` maxDD `-28.4`
