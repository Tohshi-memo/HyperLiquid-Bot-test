...
- `market_context_high->crypto_major_4h` score `1.661` n `116` status `ready` deltaP `17.3886` edge `0.1943` maxDD `-6.7444`
...
- `market_context_high->crypto_major_1h` score `1.1624` n `116` status `ready` deltaP `12.931` edge `0.0506` maxDD `-1.5286`
...
- `market_context_high->metal_1h` score `-0.8321` n `116` status `ready` deltaP `-0.0052` edge `0.0227` maxDD `-0.6936`
