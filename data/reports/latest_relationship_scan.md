...
- `news_risk_high->equity_4h` score `3.7518` n `51` status `ready` deltaP `26.7755` edge `0.2112` maxDD `-2.164`
- `news_risk_high->unknown_1h` score `3.6965` n `51` status `ready` deltaP `16.9337` edge `0.2256` maxDD `-0.7693`
...
- `news_risk_high->metal_24h` score `1.2707` n `51` status `ready` deltaP `30.6781` edge `-0.0944` maxDD `-0.0053`
...
- `news_risk_high->equity_1h` score `0.9234` n `51` status `ready` deltaP `18.0433` edge `0.0345` maxDD `-0.9128`
- `market_context_high->metal_4h` score `0.2901` n `136` status `ready` deltaP `12.0247` edge `-0.0101` maxDD `-1.3378`
- `news_risk_high->index_1h` score `0.2185` n `51` status `ready` deltaP `8.8235` edge `0.0045` maxDD `-0.1583`
- `news_risk_high->commodity_1h` score `0.1476` n `51` status `ready` deltaP `8.0897` edge `-0.0108` maxDD `-0.4666`
- `market_context_high->unknown_1h` score `0.0106` n `136` status `ready` deltaP `11.0514` edge `-0.0279` maxDD `-1.5916`
