...
- `market_context_high->crypto_alt_1h` score `-0.1112` n `176` status `ready` deltaP `5.6478` edge `0.0295` maxDD `-3.7803`
...
- `market_context_high->equity_1h` score `-1.1267` n `176` status `ready` deltaP `3.4057` edge `-0.0139` maxDD `-3.8827`
...
- `market_context_high->crypto_alt_4h` score `-2.5448` n `176` status `ready` deltaP `3.5892` edge `-0.01` maxDD `-19.2145`
- `market_context_high->metal_4h` score `-2.6557` n `176` status `ready` deltaP `-6.3193` edge `-0.0123` maxDD `-5.2172`
- `market_context_high->unknown_4h` score `-3.6353` n `176` status `ready` deltaP `-15.8675` edge `0.0394` maxDD `-10.2579`
- `market_context_high->equity_4h` score `-4.1277` n `176` status `ready` deltaP `3.617` edge `-0.1264` maxDD `-27.1529`
