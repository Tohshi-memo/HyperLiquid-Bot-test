...
- Price records: `672`
- Market context records: `2336`
- Flow alert records: `8614`
- Minimum samples: `30`
- Pattern count: `96`
...
- `news_risk_high->metal_24h` score `16.6` n `43` status `ready` deltaP `43.3341` edge `1.1384` maxDD `-3.1836`
...
- `market_context_high->unknown_24h` score `7.208` n `132` status `ready` deltaP `23.9584` edge `0.4821` maxDD `-1.626`
...
- `market_context_high->equity_24h` score `2.0671` n `132` status `ready` deltaP `19.2393` edge `0.1967` maxDD `-6.8828`
