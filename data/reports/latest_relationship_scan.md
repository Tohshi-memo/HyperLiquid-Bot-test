...
- `market_context_high->crypto_alt_24h` score `12.8645` n `142` status `ready` deltaP `12.077` edge `1.3832` maxDD `-22.6673`
...
- `market_context_high->unknown_4h` score `0.1431` n `142` status `ready` deltaP `4.5087` edge `0.0872` maxDD `-3.7602`
- `market_context_high->index_1h` score `-0.036` n `142` status `ready` deltaP `4.198` edge `0.0168` maxDD `-1.2855`
- `market_context_high->crypto_alt_4h` score `-0.1233` n `142` status `ready` deltaP `15.4049` edge `0.3211` maxDD `-28.7261`
- `market_context_high->unknown_1h` score `-0.2833` n `142` status `ready` deltaP `4.1811` edge `0.0216` maxDD `-3.1801`
- `market_context_high->equity_1h` score `-0.3956` n `142` status `ready` deltaP `0.6937` edge `0.0457` maxDD `-2.6634`
- `market_context_high->crypto_alt_1h` score `-0.4652` n `142` status `ready` deltaP `6.1441` edge `0.0754` maxDD `-10.747`
