...
- `market_context_high->equity_1h` score `-1.2579` n `120` status `ready` deltaP `4.2465` edge `-0.0331` maxDD `-10.5179`
...
- `market_context_high->metal_4h` score `-1.9045` n `120` status `ready` deltaP `-3.1707` edge `-0.0141` maxDD `-3.211`
- `market_context_high->crypto_alt_4h` score `-2.1355` n `120` status `ready` deltaP `0.5894` edge `-0.0429` maxDD `-5.7857`
- `market_context_high->crypto_major_1h` score `-2.7077` n `120` status `ready` deltaP `-6.7515` edge `-0.0433` maxDD `-7.6533`
- `market_context_high->crypto_alt_24h` score `-3.6697` n `113` status `ready` deltaP `-9.8556` edge `-0.0958` maxDD `-4.5445`
- `market_context_high->equity_4h` score `-5.9566` n `120` status `ready` deltaP `0.3455` edge `-0.2371` maxDD `-34.9766`
