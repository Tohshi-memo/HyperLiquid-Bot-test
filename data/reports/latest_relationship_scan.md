...
- `market_context_high->crypto_alt_24h` score `10.4287` n `111` status `ready` deltaP `16.3523` edge `1.1094` maxDD `-19.9486`
- `market_context_high->unknown_24h` score `8.6225` n `111` status `ready` deltaP `17.3048` edge `0.636` maxDD `-1.626`
...
- `market_context_high->crypto_major_24h` score `-0.1437` n `111` status `ready` deltaP `6.5175` edge `0.6944` maxDD `-44.169`
- `market_context_high->index_1h` score `-0.1604` n `143` status `ready` deltaP `3.0506` edge `0.0085` maxDD `-1.2855`
- `market_context_high->unknown_1h` score `-0.2579` n `143` status `ready` deltaP `2.5994` edge `0.034` maxDD `-3.1587`
...
- `market_context_high->crypto_alt_4h` score `-0.5485` n `143` status `ready` deltaP `16.2108` edge `0.2803` maxDD `-28.7261`
...
- `market_context_high->crypto_major_1h` score `-1.0235` n `143` status `ready` deltaP `3.0485` edge `0.0354` maxDD `-9.622`
...
- `market_context_high->equity_1h` score `-1.2523` n `143` status `ready` deltaP `-4.4857` edge `0.0094` maxDD `-2.7085`
- `market_context_high->equity_4h` score `-1.9841` n `143` status `ready` deltaP `-1.034` edge `-0.018` maxDD `-5.9024`
