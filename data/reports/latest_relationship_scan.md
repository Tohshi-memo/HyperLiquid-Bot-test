...
- `news_risk_high->crypto_alt_24h` score `12.3423` n `53` status `ready` deltaP `33.5321` edge `0.8491` maxDD `-2.8629`
...
- `news_risk_high->metal_24h` score `1.9746` n `53` status `ready` deltaP `30.2376` edge `-0.0328` maxDD `-0.0053`
- `news_risk_high->equity_4h` score `1.8168` n `53` status `ready` deltaP `20.3024` edge `0.0931` maxDD `-2.164`
...
- `news_risk_high->metal_4h` score `0.0473` n `53` status `ready` deltaP `8.2887` edge `0.0018` maxDD `-0.249`
...
- `market_context_high->metal_4h` score `-0.937` n `137` status `ready` deltaP `5.3277` edge `-0.0264` maxDD `-2.9763`
