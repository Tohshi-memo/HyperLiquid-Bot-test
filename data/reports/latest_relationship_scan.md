...
- `market_context_high->equity_1h` score `1.6222` n `96` status `ready` deltaP `13.8037` edge `0.0733` maxDD `-0.4112`
...
- `market_context_high->crypto_major_4h` score `1.0985` n `96` status `ready` deltaP `11.9156` edge `0.1142` maxDD `-3.1677`
...
- `market_context_high->fx_24h` score `-4.2364` n `96` status `ready` deltaP `-25.1736` edge `-0.0269` maxDD `-1.9981`
