...
- `market_context_high->equity_24h` score `0.6922` n `228` status `ready` deltaP `15.3052` edge `0.4946` maxDD `-31.6316`
...
- `market_context_high->crypto_major_4h` score `-2.7733` n `285` status `ready` deltaP `7.8198` edge `0.154` maxDD `-25.6458`
- `market_context_high->index_24h` score `-2.9314` n `228` status `ready` deltaP `1.4619` edge `0.0289` maxDD `-18.1572`
- `market_context_high->commodity_4h` score `-3.787` n `285` status `ready` deltaP `-2.959` edge `-0.0283` maxDD `-14.071`
- `market_context_high->crypto_alt_4h` score `-4.2907` n `285` status `ready` deltaP `5.5162` edge `0.1016` maxDD `-28.3414`
- `market_context_high->crypto_major_24h` score `-5.2606` n `228` status `ready` deltaP `5.1718` edge `-0.023` maxDD `-29.6555`
