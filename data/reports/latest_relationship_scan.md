...
- `risk_on_high->unknown_4h` score `7.6672` n `107` status `ready` deltaP `23.2691` edge `0.5455` maxDD `-2.2689`
- `risk_on_and_context->unknown_4h` score `7.6672` n `107` status `ready` deltaP `23.2691` edge `0.5455` maxDD `-2.2689`
- `market_context_high->unknown_4h` score `6.12` n `159` status `ready` deltaP `19.9657` edge `0.4463` maxDD `-2.5526`
...
- `risk_on_high->fx_24h` score `0.6811` n `94` status `ready` deltaP `40.9759` edge `0.0234` maxDD `-3.7401`
- `risk_on_and_context->fx_24h` score `0.6811` n `94` status `ready` deltaP `40.9759` edge `0.0234` maxDD `-3.7401`
- `risk_on_high->crypto_alt_24h` score `0.4203` n `94` status `ready` deltaP `12.3523` edge `0.6619` maxDD `-42.8959`
- `risk_on_and_context->crypto_alt_24h` score `0.4203` n `94` status `ready` deltaP `12.3523` edge `0.6619` maxDD `-42.8959`
