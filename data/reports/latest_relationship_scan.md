...
- `market_context_high->unknown_1h` score `1.2228` n `133` status `ready` deltaP `8.3878` edge `0.0687` maxDD `-0.4843`
...
- `market_context_high->unknown_4h` score `-0.0122` n `133` status `ready` deltaP `21.0904` edge `-0.0977` maxDD `-0.5133`
- `market_context_high->fx_1h` score `-0.1323` n `133` status `ready` deltaP `2.1791` edge `0.0044` maxDD `-0.2043`
- `market_context_high->equity_1h` score `-0.2194` n `133` status `ready` deltaP `6.5643` edge `0.0351` maxDD `-5.2257`
...
- `market_context_high->index_4h` score `-0.6037` n `133` status `ready` deltaP `2.4689` edge `0.0097` maxDD `-2.618`
- `market_context_high->commodity_4h` score `-0.6769` n `133` status `ready` deltaP `-1.3135` edge `0.007` maxDD `-2.4692`
- `market_context_high->commodity_1h` score `-0.6783` n `133` status `ready` deltaP `-4.5709` edge `0.0001` maxDD `-1.1941`
- `market_context_high->commodity_24h` score `-0.906` n `105` status `ready` deltaP `0.7689` edge `0.1027` maxDD `-4.666`
- `market_context_high->crypto_major_1h` score `-1.1633` n `133` status `ready` deltaP `-0.9511` edge `-0.0403` maxDD `-4.1996`
...
- `market_context_high->crypto_major_4h` score `-4.0209` n `133` status `ready` deltaP `-0.5822` edge `-0.2291` maxDD `-3.1677`
