...
- `market_context_high->equity_1h` score `-0.4829` n `108` status `ready` deltaP `3.4376` edge `0.0197` maxDD `-4.6286`
...
- `market_context_high->crypto_major_1h` score `-2.4152` n `108` status `ready` deltaP `-7.4739` edge `-0.0518` maxDD `-4.6382`
...
- `market_context_high->crypto_major_4h` score `-8.0653` n `103` status `ready` deltaP `-14.7111` edge `-0.2349` maxDD `-18.1307`
