...
- `news_risk_high->equity_1h` score `2.9351` n `52` status `ready` deltaP `21.2805` edge `0.1336` maxDD `-1.1366`
...
- `news_risk_high->metal_4h` score `0.661` n `52` status `ready` deltaP `6.5666` edge `0.0581` maxDD `-0.7433`
...
- `news_risk_high->commodity_1h` score `-2.0615` n `52` status `ready` deltaP `-7.6693` edge `-0.0421` maxDD `-2.9516`
- `news_risk_high->fx_24h` score `-5.718` n `52` status `ready` deltaP `-27.3771` edge `-0.0618` maxDD `-5.2413`
- `news_risk_high->metal_24h` score `-7.9075` n `52` status `ready` deltaP `-30.5422` edge `-0.1783` maxDD `-10.8302`
- `news_risk_high->commodity_4h` score `-8.6878` n `52` status `ready` deltaP `-28.1895` edge `-0.2053` maxDD `-13.1269`
- `news_risk_high->commodity_24h` score `-12.1754` n `52` status `ready` deltaP `-10.1763` edge `-0.3528` maxDD `-33.8515`
