...
- `news_risk_high->equity_24h` score `9.6742` n `36` status `ready` deltaP `10.0694` edge `0.777` maxDD `-1.0358`
- `news_risk_high->equity_4h` score `6.6819` n `36` status `ready` deltaP `35.8232` edge `0.318` maxDD `0.0`
...
- `risk_on_high->crypto_major_24h` score `1.3432` n `32` status `ready` deltaP `13.0208` edge `0.201` maxDD `-6.2481`
- `risk_on_and_context->crypto_major_24h` score `1.3432` n `32` status `ready` deltaP `13.0208` edge `0.201` maxDD `-6.2481`
