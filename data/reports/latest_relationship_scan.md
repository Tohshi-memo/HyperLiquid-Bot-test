...
- `market_context_high->metal_4h` score `2.6967` n `91` status `ready` deltaP `23.8743` edge `0.1278` maxDD `-0.979`
...
- `market_context_high->fx_24h` score `1.2347` n `82` status `ready` deltaP `26.3635` edge `0.0359` maxDD `-3.0343`
- `market_context_high->index_24h` score `1.1901` n `82` status `ready` deltaP `9.5698` edge `0.1558` maxDD `-1.3621`
- `market_context_high->crypto_alt_4h` score `1.1278` n `91` status `ready` deltaP `8.6103` edge `0.1483` maxDD `-3.9374`
- `market_context_high->crypto_major_4h` score `1.0194` n `91` status `ready` deltaP `10.8081` edge `0.1847` maxDD `-6.7444`
- `market_context_high->index_1h` score `1.0108` n `96` status `ready` deltaP `15.7563` edge `0.0222` maxDD `-0.7743`
- `market_context_high->metal_1h` score `0.6672` n `96` status `ready` deltaP `9.5309` edge `0.0299` maxDD `-0.6936`
- `market_context_high->crypto_major_1h` score `0.4451` n `96` status `ready` deltaP `8.9259` edge `0.0386` maxDD `-1.6171`
- `market_context_high->crypto_alt_1h` score `0.1242` n `96` status `ready` deltaP `2.8318` edge `0.0403` maxDD `-1.4603`
- `market_context_high->fx_1h` score `-0.167` n `96` status `ready` deltaP `2.1021` edge `0.0013` maxDD `-0.2715`
- `market_context_high->commodity_1h` score `-0.3132` n `96` status `ready` deltaP `2.5056` edge `0.0` maxDD `-1.5486`
