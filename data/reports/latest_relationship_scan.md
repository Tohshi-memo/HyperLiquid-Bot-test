...
- `news_risk_high->commodity_24h` score `3.5298` n `30` status `ready` deltaP `29.5486` edge `0.1177` maxDD `-0.3101`
...
- `market_context_high->equity_4h` score `1.1073` n `213` status `ready` deltaP `7.2892` edge `0.1527` maxDD `-4.055`
...
- `market_context_high->commodity_1h` score `-0.6502` n `213` status `ready` deltaP `-1.1533` edge `-0.0001` maxDD `-0.7117`
