...
- `market_context_high->unknown_1h` score `72.2093` n `47` status `ready` deltaP `11.0142` edge `5.9511` maxDD `-0.2334`
- `market_context_high->crypto_major_24h` score `35.9266` n `46` status `ready` deltaP `23.0828` edge `2.8556` maxDD `-0.5817`
- `market_context_high->equity_24h` score `20.8784` n `46` status `ready` deltaP `20.4786` edge `1.6134` maxDD `-0.1382`
- `market_context_high->crypto_alt_24h` score `20.0204` n `46` status `ready` deltaP `18.0556` edge `1.548` maxDD `0.0`
- `news_risk_high->crypto_major_24h` score `9.3128` n `98` status `ready` deltaP `-1.1408` edge `1.4695` maxDD `-46.1999`
- `market_context_high->index_24h` score `7.0176` n `46` status `ready` deltaP `29.5064` edge `0.3968` maxDD `-0.03`
- `news_risk_high->crypto_alt_24h` score `5.0606` n `98` status `ready` deltaP `-3.373` edge `0.9323` maxDD `-32.7147`
- `news_risk_high->crypto_alt_4h` score `4.9189` n `103` status `ready` deltaP `14.5365` edge `0.4128` maxDD `-5.9838`
- `news_risk_high->crypto_major_4h` score `4.5826` n `103` status `ready` deltaP `17.4328` edge `0.3234` maxDD `-2.619`
...
- `news_risk_high->crypto_major_1h` score `2.0493` n `103` status `ready` deltaP `15.8523` edge `0.1086` maxDD `-1.8141`
