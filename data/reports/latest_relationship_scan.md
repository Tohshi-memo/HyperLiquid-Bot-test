...
- `news_risk_high->crypto_major_24h` score `53.0464` n `72` status `ready` deltaP `32.118` edge `4.2956` maxDD `-5.8019`
- `news_risk_high->crypto_alt_24h` score `46.5444` n `72` status `ready` deltaP `36.632` edge `3.7724` maxDD `-9.3661`
- `market_context_high->unknown_4h` score `37.5291` n `143` status `ready` deltaP `-2.2578` edge `3.1658` maxDD `-0.5326`
- `news_risk_high->equity_24h` score `10.4669` n `72` status `ready` deltaP `41.6667` edge `0.5987` maxDD `-0.0053`
- `risk_on_high->unknown_4h` score `8.3527` n `52` status `ready` deltaP `-9.076` edge `0.7791` maxDD `-0.4694`
- `risk_on_and_context->unknown_4h` score `8.3527` n `52` status `ready` deltaP `-9.076` edge `0.7791` maxDD `-0.4694`
...
- `news_risk_high->crypto_major_4h` score `4.5186` n `86` status `ready` deltaP `21.1997` edge `0.361` maxDD `-8.0625`
...
- `news_risk_high->crypto_major_1h` score `2.5085` n `98` status `ready` deltaP `21.1689` edge `0.1202` maxDD `-2.8494`
...
- `news_risk_high->fx_4h` score `0.9935` n `86` status `ready` deltaP `11.479` edge `0.0288` maxDD `-0.1363`
