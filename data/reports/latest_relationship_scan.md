...
- `market_context_high->unknown_24h` score `18.9321` n `153` status `ready` deltaP `22.8247` edge `1.4345` maxDD `-0.3859`
- `market_context_high->crypto_major_24h` score `6.9668` n `153` status `ready` deltaP `24.52` edge `0.8321` maxDD `-26.5332`
- `market_context_high->equity_24h` score `4.9048` n `153` status `ready` deltaP `17.882` edge `0.8524` maxDD `-40.0306`
- `market_context_high->crypto_major_4h` score `3.0523` n `194` status `ready` deltaP `13.3361` edge `0.3947` maxDD `-14.0065`
- `market_context_high->crypto_alt_4h` score `2.9849` n `194` status `ready` deltaP `11.8839` edge `0.3336` maxDD `-9.46`
- `market_context_high->equity_4h` score `2.146` n `194` status `ready` deltaP `11.1594` edge `0.2683` maxDD `-7.4425`
- `market_context_high->index_24h` score `0.7232` n `153` status `ready` deltaP `24.1217` edge `0.0954` maxDD `-7.413`
- `market_context_high->equity_1h` score `0.5854` n `194` status `ready` deltaP `8.9111` edge `0.0859` maxDD `-5.0555`
- `market_context_high->fx_24h` score `0.2956` n `153` status `ready` deltaP `11.0498` edge `0.0405` maxDD `-0.8294`
- `market_context_high->crypto_alt_1h` score `0.1369` n `194` status `ready` deltaP `2.5449` edge `0.0906` maxDD `-5.0257`
...
- `market_context_high->commodity_1h` score `-1.4119` n `194` status `ready` deltaP `-3.0264` edge `-0.0057` maxDD `-3.3428`
- `market_context_high->metal_4h` score `-2.3575` n `194` status `ready` deltaP `-5.5475` edge `-0.0128` maxDD `-12.8631`
- `market_context_high->crypto_alt_24h` score `-3.3085` n `153` status `ready` deltaP `12.8268` edge `0.3313` maxDD `-53.6115`
