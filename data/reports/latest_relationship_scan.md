...
- Price records: `672`
- Market context records: `1956`
- Flow alert records: `7528`
- Minimum samples: `30`
- Pattern count: `80`
...
- `market_context_high->crypto_alt_4h` score `6.9403` n `233` status `ready` deltaP `21.5286` edge `0.5493` maxDD `-5.1574`
- `market_context_high->crypto_major_4h` score `6.4101` n `233` status `ready` deltaP `25.1825` edge `0.4909` maxDD `-4.9684`
- `market_context_high->unknown_4h` score `2.4016` n `233` status `ready` deltaP `13.4585` edge `0.3128` maxDD `-9.8581`
- `market_context_high->equity_4h` score `2.1534` n `233` status `ready` deltaP `14.1153` edge `0.1948` maxDD `-5.0894`
- `market_context_high->unknown_24h` score `1.1619` n `199` status `ready` deltaP `16.4203` edge `0.5194` maxDD `-35.8966`
- `market_context_high->crypto_major_1h` score `0.8181` n `234` status `ready` deltaP `8.3538` edge `0.1111` maxDD `-3.2225`
- `market_context_high->crypto_alt_1h` score `0.6384` n `234` status `ready` deltaP `7.6463` edge `0.1136` maxDD `-4.9097`
...
- `market_context_high->crypto_major_24h` score `-1.4925` n `199` status `ready` deltaP `15.7208` edge `0.6294` maxDD `-62.3533`
- `market_context_high->unknown_1h` score `-1.6102` n `234` status `ready` deltaP `0.0602` edge `-0.0394` maxDD `-3.6151`
