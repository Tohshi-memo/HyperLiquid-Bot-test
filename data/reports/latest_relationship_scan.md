...
- `news_risk_high->unknown_4h` score `13.5267` n `51` status `ready` deltaP `24.2587` edge `0.9701` maxDD `-0.0348`
...
- `market_context_high->crypto_alt_4h` score `0.9963` n `125` status `ready` deltaP `8.889` edge `0.1702` maxDD `-7.0478`
