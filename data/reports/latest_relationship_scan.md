...
- `market_context_high->crypto_major_24h` score `5.3822` n `76` status `ready` deltaP `18.8406` edge `0.4437` maxDD `-4.9964`
- `market_context_high->equity_24h` score `2.8288` n `76` status `ready` deltaP `16.9844` edge `0.1225` maxDD `0.0`
...
- `market_context_high->index_24h` score `1.1133` n `76` status `ready` deltaP `17.7483` edge `-0.0212` maxDD `-0.0141`
...
- `market_context_high->commodity_4h` score `0.3721` n `118` status `ready` deltaP `10.2056` edge `0.048` maxDD `-2.4692`
- `market_context_high->commodity_24h` score `0.344` n `76` status `ready` deltaP `14.3232` edge `0.1165` maxDD `-4.666`
- `market_context_high->index_1h` score `0.266` n `118` status `ready` deltaP `8.7664` edge `0.0057` maxDD `-0.3584`
