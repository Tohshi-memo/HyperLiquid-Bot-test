...
- `news_risk_high->crypto_major_24h` score `10.991` n `43` status `ready` deltaP `19.7674` edge `0.8422` maxDD `-3.3119`
- `market_context_high->crypto_major_24h` score `9.9772` n `139` status `ready` deltaP `19.7842` edge `1.0888` maxDD `-25.1408`
- `news_risk_high->unknown_24h` score `7.6617` n `43` status `ready` deltaP `27.6405` edge `0.4768` maxDD `-1.4744`
- `market_context_high->unknown_24h` score `6.8575` n `139` status `ready` deltaP `24.378` edge `0.4501` maxDD `-1.626`
- `market_context_high->crypto_alt_4h` score `6.59` n `156` status `ready` deltaP `22.4047` edge `0.6677` maxDD `-15.4319`
- `market_context_high->crypto_major_4h` score `6.5416` n `156` status `ready` deltaP `25.2502` edge `0.5578` maxDD `-10.1468`
- `market_context_high->unknown_4h` score `5.5896` n `156` status `ready` deltaP `22.4047` edge `0.3774` maxDD `-1.8773`
- `news_risk_high->index_24h` score `4.7726` n `43` status `ready` deltaP `12.7504` edge `0.3546` maxDD `-1.3507`
...
- `market_context_high->index_24h` score `2.8739` n `139` status `ready` deltaP `13.5367` edge `0.201` maxDD `-1.4737`
- `market_context_high->equity_24h` score `2.1706` n `139` status `ready` deltaP `19.8879` edge `0.201` maxDD `-6.8828`
- `market_context_high->index_4h` score `2.0571` n `156` status `ready` deltaP `20.1611` edge `0.1196` maxDD `-2.2732`
...
- `market_context_high->crypto_major_1h` score `1.5677` n `164` status `ready` deltaP `12.9984` edge `0.1634` maxDD `-4.2199`
