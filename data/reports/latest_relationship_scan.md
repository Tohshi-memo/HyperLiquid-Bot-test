...
- `market_context_high->unknown_1h` score `-0.0715` n `177` status `ready` deltaP `1.0648` edge `0.0428` maxDD `-1.4688`
...
- `market_context_high->crypto_major_1h` score `-0.6215` n `177` status `ready` deltaP `3.3391` edge `0.0333` maxDD `-7.1523`
- `market_context_high->commodity_1h` score `-0.8627` n `177` status `ready` deltaP `-4.4064` edge `-0.0196` maxDD `-1.9306`
- `market_context_high->unknown_4h` score `-0.9871` n `177` status `ready` deltaP `-5.673` edge `0.119` maxDD `-4.742`
- `market_context_high->metal_1h` score `-1.3735` n `177` status `ready` deltaP `-5.111` edge `-0.0036` maxDD `-2.1427`
- `market_context_high->commodity_4h` score `-1.7049` n `177` status `ready` deltaP `-8.4065` edge `-0.0465` maxDD `-2.9494`
- `market_context_high->equity_1h` score `-1.8907` n `177` status `ready` deltaP `4.392` edge `-0.0294` maxDD `-14.716`
- `market_context_high->index_4h` score `-2.226` n `177` status `ready` deltaP `2.8378` edge `-0.0344` maxDD `-12.2591`
- `market_context_high->commodity_24h` score `-2.4719` n `177` status `ready` deltaP `-2.8219` edge `-0.0563` maxDD `-4.4704`
- `market_context_high->crypto_alt_4h` score `-3.0183` n `177` status `ready` deltaP `-0.3186` edge `-0.0063` maxDD `-22.2831`
- `market_context_high->crypto_major_4h` score `-3.1212` n `177` status `ready` deltaP `2.1746` edge `0.0138` maxDD `-24.6094`
...
- `market_context_high->equity_4h` score `-7.9663` n `177` status `ready` deltaP `3.7076` edge `-0.159` maxDD `-63.963`
- `market_context_high->metal_24h` score `-15.602` n `177` status `ready` deltaP `-22.2134` edge `-0.1065` maxDD `-44.3131`
