...
- `risk_on_high->unknown_4h` score `6.9935` n `107` status `ready` deltaP `19.1532` edge `0.5169` maxDD `-2.2768`
- `risk_on_and_context->unknown_4h` score `6.9935` n `107` status `ready` deltaP `19.1532` edge `0.5169` maxDD `-2.2768`
- `market_context_high->unknown_4h` score `5.5401` n `151` status `ready` deltaP `15.4458` edge `0.4282` maxDD `-2.5597`
...
- `risk_on_high->index_4h` score `-0.0022` n `107` status `ready` deltaP `19.1062` edge `0.0054` maxDD `-3.6448`
- `risk_on_and_context->index_4h` score `-0.0022` n `107` status `ready` deltaP `19.1062` edge `0.0054` maxDD `-3.6448`
