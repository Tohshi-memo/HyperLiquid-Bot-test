...
- `risk_on_high->crypto_major_24h` score `2.2254` n `96` status `ready` deltaP `14.2361` edge `0.923` maxDD `-47.9416`
- `risk_on_and_context->crypto_major_24h` score `2.2254` n `96` status `ready` deltaP `14.2361` edge `0.923` maxDD `-47.9416`
- `market_context_high->equity_24h` score `1.0834` n `181` status `ready` deltaP `12.8127` edge `0.3587` maxDD `-16.9737`
...
- `risk_on_high->equity_1h` score `-0.4057` n `145` status `ready` deltaP `7.102` edge `-0.0119` maxDD `-2.6638`
- `risk_on_and_context->equity_1h` score `-0.4057` n `145` status `ready` deltaP `7.102` edge `-0.0119` maxDD `-2.6638`
...
- `market_context_high->index_4h` score `-1.2192` n `245` status `ready` deltaP `5.4959` edge `0.0007` maxDD `-5.825`
- `market_context_high->equity_1h` score `-1.2774` n `250` status `ready` deltaP `4.9641` edge `-0.0223` maxDD `-7.2983`
