...
- `market_context_high->equity_4h` score `0.5911` n `105` status `ready` deltaP `7.4841` edge `0.1623` maxDD `-8.3685`
- `market_context_high->equity_1h` score `0.5486` n `105` status `ready` deltaP `10.2167` edge `0.0591` maxDD `-3.1861`
...
- `market_context_high->crypto_alt_1h` score `-0.5361` n `105` status `ready` deltaP `1.1007` edge `0.0041` maxDD `-2.413`
- `market_context_high->crypto_major_1h` score `-0.6718` n `105` status `ready` deltaP `1.6866` edge `-0.0129` maxDD `-2.7581`
...
- `market_context_high->crypto_alt_4h` score `-1.4452` n `105` status `ready` deltaP `5.3484` edge `-0.0291` maxDD `-5.4926`
- `market_context_high->crypto_major_4h` score `-1.82` n `105` status `ready` deltaP `7.4448` edge `-0.0992` maxDD `-3.1677`
