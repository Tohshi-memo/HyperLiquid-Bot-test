...
- `market_context_high->commodity_4h` score `1.4301` n `130` status `ready` deltaP `15.1008` edge `0.0858` maxDD `-2.7169`
...
- `market_context_high->crypto_alt_4h` score `-4.2949` n `130` status `ready` deltaP `-10.0891` edge `-0.125` maxDD `-6.585`
- `market_context_high->crypto_alt_24h` score `-4.5046` n `103` status `ready` deltaP `-12.4461` edge `-0.1481` maxDD `-4.5445`
- `market_context_high->unknown_1h` score `-8.2945` n `140` status `ready` deltaP `-5.864` edge `-0.6074` maxDD `-1.2437`
