...
- `market_context_high->equity_4h` score `0.0309` n `299` status `ready` deltaP `7.0107` edge `0.1197` maxDD `-7.4425`
...
- `market_context_high->fx_24h` score `-0.9957` n `242` status `ready` deltaP `14.1429` edge `0.0399` maxDD `-3.9472`
...
- `market_context_high->fx_4h` score `-1.4108` n `299` status `ready` deltaP `0.8019` edge `0.0039` maxDD `-1.8758`
- `market_context_high->commodity_4h` score `-2.4622` n `299` status `ready` deltaP `-3.3613` edge `-0.0257` maxDD `-14.071`
- `market_context_high->index_24h` score `-2.8583` n `242` status `ready` deltaP `2.7333` edge `0.0298` maxDD `-18.1572`
...
- `market_context_high->crypto_alt_4h` score `-4.5268` n `299` status `ready` deltaP `5.3272` edge `0.0881` maxDD `-28.7346`
