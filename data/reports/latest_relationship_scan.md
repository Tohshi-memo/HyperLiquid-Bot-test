...
- Price records: `672`
- Market context records: `1059`
- Flow alert records: `4956`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_major_1h` score `-0.3023` n `178` status `ready` deltaP `7.4178` edge `0.0187` maxDD `-5.4676`
...
- `market_context_high->commodity_1h` score `-0.8087` n `178` status `ready` deltaP `0.148` edge `0.0124` maxDD `-3.7959`
- `market_context_high->index_4h` score `-0.8182` n `178` status `ready` deltaP `0.8427` edge `0.0444` maxDD `-5.1225`
- `market_context_high->metal_1h` score `-0.869` n `178` status `ready` deltaP `3.825` edge `-0.0318` maxDD `-5.7425`
- `market_context_high->crypto_alt_1h` score `-1.0442` n `178` status `ready` deltaP `1.6905` edge `0.0103` maxDD `-5.3538`
- `market_context_high->crypto_major_4h` score `-2.3301` n `178` status `ready` deltaP `7.6819` edge `0.0641` maxDD `-17.759`
- `market_context_high->crypto_alt_4h` score `-2.5023` n `178` status `ready` deltaP `1.2965` edge `0.0423` maxDD `-13.7573`
- `market_context_high->metal_4h` score `-3.0454` n `178` status `ready` deltaP `0.2518` edge `-0.1404` maxDD `-13.8035`
- `market_context_high->fx_24h` score `-3.1326` n `176` status `ready` deltaP `4.0521` edge `-0.021` maxDD `-19.2774`
- `market_context_high->commodity_4h` score `-3.7682` n `178` status `ready` deltaP `-5.8132` edge `0.0415` maxDD `-13.0076`
