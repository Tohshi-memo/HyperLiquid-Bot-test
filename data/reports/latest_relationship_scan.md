...
- `news_risk_high->crypto_major_24h` score `3.9671` n `32` status `ready` deltaP `15.625` edge `0.4824` maxDD `-4.2368`
...
- `news_risk_high->crypto_major_1h` score `1.471` n `32` status `ready` deltaP `14.128` edge `0.1411` maxDD `-2.0691`
- `news_risk_high->crypto_alt_1h` score `0.8442` n `32` status `ready` deltaP `10.2732` edge `0.0859` maxDD `-1.6923`
- `market_context_high->unknown_1h` score `0.6369` n `209` status `ready` deltaP `-5.4465` edge `0.1902` maxDD `-3.7317`
...
- `news_risk_high->unknown_1h` score `-0.3004` n `32` status `ready` deltaP `6.0816` edge `-0.0311` maxDD `-0.7581`
- `market_context_high->metal_24h` score `-0.4351` n `146` status `ready` deltaP `18.5978` edge `0.0966` maxDD `-11.8809`
