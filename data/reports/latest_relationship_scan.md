...
- `market_context_high->equity_24h` score `0.5837` n `248` status `ready` deltaP `15.3954` edge `0.4539` maxDD `-31.6316`
- `market_context_high->equity_4h` score `-0.0398` n `302` status `ready` deltaP `6.4428` edge `0.1176` maxDD `-7.4425`
- `market_context_high->fx_1h` score `-0.2622` n `302` status `ready` deltaP `2.1047` edge `0.0009` maxDD `-0.5499`
- `market_context_high->equity_1h` score `-0.6402` n `302` status `ready` deltaP `3.111` edge `0.0266` maxDD `-5.0555`
...
- `market_context_high->fx_24h` score `-1.1411` n `248` status `ready` deltaP `13.1161` edge `0.0375` maxDD `-4.6987`
- `market_context_high->index_4h` score `-1.1938` n `302` status `ready` deltaP `0.7774` edge `0.0105` maxDD `-3.165`
- `market_context_high->fx_4h` score `-1.4798` n `302` status `ready` deltaP `0.2836` edge `0.0033` maxDD `-2.2593`
...
- `market_context_high->index_24h` score `-2.7956` n `248` status `ready` deltaP `3.7131` edge `0.0313` maxDD `-18.1572`
- `market_context_high->crypto_major_4h` score `-2.9726` n `302` status `ready` deltaP `7.5785` edge `0.139` maxDD `-25.6458`
- `market_context_high->crypto_alt_4h` score `-4.5637` n `302` status `ready` deltaP `5.3606` edge `0.0848` maxDD `-28.7346`
- `market_context_high->metal_24h` score `-6.7918` n `248` status `ready` deltaP `-7.2917` edge `-0.2504` maxDD `-25.7388`
- `market_context_high->crypto_major_24h` score `-8.5137` n `248` status `ready` deltaP `0.3024` edge `-0.1658` maxDD `-29.6555`
