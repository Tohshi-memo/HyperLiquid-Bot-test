...
- `market_context_high->crypto_major_1h` score `0.0313` n `176` status `ready` deltaP `8.2506` edge `0.035` maxDD `-4.2122`
- `market_context_high->crypto_alt_1h` score `-0.0416` n `176` status `ready` deltaP `5.7975` edge `0.0343` maxDD `-3.7803`
...
- `market_context_high->index_4h` score `-1.1584` n `176` status `ready` deltaP `7.3586` edge `-0.0096` maxDD `-5.7046`
...
- `market_context_high->unknown_1h` score `-1.9875` n `176` status `ready` deltaP `-8.2233` edge `-0.0207` maxDD `-3.2083`
- `market_context_high->crypto_major_4h` score `-2.1498` n `176` status `ready` deltaP `5.9451` edge `0.0162` maxDD `-16.8495`
- `market_context_high->crypto_alt_4h` score `-2.3389` n `176` status `ready` deltaP `3.5892` edge `0.0164` maxDD `-19.2145`
- `market_context_high->metal_4h` score `-2.5656` n `176` status `ready` deltaP `-5.862` edge `-0.0038` maxDD `-5.2172`
- `market_context_high->equity_4h` score `-3.8545` n `176` status `ready` deltaP `5.7511` edge `-0.1056` maxDD `-27.1529`
...
- `market_context_high->metal_24h` score `-7.4353` n `176` status `ready` deltaP `-8.2545` edge `-0.0497` maxDD `-28.2147`
