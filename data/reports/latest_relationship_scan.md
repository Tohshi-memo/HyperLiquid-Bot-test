...
- `news_risk_high->equity_24h` score `9.2516` n `51` status `ready` deltaP `34.5078` edge `0.634` maxDD `-4.7801`
...
- `news_risk_high->equity_4h` score `2.1542` n `52` status `ready` deltaP `22.0451` edge `0.1096` maxDD `-2.164`
...
- `news_risk_high->equity_1h` score `0.6258` n `53` status `ready` deltaP `15.1706` edge `0.0155` maxDD `-0.9128`
...
- `news_risk_high->metal_4h` score `-0.3338` n `52` status `ready` deltaP `6.1797` edge `-0.0159` maxDD `-0.249`
...
- `market_context_high->metal_4h` score `-0.7741` n `133` status `ready` deltaP `5.7893` edge `-0.0394` maxDD `-2.4293`
