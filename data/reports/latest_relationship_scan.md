...
- `news_risk_high->crypto_alt_24h` score `10.532` n `30` status `ready` deltaP `39.1666` edge `0.6313` maxDD `-0.5131`
...
- `news_risk_high->crypto_major_1h` score `1.2394` n `32` status `ready` deltaP `13.5292` edge `0.1154` maxDD `-2.0691`
- `news_risk_high->crypto_alt_1h` score `0.6393` n `32` status `ready` deltaP `8.6265` edge `0.0706` maxDD `-1.6923`
- `market_context_high->equity_4h` score `0.4745` n `195` status `ready` deltaP `4.3598` edge `0.1022` maxDD `-2.671`
...
- `market_context_high->metal_4h` score `-0.6847` n `195` status `ready` deltaP `3.0848` edge `0.0104` maxDD `-3.4996`
...
- `market_context_high->crypto_major_1h` score `-0.9585` n `195` status `ready` deltaP `4.3145` edge `0.0251` maxDD `-9.807`
