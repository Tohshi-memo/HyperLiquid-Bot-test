...
- `market_context_high->crypto_alt_4h` score `1.1117` n `258` status `ready` deltaP `10.5821` edge `0.183` maxDD `-7.5392`
- `market_context_high->equity_4h` score `0.2603` n `258` status `ready` deltaP `6.998` edge `0.1389` maxDD `-7.4425`
- `market_context_high->crypto_major_1h` score `-0.163` n `270` status `ready` deltaP `4.287` edge `0.0451` maxDD `-3.9811`
...
- `market_context_high->index_4h` score `-1.3391` n `258` status `ready` deltaP `-1.4027` edge `0.0064` maxDD `-3.165`
- `market_context_high->metal_4h` score `-2.7469` n `258` status `ready` deltaP `-9.3898` edge `-0.052` maxDD `-11.6719`
- `market_context_high->index_24h` score `-2.878` n `208` status `ready` deltaP `2.6442` edge `0.026` maxDD `-18.0079`
- `market_context_high->crypto_major_24h` score `-3.7427` n `208` status `ready` deltaP `6.6907` edge `0.0892` maxDD `-29.6555`
- `market_context_high->commodity_4h` score `-3.9758` n `258` status `ready` deltaP `-4.4196` edge `-0.0343` maxDD `-14.071`
- `market_context_high->metal_24h` score `-8.0582` n `208` status `ready` deltaP `-9.1346` edge `-0.2446` maxDD `-32.5421`
- `market_context_high->commodity_24h` score `-12.2908` n `208` status `ready` deltaP `-12.3664` edge `-0.0809` maxDD `-45.8715`
