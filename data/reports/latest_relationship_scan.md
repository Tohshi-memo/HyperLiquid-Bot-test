...
- `market_context_high->unknown_1h` score `8.0989` n `122` status `ready` deltaP `12.7295` edge `0.6318` maxDD `-1.674`
...
- `market_context_high->commodity_24h` score `-2.1712` n `107` status `ready` deltaP `19.9231` edge `0.0997` maxDD `-27.5371`
- `market_context_high->metal_1h` score `-2.2938` n `122` status `ready` deltaP `-1.097` edge `-0.0692` maxDD `-14.0715`
- `market_context_high->crypto_alt_1h` score `-3.2611` n `122` status `ready` deltaP `0.2994` edge `-0.0498` maxDD `-15.2495`
- `market_context_high->fx_24h` score `-3.362` n `107` status `ready` deltaP `-15.4206` edge `-0.0224` maxDD `-3.3968`
- `market_context_high->crypto_major_1h` score `-4.5811` n `122` status `ready` deltaP `0.0859` edge `-0.0733` maxDD `-22.0555`
- `market_context_high->crypto_alt_4h` score `-5.1155` n `122` status `ready` deltaP `3.5261` edge `-0.0369` maxDD `-46.0617`
- `market_context_high->index_24h` score `-5.6798` n `107` status `ready` deltaP `-5.1029` edge `-0.1059` maxDD `-18.6716`
- `market_context_high->crypto_major_4h` score `-8.4213` n `122` status `ready` deltaP `2.2866` edge `-0.1718` maxDD `-68.5143`
- `market_context_high->metal_4h` score `-8.5595` n `122` status `ready` deltaP `5.0105` edge `-0.3067` maxDD `-61.2596`
