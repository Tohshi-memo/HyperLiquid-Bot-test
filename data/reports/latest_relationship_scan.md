...
- `market_context_high->unknown_24h` score `-0.6734` n `209` status `ready` deltaP `-6.4677` edge `0.4118` maxDD `-18.7342`
- `market_context_high->metal_1h` score `-0.6819` n `222` status `ready` deltaP `-1.671` edge `0.0005` maxDD `-2.1427`
- `market_context_high->crypto_alt_1h` score `-0.6839` n `222` status `ready` deltaP `0.6069` edge `0.0254` maxDD `-4.5815`
- `market_context_high->index_1h` score `-0.7459` n `222` status `ready` deltaP `-0.6164` edge `-0.0004` maxDD `-2.2895`
- `market_context_high->crypto_major_1h` score `-0.766` n `222` status `ready` deltaP `2.255` edge `0.022` maxDD `-7.1523`
...
- `market_context_high->index_4h` score `-1.84` n `222` status `ready` deltaP `6.9916` edge `-0.0126` maxDD `-12.2591`
- `market_context_high->metal_4h` score `-1.941` n `222` status `ready` deltaP `5.9506` edge `0.0098` maxDD `-5.5324`
- `market_context_high->unknown_4h` score `-2.3199` n `222` status `ready` deltaP `-5.9478` edge `0.0751` maxDD `-9.6351`
- `market_context_high->crypto_alt_4h` score `-2.7963` n `222` status `ready` deltaP `0.651` edge `0.0157` maxDD `-22.2831`
- `market_context_high->commodity_24h` score `-2.8093` n `209` status `ready` deltaP `-3.8137` edge `-0.0778` maxDD `-4.4704`
- `market_context_high->equity_1h` score `-3.0647` n `222` status `ready` deltaP `2.5381` edge `-0.0169` maxDD `-15.7664`
- `market_context_high->crypto_major_4h` score `-3.181` n `222` status `ready` deltaP `1.6836` edge `0.0094` maxDD `-24.6094`
- `market_context_high->fx_24h` score `-4.026` n `209` status `ready` deltaP `-4.592` edge `-0.0146` maxDD `-4.5562`
- `market_context_high->equity_4h` score `-11.6073` n `222` status `ready` deltaP `3.8796` edge `-0.0757` maxDD `-66.3951`
