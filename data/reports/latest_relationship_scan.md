...
- `market_context_high->commodity_1h` score `0.388` n `109` status `ready` deltaP `7.4603` edge `0.0242` maxDD `-1.3282`
...
- `market_context_high->crypto_alt_1h` score `-1.4629` n `109` status `ready` deltaP `-4.8385` edge `-0.0186` maxDD `-3.0178`
...
- `market_context_high->crypto_alt_4h` score `-2.1247` n `109` status `ready` deltaP `1.3845` edge `-0.0473` maxDD `-5.7857`
- `market_context_high->crypto_alt_24h` score `-2.3494` n `98` status `ready` deltaP `-2.1861` edge `-0.0369` maxDD `-4.5445`
- `market_context_high->crypto_major_1h` score `-3.1916` n `109` status `ready` deltaP `-10.7002` edge `-0.0573` maxDD `-7.6533`
- `market_context_high->unknown_1h` score `-5.8779` n `109` status `ready` deltaP `0.9847` edge `-0.4517` maxDD `-1.2421`
- `market_context_high->commodity_24h` score `-6.8287` n `98` status `ready` deltaP `5.0311` edge `-0.0325` maxDD `-52.7876`
