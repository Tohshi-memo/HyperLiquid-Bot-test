...
- `risk_on_high->unknown_4h` score `20.6214` n `142` status `ready` deltaP `-2.8942` edge `1.9383` maxDD `-7.7112`
- `risk_on_and_context->unknown_4h` score `20.6214` n `142` status `ready` deltaP `-2.8942` edge `1.9383` maxDD `-7.7112`
- `market_context_high->unknown_4h` score `8.1212` n `237` status `ready` deltaP `1.0935` edge `0.9163` maxDD `-9.4124`
- `news_risk_high->crypto_alt_24h` score `5.0815` n `37` status `ready` deltaP `23.2686` edge `0.2953` maxDD `-0.8236`
- `news_risk_high->commodity_24h` score `3.9223` n `37` status `ready` deltaP `20.1389` edge `0.1926` maxDD `0.0`
- `news_risk_high->crypto_major_4h` score `3.2949` n `37` status `ready` deltaP `16.4181` edge `0.2064` maxDD `-0.9693`
- `news_risk_high->metal_4h` score `2.4003` n `37` status `ready` deltaP `24.4562` edge `0.0591` maxDD `-0.7692`
- `market_context_high->equity_24h` score `2.3558` n `157` status `ready` deltaP `14.1078` edge `0.4561` maxDD `-16.9737`
...
- `risk_on_high->crypto_major_24h` score `0.918` n `78` status `ready` deltaP `10.2297` edge `0.7821` maxDD `-47.9416`
- `risk_on_and_context->crypto_major_24h` score `0.918` n `78` status `ready` deltaP `10.2297` edge `0.7821` maxDD `-47.9416`
- `news_risk_high->crypto_alt_1h` score `0.7714` n `37` status `ready` deltaP `8.2781` edge `0.0356` maxDD `-0.7867`
- `news_risk_high->crypto_alt_4h` score `-0.0252` n `37` status `ready` deltaP `2.7398` edge `0.0125` maxDD `-1.296`
