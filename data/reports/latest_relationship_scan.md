...
- `risk_on_high->crypto_major_1h` score `1.6249` n `36` status `ready` deltaP `23.9521` edge `0.0731` maxDD `-0.957`
- `risk_on_and_context->crypto_major_1h` score `1.6249` n `36` status `ready` deltaP `23.9521` edge `0.0731` maxDD `-0.957`
