...
- `market_context_high->index_24h` score `0.3602` n `104` status `ready` deltaP `6.063` edge `0.1589` maxDD `-5.9181`
...
- `market_context_high->crypto_major_1h` score `-3.279` n `143` status `ready` deltaP `-11.7353` edge `-0.0628` maxDD `-7.2436`
- `market_context_high->crypto_alt_4h` score `-3.8765` n `143` status `ready` deltaP `-8.429` edge `-0.1012` maxDD `-6.585`
- `market_context_high->crypto_major_24h` score `-4.1726` n `104` status `ready` deltaP `1.4557` edge `-0.108` maxDD `-14.2873`
- `market_context_high->crypto_alt_24h` score `-6.5208` n `104` status `ready` deltaP `-18.149` edge `-0.2781` maxDD `-4.5445`
- `market_context_high->unknown_1h` score `-7.8197` n `143` status `ready` deltaP `-6.0938` edge `-0.5663` maxDD `-1.2437`
