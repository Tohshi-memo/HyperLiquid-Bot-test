...
- Price records: `672`
- Market context records: `1875`
- Flow alert records: `7297`
- Minimum samples: `30`
- Pattern count: `48`
...
- `market_context_high->crypto_major_4h` score `6.5262` n `199` status `ready` deltaP `26.6477` edge `0.4908` maxDD `-4.9684`
- `market_context_high->unknown_4h` score `4.3157` n `199` status `ready` deltaP `18.1104` edge `0.4413` maxDD `-9.8581`
...
- `market_context_high->index_24h` score `2.2651` n `178` status `ready` deltaP `12.66` edge `0.2272` maxDD `-4.1604`
...
- `market_context_high->metal_1h` score `-0.5538` n `199` status `ready` deltaP `6.1317` edge `0.0217` maxDD `-6.3532`
- `market_context_high->unknown_1h` score `-0.554` n `199` status `ready` deltaP `2.988` edge `0.0291` maxDD `-3.6151`
