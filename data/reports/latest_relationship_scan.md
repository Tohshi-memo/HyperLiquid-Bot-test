...
- `news_risk_high->unknown_24h` score `4750.8844` n `64` status `ready` deltaP `37.8472` edge `395.6968` maxDD `-2.0332`
...
- `market_context_high->crypto_alt_4h` score `1.7808` n `62` status `ready` deltaP `12.7508` edge `0.1591` maxDD `-5.323`
- `news_risk_high->crypto_major_4h` score `1.0673` n `64` status `ready` deltaP `7.0503` edge `0.1674` maxDD `-3.5385`
- `news_risk_high->crypto_alt_4h` score `0.5666` n `64` status `ready` deltaP `12.3476` edge `0.1295` maxDD `-5.8012`
- `news_risk_high->crypto_alt_1h` score `0.4453` n `64` status `ready` deltaP `8.2616` edge `0.0547` maxDD `-1.8813`
...
- `market_context_high->crypto_alt_1h` score `-0.5314` n `62` status `ready` deltaP `-2.7767` edge `0.0131` maxDD `-3.0178`
