...
- Price records: `672`
- Market context records: `1001`
- Flow alert records: `4789`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->commodity_1h` score `-0.5188` n `211` status `ready` deltaP `2.6322` edge `0.02` maxDD `-3.7959`
