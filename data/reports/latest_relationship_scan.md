...
- `market_context_high->unknown_4h` score `10.2544` n `200` status `ready` deltaP `-4.1829` edge `1.4254` maxDD `-35.7719`
...
- `risk_on_high->crypto_major_4h` score `1.3559` n `40` status `ready` deltaP `17.3171` edge `0.0641` maxDD `-2.6576`
- `risk_on_and_context->crypto_major_4h` score `1.3559` n `40` status `ready` deltaP `17.3171` edge `0.0641` maxDD `-2.6576`
