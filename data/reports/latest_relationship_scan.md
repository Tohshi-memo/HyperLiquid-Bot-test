...
- `news_risk_high->equity_4h` score `2.9574` n `51` status `ready` deltaP `25.0986` edge `0.1564` maxDD `-2.1818`
...
- `news_risk_high->equity_1h` score `0.8555` n `51` status `ready` deltaP `18.4924` edge `0.0229` maxDD `-0.9204`
...
- `market_context_high->fx_4h` score `0.218` n `123` status `ready` deltaP `8.1809` edge `0.0093` maxDD `-0.3204`
