...
- `market_context_high->equity_1h` score `1.8668` n `96` status `ready` deltaP `15.3007` edge `0.0837` maxDD `-0.4112`
- `market_context_high->crypto_major_24h` score `1.4335` n `96` status `ready` deltaP `4.6875` edge `0.209` maxDD `-4.9964`
...
- `market_context_high->crypto_major_4h` score `0.4518` n `96` status `ready` deltaP `9.1717` edge `0.0786` maxDD `-3.1677`
...
- `market_context_high->crypto_alt_4h` score `-0.3519` n `96` status `ready` deltaP `7.1646` edge `0.0499` maxDD `-5.4926`
- `market_context_high->crypto_major_1h` score `-0.5233` n `96` status `ready` deltaP `2.3827` edge `0.0015` maxDD `-2.7581`
- `market_context_high->crypto_alt_1h` score `-0.5632` n `96` status `ready` deltaP `1.0292` edge `0.0011` maxDD `-2.413`
