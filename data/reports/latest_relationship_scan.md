...
- `market_context_high->fx_4h` score `-0.283` n `122` status `ready` deltaP `4.5581` edge `0.0065` maxDD `-0.504`
- `market_context_high->fx_1h` score `-0.2917` n `125` status `ready` deltaP `1.6024` edge `0.0015` maxDD `-0.2527`
