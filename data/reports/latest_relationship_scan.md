...
- Price records: `672`
- Market context records: `848`
- Flow alert records: `2383`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_major_24h` score `11.8026` n `159` status `ready` deltaP `27.4568` edge `0.8339` maxDD `-1.3382`
- `market_context_high->crypto_alt_24h` score `5.1899` n `159` status `ready` deltaP `7.1836` edge `0.3894` maxDD `-0.0508`
...
- `risk_on_high->crypto_alt_4h` score `2.2836` n `33` status `ready` deltaP `19.7201` edge `0.0793` maxDD `-0.6377`
- `risk_on_and_context->crypto_alt_4h` score `2.2836` n `33` status `ready` deltaP `19.7201` edge `0.0793` maxDD `-0.6377`
- `risk_on_high->metal_1h` score `1.1147` n `33` status `ready` deltaP `13.1102` edge `0.0285` maxDD `-0.5074`
- `risk_on_and_context->metal_1h` score `1.1147` n `33` status `ready` deltaP `13.1102` edge `0.0285` maxDD `-0.5074`
