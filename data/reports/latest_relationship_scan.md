...
- `news_risk_high->unknown_24h` score `44.2844` n `51` status `ready` deltaP `5.0347` edge `3.6568` maxDD `0.0`
- `news_risk_high->unknown_4h` score `12.5472` n `53` status `ready` deltaP `24.0652` edge `0.8951` maxDD `-0.1281`
- `news_risk_high->equity_24h` score `8.2153` n `51` status `ready` deltaP `31.9036` edge `0.565` maxDD `-4.7801`
...
- `market_context_high->unknown_4h` score `2.5886` n `133` status `ready` deltaP `22.2068` edge `0.1085` maxDD `-0.5994`
- `news_risk_high->equity_4h` score `1.7919` n `53` status `ready` deltaP `20.6512` edge `0.0887` maxDD `-2.164`
...
- `news_risk_high->metal_24h` score `-0.1455` n `51` status `ready` deltaP `24.6017` edge `-0.1719` maxDD `-0.0053`
- `market_context_high->fx_1h` score `-0.4109` n `133` status `ready` deltaP `3.0976` edge `-0.0001` maxDD `-0.8587`
- `news_risk_high->crypto_alt_24h` score `-0.4246` n `51` status `ready` deltaP `21.5278` edge `-0.1789` maxDD `0.0`
