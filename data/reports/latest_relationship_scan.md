...
- `market_context_high->commodity_1h` score `1.0118` n `123` status `ready` deltaP `12.1525` edge `0.0376` maxDD `-0.7439`
...
- `market_context_high->equity_1h` score `-0.6878` n `123` status `ready` deltaP `2.1664` edge `0.0111` maxDD `-4.6286`
...
- `market_context_high->crypto_alt_1h` score `-2.2614` n `123` status `ready` deltaP `-13.4974` edge `-0.0344` maxDD `-2.4589`
- `market_context_high->equity_4h` score `-2.2889` n `113` status `ready` deltaP `0.8229` edge `-0.0625` maxDD `-7.6983`
- `market_context_high->crypto_major_1h` score `-3.0939` n `123` status `ready` deltaP `-10.7176` edge `-0.0658` maxDD `-6.3124`
- `market_context_high->crypto_major_24h` score `-3.7999` n `103` status `ready` deltaP `6.2197` edge `-0.1087` maxDD `-14.2873`
- `market_context_high->crypto_alt_24h` score `-4.3894` n `103` status `ready` deltaP `-12.4461` edge `-0.1385` maxDD `-4.5445`
- `market_context_high->crypto_alt_4h` score `-4.7802` n `113` status `ready` deltaP `-13.3742` edge `-0.144` maxDD `-6.5487`
- `market_context_high->unknown_1h` score `-8.3506` n `123` status `ready` deltaP `-5.1555` edge `-0.6168` maxDD `-1.2437`
