...
- `market_context_high->crypto_major_24h` score `5.0026` n `79` status `ready` deltaP `19.5402` edge `0.4074` maxDD `-4.9964`
- `market_context_high->equity_24h` score `3.0796` n `79` status `ready` deltaP `16.9844` edge `0.1434` maxDD `0.0`
- `market_context_high->index_24h` score `1.3169` n `79` status `ready` deltaP `18.8908` edge `-0.0162` maxDD `0.0`
...
- `risk_on_high->equity_1h` score `0.7526` n `35` status `ready` deltaP `12.6091` edge `0.033` maxDD `-1.6811`
- `risk_on_and_context->equity_1h` score `0.7526` n `35` status `ready` deltaP `12.6091` edge `0.033` maxDD `-1.6811`
