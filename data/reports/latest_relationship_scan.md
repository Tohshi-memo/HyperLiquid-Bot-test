...
- `news_risk_high->unknown_4h` score `14.6648` n `51` status `ready` deltaP `26.5453` edge `1.0497` maxDD `-0.0347`
...
- `news_risk_high->equity_4h` score `2.8251` n `51` status `ready` deltaP `23.8791` edge `0.1535` maxDD `-2.1818`
...
- `risk_on_high->equity_4h` score `1.6735` n `33` status `ready` deltaP `-1.0763` edge `0.2648` maxDD `-0.7794`
- `risk_on_and_context->equity_4h` score `1.6735` n `33` status `ready` deltaP `-1.0763` edge `0.2648` maxDD `-0.7794`
...
- `market_context_high->unknown_4h` score `1.1335` n `124` status `ready` deltaP `22.0545` edge `-0.0354` maxDD `-0.3736`
- `market_context_high->crypto_alt_4h` score `1.1055` n `124` status `ready` deltaP `8.5562` edge `0.1819` maxDD `-7.0785`
- `market_context_high->commodity_24h` score `0.966` n `107` status `ready` deltaP `1.595` edge `0.1172` maxDD `-0.7869`
- `news_risk_high->equity_1h` score `0.7932` n `51` status `ready` deltaP `17.4445` edge `0.0219` maxDD `-0.9204`
...
- `risk_on_high->unknown_4h` score `0.5117` n `33` status `ready` deltaP `28.5061` edge `-0.1474` maxDD `0.0`
