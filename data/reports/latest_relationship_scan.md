...
- `news_risk_high->crypto_major_24h` score `47.6828` n `75` status `ready` deltaP `22.9584` edge `3.9097` maxDD `-5.8019`
- `news_risk_high->crypto_alt_24h` score `42.0503` n `75` status `ready` deltaP `31.875` edge `3.4296` maxDD `-9.3661`
- `market_context_high->unknown_4h` score `19.6224` n `98` status `ready` deltaP `-6.2064` edge `1.6999` maxDD `-0.5326`
- `market_context_high->commodity_24h` score `7.8377` n `96` status `ready` deltaP `38.8889` edge `0.4464` maxDD `-0.8682`
- `news_risk_high->equity_24h` score `7.8304` n `75` status `ready` deltaP `36.3403` edge `0.4145` maxDD `-0.0053`
...
- `news_risk_high->crypto_alt_1h` score `3.27` n `98` status `ready` deltaP `18.624` edge `0.1949` maxDD `-2.058`
...
- `news_risk_high->fx_24h` score `0.1881` n `75` status `ready` deltaP `2.0069` edge `0.0349` maxDD `-0.2748`
- `news_risk_high->commodity_24h` score `0.0086` n `75` status `ready` deltaP `14.6389` edge `0.0341` maxDD `-3.4467`
