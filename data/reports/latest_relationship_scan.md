...
- `market_context_high->index_1h` score `-0.8186` n `180` status `ready` deltaP `-6.2641` edge `-0.0044` maxDD `-1.0359`
- `market_context_high->metal_1h` score `-1.2984` n `180` status `ready` deltaP `-5.2195` edge `-0.0098` maxDD `-2.0884`
- `market_context_high->equity_1h` score `-1.4762` n `180` status `ready` deltaP `-6.4604` edge `-0.0185` maxDD `-6.8818`
- `market_context_high->metal_24h` score `-1.7656` n `143` status `ready` deltaP `2.2203` edge `-0.0295` maxDD `-2.9283`
...
- `market_context_high->metal_4h` score `-3.2135` n `168` status `ready` deltaP `-8.101` edge `-0.0374` maxDD `-6.1111`
- `market_context_high->crypto_major_1h` score `-3.6161` n `180` status `ready` deltaP `-9.0186` edge `-0.0508` maxDD `-11.9002`
- `market_context_high->equity_4h` score `-4.5107` n `168` status `ready` deltaP `-16.7973` edge `-0.1554` maxDD `-15.8728`
- `market_context_high->crypto_alt_4h` score `-6.675` n `168` status `ready` deltaP `-12.2314` edge `-0.1399` maxDD `-20.1177`
- `market_context_high->crypto_major_24h` score `-6.6873` n `143` status `ready` deltaP `-13.1122` edge `-0.1928` maxDD `-33.5037`
