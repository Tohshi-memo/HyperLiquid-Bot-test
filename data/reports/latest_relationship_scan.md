...
- `risk_on_high->unknown_4h` score `130.5534` n `44` status `ready` deltaP `-2.3559` edge `11.077` maxDD `-10.8809`
- `risk_on_and_context->unknown_4h` score `130.5534` n `44` status `ready` deltaP `-2.3559` edge `11.077` maxDD `-10.8809`
- `market_context_high->unknown_1h` score `27.8426` n `236` status `ready` deltaP `2.7556` edge `2.4598` maxDD `-9.6361`
- `market_context_high->unknown_4h` score `8.91` n `236` status `ready` deltaP `0.6873` edge `1.2809` maxDD `-35.7719`
- `market_context_high->unknown_24h` score `5.061` n `207` status `ready` deltaP `-7.8879` edge `0.8777` maxDD `-24.2693`
...
- `risk_on_high->crypto_major_4h` score `1.1264` n `44` status `ready` deltaP `16.1724` edge `0.0526` maxDD `-2.6576`
- `risk_on_and_context->crypto_major_4h` score `1.1264` n `44` status `ready` deltaP `16.1724` edge `0.0526` maxDD `-2.6576`
...
- `risk_on_high->crypto_major_1h` score `0.1994` n `44` status `ready` deltaP `8.5466` edge `0.0228` maxDD `-2.3372`
- `risk_on_and_context->crypto_major_1h` score `0.1994` n `44` status `ready` deltaP `8.5466` edge `0.0228` maxDD `-2.3372`
