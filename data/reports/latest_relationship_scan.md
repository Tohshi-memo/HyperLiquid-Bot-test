...
- `market_context_high->equity_4h` score `1.7869` n `96` status `ready` deltaP `10.2388` edge `0.1695` maxDD `-2.4411`
...
- `market_context_high->commodity_24h` score `0.8867` n `96` status `ready` deltaP `11.8056` edge `0.2183` maxDD `-4.666`
- `market_context_high->unknown_1h` score `0.2168` n `96` status `ready` deltaP `8.3084` edge `-0.0146` maxDD `-0.4843`
- `market_context_high->metal_1h` score `0.1847` n `96` status `ready` deltaP `6.2687` edge `0.0123` maxDD `-0.4291`
- `market_context_high->crypto_alt_4h` score `0.1466` n `96` status `ready` deltaP `9.4512` edge `0.0762` maxDD `-5.4926`
...
- `market_context_high->fx_24h` score `-4.0073` n `96` status `ready` deltaP `-23.0902` edge `-0.0217` maxDD `-1.9981`
