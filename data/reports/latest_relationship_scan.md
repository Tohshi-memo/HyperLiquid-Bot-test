...
- `news_risk_high->unknown_1h` score `750.9725` n `59` status `ready` deltaP `-6.2088` edge `62.6646` maxDD `-1.7068`
...
- `risk_on_high->crypto_major_4h` score `7.1679` n `91` status `ready` deltaP `31.4393` edge `0.4736` maxDD `-3.8693`
- `risk_on_and_context->crypto_major_4h` score `7.1679` n `91` status `ready` deltaP `31.4393` edge `0.4736` maxDD `-3.8693`
- `risk_on_high->index_24h` score `5.5763` n `91` status `ready` deltaP `51.738` edge `0.124` maxDD `-0.0051`
- `risk_on_and_context->index_24h` score `5.5763` n `91` status `ready` deltaP `51.738` edge `0.124` maxDD `-0.0051`
- `market_context_high->index_24h` score `4.4341` n `161` status `ready` deltaP `43.8546` edge `0.1165` maxDD `-0.1483`
- `risk_on_high->equity_4h` score `3.5386` n `91` status `ready` deltaP `34.2603` edge `0.0758` maxDD `-0.079`
- `risk_on_and_context->equity_4h` score `3.5386` n `91` status `ready` deltaP `34.2603` edge `0.0758` maxDD `-0.079`
- `market_context_high->crypto_alt_4h` score `3.5046` n `161` status `ready` deltaP `22.7503` edge `0.3109` maxDD `-7.6417`
- `market_context_high->equity_4h` score `2.3751` n `161` status `ready` deltaP `27.8102` edge `0.0952` maxDD `-2.6138`
