...
- `market_context_high->commodity_24h` score `7.5049` n `88` status `ready` deltaP `41.3037` edge `0.3558` maxDD `-0.1266`
- `news_risk_high->index_24h` score `3.8304` n `33` status `ready` deltaP `30.5556` edge `0.1155` maxDD `0.0`
- `market_context_high->commodity_4h` score `1.9198` n `113` status `ready` deltaP `18.2684` edge `0.0853` maxDD `-0.7687`
...
- `market_context_high->commodity_1h` score `-0.046` n `125` status `ready` deltaP `2.5054` edge `0.0206` maxDD `-0.624`
