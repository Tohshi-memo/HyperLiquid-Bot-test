...
- `news_risk_high->unknown_4h` score `12.8901` n `51` status `ready` deltaP `24.716` edge `0.914` maxDD `-0.0348`
...
- `news_risk_high->unknown_1h` score `3.2647` n `51` status `ready` deltaP `15.7361` edge `0.1976` maxDD `-0.7693`
...
- `market_context_high->unknown_4h` score `1.9633` n `129` status `ready` deltaP `19.7001` edge `0.0731` maxDD `-0.5994`
...
- `market_context_high->unknown_1h` score `-0.1227` n `133` status `ready` deltaP `10.0749` edge `-0.0325` maxDD `-1.5916`
- `news_risk_high->metal_1h` score `-0.1831` n `51` status `ready` deltaP `0.8454` edge `-0.0068` maxDD `-0.1184`
- `market_context_high->metal_4h` score `-0.1848` n `129` status `ready` deltaP `8.3215` edge `-0.0291` maxDD `-1.6725`
