...
- `market_context_high->unknown_1h` score `1.4244` n `133` status `ready` deltaP `8.3878` edge `0.0855` maxDD `-0.4843`
- `market_context_high->unknown_4h` score `0.5451` n `133` status `ready` deltaP `20.4807` edge `-0.0472` maxDD `-0.5133`
...
- `market_context_high->crypto_alt_1h` score `-0.9102` n `133` status `ready` deltaP `-0.628` edge `0.0085` maxDD `-2.413`
- `market_context_high->crypto_major_1h` score `-1.4634` n `133` status `ready` deltaP `-2.2984` edge `-0.0698` maxDD `-4.1996`
...
- `market_context_high->crypto_alt_4h` score `-2.1377` n `133` status `ready` deltaP `4.5079` edge `-0.0812` maxDD `-5.4926`
...
- `market_context_high->crypto_major_4h` score `-5.4951` n `133` status `ready` deltaP `-1.9542` edge `-0.3428` maxDD `-3.1677`
