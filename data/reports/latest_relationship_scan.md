...
- `market_context_high->crypto_major_4h` score `10.361` n `192` status `ready` deltaP `36.4964` edge `0.6731` maxDD `-1.9063`
- `market_context_high->crypto_alt_4h` score `10.2849` n `192` status `ready` deltaP `30.5768` edge `0.7677` maxDD `-5.1574`
...
- `market_context_high->index_4h` score `2.4587` n `192` status `ready` deltaP `18.2927` edge `0.1513` maxDD `-1.8022`
- `market_context_high->crypto_major_1h` score `2.2331` n `192` status `ready` deltaP `15.9306` edge `0.1785` maxDD `-3.2225`
- `market_context_high->index_24h` score `1.9588` n `191` status `ready` deltaP `10.9005` edge `0.2134` maxDD `-4.1604`
- `market_context_high->crypto_alt_1h` score `1.8828` n `192` status `ready` deltaP `12.5655` edge `0.1845` maxDD `-4.9097`
...
- `market_context_high->crypto_major_24h` score `0.1873` n `191` status `ready` deltaP `21.1634` edge `0.7331` maxDD `-62.3533`
- `market_context_high->index_1h` score `0.0165` n `192` status `ready` deltaP `5.0275` edge `0.0269` maxDD `-1.3898`
