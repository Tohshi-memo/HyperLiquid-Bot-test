...
- `market_context_high->crypto_alt_24h` score `11.984` n `111` status `ready` deltaP `13.6824` edge `2.4428` maxDD `-71.142`
- `market_context_high->index_24h` score `6.7136` n `111` status `ready` deltaP `31.7192` edge `0.9047` maxDD `-16.1026`
- `market_context_high->equity_24h` score `5.0047` n `111` status `ready` deltaP `13.4478` edge `1.3936` maxDD `-53.663`
...
- `market_context_high->crypto_major_1h` score `-1.0278` n `145` status `ready` deltaP `2.7937` edge `0.0759` maxDD `-15.1032`
- `market_context_high->fx_1h` score `-1.1415` n `145` status `ready` deltaP `-10.9034` edge `-0.0054` maxDD `-0.7941`
- `market_context_high->index_4h` score `-1.1887` n `145` status `ready` deltaP `11.3866` edge `0.0626` maxDD `-17.6057`
...
- `market_context_high->metal_1h` score `-2.0913` n `145` status `ready` deltaP `-4.4559` edge `-0.0052` maxDD `-7.4828`
