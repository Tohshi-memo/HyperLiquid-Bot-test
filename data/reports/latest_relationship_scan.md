...
- `market_context_high->crypto_major_24h` score `3.0781` n `85` status `ready` deltaP `9.6896` edge `0.3127` maxDD `-4.9964`
...
- `risk_on_high->crypto_major_4h` score `-0.0254` n `35` status `ready` deltaP `1.0845` edge `0.0607` maxDD `-2.0278`
