...
- `market_context_high->crypto_alt_1h` score `-0.4971` n `203` status `ready` deltaP `4.7041` edge `0.0203` maxDD `-3.7803`
...
- `market_context_high->crypto_alt_4h` score `-2.0569` n `203` status `ready` deltaP `5.1258` edge `0.0423` maxDD `-19.2145`
- `market_context_high->metal_4h` score `-2.1` n `203` status `ready` deltaP `-0.612` edge `0.0209` maxDD `-5.2172`
- `market_context_high->metal_24h` score `-4.1343` n `175` status `ready` deltaP `-1.8735` edge `0.0453` maxDD `-14.6947`
- `market_context_high->equity_4h` score `-4.6716` n `203` status `ready` deltaP `8.2212` edge `-0.0172` maxDD `-27.1529`
- `market_context_high->fx_24h` score `-5.6963` n `175` status `ready` deltaP `-7.5304` edge `-0.0009` maxDD `-9.2202`
