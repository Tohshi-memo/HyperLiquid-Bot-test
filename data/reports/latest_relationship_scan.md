...
- Price records: `672`
- Market context records: `861`
- Flow alert records: `2415`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_major_24h` score `12.2406` n `165` status `ready` deltaP `27.5316` edge `0.8699` maxDD `-1.3382`
- `market_context_high->crypto_alt_24h` score `5.7437` n `165` status `ready` deltaP `7.2064` edge `0.4354` maxDD `-0.0508`
...
- `risk_on_high->crypto_major_4h` score `2.62` n `32` status `ready` deltaP `19.0549` edge `0.1285` maxDD `-0.9758`
- `risk_on_and_context->crypto_major_4h` score `2.62` n `32` status `ready` deltaP `19.0549` edge `0.1285` maxDD `-0.9758`
...
- `risk_on_high->crypto_major_1h` score `-0.006` n `32` status `ready` deltaP `6.381` edge `-0.0129` maxDD `-1.0995`
- `risk_on_and_context->crypto_major_1h` score `-0.006` n `32` status `ready` deltaP `6.381` edge `-0.0129` maxDD `-1.0995`
