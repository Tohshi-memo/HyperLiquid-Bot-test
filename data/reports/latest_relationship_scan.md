...
- `market_context_high->crypto_alt_1h` score `-0.8075` n `290` status `ready` deltaP `2.4458` edge `0.0368` maxDD `-5.6318`
...
- `market_context_high->crypto_alt_4h` score `-3.7934` n `285` status `ready` deltaP `6.5543` edge `0.1092` maxDD `-26.1874`
