...
- `risk_on_high->crypto_major_4h` score `7.8622` n `36` status `ready` deltaP `41.3618` edge `0.3987` maxDD `-0.8742`
- `risk_on_and_context->crypto_major_4h` score `7.8622` n `36` status `ready` deltaP `41.3618` edge `0.3987` maxDD `-0.8742`
...
- `risk_on_high->crypto_major_24h` score `3.8923` n `36` status `ready` deltaP `10.243` edge `0.3582` maxDD `-5.8371`
- `risk_on_and_context->crypto_major_24h` score `3.8923` n `36` status `ready` deltaP `10.243` edge `0.3582` maxDD `-5.8371`
- `risk_on_high->crypto_major_1h` score `1.7566` n `36` status `ready` deltaP `25.0` edge `0.083` maxDD `-0.957`
- `risk_on_and_context->crypto_major_1h` score `1.7566` n `36` status `ready` deltaP `25.0` edge `0.083` maxDD `-0.957`
...
- `risk_on_high->crypto_alt_1h` score `0.3708` n `36` status `ready` deltaP `3.676` edge `0.0601` maxDD `-0.9651`
- `risk_on_and_context->crypto_alt_1h` score `0.3708` n `36` status `ready` deltaP `3.676` edge `0.0601` maxDD `-0.9651`
