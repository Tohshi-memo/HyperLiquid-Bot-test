...
- `risk_on_high->unknown_4h` score `144.7136` n `40` status `ready` deltaP `-10.1829` edge `12.3092` maxDD `-10.8809`
- `risk_on_and_context->unknown_4h` score `144.7136` n `40` status `ready` deltaP `-10.1829` edge `12.3092` maxDD `-10.8809`
...
- `market_context_high->unknown_4h` score `9.7145` n `202` status `ready` deltaP `-4.8116` edge `1.3846` maxDD `-35.7719`
...
- `risk_on_high->crypto_major_4h` score `1.1463` n `40` status `ready` deltaP `16.7073` edge `0.0507` maxDD `-2.6576`
- `risk_on_and_context->crypto_major_4h` score `1.1463` n `40` status `ready` deltaP `16.7073` edge `0.0507` maxDD `-2.6576`
...
- `risk_on_high->crypto_major_1h` score `0.1307` n `40` status `ready` deltaP `10.0599` edge `0.0039` maxDD `-2.3372`
- `risk_on_and_context->crypto_major_1h` score `0.1307` n `40` status `ready` deltaP `10.0599` edge `0.0039` maxDD `-2.3372`
