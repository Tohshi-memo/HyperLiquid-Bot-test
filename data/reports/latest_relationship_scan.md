...
- `news_risk_high->unknown_24h` score `46.6482` n `51` status `ready` deltaP `11.6319` edge `3.8098` maxDD `0.0`
...
- `market_context_high->fx_1h` score `-0.452` n `136` status `ready` deltaP `2.4128` edge `-0.0008` maxDD `-0.8587`
