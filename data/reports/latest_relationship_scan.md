...
- `market_context_high->equity_24h` score `15.9818` n `90` status `ready` deltaP `26.25` edge `1.291` maxDD `-6.0681`
...
- `market_context_high->index_24h` score `2.0784` n `90` status `ready` deltaP `12.6042` edge `0.1562` maxDD `-1.3621`
...
- `market_context_high->crypto_major_4h` score `0.7586` n `104` status `ready` deltaP `10.4127` edge `0.1656` maxDD `-6.7444`
- `market_context_high->metal_1h` score `0.7176` n `104` status `ready` deltaP `10.3409` edge `0.0287` maxDD `-0.6936`
- `market_context_high->crypto_alt_4h` score `0.6903` n `104` status `ready` deltaP `7.0708` edge `0.1221` maxDD `-3.9374`
- `market_context_high->crypto_major_1h` score `0.5467` n `104` status `ready` deltaP `10.79` edge `0.0392` maxDD `-1.6171`
- `market_context_high->crypto_alt_1h` score `-0.0473` n `104` status `ready` deltaP `0.7485` edge `0.0322` maxDD `-1.4603`
...
- `market_context_high->commodity_1h` score `-0.5467` n `104` status `ready` deltaP `-0.5355` edge `-0.0042` maxDD `-1.9855`
