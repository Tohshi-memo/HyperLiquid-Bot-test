...
- `market_context_high->commodity_4h` score `0.7272` n `171` status `ready` deltaP `10.7491` edge `0.0604` maxDD `-2.7169`
...
- `risk_on_high->crypto_major_1h` score `-1.3982` n `32` status `ready` deltaP `1.3286` edge `-0.0672` maxDD `-2.6536`
- `risk_on_and_context->crypto_major_1h` score `-1.3982` n `32` status `ready` deltaP `1.3286` edge `-0.0672` maxDD `-2.6536`
