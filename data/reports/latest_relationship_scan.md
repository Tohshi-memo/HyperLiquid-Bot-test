...
- Price records: `523`
- Market context records: `618`
- Flow alert records: `1748`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_alt_24h` score `5.1849` n `146` status `ready` deltaP `7.5118` edge `0.3868` maxDD `-0.0508`
...
- `market_context_high->commodity_1h` score `-0.6239` n `146` status `ready` deltaP `1.3433` edge `0.0365` maxDD `-3.7959`
- `market_context_high->index_1h` score `-0.6991` n `146` status `ready` deltaP `-0.2061` edge `-0.0029` maxDD `-2.8282`
- `market_context_high->unknown_1h` score `-1.0897` n `146` status `ready` deltaP `-3.6714` edge `-0.006` maxDD `-2.1602`
- `market_context_high->crypto_alt_1h` score `-1.1705` n `146` status `ready` deltaP `5.8094` edge `-0.0048` maxDD `-8.1842`
- `market_context_high->equity_1h` score `-1.293` n `146` status `ready` deltaP `-2.3421` edge `-0.0111` maxDD `-4.4826`
- `market_context_high->crypto_alt_4h` score `-1.591` n `146` status `ready` deltaP `5.0539` edge `0.0907` maxDD `-15.2248`
...
- `market_context_high->equity_4h` score `-3.2454` n `146` status `ready` deltaP `-3.3212` edge `-0.0331` maxDD `-10.5498`
...
- `market_context_high->unknown_4h` score `-4.6293` n `146` status `ready` deltaP `2.7519` edge `-0.2163` maxDD `-8.3588`
- `market_context_high->equity_24h` score `-4.7571` n `146` status `ready` deltaP `-11.1823` edge `-0.0614` maxDD `-10.5047`
