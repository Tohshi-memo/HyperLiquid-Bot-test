...
- `news_risk_high->unknown_24h` score `43.6656` n `51` status `ready` deltaP `2.4306` edge `3.6226` maxDD `0.0`
- `news_risk_high->unknown_4h` score `12.9884` n `51` status `ready` deltaP `25.6307` edge `0.9161` maxDD `-0.0348`
- `news_risk_high->equity_24h` score `10.0832` n `51` status `ready` deltaP `36.9383` edge `0.6871` maxDD `-4.7801`
- `news_risk_high->index_24h` score `4.7107` n `51` status `ready` deltaP `45.9967` edge `0.1011` maxDD `-0.2147`
- `news_risk_high->unknown_1h` score `3.0864` n `52` status `ready` deltaP `15.35` edge `0.1904` maxDD `-0.8426`
...
- `news_risk_high->commodity_1h` score `0.2212` n `52` status `ready` deltaP `8.7172` edge `-0.0084` maxDD `-0.5024`
- `news_risk_high->index_1h` score `0.0347` n `52` status `ready` deltaP `5.7232` edge `0.0016` maxDD `-0.1583`
- `market_context_high->unknown_1h` score `0.0115` n `133` status `ready` deltaP `11.2725` edge `-0.0293` maxDD `-1.5916`
- `news_risk_high->metal_4h` score `-0.2605` n `51` status `ready` deltaP `6.3008` edge `-0.0106` maxDD `-0.249`
...
- `market_context_high->metal_4h` score `-0.6483` n `133` status `ready` deltaP `6.5514` edge `-0.034` maxDD `-2.4293`
- `news_risk_high->metal_24h` score `-0.6624` n `51` status `ready` deltaP `21.6503` edge `-0.1953` maxDD `-0.0053`
