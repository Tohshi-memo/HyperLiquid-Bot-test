...
- `market_context_high->crypto_major_24h` score `5.8802` n `158` status `ready` deltaP `22.431` edge `0.7854` maxDD `-28.9274`
- `market_context_high->equity_24h` score `4.6435` n `158` status `ready` deltaP `17.8863` edge `0.8306` maxDD `-40.0306`
- `market_context_high->crypto_major_4h` score `2.8555` n `194` status `ready` deltaP `13.3361` edge `0.3783` maxDD `-14.0065`
- `market_context_high->crypto_alt_4h` score `2.62` n `194` status `ready` deltaP `10.8169` edge `0.3103` maxDD `-9.46`
- `market_context_high->equity_4h` score `1.8098` n `194` status `ready` deltaP `10.0924` edge `0.2474` maxDD `-7.4425`
- `market_context_high->index_24h` score `0.843` n `158` status `ready` deltaP `25.255` edge `0.1032` maxDD `-7.413`
- `market_context_high->equity_1h` score `0.4775` n `194` status `ready` deltaP `7.8632` edge `0.0839` maxDD `-5.0555`
- `market_context_high->fx_24h` score `0.1434` n `158` status `ready` deltaP `9.4629` edge `0.0384` maxDD `-0.8294`
- `market_context_high->crypto_major_1h` score `0.1066` n `194` status `ready` deltaP `4.7904` edge `0.1015` maxDD `-6.9639`
...
- `market_context_high->commodity_1h` score `-1.4814` n `194` status `ready` deltaP `-3.7749` edge `-0.0065` maxDD `-3.3428`
