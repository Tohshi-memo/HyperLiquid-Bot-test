...
- `news_risk_high->equity_4h` score `7.5643` n `52` status `ready` deltaP `26.8293` edge `0.5112` maxDD `-3.4427`
- `news_risk_high->equity_1h` score `2.9364` n `52` status `ready` deltaP `21.1308` edge `0.1347` maxDD `-1.1366`
- `news_risk_high->index_4h` score `2.6798` n `52` status `ready` deltaP `22.2561` edge `0.094` maxDD `-0.191`
- `news_risk_high->crypto_major_4h` score `1.9603` n `52` status `ready` deltaP `8.7594` edge `0.2623` maxDD `-2.8833`
- `news_risk_high->crypto_alt_1h` score `1.6879` n `52` status `ready` deltaP `13.0585` edge `0.097` maxDD `-1.1388`
- `news_risk_high->crypto_major_1h` score `1.6494` n `52` status `ready` deltaP `11.5615` edge `0.1001` maxDD `-1.1783`
- `news_risk_high->crypto_alt_4h` score `1.4692` n `52` status `ready` deltaP `17.3312` edge `0.212` maxDD `-5.8012`
- `news_risk_high->metal_4h` score `0.8306` n `52` status `ready` deltaP `7.7861` edge `0.0641` maxDD `-0.7433`
...
- `news_risk_high->metal_1h` score `-0.1162` n `52` status `ready` deltaP `3.2474` edge `0.009` maxDD `-0.5599`
...
- `news_risk_high->commodity_24h` score `-11.9488` n `52` status `ready` deltaP `-9.3082` edge `-0.3397` maxDD `-33.8515`
- `news_risk_high->index_24h` score `-12.3239` n `52` status `ready` deltaP `-25.2938` edge `-0.3081` maxDD `-28.0214`
- `news_risk_high->equity_24h` score `-34.9559` n `52` status `ready` deltaP `-23.2105` edge `-0.9707` maxDD `-127.0042`
