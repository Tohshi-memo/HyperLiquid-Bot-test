...
- `market_context_high->unknown_24h` score `161.9811` n `95` status `ready` deltaP `-24.3364` edge `21.1974` maxDD `-7.8016`
- `risk_on_high->unknown_24h` score `33.5747` n `32` status `ready` deltaP `-39.3035` edge `4.6415` maxDD `-1.6689`
- `risk_on_and_context->unknown_24h` score `33.5747` n `32` status `ready` deltaP `-39.3035` edge `4.6415` maxDD `-1.6689`
- `news_risk_high->equity_24h` score `12.7919` n `36` status `ready` deltaP `25.1011` edge `0.9366` maxDD `-1.0358`
- `news_risk_high->equity_4h` score `7.6374` n `36` status `ready` deltaP `38.872` edge `0.3773` maxDD `0.0`
- `market_context_high->commodity_24h` score `7.0145` n `95` status `ready` deltaP `38.9692` edge `0.3305` maxDD `-0.1266`
- `risk_on_high->commodity_24h` score `5.8792` n `32` status `ready` deltaP `41.0745` edge `0.2161` maxDD `0.0`
- `risk_on_and_context->commodity_24h` score `5.8792` n `32` status `ready` deltaP `41.0745` edge `0.2161` maxDD `0.0`
- `risk_on_high->crypto_major_24h` score `3.8886` n `32` status `ready` deltaP `26.1211` edge `0.44` maxDD `-6.2481`
- `risk_on_and_context->crypto_major_24h` score `3.8886` n `32` status `ready` deltaP `26.1211` edge `0.44` maxDD `-6.2481`
...
- `market_context_high->commodity_4h` score `2.0214` n `103` status `ready` deltaP `17.9937` edge `0.0956` maxDD `-0.7687`
