...
- `market_context_high->commodity_24h` score `0.8759` n `137` status `ready` deltaP `10.2481` edge `0.085` maxDD `-2.4263`
...
- `risk_on_high->equity_1h` score `-0.7357` n `32` status `ready` deltaP `-4.0606` edge `-0.0129` maxDD `-1.6811`
