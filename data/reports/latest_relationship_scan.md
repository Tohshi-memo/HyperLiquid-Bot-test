...
- `news_risk_high->unknown_24h` score `56.653` n `33` status `ready` deltaP `17.1875` edge `4.6065` maxDD `0.0`
- `news_risk_high->equity_24h` score `18.5032` n `33` status `ready` deltaP `52.1938` edge `1.2255` maxDD `-1.522`
- `news_risk_high->unknown_4h` score `13.0625` n `51` status `ready` deltaP `23.4965` edge `0.9365` maxDD `-0.0348`
- `news_risk_high->index_24h` score `6.817` n `33` status `ready` deltaP `56.9602` edge `0.1968` maxDD `-0.0095`
- `news_risk_high->crypto_alt_24h` score `6.0516` n `33` status `ready` deltaP `28.125` edge `0.3168` maxDD `0.0`
...
- `news_risk_high->metal_24h` score `2.4235` n `33` status `ready` deltaP `40.1042` edge `-0.0654` maxDD `0.0`
...
- `market_context_high->unknown_4h` score `1.4886` n `140` status `ready` deltaP `21.1716` edge `-0.0034` maxDD `-0.0956`
- `market_context_high->unknown_1h` score `1.2986` n `152` status `ready` deltaP `7.6662` edge `0.102` maxDD `-1.5916`
- `news_risk_high->fx_1h` score `1.217` n `51` status `ready` deltaP `16.696` edge `0.0071` maxDD `-0.0257`
- `market_context_high->crypto_alt_4h` score `1.1014` n `140` status `ready` deltaP `11.4024` edge `0.1622` maxDD `-7.0478`
