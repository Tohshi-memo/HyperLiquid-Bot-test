...
- Generated: `2026-09-06T09:52:27.659690+00:00`
- Price records: `672`
...
- `risk_on_high->crypto_major_24h` score `2.1917` n `102` status `ready` deltaP `15.1042` edge `0.9129` maxDD `-47.9416`
- `risk_on_and_context->crypto_major_24h` score `2.1917` n `102` status `ready` deltaP `15.1042` edge `0.9129` maxDD `-47.9416`
- `market_context_high->equity_24h` score `0.7937` n `188` status `ready` deltaP `12.2968` edge `0.338` maxDD `-16.9737`
...
- `risk_on_high->crypto_alt_1h` score `-0.406` n `145` status `ready` deltaP `1.943` edge `0.0549` maxDD `-5.4685`
- `risk_on_and_context->crypto_alt_1h` score `-0.406` n `145` status `ready` deltaP `1.943` edge `0.0549` maxDD `-5.4685`
- `risk_on_high->equity_1h` score `-0.4486` n `145` status `ready` deltaP `6.3535` edge `-0.0124` maxDD `-2.6638`
- `risk_on_and_context->equity_1h` score `-0.4486` n `145` status `ready` deltaP `6.3535` edge `-0.0124` maxDD `-2.6638`
...
- `market_context_high->index_4h` score `-1.1721` n `249` status `ready` deltaP `6.3712` edge `0.0009` maxDD `-5.825`
- `risk_on_high->metal_4h` score `-1.2869` n `145` status `ready` deltaP `2.6387` edge `-0.001` maxDD `-5.1925`
