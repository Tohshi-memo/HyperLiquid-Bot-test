...
- `data/reports/latest_ai_context_index.md` (3027 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (66553 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2915 bytes): Current canary signals.
