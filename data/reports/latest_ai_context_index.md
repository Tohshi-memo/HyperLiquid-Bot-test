...
- Flow-alert history records: `791`
...
- `data/processed/ai_context_index.json` (14685 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (34989 bytes): Compact strategy stats.
