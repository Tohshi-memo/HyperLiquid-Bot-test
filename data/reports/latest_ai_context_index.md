...
- `data/processed/ai_context_index.json` (63541 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47979 bytes): Compact strategy stats.
