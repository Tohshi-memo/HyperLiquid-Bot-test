...
- Asset price active records: `262`
- Day/swing records: `275`
- Flow-alert history records: `934`
...
- `data/processed/ai_analysis_pack.json` (42552 bytes): Compact strategy stats.
