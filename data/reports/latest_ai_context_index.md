...
- `data/reports/latest_ai_context_index.md` (2393 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61507 bytes): Machine-readable map.
