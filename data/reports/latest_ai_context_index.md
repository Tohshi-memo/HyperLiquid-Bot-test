...
- Asset price active records: `596`
- Day/swing records: `609`
- Flow-alert history records: `1975`
...
- `data/processed/ai_context_index.json` (36545 bytes): Machine-readable map.
