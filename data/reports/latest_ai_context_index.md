...
- Asset price active records: `275`
- Day/swing records: `288`
- Flow-alert history records: `974`
...
- `data/processed/ai_analysis_pack.json` (42829 bytes): Compact strategy stats.
