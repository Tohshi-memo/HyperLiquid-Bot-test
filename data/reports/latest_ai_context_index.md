...
- Asset price active records: `326`
- Day/swing records: `339`
- Flow-alert history records: `1133`
...
- `data/processed/ai_context_index.json` (14618 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43669 bytes): Compact strategy stats.
