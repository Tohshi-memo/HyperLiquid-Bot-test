...
- `data/processed/ai_context_index.json` (63780 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2532 bytes): Current canary signals.
