...
- `data/processed/ai_context_index.json` (63575 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5625 bytes): Asset-class overview.
...
- `data/reports/latest_relationship_scan.md` (3516 bytes): Mechanical relationship candidates.
