...
- `data/processed/ai_context_index.json` (63598 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47690 bytes): Compact strategy stats.
