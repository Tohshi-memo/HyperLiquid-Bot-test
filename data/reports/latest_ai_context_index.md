...
- `data/reports/latest_ai_context_index.md` (2444 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62976 bytes): Machine-readable map.
