...
- Macro indicators: `11`
- Flow-alert history records: `7369`
...
- `data/processed/ai_context_index.json` (68186 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (7542 bytes): HIP-4 outcome market overview.
