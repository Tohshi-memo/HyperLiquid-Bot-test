...
- Day/swing records: `731`
- Macro indicators: `11`
- Flow-alert history records: `2354`
...
- `data/processed/ai_context_index.json` (60654 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45748 bytes): Compact strategy stats.
