...
- `data/processed/ai_context_index.json` (63508 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47694 bytes): Compact strategy stats.
