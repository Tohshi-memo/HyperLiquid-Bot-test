...
- `data/reports/latest_ai_context_index.md` (2834 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64318 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2889 bytes): Current canary signals.
