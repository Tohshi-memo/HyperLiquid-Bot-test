...
- `data/processed/ai_context_index.json` (62392 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2388 bytes): Individual asset screen.
