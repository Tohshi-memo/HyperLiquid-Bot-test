...
- Macro indicators: `11`
- Flow-alert history records: `6865`
...
- `data/reports/latest_ai_context_index.md` (2226 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (68093 bytes): Machine-readable map.
