...
- Macro indicators: `11`
- Flow-alert history records: `6696`
...
- `data/processed/ai_context_index.json` (66905 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (4031 bytes): HIP-4 outcome market overview.
