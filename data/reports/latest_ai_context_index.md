...
- `data/reports/latest_ai_context_index.md` (2490 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63894 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48262 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8796 bytes): HIP-4 outcome market overview.
