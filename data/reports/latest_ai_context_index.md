...
- `data/reports/latest_ai_context_index.md` (2460 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (60726 bytes): Machine-readable map.
