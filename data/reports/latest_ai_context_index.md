...
- Asset price active records: `371`
- Day/swing records: `384`
- Flow-alert history records: `1275`
...
- `data/processed/ai_analysis_pack.json` (43972 bytes): Compact strategy stats.
