...
- Day/swing records: `1394`
- Macro indicators: `11`
- Flow-alert history records: `6416`
...
- `data/processed/ai_context_index.json` (66256 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46961 bytes): Compact strategy stats.
