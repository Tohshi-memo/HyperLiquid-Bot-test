...
- `data/processed/ai_context_index.json` (60740 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2505 bytes): Current canary signals.
