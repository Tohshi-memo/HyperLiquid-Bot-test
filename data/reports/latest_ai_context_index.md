...
- Day/swing records: `1735`
- Macro indicators: `11`
- Flow-alert history records: `7500`
...
- `data/processed/ai_context_index.json` (73912 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46948 bytes): Compact strategy stats.
