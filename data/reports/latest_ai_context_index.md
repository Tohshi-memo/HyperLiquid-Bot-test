...
- Updated: `2026-07-29T04:07:26.516083+00:00`
- Asset price active records: `672`
- Day/swing records: `7459`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (64004 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2436 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48270 bytes): Compact strategy stats.
...
- `data/reports/latest_relationship_scan.md` (3523 bytes): Mechanical relationship candidates.
...
- 4h_crypto_equity_divergence: score `2.2313` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
