...
- `data/processed/ai_context_index.json` (63692 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5614 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2091 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8804 bytes): HIP-4 outcome market overview.
