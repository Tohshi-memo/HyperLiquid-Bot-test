...
- `data/processed/ai_context_index.json` (63711 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48277 bytes): Compact strategy stats.
