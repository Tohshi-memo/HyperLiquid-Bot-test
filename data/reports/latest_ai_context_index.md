...
- Macro indicators: `11`
- Flow-alert history records: `4915`
...
- `data/processed/ai_context_index.json` (71594 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46311 bytes): Compact strategy stats.
