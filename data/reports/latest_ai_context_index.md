...
- Macro indicators: `11`
- Flow-alert history records: `2540`
...
- `data/processed/ai_context_index.json` (68194 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45772 bytes): Compact strategy stats.
