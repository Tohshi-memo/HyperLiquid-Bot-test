...
- Day/swing records: `1074`
- Macro indicators: `11`
- Flow-alert history records: `5418`
...
- `data/processed/ai_context_index.json` (69570 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46662 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5797 bytes): Asset-class overview.
