...
- `data/processed/ai_context_index.json` (62176 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (49343 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5659 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2165 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10396 bytes): HIP-4 outcome market overview.
