...
- Macro indicators: `11`
- Flow-alert history records: `5018`
...
- `data/processed/ai_context_index.json` (70524 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46342 bytes): Compact strategy stats.
