...
- `data/reports/latest_ai_context_index.md` (2983 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62809 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2886 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (10225 bytes): HIP-4 outcome market overview.
