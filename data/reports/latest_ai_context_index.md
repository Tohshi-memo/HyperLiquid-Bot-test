...
- Macro indicators: `11`
- Flow-alert history records: `2691`
...
- `data/processed/ai_context_index.json` (64875 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2434 bytes): Individual asset screen.
