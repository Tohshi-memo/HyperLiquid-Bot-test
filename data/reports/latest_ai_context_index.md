...
- Asset price active records: `358`
- Day/swing records: `371`
- Flow-alert history records: `1231`
...
- `data/processed/ai_context_index.json` (14628 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43946 bytes): Compact strategy stats.
