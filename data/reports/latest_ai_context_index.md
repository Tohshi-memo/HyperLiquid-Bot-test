...
- Macro indicators: `5`
- Flow-alert history records: `6229`
...
- `data/processed/ai_context_index.json` (64386 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46941 bytes): Compact strategy stats.
