...
- Asset price active records: `303`
- Day/swing records: `316`
- Flow-alert history records: `1063`
...
- `data/processed/ai_analysis_pack.json` (43387 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4693 bytes): Asset-class overview.
