...
- Day/swing records: `1276`
- Macro indicators: `11`
- Flow-alert history records: `6044`
...
- `data/processed/ai_context_index.json` (73645 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2603 bytes): Current canary signals.
