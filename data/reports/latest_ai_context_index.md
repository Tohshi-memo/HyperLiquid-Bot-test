...
- `data/reports/latest_ai_context_index.md` (2487 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62165 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2488 bytes): Current canary signals.
