...
- Updated: `2026-07-15T15:07:32.470661+00:00`
- Asset price active records: `672`
- Day/swing records: `6185`
- Macro indicators: `9`
...
- `data/reports/latest_ai_context_index.md` (2408 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62130 bytes): Machine-readable map.
...
- `data/reports/latest_macro_indicators.md` (2358 bytes): Macro rates, employment, inflation, dollar, and risk overview.
- `data/processed/ai_analysis_pack.json` (48200 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5723 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2311 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (9003 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `2.6099` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
