...
- `data/reports/latest_ai_context_index.md` (2426 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (71035 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47061 bytes): Compact strategy stats.
