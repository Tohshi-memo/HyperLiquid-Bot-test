...
- Asset price active records: `259`
- Day/swing records: `272`
- Flow-alert history records: `924`
...
- `data/processed/ai_analysis_pack.json` (42261 bytes): Compact strategy stats.
