...
- `data/processed/ai_context_index.json` (61543 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (49334 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5661 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2204 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10338 bytes): HIP-4 outcome market overview.
