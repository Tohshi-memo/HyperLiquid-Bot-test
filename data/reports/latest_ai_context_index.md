...
- Updated: `2026-06-14T21:22:28.963149+00:00`
- Asset price active records: `672`
- Day/swing records: `3560`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63549 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2550 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47974 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5676 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2110 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8829 bytes): HIP-4 outcome market overview.
...
- 1h_commodity_crypto_divergence: score `2.3508` - Commodity perps and crypto are moving differently; check macro-linked stress.
- 4h_commodity_crypto_divergence: score `2.095` - Commodity perps and crypto are moving differently; check macro-linked stress.
