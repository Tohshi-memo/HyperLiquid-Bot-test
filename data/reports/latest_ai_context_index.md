...
- Macro indicators: `11`
- Flow-alert history records: `5436`
...
- `data/processed/ai_context_index.json` (72934 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46667 bytes): Compact strategy stats.
