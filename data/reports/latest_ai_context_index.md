...
- `data/processed/ai_context_index.json` (63376 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2523 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2066 bytes): Individual asset screen.
