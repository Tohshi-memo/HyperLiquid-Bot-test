...
- `data/processed/ai_context_index.json` (63476 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47703 bytes): Compact strategy stats.
