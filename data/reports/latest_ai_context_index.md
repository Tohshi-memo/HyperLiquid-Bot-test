...
- Day/swing records: `1339`
- Macro indicators: `5`
- Flow-alert history records: `6242`
...
- `data/processed/ai_context_index.json` (63317 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46959 bytes): Compact strategy stats.
