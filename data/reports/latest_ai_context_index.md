...
- `data/processed/ai_context_index.json` (63258 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (9240 bytes): HIP-4 outcome market overview.
