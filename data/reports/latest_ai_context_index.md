...
- `data/processed/ai_context_index.json` (63475 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48203 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5612 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2079 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8784 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3511 bytes): Mechanical relationship candidates.
