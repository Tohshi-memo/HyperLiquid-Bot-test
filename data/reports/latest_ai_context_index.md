...
- Day/swing records: `1199`
- Macro indicators: `11`
- Flow-alert history records: `5807`
...
- `data/processed/ai_context_index.json` (73757 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46914 bytes): Compact strategy stats.
