...
- Day/swing records: `1973`
- Macro indicators: `11`
- Flow-alert history records: `8239`
...
- `data/processed/ai_context_index.json` (66125 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46986 bytes): Compact strategy stats.
