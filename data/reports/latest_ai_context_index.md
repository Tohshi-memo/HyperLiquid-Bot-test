...
- `data/processed/ai_context_index.json` (65856 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3163 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47100 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9454 bytes): HIP-4 outcome market overview.
