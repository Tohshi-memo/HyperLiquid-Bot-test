...
- `data/processed/ai_context_index.json` (67980 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47106 bytes): Compact strategy stats.
