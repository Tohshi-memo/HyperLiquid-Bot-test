...
- Asset price active records: `364`
- Day/swing records: `377`
- Flow-alert history records: `1250`
...
- `data/processed/ai_analysis_pack.json` (43976 bytes): Compact strategy stats.
