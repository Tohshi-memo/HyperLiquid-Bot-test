...
- `data/processed/ai_context_index.json` (61874 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2799 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (10149 bytes): HIP-4 outcome market overview.
