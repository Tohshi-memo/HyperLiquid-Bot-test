...
- Updated: `2026-06-01T23:46:53.991750+00:00`
- Asset price active records: `672`
- Day/swing records: `2340`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (66258 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47021 bytes): Compact strategy stats.
...
- polymarket_volume_spike: score `4.93` - Polymarket crypto volume is unusually high.
