...
- Macro indicators: `11`
- Flow-alert history records: `5742`
...
- `data/processed/ai_context_index.json` (73815 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46900 bytes): Compact strategy stats.
