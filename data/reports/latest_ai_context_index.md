...
- `data/processed/ai_context_index.json` (60444 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8608 bytes): HIP-4 outcome market overview.
