...
- Macro indicators: `11`
- Flow-alert history records: `2582`
...
- `data/processed/ai_context_index.json` (65059 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45804 bytes): Compact strategy stats.
