...
- `data/reports/latest_ai_context_index.md` (3035 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62983 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3049 bytes): Current canary signals.
