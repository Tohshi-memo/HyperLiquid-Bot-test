...
- Asset price active records: `471`
- Day/swing records: `484`
- Flow-alert history records: `1587`
- Correlation status: `ready`
- Asset price archives: `none yet`

## First Read Files

- `data/reports/latest_ai_context_index.md` (2103 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (35834 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2727 bytes): Current canary signals.
- `data/reports/latest_ai_analysis_brief.md` (860 bytes): BTC/ETH/HYPE/SOL compact stats.
- `data/processed/ai_analysis_pack.json` (45674 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5634 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (1997 bytes): Individual asset screen.
