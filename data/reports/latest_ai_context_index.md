...
- `data/processed/ai_context_index.json` (62789 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2756 bytes): Current canary signals.
