...
- Updated: `2026-09-14T20:52:29.493805+00:00`
...
- `data/processed/ai_context_index.json` (62106 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48218 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5685 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2142 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10281 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `1.644` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
