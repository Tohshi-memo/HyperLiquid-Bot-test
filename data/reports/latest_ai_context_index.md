...
- `data/processed/ai_context_index.json` (63449 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47715 bytes): Compact strategy stats.
