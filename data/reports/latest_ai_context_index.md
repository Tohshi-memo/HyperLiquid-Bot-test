...
- Macro indicators: `11`
- Flow-alert history records: `7673`
...
- `data/processed/ai_context_index.json` (65220 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47007 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8320 bytes): HIP-4 outcome market overview.
