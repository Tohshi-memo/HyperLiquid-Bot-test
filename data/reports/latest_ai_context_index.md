...
- `data/reports/latest_ai_context_index.md` (2478 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62544 bytes): Machine-readable map.
