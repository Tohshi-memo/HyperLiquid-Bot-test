...
- Asset price active records: `456`
- Day/swing records: `469`
- Flow-alert history records: `1541`
...
- `data/processed/ai_context_index.json` (14949 bytes): Machine-readable map.
