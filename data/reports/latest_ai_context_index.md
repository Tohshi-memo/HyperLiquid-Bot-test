...
- `data/reports/latest_ai_context_index.md` (2573 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61085 bytes): Machine-readable map.
