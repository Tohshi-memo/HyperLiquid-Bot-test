...
- Asset price active records: `562`
- Day/swing records: `575`
- Flow-alert history records: `1869`
- Correlation status: `ready`
- Asset price archives: `none yet`

## First Read Files

- `data/reports/latest_ai_context_index.md` (1895 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (36470 bytes): Machine-readable map.
