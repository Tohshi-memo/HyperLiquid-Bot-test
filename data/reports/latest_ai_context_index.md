...
- `data/processed/ai_context_index.json` (63362 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47175 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8956 bytes): HIP-4 outcome market overview.
