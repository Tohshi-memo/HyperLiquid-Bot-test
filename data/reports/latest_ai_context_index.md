...
- `data/processed/ai_context_index.json` (63841 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48294 bytes): Compact strategy stats.
