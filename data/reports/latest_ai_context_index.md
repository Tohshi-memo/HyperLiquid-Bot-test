...
- Day/swing records: `1220`
- Macro indicators: `11`
- Flow-alert history records: `5873`
...
- `data/processed/ai_context_index.json` (66018 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46897 bytes): Compact strategy stats.
