...
- `data/processed/ai_context_index.json` (60988 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2623 bytes): Current canary signals.
