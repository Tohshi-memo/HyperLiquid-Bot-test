...
- `data/processed/ai_context_index.json` (63377 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48165 bytes): Compact strategy stats.
