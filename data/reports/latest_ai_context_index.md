...
- `data/reports/latest_ai_context_index.md` (2684 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64137 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2509 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47934 bytes): Compact strategy stats.
