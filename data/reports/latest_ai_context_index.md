...
- `data/processed/ai_context_index.json` (73191 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47020 bytes): Compact strategy stats.
