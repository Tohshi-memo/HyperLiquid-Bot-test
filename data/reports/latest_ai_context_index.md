...
- Day/swing records: `725`
- Macro indicators: `11`
- Flow-alert history records: `2336`
...
- `data/processed/ai_context_index.json` (60678 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45738 bytes): Compact strategy stats.
