...
- `data/processed/ai_context_index.json` (63701 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2625 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47949 bytes): Compact strategy stats.
