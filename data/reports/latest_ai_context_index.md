...
- `data/processed/ai_context_index.json` (69049 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3038 bytes): Current canary signals.
