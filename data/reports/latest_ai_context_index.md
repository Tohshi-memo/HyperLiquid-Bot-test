...
- `data/processed/ai_context_index.json` (70873 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47053 bytes): Compact strategy stats.
