...
- Day/swing records: `1067`
- Macro indicators: `11`
- Flow-alert history records: `5396`
...
- `data/processed/ai_context_index.json` (67471 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5794 bytes): Asset-class overview.
