...
- Macro indicators: `11`
- Flow-alert history records: `2559`
...
- `data/processed/ai_context_index.json` (68232 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45815 bytes): Compact strategy stats.
