...
- Macro indicators: `11`
- Flow-alert history records: `4784`
...
- `data/processed/ai_context_index.json` (69706 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2572 bytes): Current canary signals.
