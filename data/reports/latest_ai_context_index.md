...
- `data/processed/ai_context_index.json` (64166 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8758 bytes): HIP-4 outcome market overview.
