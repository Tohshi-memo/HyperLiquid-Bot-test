...
- Updated: `2026-08-21T01:52:36.033890+00:00`
- Asset price active records: `672`
- Day/swing records: `9597`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (61790 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48186 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5757 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2365 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (6208 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_metal_divergence: score `1.715` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
