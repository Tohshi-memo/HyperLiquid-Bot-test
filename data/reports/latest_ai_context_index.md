...
- Day/swing records: `1147`
- Macro indicators: `11`
- Flow-alert history records: `5644`
...
- `data/processed/ai_context_index.json` (70317 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46626 bytes): Compact strategy stats.
