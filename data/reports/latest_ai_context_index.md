...
- Asset price active records: `584`
- Day/swing records: `597`
- Flow-alert history records: `1937`
...
- `data/processed/ai_context_index.json` (36559 bytes): Machine-readable map.
