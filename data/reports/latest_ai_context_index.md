...
- Macro indicators: `11`
- Flow-alert history records: `8482`
...
- `data/processed/ai_context_index.json` (69602 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (7989 bytes): HIP-4 outcome market overview.
