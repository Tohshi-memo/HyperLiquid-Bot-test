...
- Day/swing records: `875`
- Macro indicators: `11`
- Flow-alert history records: `4797`
...
- `data/processed/ai_context_index.json` (72828 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46039 bytes): Compact strategy stats.
