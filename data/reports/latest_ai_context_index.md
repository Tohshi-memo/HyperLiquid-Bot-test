...
- Asset price active records: `528`
- Day/swing records: `541`
- Flow-alert history records: `1765`
...
- `data/processed/ai_context_index.json` (35225 bytes): Machine-readable map.
