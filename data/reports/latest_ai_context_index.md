...
- Updated: `2026-08-13T16:52:32.278585+00:00`
- Asset price active records: `672`
- Day/swing records: `8901`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (61997 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2441 bytes): Current canary signals.
...
- 4h_crypto_equity_divergence: score `-1.7734` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
