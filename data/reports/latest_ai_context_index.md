...
- `data/processed/ai_context_index.json` (63462 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5644 bytes): Asset-class overview.
