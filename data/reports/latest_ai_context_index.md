...
- `data/reports/latest_ai_context_index.md` (2346 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (60606 bytes): Machine-readable map.
