...
- `data/reports/latest_ai_context_index.md` (2970 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64652 bytes): Machine-readable map.
