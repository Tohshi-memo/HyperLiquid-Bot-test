...
- Day/swing records: `1799`
- Macro indicators: `11`
- Flow-alert history records: `7701`
...
- `data/processed/ai_context_index.json` (66328 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46996 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8299 bytes): HIP-4 outcome market overview.
