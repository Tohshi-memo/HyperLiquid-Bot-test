...
- Day/swing records: `1675`
- Macro indicators: `11`
- Flow-alert history records: `7309`
...
- `data/processed/ai_context_index.json` (73709 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46960 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (6806 bytes): HIP-4 outcome market overview.
