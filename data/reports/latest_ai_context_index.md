...
- Macro indicators: `11`
- Flow-alert history records: `5625`
...
- `data/processed/ai_context_index.json` (69206 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46629 bytes): Compact strategy stats.
