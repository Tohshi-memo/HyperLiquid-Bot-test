...
- `data/processed/ai_context_index.json` (73940 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (9234 bytes): HIP-4 outcome market overview.
