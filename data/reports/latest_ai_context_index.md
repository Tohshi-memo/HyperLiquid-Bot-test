...
- Day/swing records: `1487`
- Macro indicators: `11`
- Flow-alert history records: `6712`
...
- `data/reports/latest_ai_context_index.md` (2506 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (66205 bytes): Machine-readable map.
