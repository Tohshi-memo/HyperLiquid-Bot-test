...
- `data/reports/latest_ai_context_index.md` (2840 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64225 bytes): Machine-readable map.
