...
- `data/processed/ai_context_index.json` (64753 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8705 bytes): HIP-4 outcome market overview.
