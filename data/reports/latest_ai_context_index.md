...
- Day/swing records: `1018`
- Macro indicators: `11`
- Flow-alert history records: `5246`
...
- `data/processed/ai_context_index.json` (64016 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46620 bytes): Compact strategy stats.
