...
- `data/processed/ai_context_index.json` (63975 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2743 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (8826 bytes): HIP-4 outcome market overview.
