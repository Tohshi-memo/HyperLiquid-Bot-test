...
- Asset price active records: `334`
- Day/swing records: `347`
- Flow-alert history records: `1157`
...
- `data/processed/ai_analysis_pack.json` (43691 bytes): Compact strategy stats.
