...
- Asset price active records: `263`
- Day/swing records: `276`
- Flow-alert history records: `938`
...
- `data/processed/ai_analysis_pack.json` (42564 bytes): Compact strategy stats.
