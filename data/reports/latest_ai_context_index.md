...
- `data/reports/latest_ai_context_index.md` (2658 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (65539 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2691 bytes): Current canary signals.
