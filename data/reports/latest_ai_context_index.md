...
- `data/processed/ai_context_index.json` (62373 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8953 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3660 bytes): Mechanical relationship candidates.
