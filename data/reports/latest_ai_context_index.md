...
- Macro indicators: `11`
- Flow-alert history records: `5000`
...
- `data/reports/latest_ai_context_index.md` (2485 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (74220 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46340 bytes): Compact strategy stats.
