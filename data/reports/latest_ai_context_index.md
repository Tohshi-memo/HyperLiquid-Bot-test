...
- Macro indicators: `11`
- Flow-alert history records: `7482`
...
- `data/processed/ai_context_index.json` (73917 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46950 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (7584 bytes): HIP-4 outcome market overview.
