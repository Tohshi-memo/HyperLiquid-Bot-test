...
- `data/processed/ai_context_index.json` (62364 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (50435 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (10416 bytes): HIP-4 outcome market overview.
