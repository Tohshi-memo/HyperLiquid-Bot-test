...
- `data/reports/latest_ai_context_index.md` (2307 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (72956 bytes): Machine-readable map.
