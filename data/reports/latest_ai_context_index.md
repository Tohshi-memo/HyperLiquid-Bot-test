...
- `data/processed/ai_context_index.json` (63644 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48291 bytes): Compact strategy stats.
