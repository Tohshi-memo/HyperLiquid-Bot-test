...
- `data/processed/ai_context_index.json` (70969 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47026 bytes): Compact strategy stats.
