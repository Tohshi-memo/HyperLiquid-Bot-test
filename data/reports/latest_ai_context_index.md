...
- `data/processed/ai_context_index.json` (69016 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47180 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9079 bytes): HIP-4 outcome market overview.
