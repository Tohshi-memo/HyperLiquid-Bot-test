...
- Day/swing records: `1099`
- Macro indicators: `11`
- Flow-alert history records: `5495`
...
- `data/processed/ai_context_index.json` (73904 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46651 bytes): Compact strategy stats.
