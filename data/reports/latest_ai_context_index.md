...
- `data/processed/ai_context_index.json` (73136 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47048 bytes): Compact strategy stats.
