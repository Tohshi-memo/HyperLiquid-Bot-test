...
- `data/processed/ai_context_index.json` (64794 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8747 bytes): HIP-4 outcome market overview.
