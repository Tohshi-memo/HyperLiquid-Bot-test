...
- `data/reports/latest_ai_context_index.md` (2493 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (74362 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2861 bytes): Current canary signals.
