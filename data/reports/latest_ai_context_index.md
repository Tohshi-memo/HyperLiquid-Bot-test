...
- `data/processed/ai_context_index.json` (64757 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2764 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (8904 bytes): HIP-4 outcome market overview.
