...
- Asset price active records: `246`
- Day/swing records: `259`
- Flow-alert history records: `884`
...
- `data/processed/ai_analysis_pack.json` (36085 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4792 bytes): Asset-class overview.
