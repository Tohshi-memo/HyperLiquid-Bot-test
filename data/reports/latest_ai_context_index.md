...
- Flow-alert history records: `1748`
...
- `data/processed/ai_context_index.json` (35508 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2060 bytes): Individual asset screen.
