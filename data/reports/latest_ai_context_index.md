...
- `data/processed/ai_context_index.json` (64368 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47004 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (7560 bytes): HIP-4 outcome market overview.
