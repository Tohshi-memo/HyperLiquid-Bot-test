...
- `data/reports/latest_ai_context_index.md` (2776 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64154 bytes): Machine-readable map.
