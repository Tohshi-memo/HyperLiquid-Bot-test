...
- Asset price active records: `521`
- Day/swing records: `534`
- Flow-alert history records: `1743`
...
- `data/processed/ai_context_index.json` (35195 bytes): Machine-readable map.
