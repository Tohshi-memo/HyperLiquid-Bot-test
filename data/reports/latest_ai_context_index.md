...
- `data/processed/ai_context_index.json` (61646 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2518 bytes): Current canary signals.
