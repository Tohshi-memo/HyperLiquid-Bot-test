...
- `data/reports/latest_ai_context_index.md` (2789 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64472 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (49864 bytes): Compact strategy stats.
