...
- Macro indicators: `11`
- Flow-alert history records: `7431`
...
- `data/processed/ai_context_index.json` (69389 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46957 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (7280 bytes): HIP-4 outcome market overview.
