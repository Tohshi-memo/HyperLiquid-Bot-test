...
- `data/processed/ai_context_index.json` (63619 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5609 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2081 bytes): Individual asset screen.
