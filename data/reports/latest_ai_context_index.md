...
- Day/swing records: `2007`
- Macro indicators: `11`
- Flow-alert history records: `8343`
...
- `data/processed/ai_context_index.json` (73689 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47027 bytes): Compact strategy stats.
