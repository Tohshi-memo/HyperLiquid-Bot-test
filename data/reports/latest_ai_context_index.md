...
- Asset price active records: `389`
- Day/swing records: `402`
- Flow-alert history records: `1332`
...
- `data/processed/ai_analysis_pack.json` (44229 bytes): Compact strategy stats.
