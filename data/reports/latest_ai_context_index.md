...
- Day/swing records: `1106`
- Macro indicators: `11`
- Flow-alert history records: `5517`
...
- `data/processed/ai_context_index.json` (68438 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46646 bytes): Compact strategy stats.
