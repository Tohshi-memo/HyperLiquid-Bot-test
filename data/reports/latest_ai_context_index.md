...
- `data/processed/ai_context_index.json` (61568 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2657 bytes): Current canary signals.
