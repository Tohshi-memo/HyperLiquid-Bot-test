...
- Day/swing records: `1137`
- Macro indicators: `11`
- Flow-alert history records: `5613`
...
- `data/processed/ai_context_index.json` (67069 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46637 bytes): Compact strategy stats.
