...
- Asset price active records: `469`
- Day/swing records: `482`
- Flow-alert history records: `1581`
- Correlation status: `ready`
- Asset price archives: `none yet`

## First Read Files

- `data/reports/latest_ai_context_index.md` (1871 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (35490 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2735 bytes): Current canary signals.
- `data/reports/latest_ai_analysis_brief.md` (858 bytes): BTC/ETH/HYPE/SOL compact stats.
- `data/processed/ai_analysis_pack.json` (45640 bytes): Compact strategy stats.
