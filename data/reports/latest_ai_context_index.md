...
- `data/reports/latest_ai_context_index.md` (2401 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62311 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2288 bytes): Individual asset screen.
