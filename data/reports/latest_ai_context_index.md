...
- Asset price active records: `606`
- Day/swing records: `619`
- Macro indicators: `11`
- Flow-alert history records: `2006`
...
- `data/processed/ai_context_index.json` (52845 bytes): Machine-readable map.
