...
- Day/swing records: `858`
- Macro indicators: `11`
- Flow-alert history records: `3164`
...
- `data/processed/ai_context_index.json` (70509 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2497 bytes): Individual asset screen.
