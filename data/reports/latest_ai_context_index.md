...
- `data/processed/ai_context_index.json` (62190 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5630 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2086 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10361 bytes): HIP-4 outcome market overview.
