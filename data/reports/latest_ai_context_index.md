...
- `data/reports/latest_ai_context_index.md` (2631 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (68107 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2520 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47054 bytes): Compact strategy stats.
