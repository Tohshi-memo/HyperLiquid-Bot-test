...
- Asset price active records: `535`
- Day/swing records: `548`
- Flow-alert history records: `1786`
...
- `data/processed/ai_context_index.json` (35234 bytes): Machine-readable map.
