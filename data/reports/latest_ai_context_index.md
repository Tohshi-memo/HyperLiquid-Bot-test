...
- `data/processed/ai_context_index.json` (63434 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47171 bytes): Compact strategy stats.
