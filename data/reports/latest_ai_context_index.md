...
- `data/processed/ai_context_index.json` (64672 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3043 bytes): Current canary signals.
