...
- `data/processed/ai_context_index.json` (60750 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2504 bytes): Current canary signals.
