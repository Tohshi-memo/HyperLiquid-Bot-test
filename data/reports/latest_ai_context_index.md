...
- `data/processed/ai_context_index.json` (69359 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2730 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47018 bytes): Compact strategy stats.
