...
- `data/processed/ai_context_index.json` (65367 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47081 bytes): Compact strategy stats.
