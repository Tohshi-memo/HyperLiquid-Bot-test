...
- `data/processed/ai_context_index.json` (61478 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48279 bytes): Compact strategy stats.
