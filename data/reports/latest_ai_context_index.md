...
- Updated: `2026-09-21T00:52:26.316361+00:00`
...
- `data/reports/latest_canary_signals.md` (2448 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (49859 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (10417 bytes): HIP-4 outcome market overview.
...
- 4h_commodity_crypto_divergence: score `2.0911` - Commodity perps and crypto are moving differently; check macro-linked stress.
