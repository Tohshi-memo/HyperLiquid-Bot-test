...
- `data/processed/ai_context_index.json` (70398 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2906 bytes): Current canary signals.
