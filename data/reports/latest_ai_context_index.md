...
- Asset price active records: `649`
- Day/swing records: `662`
- Macro indicators: `11`
- Flow-alert history records: `2140`
...
- `data/processed/ai_context_index.json` (56725 bytes): Machine-readable map.
