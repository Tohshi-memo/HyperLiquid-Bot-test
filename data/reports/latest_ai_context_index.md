...
- Day/swing records: `799`
- Macro indicators: `11`
- Flow-alert history records: `2572`
...
- `data/processed/ai_context_index.json` (66112 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45805 bytes): Compact strategy stats.
