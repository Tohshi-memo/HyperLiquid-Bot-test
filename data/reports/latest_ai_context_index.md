...
- `data/reports/latest_ai_context_index.md` (2977 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62895 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2875 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48208 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5683 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2223 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10273 bytes): HIP-4 outcome market overview.
