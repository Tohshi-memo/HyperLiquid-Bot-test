...
- `data/processed/ai_context_index.json` (63663 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47928 bytes): Compact strategy stats.
