...
- Macro indicators: `11`
- Flow-alert history records: `5638`
...
- `data/processed/ai_context_index.json` (71337 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46606 bytes): Compact strategy stats.
