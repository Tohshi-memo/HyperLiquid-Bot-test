...
- `data/processed/ai_context_index.json` (66502 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5790 bytes): Asset-class overview.
