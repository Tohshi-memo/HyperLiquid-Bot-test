...
- Day/swing records: `1056`
- Macro indicators: `11`
- Flow-alert history records: `5363`
...
- `data/processed/ai_context_index.json` (65300 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46623 bytes): Compact strategy stats.
