...
- Macro indicators: `11`
- Flow-alert history records: `6085`
...
- `data/processed/ai_context_index.json` (73828 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46918 bytes): Compact strategy stats.
