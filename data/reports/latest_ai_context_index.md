...
- `data/reports/latest_ai_context_index.md` (2679 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63955 bytes): Machine-readable map.
