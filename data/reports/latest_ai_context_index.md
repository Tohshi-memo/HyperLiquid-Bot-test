...
- `data/reports/latest_ai_context_index.md` (2587 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63885 bytes): Machine-readable map.
