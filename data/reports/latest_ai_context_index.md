...
- Asset price active records: `571`
- Day/swing records: `584`
- Flow-alert history records: `1898`
...
- `data/processed/ai_context_index.json` (36579 bytes): Machine-readable map.
