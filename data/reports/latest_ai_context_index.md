...
- Day/swing records: `1751`
- Macro indicators: `11`
- Flow-alert history records: `7548`
...
- `data/processed/ai_context_index.json` (74311 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2538 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (46947 bytes): Compact strategy stats.
