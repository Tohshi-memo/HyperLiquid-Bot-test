...
- `data/processed/ai_context_index.json` (63469 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2549 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47166 bytes): Compact strategy stats.
