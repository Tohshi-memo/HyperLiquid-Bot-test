...
- `data/processed/ai_context_index.json` (63499 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2498 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47947 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5749 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2105 bytes): Individual asset screen.
