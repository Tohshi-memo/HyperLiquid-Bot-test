...
- Asset price active records: `319`
- Day/swing records: `332`
- Flow-alert history records: `1112`
...
- `data/processed/ai_analysis_pack.json` (43688 bytes): Compact strategy stats.
