...
- Asset price active records: `668`
- Day/swing records: `681`
- Macro indicators: `11`
- Flow-alert history records: `2198`
- Correlation status: `ready`
- Asset price archives: `none yet`

## First Read Files

- `data/reports/latest_ai_context_index.md` (1930 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (58393 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45761 bytes): Compact strategy stats.
