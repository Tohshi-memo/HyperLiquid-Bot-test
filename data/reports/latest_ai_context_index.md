...
- Day/swing records: `1328`
- Macro indicators: `5`
- Flow-alert history records: `6208`
...
- `data/processed/ai_context_index.json` (62187 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46920 bytes): Compact strategy stats.
