...
- `data/processed/ai_context_index.json` (63656 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2502 bytes): Current canary signals.
