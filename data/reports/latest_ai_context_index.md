...
- Day/swing records: `1020`
- Macro indicators: `11`
- Flow-alert history records: `5252`
...
- `data/processed/ai_context_index.json` (64072 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46645 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5799 bytes): Asset-class overview.
