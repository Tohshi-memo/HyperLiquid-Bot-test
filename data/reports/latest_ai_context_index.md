...
- Macro indicators: `11`
- Flow-alert history records: `5763`
...
- `data/processed/ai_context_index.json` (73841 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46898 bytes): Compact strategy stats.
