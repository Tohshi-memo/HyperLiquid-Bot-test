...
- Macro indicators: `11`
- Flow-alert history records: `2533`
...
- `data/processed/ai_context_index.json` (69289 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45793 bytes): Compact strategy stats.
