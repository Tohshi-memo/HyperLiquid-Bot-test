...
- `data/processed/ai_context_index.json` (68999 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2636 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47058 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9473 bytes): HIP-4 outcome market overview.
