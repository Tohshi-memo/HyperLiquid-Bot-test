...
- `data/reports/latest_ai_context_index.md` (2961 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64785 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3032 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (8761 bytes): HIP-4 outcome market overview.
