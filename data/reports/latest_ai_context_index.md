...
- Day/swing records: `1621`
- Macro indicators: `11`
- Flow-alert history records: `7139`
...
- `data/processed/ai_context_index.json` (64737 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46955 bytes): Compact strategy stats.
