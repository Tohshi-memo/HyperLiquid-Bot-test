...
- Day/swing records: `2036`
- Macro indicators: `11`
- Flow-alert history records: `8432`
...
- `data/processed/ai_context_index.json` (74047 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46997 bytes): Compact strategy stats.
