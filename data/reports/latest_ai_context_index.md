...
- Updated: `2026-06-24T02:52:29.739981+00:00`
- Asset price active records: `672`
- Day/swing records: `4160`
- Macro indicators: `11`
...
- `data/reports/latest_ai_context_index.md` (2477 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63850 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2539 bytes): Current canary signals.
...
- 1h_crypto_equity_divergence: score `-4.05` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
- 4h_crypto_equity_divergence: score `-3.9849` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
