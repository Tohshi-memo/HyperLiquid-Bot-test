...
- `data/processed/ai_context_index.json` (66635 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47066 bytes): Compact strategy stats.
