...
- `data/processed/ai_context_index.json` (61143 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2203 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10322 bytes): HIP-4 outcome market overview.
