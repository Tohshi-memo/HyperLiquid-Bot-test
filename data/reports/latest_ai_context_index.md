...
- `data/processed/ai_context_index.json` (59717 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5620 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2335 bytes): Individual asset screen.
