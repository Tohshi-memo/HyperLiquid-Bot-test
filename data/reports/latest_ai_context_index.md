...
- `data/processed/ai_context_index.json` (63781 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5605 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2121 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8803 bytes): HIP-4 outcome market overview.
