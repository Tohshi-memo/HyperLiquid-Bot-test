...
- Day/swing records: `2034`
- Macro indicators: `11`
- Flow-alert history records: `8425`
...
- `data/processed/ai_context_index.json` (74183 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46999 bytes): Compact strategy stats.
