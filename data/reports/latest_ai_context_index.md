...
- `data/processed/ai_context_index.json` (64119 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48310 bytes): Compact strategy stats.
