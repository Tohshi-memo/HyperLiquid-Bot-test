...
- Asset price active records: `331`
- Day/swing records: `344`
- Flow-alert history records: `1148`
...
- `data/processed/ai_analysis_pack.json` (43678 bytes): Compact strategy stats.
