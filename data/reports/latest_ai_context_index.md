...
- Asset price active records: `665`
- Day/swing records: `678`
- Macro indicators: `11`
- Flow-alert history records: `2189`
...
- `data/processed/ai_context_index.json` (58359 bytes): Machine-readable map.
