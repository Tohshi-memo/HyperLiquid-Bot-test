...
- Asset price active records: `269`
- Day/swing records: `282`
- Flow-alert history records: `956`
...
- `data/processed/ai_analysis_pack.json` (42588 bytes): Compact strategy stats.
