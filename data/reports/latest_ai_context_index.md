...
- Updated: `2026-07-16T16:52:25.949008+00:00`
- Asset price active records: `672`
- Day/swing records: `6285`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63893 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8970 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `1.6284` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
