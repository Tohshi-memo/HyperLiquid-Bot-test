...
- `data/reports/latest_ai_context_index.md` (2793 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (75042 bytes): Machine-readable map.
