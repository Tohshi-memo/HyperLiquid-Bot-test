...
- `data/processed/ai_context_index.json` (63871 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47952 bytes): Compact strategy stats.
