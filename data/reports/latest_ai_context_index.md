...
- Asset price active records: `439`
- Day/swing records: `452`
- Flow-alert history records: `1487`
...
- `data/processed/ai_analysis_pack.json` (45645 bytes): Compact strategy stats.
