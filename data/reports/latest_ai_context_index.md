...
- `data/reports/latest_ai_context_index.md` (2626 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (70487 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2728 bytes): Current canary signals.
