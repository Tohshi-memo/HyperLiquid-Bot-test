...
- Asset price active records: `261`
- Day/swing records: `274`
- Flow-alert history records: `931`
...
- `data/processed/ai_analysis_pack.json` (42556 bytes): Compact strategy stats.
