...
- `data/processed/ai_context_index.json` (74824 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8724 bytes): HIP-4 outcome market overview.
