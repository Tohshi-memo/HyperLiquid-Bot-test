...
- `data/reports/latest_ai_context_index.md` (2517 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62484 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (50447 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5670 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2323 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10418 bytes): HIP-4 outcome market overview.
