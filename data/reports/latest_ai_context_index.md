...
- Day/swing records: `1164`
- Macro indicators: `11`
- Flow-alert history records: `5696`
...
- `data/processed/ai_context_index.json` (73704 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46894 bytes): Compact strategy stats.
