...
- Day/swing records: `807`
- Macro indicators: `11`
- Flow-alert history records: `2597`
...
- `data/processed/ai_context_index.json` (48404 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45834 bytes): Compact strategy stats.
