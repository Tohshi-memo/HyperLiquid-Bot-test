...
- `data/reports/latest_ai_context_index.md` (2484 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61037 bytes): Machine-readable map.
