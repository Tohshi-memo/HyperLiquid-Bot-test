...
- Asset price active records: `473`
- Day/swing records: `486`
- Flow-alert history records: `1593`
...
- `data/processed/ai_context_index.json` (35463 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45666 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5634 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2026 bytes): Individual asset screen.
