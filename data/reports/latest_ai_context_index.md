...
- `data/processed/ai_context_index.json` (62261 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2788 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2306 bytes): Individual asset screen.
