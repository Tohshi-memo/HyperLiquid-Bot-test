...
- Day/swing records: `691`
- Macro indicators: `11`
- Flow-alert history records: `2231`
- Correlation status: `ready`
- Asset price archives: `data/archive/asset_price_history_2026-05.jsonl.gz`

## First Read Files

- `data/reports/latest_ai_context_index.md` (2068 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (65191 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45734 bytes): Compact strategy stats.
