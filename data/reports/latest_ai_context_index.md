...
- Asset price active records: `424`
- Day/swing records: `437`
- Flow-alert history records: `1441`
...
- `data/processed/ai_analysis_pack.json` (45372 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4662 bytes): Asset-class overview.
