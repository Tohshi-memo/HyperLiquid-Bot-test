...
- Asset price active records: `399`
- Day/swing records: `412`
- Flow-alert history records: `1365`
...
- `data/processed/ai_analysis_pack.json` (44541 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4682 bytes): Asset-class overview.
