...
- `data/reports/latest_ai_context_index.md` (2691 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64143 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2627 bytes): Current canary signals.
