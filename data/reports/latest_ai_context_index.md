...
- `data/processed/ai_context_index.json` (60422 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2480 bytes): Current canary signals.
