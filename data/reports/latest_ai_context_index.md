...
- `data/processed/ai_context_index.json` (63530 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48013 bytes): Compact strategy stats.
