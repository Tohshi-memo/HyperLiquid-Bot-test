...
- Asset price active records: `413`
- Day/swing records: `426`
- Flow-alert history records: `1408`
...
- `data/processed/ai_analysis_pack.json` (45091 bytes): Compact strategy stats.
