...
- `data/processed/ai_context_index.json` (64197 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2757 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47929 bytes): Compact strategy stats.
