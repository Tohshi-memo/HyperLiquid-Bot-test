...
- Day/swing records: `1148`
- Macro indicators: `11`
- Flow-alert history records: `5647`
...
- `data/processed/ai_context_index.json` (71378 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46608 bytes): Compact strategy stats.
