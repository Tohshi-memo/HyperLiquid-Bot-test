...
- Day/swing records: `1908`
- Macro indicators: `11`
- Flow-alert history records: `8040`
...
- `data/processed/ai_context_index.json` (73476 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47013 bytes): Compact strategy stats.
