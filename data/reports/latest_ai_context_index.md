...
- Asset price active records: `278`
- Day/swing records: `291`
- Flow-alert history records: `983`
...
- `data/processed/ai_analysis_pack.json` (42832 bytes): Compact strategy stats.
