...
- Asset price active records: `370`
- Day/swing records: `383`
- Flow-alert history records: `1272`
...
- `data/processed/ai_context_index.json` (14665 bytes): Machine-readable map.
