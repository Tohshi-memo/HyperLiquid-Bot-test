...
- Updated: `2026-08-23T13:52:29.428920+00:00`
- Asset price active records: `672`
- Day/swing records: `9835`
- Macro indicators: `11`
...
- `data/reports/latest_ai_context_index.md` (2362 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61215 bytes): Machine-readable map.
...
- 4h_crypto_metal_divergence: score `1.5448` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
