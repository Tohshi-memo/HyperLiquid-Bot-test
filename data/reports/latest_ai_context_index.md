...
- Macro indicators: `11`
- Flow-alert history records: `7348`
...
- `data/processed/ai_context_index.json` (69263 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (7536 bytes): HIP-4 outcome market overview.
