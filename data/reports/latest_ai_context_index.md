...
- `data/processed/ai_analysis_pack.json` (47108 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9031 bytes): HIP-4 outcome market overview.
