...
- `data/processed/ai_context_index.json` (73981 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47090 bytes): Compact strategy stats.
