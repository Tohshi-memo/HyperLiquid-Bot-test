...
- `data/processed/ai_context_index.json` (59256 bytes): Machine-readable map.
...
- `data/reports/latest_macro_indicators.md` (2055 bytes): Macro rates, employment, inflation, dollar, and risk overview.
...
- `data/reports/latest_asset_features.md` (2347 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8714 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3609 bytes): Mechanical relationship candidates.
