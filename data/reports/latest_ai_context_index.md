...
- Day/swing records: `1037`
- Macro indicators: `11`
- Flow-alert history records: `5304`
...
- `data/processed/ai_analysis_pack.json` (46616 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5789 bytes): Asset-class overview.
