...
- Asset price active records: `529`
- Day/swing records: `542`
- Flow-alert history records: `1768`
...
- `data/processed/ai_context_index.json` (35541 bytes): Machine-readable map.
