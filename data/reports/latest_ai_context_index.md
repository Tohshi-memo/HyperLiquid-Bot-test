...
- Day/swing records: `1854`
- Macro indicators: `11`
- Flow-alert history records: `7873`
...
- `data/processed/ai_context_index.json` (71526 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46972 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8311 bytes): HIP-4 outcome market overview.
