...
- `data/reports/latest_ai_context_index.md` (2533 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61995 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2675 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48191 bytes): Compact strategy stats.
