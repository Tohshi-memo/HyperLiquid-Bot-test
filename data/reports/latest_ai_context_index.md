...
- Asset price active records: `375`
- Day/swing records: `388`
- Flow-alert history records: `1288`
...
- `data/processed/ai_analysis_pack.json` (43967 bytes): Compact strategy stats.
