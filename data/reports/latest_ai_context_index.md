...
- Flow-alert history records: `1007`
...
- `data/processed/ai_context_index.json` (14647 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43115 bytes): Compact strategy stats.
