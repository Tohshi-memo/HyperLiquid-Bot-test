...
- Updated: `2026-07-19T20:37:24.890558+00:00`
...
- `data/processed/ai_context_index.json` (58855 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48212 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5668 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2308 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8980 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3663 bytes): Mechanical relationship candidates.
...
- polymarket_volume_spike: score `4.46` - Polymarket crypto volume is unusually high.
