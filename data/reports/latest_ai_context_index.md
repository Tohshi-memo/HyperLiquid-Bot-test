...
- Updated: `2026-06-09T18:07:32.746912+00:00`
- Asset price active records: `672`
- Day/swing records: `3075`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63484 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47182 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8975 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `1.9445` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
