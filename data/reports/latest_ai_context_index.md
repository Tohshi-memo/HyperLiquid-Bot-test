...
- `data/processed/ai_context_index.json` (62494 bytes): Machine-readable map.
...
- `data/reports/latest_macro_indicators.md` (2370 bytes): Macro rates, employment, inflation, dollar, and risk overview.
...
- `data/reports/latest_hip4_outcome.md` (8750 bytes): HIP-4 outcome market overview.
