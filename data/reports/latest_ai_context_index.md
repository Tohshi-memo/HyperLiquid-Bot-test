...
- Macro indicators: `11`
- Flow-alert history records: `7997`
...
- `data/reports/latest_ai_context_index.md` (2359 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (70747 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46991 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8293 bytes): HIP-4 outcome market overview.
