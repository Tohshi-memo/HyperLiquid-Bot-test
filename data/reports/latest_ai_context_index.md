...
- `data/processed/ai_context_index.json` (67498 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47055 bytes): Compact strategy stats.
