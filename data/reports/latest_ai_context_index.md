...
- Macro indicators: `11`
- Flow-alert history records: `5216`
...
- `data/processed/ai_context_index.json` (69428 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46627 bytes): Compact strategy stats.
