...
- `data/reports/latest_ai_context_index.md` (2452 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63821 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47950 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5748 bytes): Asset-class overview.
