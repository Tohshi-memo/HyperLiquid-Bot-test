...
- Day/swing records: `995`
- Macro indicators: `11`
- Flow-alert history records: `5173`
...
- `data/processed/ai_context_index.json` (68552 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46664 bytes): Compact strategy stats.
