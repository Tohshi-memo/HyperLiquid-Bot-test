...
- Day/swing records: `1707`
- Macro indicators: `11`
- Flow-alert history records: `7409`
...
- `data/processed/ai_context_index.json` (68293 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (7548 bytes): HIP-4 outcome market overview.
