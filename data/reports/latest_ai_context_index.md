...
- Macro indicators: `11`
- Flow-alert history records: `7273`
...
- `data/processed/ai_analysis_pack.json` (46938 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (6782 bytes): HIP-4 outcome market overview.
