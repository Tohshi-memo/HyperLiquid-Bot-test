...
- Updated: `2026-09-05T18:07:27.417564+00:00`
...
- `data/processed/ai_context_index.json` (61728 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2153 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10327 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_metal_divergence: score `1.534` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
