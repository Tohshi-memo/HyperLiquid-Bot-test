...
- `data/reports/latest_ai_context_index.md` (2545 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62039 bytes): Machine-readable map.
