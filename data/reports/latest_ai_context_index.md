...
- Asset price active records: `593`
- Day/swing records: `606`
- Flow-alert history records: `1965`
...
- `data/processed/ai_context_index.json` (36547 bytes): Machine-readable map.
