...
- `data/reports/latest_ai_context_index.md` (2554 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (66970 bytes): Machine-readable map.
