...
- Updated: `2026-09-04T16:52:45.598460+00:00`
- Asset price active records: `672`
- Day/swing records: `10977`
- Macro indicators: `11`
...
- `data/reports/latest_ai_context_index.md` (2378 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62008 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (10275 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3518 bytes): Mechanical relationship candidates.
...
- 4h_crypto_equity_divergence: score `-1.681` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
