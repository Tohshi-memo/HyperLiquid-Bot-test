...
- Asset price active records: `598`
- Day/swing records: `611`
- Macro indicators: `11`
- Flow-alert history records: `1981`
...
- `data/processed/ai_context_index.json` (51128 bytes): Machine-readable map.
