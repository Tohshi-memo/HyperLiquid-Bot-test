...
- `data/reports/latest_ai_context_index.md` (2632 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (66986 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2633 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47042 bytes): Compact strategy stats.
