...
- Asset price active records: `585`
- Day/swing records: `598`
- Flow-alert history records: `1940`
...
- `data/processed/ai_context_index.json` (36567 bytes): Machine-readable map.
