...
- Day/swing records: `723`
- Macro indicators: `11`
- Flow-alert history records: `2329`
...
- `data/processed/ai_context_index.json` (60733 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45729 bytes): Compact strategy stats.
