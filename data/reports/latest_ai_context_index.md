...
- `data/reports/latest_ai_context_index.md` (2660 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62248 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2682 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (10318 bytes): HIP-4 outcome market overview.
