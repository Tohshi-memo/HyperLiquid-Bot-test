...
- Updated: `2026-05-21T02:52:14.688077+00:00`
- Asset price active records: `672`
- Day/swing records: `1226`
- Macro indicators: `11`
- Flow-alert history records: `5892`
...
- `data/processed/ai_context_index.json` (66020 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46906 bytes): Compact strategy stats.
...
- 4h_crypto_metal_divergence: score `1.6544` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
