...
- Asset price active records: `227`
- Day/swing records: `240`
- Flow-alert history records: `825`
...
- `data/processed/ai_context_index.json` (14691 bytes): Machine-readable map.
