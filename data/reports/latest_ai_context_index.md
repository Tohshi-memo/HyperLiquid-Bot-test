...
- `data/processed/ai_analysis_pack.json` (47985 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5633 bytes): Asset-class overview.
