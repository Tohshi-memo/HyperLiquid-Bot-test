...
- Macro indicators: `11`
- Flow-alert history records: `7573`
...
- `data/processed/ai_context_index.json` (73048 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46983 bytes): Compact strategy stats.
