...
- `data/processed/ai_context_index.json` (63622 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48242 bytes): Compact strategy stats.
