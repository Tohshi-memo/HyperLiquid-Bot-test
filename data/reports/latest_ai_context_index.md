...
- `data/processed/ai_context_index.json` (60756 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2100 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8828 bytes): HIP-4 outcome market overview.
