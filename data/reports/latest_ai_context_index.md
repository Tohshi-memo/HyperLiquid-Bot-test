...
- Flow-alert history records: `1523`
...
- `data/processed/ai_context_index.json` (14944 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45623 bytes): Compact strategy stats.
