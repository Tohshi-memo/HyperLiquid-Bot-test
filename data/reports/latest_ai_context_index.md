...
- `data/reports/latest_ai_context_index.md` (2665 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63590 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2688 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (49854 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (10444 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3553 bytes): Mechanical relationship candidates.
