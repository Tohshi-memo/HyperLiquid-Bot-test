...
- `data/processed/ai_context_index.json` (61329 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (49344 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (10415 bytes): HIP-4 outcome market overview.
