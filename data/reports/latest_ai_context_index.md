...
- `data/processed/ai_context_index.json` (70863 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47033 bytes): Compact strategy stats.
