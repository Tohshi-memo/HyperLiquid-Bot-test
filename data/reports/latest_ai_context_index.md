...
- Day/swing records: `975`
- Macro indicators: `11`
- Flow-alert history records: `5113`
...
- `data/processed/ai_context_index.json` (72949 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46594 bytes): Compact strategy stats.
