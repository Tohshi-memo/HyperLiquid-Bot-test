...
- `data/processed/ai_context_index.json` (61880 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48183 bytes): Compact strategy stats.
