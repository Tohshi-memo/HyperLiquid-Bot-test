...
- `data/reports/latest_ai_context_index.md` (2570 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63730 bytes): Machine-readable map.
