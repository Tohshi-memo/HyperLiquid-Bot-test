...
- `data/processed/ai_context_index.json` (62097 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2372 bytes): Individual asset screen.
