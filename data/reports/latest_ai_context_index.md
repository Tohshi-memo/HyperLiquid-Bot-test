...
- `data/reports/latest_ai_context_index.md` (2461 bytes): Human-readable map.
...
- `data/reports/latest_asset_universe.md` (5608 bytes): Asset-class overview.
...
- `data/reports/latest_relationship_scan.md` (3514 bytes): Mechanical relationship candidates.
