...
- Day/swing records: `1219`
- Macro indicators: `11`
- Flow-alert history records: `5870`
...
- `data/processed/ai_context_index.json` (66053 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46886 bytes): Compact strategy stats.
