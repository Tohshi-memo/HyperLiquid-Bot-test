...
- Day/swing records: `818`
- Macro indicators: `11`
- Flow-alert history records: `2630`
...
- `data/processed/ai_context_index.json` (60684 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45799 bytes): Compact strategy stats.
