...
- `data/reports/latest_ai_context_index.md` (2670 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (68287 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2805 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (9464 bytes): HIP-4 outcome market overview.
