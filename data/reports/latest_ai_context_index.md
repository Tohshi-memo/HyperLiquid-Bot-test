...
- Day/swing records: `1076`
- Macro indicators: `11`
- Flow-alert history records: `5424`
...
- `data/processed/ai_context_index.json` (70651 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46663 bytes): Compact strategy stats.
