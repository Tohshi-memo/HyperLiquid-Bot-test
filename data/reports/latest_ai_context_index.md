...
- `data/processed/ai_context_index.json` (66287 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2922 bytes): Current canary signals.
