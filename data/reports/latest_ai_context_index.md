...
- `data/reports/latest_ai_context_index.md` (2503 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61938 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5639 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2107 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10344 bytes): HIP-4 outcome market overview.
