...
- Day/swing records: `1717`
- Macro indicators: `11`
- Flow-alert history records: `7443`
...
- `data/processed/ai_context_index.json` (69384 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46974 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (7572 bytes): HIP-4 outcome market overview.
