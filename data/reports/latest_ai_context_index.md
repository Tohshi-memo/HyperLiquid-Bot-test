...
- `data/reports/latest_ai_context_index.md` (2602 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64089 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2251 bytes): Individual asset screen.
