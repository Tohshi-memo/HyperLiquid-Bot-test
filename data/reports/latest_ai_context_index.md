...
- `data/processed/ai_context_index.json` (64067 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2385 bytes): Individual asset screen.
