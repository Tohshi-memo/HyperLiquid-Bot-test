...
- `data/processed/ai_context_index.json` (61709 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48155 bytes): Compact strategy stats.
