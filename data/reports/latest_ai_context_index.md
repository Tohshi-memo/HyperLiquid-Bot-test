...
- `data/processed/ai_context_index.json` (64286 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2752 bytes): Current canary signals.
