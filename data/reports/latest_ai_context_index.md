...
- Asset price active records: `505`
- Day/swing records: `518`
- Flow-alert history records: `1694`
...
- `data/processed/ai_analysis_pack.json` (45711 bytes): Compact strategy stats.
