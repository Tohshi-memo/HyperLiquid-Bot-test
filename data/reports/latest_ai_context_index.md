...
- `data/processed/ai_context_index.json` (61698 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48171 bytes): Compact strategy stats.
