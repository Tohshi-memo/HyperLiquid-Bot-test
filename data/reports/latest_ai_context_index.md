...
- Day/swing records: `1086`
- Macro indicators: `11`
- Flow-alert history records: `5455`
...
- `data/processed/ai_context_index.json` (74079 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46659 bytes): Compact strategy stats.
