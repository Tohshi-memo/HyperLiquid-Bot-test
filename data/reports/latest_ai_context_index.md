...
- Updated: `2026-07-02T15:07:39.656575+00:00`
- Asset price active records: `672`
- Day/swing records: `4968`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63609 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2522 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48202 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5724 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2279 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8782 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3635 bytes): Mechanical relationship candidates.
...
- 4h_crypto_equity_divergence: score `1.7064` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
- 1h_crypto_equity_divergence: score `1.7051` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
