...
- `data/processed/ai_context_index.json` (73969 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47210 bytes): Compact strategy stats.
