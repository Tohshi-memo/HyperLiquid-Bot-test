...
- `data/processed/ai_analysis_pack.json` (47700 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5741 bytes): Asset-class overview.
