...
- Macro indicators: `5`
- Flow-alert history records: `6224`
...
- `data/processed/ai_context_index.json` (63282 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46944 bytes): Compact strategy stats.
