...
- `data/processed/ai_context_index.json` (61620 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (6199 bytes): HIP-4 outcome market overview.
