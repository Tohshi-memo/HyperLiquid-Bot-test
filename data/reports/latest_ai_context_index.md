...
- Asset price active records: `357`
- Day/swing records: `370`
- Flow-alert history records: `1228`
...
- `data/processed/ai_analysis_pack.json` (43963 bytes): Compact strategy stats.
