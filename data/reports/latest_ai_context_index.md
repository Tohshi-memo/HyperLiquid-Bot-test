...
- Day/swing records: `946`
- Macro indicators: `11`
- Flow-alert history records: `5024`
...
- `data/processed/ai_context_index.json` (66165 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46330 bytes): Compact strategy stats.
