...
- `data/processed/ai_context_index.json` (62125 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2678 bytes): Current canary signals.
