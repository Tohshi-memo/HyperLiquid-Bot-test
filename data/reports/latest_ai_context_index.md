...
- Updated: `2026-07-15T13:37:30.945369+00:00`
- Asset price active records: `672`
- Day/swing records: `6179`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63861 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (9020 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `1.5622` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
