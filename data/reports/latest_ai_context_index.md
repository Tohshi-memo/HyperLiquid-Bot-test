...
- `data/processed/ai_context_index.json` (63783 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2749 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2099 bytes): Individual asset screen.
