...
- Updated: `2026-06-03T21:37:24.614663+00:00`
- Asset price active records: `672`
- Day/swing records: `2521`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (67501 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47050 bytes): Compact strategy stats.
...
- 1h_crypto_equity_divergence: score `1.6692` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
