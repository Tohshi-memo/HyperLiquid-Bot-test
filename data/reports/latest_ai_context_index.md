...
- `data/processed/ai_context_index.json` (63576 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2742 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47957 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5781 bytes): Asset-class overview.
