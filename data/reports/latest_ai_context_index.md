...
- `data/processed/ai_context_index.json` (63725 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5610 bytes): Asset-class overview.
