...
- `data/reports/latest_ai_context_index.md` (2611 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62093 bytes): Machine-readable map.
