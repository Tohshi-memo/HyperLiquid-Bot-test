...
- `data/processed/ai_context_index.json` (63558 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47678 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5695 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2152 bytes): Individual asset screen.
