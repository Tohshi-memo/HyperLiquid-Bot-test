...
- `data/reports/latest_ai_context_index.md` (2903 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (67674 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3291 bytes): Current canary signals.
