...
- Asset price active records: `590`
- Day/swing records: `603`
- Flow-alert history records: `1956`
...
- `data/processed/ai_context_index.json` (36528 bytes): Machine-readable map.
