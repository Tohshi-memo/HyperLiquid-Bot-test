...
- Day/swing records: `1692`
- Macro indicators: `11`
- Flow-alert history records: `7363`
...
- `data/processed/ai_context_index.json` (68183 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (7554 bytes): HIP-4 outcome market overview.
