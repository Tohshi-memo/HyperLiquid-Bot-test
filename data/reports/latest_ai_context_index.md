...
- Day/swing records: `1652`
- Macro indicators: `11`
- Flow-alert history records: `7237`
...
- `data/processed/ai_context_index.json` (73611 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (6797 bytes): HIP-4 outcome market overview.
