...
- Day/swing records: `1680`
- Macro indicators: `11`
- Flow-alert history records: `7325`
...
- `data/processed/ai_context_index.json` (70322 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46966 bytes): Compact strategy stats.
