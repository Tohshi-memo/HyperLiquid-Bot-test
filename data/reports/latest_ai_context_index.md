...
- Updated: `2026-07-08T13:37:35.804236+00:00`
- Asset price active records: `672`
- Day/swing records: `5530`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63314 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48227 bytes): Compact strategy stats.
...
- 4h_crypto_equity_divergence: score `-1.9319` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
