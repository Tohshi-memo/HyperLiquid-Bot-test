...
- `data/processed/ai_context_index.json` (61982 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (9000 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3659 bytes): Mechanical relationship candidates.
