...
- `data/processed/ai_context_index.json` (62272 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2332 bytes): Individual asset screen.
