...
- `data/processed/ai_context_index.json` (63818 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2621 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47963 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5751 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2108 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8831 bytes): HIP-4 outcome market overview.
