...
- Day/swing records: `966`
- Macro indicators: `11`
- Flow-alert history records: `5085`
...
- `data/processed/ai_context_index.json` (66209 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46633 bytes): Compact strategy stats.
