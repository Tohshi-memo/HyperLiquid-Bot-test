...
- `data/reports/latest_canary_signals.md` (2557 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (50443 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5685 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2303 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10433 bytes): HIP-4 outcome market overview.
