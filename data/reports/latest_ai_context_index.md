...
- Updated: `2026-07-06T19:21:31.308811+00:00`
- Asset price active records: `672`
- Day/swing records: `5365`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63083 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8808 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `1.616` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
