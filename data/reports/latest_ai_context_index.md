...
- `data/processed/ai_context_index.json` (62074 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2088 bytes): Individual asset screen.
