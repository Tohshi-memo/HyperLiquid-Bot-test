...
- Day/swing records: `718`
- Macro indicators: `11`
- Flow-alert history records: `2314`
...
- `data/processed/ai_context_index.json` (60702 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45726 bytes): Compact strategy stats.
