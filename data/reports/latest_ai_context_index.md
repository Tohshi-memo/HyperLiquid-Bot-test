...
- Day/swing records: `1023`
- Macro indicators: `11`
- Flow-alert history records: `5261`
...
- `data/processed/ai_context_index.json` (63997 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46643 bytes): Compact strategy stats.
