...
- `data/processed/ai_context_index.json` (64324 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47092 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5760 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2305 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (9451 bytes): HIP-4 outcome market overview.
