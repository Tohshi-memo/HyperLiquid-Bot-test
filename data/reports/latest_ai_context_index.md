...
- Day/swing records: `1309`
- Macro indicators: `5`
- Flow-alert history records: `6148`
...
- `data/processed/ai_context_index.json` (61124 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46927 bytes): Compact strategy stats.
