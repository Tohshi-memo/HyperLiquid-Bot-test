...
- Day/swing records: `817`
- Macro indicators: `11`
- Flow-alert history records: `2627`
...
- `data/processed/ai_context_index.json` (60682 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45781 bytes): Compact strategy stats.
