...
- Day/swing records: `974`
- Macro indicators: `11`
- Flow-alert history records: `5110`
...
- `data/processed/ai_context_index.json` (71760 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46658 bytes): Compact strategy stats.
