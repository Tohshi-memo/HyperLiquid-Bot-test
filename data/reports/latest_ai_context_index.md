...
- `data/processed/ai_context_index.json` (63635 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3606 bytes): Mechanical relationship candidates.
