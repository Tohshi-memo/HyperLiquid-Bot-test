...
- `data/processed/ai_context_index.json` (62014 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48267 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9146 bytes): HIP-4 outcome market overview.
