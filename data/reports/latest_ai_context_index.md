...
- Asset price active records: `342`
- Day/swing records: `355`
- Flow-alert history records: `1182`
...
- `data/processed/ai_analysis_pack.json` (43655 bytes): Compact strategy stats.
