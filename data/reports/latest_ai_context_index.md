...
- Macro indicators: `11`
- Flow-alert history records: `4997`
...
- `data/processed/ai_context_index.json` (74029 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46352 bytes): Compact strategy stats.
