...
- Day/swing records: `800`
- Macro indicators: `11`
- Flow-alert history records: `2575`
...
- `data/processed/ai_context_index.json` (65050 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45790 bytes): Compact strategy stats.
