...
- Updated: `2026-08-23T13:37:30.269221+00:00`
...
- `data/processed/ai_context_index.json` (61517 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48205 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (6178 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3509 bytes): Mechanical relationship candidates.
...
- 4h_crypto_metal_divergence: score `1.5726` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
