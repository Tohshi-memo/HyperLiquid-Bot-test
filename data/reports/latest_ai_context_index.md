...
- `data/processed/ai_context_index.json` (62217 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2545 bytes): Current canary signals.
