...
- Asset price active records: `538`
- Day/swing records: `551`
- Flow-alert history records: `1795`
...
- `data/processed/ai_context_index.json` (35200 bytes): Machine-readable map.
