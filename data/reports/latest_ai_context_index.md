...
- `data/reports/latest_ai_context_index.md` (2434 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63853 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2741 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47998 bytes): Compact strategy stats.
