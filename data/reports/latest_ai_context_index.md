...
- `data/processed/ai_context_index.json` (62385 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8760 bytes): HIP-4 outcome market overview.
