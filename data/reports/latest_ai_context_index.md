...
- Asset price active records: `386`
- Day/swing records: `399`
- Flow-alert history records: `1323`
...
- `data/processed/ai_analysis_pack.json` (43955 bytes): Compact strategy stats.
