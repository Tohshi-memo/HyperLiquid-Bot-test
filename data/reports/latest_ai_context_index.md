...
- Asset price active records: `553`
- Day/swing records: `566`
- Flow-alert history records: `1842`
...
- `data/processed/ai_context_index.json` (35560 bytes): Machine-readable map.
