...
- Macro indicators: `11`
- Flow-alert history records: `2524`
...
- `data/processed/ai_context_index.json` (68286 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45753 bytes): Compact strategy stats.
