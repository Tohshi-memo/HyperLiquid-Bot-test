...
- Day/swing records: `851`
- Macro indicators: `11`
- Flow-alert history records: `2734`
...
- `data/processed/ai_context_index.json` (69500 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45783 bytes): Compact strategy stats.
