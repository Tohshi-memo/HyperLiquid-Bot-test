...
- Updated: `2026-07-07T15:52:34.646335+00:00`
- Asset price active records: `672`
- Day/swing records: `5446`
- Macro indicators: `11`
...
- `data/reports/latest_ai_context_index.md` (2480 bytes): Human-readable map.
...
- `data/processed/ai_analysis_pack.json` (48175 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8887 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `2.2917` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
