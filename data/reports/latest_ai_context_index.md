...
- `data/processed/ai_context_index.json` (63517 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5613 bytes): Asset-class overview.
