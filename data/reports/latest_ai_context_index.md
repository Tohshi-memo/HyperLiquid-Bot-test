...
- Asset price active records: `216`
- Day/swing records: `229`
- Flow-alert history records: `792`
...
- `data/processed/ai_analysis_pack.json` (35536 bytes): Compact strategy stats.
