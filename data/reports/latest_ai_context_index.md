...
- Asset price active records: `498`
- Day/swing records: `511`
- Flow-alert history records: `1673`
...
- `data/processed/ai_context_index.json` (34685 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2029 bytes): Individual asset screen.
