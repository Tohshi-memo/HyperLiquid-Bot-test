...
- `data/reports/latest_ai_context_index.md` (2669 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (68313 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2794 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47099 bytes): Compact strategy stats.
