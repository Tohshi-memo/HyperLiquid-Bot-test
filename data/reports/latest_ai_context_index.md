...
- Macro indicators: `11`
- Flow-alert history records: `4759`
...
- `data/processed/ai_context_index.json` (67375 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2487 bytes): Individual asset screen.
