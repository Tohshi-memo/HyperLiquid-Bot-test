...
- `data/processed/ai_context_index.json` (63429 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47699 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8934 bytes): HIP-4 outcome market overview.
