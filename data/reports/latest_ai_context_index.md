...
- `data/processed/ai_context_index.json` (63446 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2061 bytes): Individual asset screen.
