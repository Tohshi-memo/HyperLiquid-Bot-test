...
- Macro indicators: `11`
- Flow-alert history records: `2252`
...
- `data/processed/ai_context_index.json` (64034 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45730 bytes): Compact strategy stats.
