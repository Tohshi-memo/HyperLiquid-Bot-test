...
- `data/processed/ai_context_index.json` (61909 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2362 bytes): Individual asset screen.
