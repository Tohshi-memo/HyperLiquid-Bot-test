...
- Day/swing records: `961`
- Macro indicators: `11`
- Flow-alert history records: `5070`
...
- `data/processed/ai_context_index.json` (66198 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46642 bytes): Compact strategy stats.
