...
- Day/swing records: `1048`
- Macro indicators: `11`
- Flow-alert history records: `5338`
...
- `data/processed/ai_analysis_pack.json` (46630 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5792 bytes): Asset-class overview.
