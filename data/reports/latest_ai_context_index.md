...
- Macro indicators: `11`
- Flow-alert history records: `6369`
...
- `data/reports/latest_ai_context_index.md` (2233 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (68212 bytes): Machine-readable map.
