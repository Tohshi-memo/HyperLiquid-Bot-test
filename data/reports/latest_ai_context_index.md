...
- `data/reports/latest_ai_context_index.md` (3120 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63091 bytes): Machine-readable map.
