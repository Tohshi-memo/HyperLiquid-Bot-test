...
- `data/processed/ai_context_index.json` (64224 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2519 bytes): Current canary signals.
...
- `data/reports/latest_asset_universe.md` (5746 bytes): Asset-class overview.
