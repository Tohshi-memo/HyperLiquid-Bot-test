...
- `data/processed/ai_context_index.json` (63496 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47714 bytes): Compact strategy stats.
