...
- Macro indicators: `11`
- Flow-alert history records: `5785`
...
- `data/processed/ai_context_index.json` (72720 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46883 bytes): Compact strategy stats.
