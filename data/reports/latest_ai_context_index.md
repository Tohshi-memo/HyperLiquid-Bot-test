...
- Day/swing records: `1828`
- Macro indicators: `11`
- Flow-alert history records: `7790`
...
- `data/processed/ai_context_index.json` (73605 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47001 bytes): Compact strategy stats.
