...
- Day/swing records: `803`
- Macro indicators: `11`
- Flow-alert history records: `2585`
...
- `data/processed/ai_context_index.json` (65035 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45814 bytes): Compact strategy stats.
