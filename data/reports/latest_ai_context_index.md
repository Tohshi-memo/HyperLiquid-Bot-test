...
- `data/reports/latest_canary_signals.md` (2537 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47115 bytes): Compact strategy stats.
