...
- Macro indicators: `11`
- Flow-alert history records: `7902`
...
- `data/reports/latest_ai_context_index.md` (2235 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (68517 bytes): Machine-readable map.
