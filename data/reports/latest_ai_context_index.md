...
- Macro indicators: `11`
- Flow-alert history records: `6072`
...
- `data/reports/latest_ai_context_index.md` (2339 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (73864 bytes): Machine-readable map.
