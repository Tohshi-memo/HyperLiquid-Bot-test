...
- `data/processed/ai_context_index.json` (75139 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3243 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47036 bytes): Compact strategy stats.
