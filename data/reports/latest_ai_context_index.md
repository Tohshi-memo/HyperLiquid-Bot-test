...
- Updated: `2026-05-23T22:07:16.293454+00:00`
- Asset price active records: `672`
- Day/swing records: `1490`
- Macro indicators: `11`
- Flow-alert history records: `6722`
...
- `data/processed/ai_context_index.json` (64798 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46942 bytes): Compact strategy stats.
...
- 4h_commodity_crypto_divergence: score `3.8883` - Commodity perps and crypto are moving differently; check macro-linked stress.
