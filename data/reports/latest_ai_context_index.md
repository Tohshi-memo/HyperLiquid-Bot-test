...
- `data/reports/latest_ai_context_index.md` (2775 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62444 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2904 bytes): Current canary signals.
