...
- `data/processed/ai_context_index.json` (71993 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2319 bytes): Individual asset screen.
