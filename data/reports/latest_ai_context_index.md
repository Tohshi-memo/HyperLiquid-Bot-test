...
- Asset price active records: `393`
- Day/swing records: `406`
- Flow-alert history records: `1345`
...
- `data/processed/ai_context_index.json` (14648 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (44244 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4661 bytes): Asset-class overview.
