...
- Asset price active records: `302`
- Day/swing records: `315`
- Flow-alert history records: `1060`
...
- `data/processed/ai_context_index.json` (14657 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43392 bytes): Compact strategy stats.
