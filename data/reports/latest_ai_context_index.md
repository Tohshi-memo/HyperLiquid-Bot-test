...
- Macro indicators: `11`
- Flow-alert history records: `6868`
...
- `data/reports/latest_ai_context_index.md` (2227 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (69234 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46937 bytes): Compact strategy stats.
