...
- `data/reports/latest_ai_context_index.md` (2566 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64031 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2511 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47966 bytes): Compact strategy stats.
