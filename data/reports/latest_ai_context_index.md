...
- Day/swing records: `1249`
- Macro indicators: `11`
- Flow-alert history records: `5962`
...
- `data/processed/ai_context_index.json` (68101 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46912 bytes): Compact strategy stats.
