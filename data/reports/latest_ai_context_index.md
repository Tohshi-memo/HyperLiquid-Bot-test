...
- `data/reports/latest_ai_context_index.md` (2593 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61120 bytes): Machine-readable map.
