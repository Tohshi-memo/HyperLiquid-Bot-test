...
- `data/processed/ai_context_index.json` (61690 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2907 bytes): Current canary signals.
