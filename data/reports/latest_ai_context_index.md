...
- Macro indicators: `11`
- Flow-alert history records: `4803`
...
- `data/processed/ai_context_index.json` (72840 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46052 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5643 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2405 bytes): Individual asset screen.
