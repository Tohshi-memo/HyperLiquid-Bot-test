...
- `data/processed/ai_context_index.json` (63800 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3616 bytes): Mechanical relationship candidates.
