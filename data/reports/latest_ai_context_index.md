...
- Updated: `2026-06-24T21:03:10.249578+00:00`
...
- `data/reports/latest_ai_context_index.md` (2743 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64302 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48240 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5719 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2250 bytes): Individual asset screen.
...
- 4h_crypto_metal_divergence: score `1.9389` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
