...
- `data/reports/latest_ai_context_index.md` (2732 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (74695 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3108 bytes): Current canary signals.
