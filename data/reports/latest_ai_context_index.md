...
- `data/reports/latest_ai_context_index.md` (2711 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62142 bytes): Machine-readable map.
