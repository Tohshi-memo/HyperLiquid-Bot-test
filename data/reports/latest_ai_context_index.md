...
- Asset price active records: `272`
- Day/swing records: `285`
- Flow-alert history records: `965`
...
- `data/processed/ai_context_index.json` (14670 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (42584 bytes): Compact strategy stats.
