...
- `data/processed/ai_context_index.json` (69615 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2534 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2304 bytes): Individual asset screen.
