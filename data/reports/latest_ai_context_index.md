...
- `data/processed/ai_context_index.json` (61429 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3490 bytes): Mechanical relationship candidates.
