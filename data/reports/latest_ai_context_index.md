...
- Day/swing records: `1083`
- Macro indicators: `11`
- Flow-alert history records: `5446`
...
- `data/processed/ai_context_index.json` (72980 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46665 bytes): Compact strategy stats.
