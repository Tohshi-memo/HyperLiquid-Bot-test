...
- `data/processed/ai_context_index.json` (63099 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48285 bytes): Compact strategy stats.
