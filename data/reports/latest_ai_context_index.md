...
- Macro indicators: `11`
- Flow-alert history records: `7124`
...
- `data/processed/ai_context_index.json` (64838 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (4095 bytes): HIP-4 outcome market overview.
