...
- `data/reports/latest_ai_context_index.md` (2576 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63787 bytes): Machine-readable map.
