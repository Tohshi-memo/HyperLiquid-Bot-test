...
- Macro indicators: `11`
- Flow-alert history records: `4901`
...
- `data/processed/ai_context_index.json` (72686 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46339 bytes): Compact strategy stats.
