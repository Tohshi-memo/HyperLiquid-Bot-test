...
- `data/processed/ai_context_index.json` (61096 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8768 bytes): HIP-4 outcome market overview.
