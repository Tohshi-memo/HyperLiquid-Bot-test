...
- `data/processed/ai_context_index.json` (64205 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3024 bytes): Current canary signals.
