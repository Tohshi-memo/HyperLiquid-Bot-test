...
- Asset price active records: `279`
- Day/swing records: `292`
- Flow-alert history records: `988`
...
- `data/processed/ai_analysis_pack.json` (42849 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4827 bytes): Asset-class overview.
