...
- `data/processed/ai_context_index.json` (63813 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2240 bytes): Current canary signals.
