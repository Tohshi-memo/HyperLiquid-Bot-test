...
- `data/processed/ai_context_index.json` (64152 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48297 bytes): Compact strategy stats.
