...
- Asset price active records: `374`
- Day/swing records: `387`
- Flow-alert history records: `1285`
...
- `data/processed/ai_analysis_pack.json` (43978 bytes): Compact strategy stats.
