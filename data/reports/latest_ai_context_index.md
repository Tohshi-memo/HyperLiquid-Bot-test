...
- `data/processed/ai_context_index.json` (62045 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (9140 bytes): HIP-4 outcome market overview.
