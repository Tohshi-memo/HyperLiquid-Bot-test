...
- Day/swing records: `1228`
- Macro indicators: `11`
- Flow-alert history records: `5898`
...
- `data/processed/ai_context_index.json` (65998 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46907 bytes): Compact strategy stats.
