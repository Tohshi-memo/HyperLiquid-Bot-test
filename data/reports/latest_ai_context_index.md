...
- Macro indicators: `11`
- Flow-alert history records: `5210`
...
- `data/processed/ai_context_index.json` (68335 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46648 bytes): Compact strategy stats.
