...
- `data/processed/ai_context_index.json` (69355 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47035 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9460 bytes): HIP-4 outcome market overview.
