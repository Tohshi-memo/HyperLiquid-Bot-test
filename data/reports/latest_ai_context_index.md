...
- Asset price active records: `550`
- Day/swing records: `563`
- Flow-alert history records: `1832`
...
- `data/processed/ai_context_index.json` (35542 bytes): Machine-readable map.
