...
- Asset price active records: `612`
- Day/swing records: `625`
- Macro indicators: `11`
- Flow-alert history records: `2024`
...
- `data/processed/ai_context_index.json` (52831 bytes): Machine-readable map.
