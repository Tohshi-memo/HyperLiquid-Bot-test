...
- `data/reports/latest_ai_context_index.md` (2534 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61650 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2531 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48176 bytes): Compact strategy stats.
