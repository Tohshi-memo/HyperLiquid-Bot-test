...
- Day/swing records: `860`
- Macro indicators: `11`
- Flow-alert history records: `3196`
- Correlation status: `ready`
- Asset price archives: `data/archive/asset_price_history_2026-05.jsonl.gz`

## First Read Files

- `data/reports/latest_ai_context_index.md` (2058 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (48669 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45789 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5717 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2499 bytes): Individual asset screen.
