...
- Day/swing records: `2028`
- Macro indicators: `11`
- Flow-alert history records: `8407`
...
- `data/reports/latest_ai_context_index.md` (2376 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (74044 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46964 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8329 bytes): HIP-4 outcome market overview.
