...
- `data/processed/ai_context_index.json` (73926 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47082 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9091 bytes): HIP-4 outcome market overview.
