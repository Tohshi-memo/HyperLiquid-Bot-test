...
- Flow-alert history records: `1235`
...
- `data/processed/ai_context_index.json` (14625 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43935 bytes): Compact strategy stats.
