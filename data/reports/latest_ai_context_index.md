...
- Asset price active records: `627`
- Day/swing records: `640`
- Macro indicators: `11`
- Flow-alert history records: `2071`
...
- `data/processed/ai_context_index.json` (53177 bytes): Machine-readable map.
