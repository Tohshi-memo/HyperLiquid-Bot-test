...
- `data/processed/ai_context_index.json` (61898 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48190 bytes): Compact strategy stats.
...
- `data/reports/latest_relationship_scan.md` (3507 bytes): Mechanical relationship candidates.
