...
- `data/processed/ai_context_index.json` (60570 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48224 bytes): Compact strategy stats.
