...
- `data/reports/latest_ai_context_index.md` (2567 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63970 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2632 bytes): Current canary signals.
