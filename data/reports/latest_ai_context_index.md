...
- `data/processed/ai_context_index.json` (62298 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2451 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (49346 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5655 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2201 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10370 bytes): HIP-4 outcome market overview.
