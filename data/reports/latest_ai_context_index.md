...
- `data/processed/ai_context_index.json` (61964 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8690 bytes): HIP-4 outcome market overview.
