...
- Day/swing records: `1391`
- Macro indicators: `11`
- Flow-alert history records: `6407`
...
- `data/processed/ai_context_index.json` (67359 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46969 bytes): Compact strategy stats.
