...
- Asset price active records: `644`
- Day/swing records: `657`
- Macro indicators: `11`
- Flow-alert history records: `2125`
...
- `data/processed/ai_context_index.json` (55064 bytes): Machine-readable map.
