...
- `data/reports/latest_ai_context_index.md` (2782 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (71628 bytes): Machine-readable map.
