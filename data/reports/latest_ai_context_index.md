...
- Day/swing records: `1283`
- Macro indicators: `11`
- Flow-alert history records: `6069`
...
- `data/processed/ai_context_index.json` (73635 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2490 bytes): Current canary signals.
