...
- `data/reports/latest_ai_context_index.md` (2551 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (70124 bytes): Machine-readable map.
