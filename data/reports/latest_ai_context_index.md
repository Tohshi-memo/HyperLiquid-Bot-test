...
- `data/reports/latest_canary_signals.md` (2503 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47948 bytes): Compact strategy stats.
