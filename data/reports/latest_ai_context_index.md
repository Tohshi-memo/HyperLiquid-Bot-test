...
- Macro indicators: `11`
- Flow-alert history records: `6550`
...
- `data/reports/latest_ai_context_index.md` (2471 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (66992 bytes): Machine-readable map.
