...
- Asset price active records: `396`
- Day/swing records: `409`
- Flow-alert history records: `1355`
...
- `data/processed/ai_analysis_pack.json` (44510 bytes): Compact strategy stats.
