...
- `data/processed/ai_context_index.json` (61367 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48162 bytes): Compact strategy stats.
...
- `data/reports/latest_relationship_scan.md` (3505 bytes): Mechanical relationship candidates.
