...
- `data/processed/ai_context_index.json` (64127 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5656 bytes): Asset-class overview.
