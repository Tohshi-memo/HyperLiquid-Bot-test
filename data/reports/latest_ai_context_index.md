...
- `data/reports/latest_canary_signals.md` (2463 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (49355 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (10316 bytes): HIP-4 outcome market overview.
