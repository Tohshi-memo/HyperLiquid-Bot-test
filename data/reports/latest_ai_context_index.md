...
- Asset price active records: `316`
- Day/swing records: `329`
- Flow-alert history records: `1103`
...
- `data/processed/ai_analysis_pack.json` (43677 bytes): Compact strategy stats.
