...
- Asset price active records: `336`
- Day/swing records: `349`
- Flow-alert history records: `1165`
...
- `data/processed/ai_context_index.json` (14655 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43704 bytes): Compact strategy stats.
