...
- `data/reports/latest_ai_context_index.md` (2592 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63774 bytes): Machine-readable map.
