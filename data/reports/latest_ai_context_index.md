...
- `data/processed/ai_context_index.json` (68169 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2798 bytes): Current canary signals.
