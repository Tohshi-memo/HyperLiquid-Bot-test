...
- Day/swing records: `867`
- Macro indicators: `11`
- Flow-alert history records: `4772`
...
- `data/processed/ai_context_index.json` (67329 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46058 bytes): Compact strategy stats.
