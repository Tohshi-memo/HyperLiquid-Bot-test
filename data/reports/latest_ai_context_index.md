...
- `data/processed/ai_context_index.json` (61660 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2506 bytes): Current canary signals.
