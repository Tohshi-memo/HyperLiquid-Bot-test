...
- `data/reports/latest_ai_context_index.md` (2726 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62255 bytes): Machine-readable map.
