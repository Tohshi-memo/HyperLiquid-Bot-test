...
- `data/processed/ai_context_index.json` (72061 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47096 bytes): Compact strategy stats.
