...
- Asset price active records: `539`
- Day/swing records: `552`
- Flow-alert history records: `1798`
...
- `data/processed/ai_context_index.json` (35199 bytes): Machine-readable map.
