...
- Updated: `2026-07-15T15:22:35.329483+00:00`
- Asset price active records: `672`
- Day/swing records: `6186`
- Macro indicators: `9`
...
- `data/processed/ai_context_index.json` (62121 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48207 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5728 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2269 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8998 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `2.7439` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
