...
- Asset price active records: `633`
- Day/swing records: `646`
- Macro indicators: `11`
- Flow-alert history records: `2090`
...
- `data/processed/ai_context_index.json` (52887 bytes): Machine-readable map.
