...
- Day/swing records: `935`
- Macro indicators: `11`
- Flow-alert history records: `4991`
...
- `data/processed/ai_context_index.json` (74309 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46365 bytes): Compact strategy stats.
