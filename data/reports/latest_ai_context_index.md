...
- `data/processed/ai_context_index.json` (62157 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3482 bytes): Mechanical relationship candidates.
