...
- Asset price active records: `222`
- Day/swing records: `235`
- Flow-alert history records: `810`
...
- `data/processed/ai_analysis_pack.json` (35538 bytes): Compact strategy stats.
