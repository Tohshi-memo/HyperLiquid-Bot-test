...
- Day/swing records: `1496`
- Macro indicators: `11`
- Flow-alert history records: `6741`
...
- `data/reports/latest_ai_context_index.md` (2252 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64744 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46945 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (4119 bytes): HIP-4 outcome market overview.
