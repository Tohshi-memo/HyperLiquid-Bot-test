...
- `data/processed/ai_context_index.json` (62590 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2817 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (9899 bytes): HIP-4 outcome market overview.
