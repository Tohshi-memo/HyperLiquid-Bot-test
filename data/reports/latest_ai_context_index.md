...
- Day/swing records: `1117`
- Macro indicators: `11`
- Flow-alert history records: `5551`
...
- `data/processed/ai_context_index.json` (66059 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46640 bytes): Compact strategy stats.
