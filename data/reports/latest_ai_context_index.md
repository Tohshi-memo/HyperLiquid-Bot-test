...
- Updated: `2026-07-15T14:52:28.307271+00:00`
- Asset price active records: `672`
- Day/swing records: `6184`
- Macro indicators: `9`
...
- `data/processed/ai_context_index.json` (62127 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2299 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (9018 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `2.7679` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
