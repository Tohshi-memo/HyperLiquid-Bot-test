...
- Asset price active records: `647`
- Day/swing records: `660`
- Macro indicators: `11`
- Flow-alert history records: `2134`
...
- `data/processed/ai_context_index.json` (56478 bytes): Machine-readable map.
