...
- Updated: `2026-05-28T18:07:25.277493+00:00`
- Asset price active records: `672`
- Day/swing records: `1937`
- Macro indicators: `11`
- Flow-alert history records: `8128`
...
- `data/processed/ai_context_index.json` (73686 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46985 bytes): Compact strategy stats.
...
- 4h_commodity_crypto_divergence: score `2.9406` - Commodity perps and crypto are moving differently; check macro-linked stress.
