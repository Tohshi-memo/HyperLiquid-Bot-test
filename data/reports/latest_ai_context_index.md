...
- Updated: `2026-05-20T16:52:33.915756+00:00`
- Asset price active records: `672`
- Day/swing records: `1186`
- Macro indicators: `11`
- Flow-alert history records: `5767`
...
- `data/processed/ai_context_index.json` (73813 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46902 bytes): Compact strategy stats.
...
- 4h_commodity_crypto_divergence: score `2.3557` - Commodity perps and crypto are moving differently; check macro-linked stress.
