...
- Asset price active records: `299`
- Day/swing records: `312`
- Flow-alert history records: `1051`
...
- `data/processed/ai_analysis_pack.json` (43107 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4691 bytes): Asset-class overview.
