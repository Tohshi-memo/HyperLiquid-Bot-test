...
- Asset price active records: `658`
- Day/swing records: `671`
- Macro indicators: `11`
- Flow-alert history records: `2168`
...
- `data/processed/ai_context_index.json` (55747 bytes): Machine-readable map.
