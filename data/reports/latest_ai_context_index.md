...
- `data/processed/ai_context_index.json` (63779 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48284 bytes): Compact strategy stats.
