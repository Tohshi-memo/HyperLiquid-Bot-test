...
- Macro indicators: `11`
- Flow-alert history records: `2570`
...
- `data/processed/ai_context_index.json` (66099 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45801 bytes): Compact strategy stats.
