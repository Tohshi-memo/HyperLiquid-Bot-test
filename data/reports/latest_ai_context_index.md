...
- `data/reports/latest_ai_context_index.md` (2655 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (65601 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2680 bytes): Current canary signals.
