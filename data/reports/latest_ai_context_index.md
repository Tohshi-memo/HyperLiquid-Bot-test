...
- Day/swing records: `826`
- Macro indicators: `11`
- Flow-alert history records: `2654`
...
- `data/processed/ai_context_index.json` (60703 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45765 bytes): Compact strategy stats.
