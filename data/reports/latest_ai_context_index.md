...
- Day/swing records: `1032`
- Macro indicators: `11`
- Flow-alert history records: `5289`
...
- `data/processed/ai_context_index.json` (64115 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46660 bytes): Compact strategy stats.
