...
- `data/reports/latest_ai_context_index.md` (2783 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (68367 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3289 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47205 bytes): Compact strategy stats.
