...
- `data/reports/latest_ai_context_index.md` (2663 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62168 bytes): Machine-readable map.
