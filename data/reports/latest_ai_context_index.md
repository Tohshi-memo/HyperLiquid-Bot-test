...
- `data/processed/ai_context_index.json` (74260 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2564 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47093 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5766 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2326 bytes): Individual asset screen.
