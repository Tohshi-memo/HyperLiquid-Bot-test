...
- `data/reports/latest_ai_context_index.md` (2347 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63417 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2528 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2070 bytes): Individual asset screen.
