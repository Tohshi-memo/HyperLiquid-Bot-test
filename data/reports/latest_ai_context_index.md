...
- Day/swing records: `1232`
- Macro indicators: `11`
- Flow-alert history records: `5910`
...
- `data/processed/ai_context_index.json` (67036 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46876 bytes): Compact strategy stats.
