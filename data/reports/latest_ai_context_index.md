...
- Asset price active records: `310`
- Day/swing records: `323`
- Flow-alert history records: `1085`
...
- `data/processed/ai_analysis_pack.json` (43701 bytes): Compact strategy stats.
