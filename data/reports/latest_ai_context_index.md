...
- `data/reports/latest_ai_context_index.md` (2523 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62064 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2684 bytes): Current canary signals.
