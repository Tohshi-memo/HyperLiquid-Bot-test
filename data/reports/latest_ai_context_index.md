...
- `data/processed/ai_context_index.json` (70804 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47217 bytes): Compact strategy stats.
