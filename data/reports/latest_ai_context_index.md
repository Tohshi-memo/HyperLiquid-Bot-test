...
- Day/swing records: `853`
- Macro indicators: `11`
- Flow-alert history records: `2739`
...
- `data/processed/ai_context_index.json` (68465 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2408 bytes): Individual asset screen.
