...
- `data/processed/ai_context_index.json` (62400 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2780 bytes): Current canary signals.
