...
- `data/processed/ai_context_index.json` (63451 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5623 bytes): Asset-class overview.
