...
- Day/swing records: `1674`
- Macro indicators: `11`
- Flow-alert history records: `7306`
...
- `data/processed/ai_context_index.json` (73716 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (6803 bytes): HIP-4 outcome market overview.
