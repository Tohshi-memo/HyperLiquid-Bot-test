...
- `data/processed/ai_context_index.json` (61759 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (10245 bytes): HIP-4 outcome market overview.
