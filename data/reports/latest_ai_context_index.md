...
- `data/reports/latest_ai_context_index.md` (2836 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64420 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2783 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48293 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5715 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2235 bytes): Individual asset screen.
