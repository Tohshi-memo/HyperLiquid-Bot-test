...
- `data/processed/ai_context_index.json` (64076 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2666 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48259 bytes): Compact strategy stats.
