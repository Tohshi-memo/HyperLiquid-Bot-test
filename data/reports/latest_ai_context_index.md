...
- Macro indicators: `11`
- Flow-alert history records: `2569`
...
- `data/processed/ai_context_index.json` (66083 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45823 bytes): Compact strategy stats.
