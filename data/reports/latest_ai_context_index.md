...
- `data/processed/ai_context_index.json` (63647 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47956 bytes): Compact strategy stats.
