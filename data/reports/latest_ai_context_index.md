...
- Day/swing records: `1755`
- Macro indicators: `11`
- Flow-alert history records: `7561`
...
- `data/processed/ai_context_index.json` (74152 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46984 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8335 bytes): HIP-4 outcome market overview.
