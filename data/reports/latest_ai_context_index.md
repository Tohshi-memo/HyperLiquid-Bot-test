...
- Asset price active records: `504`
- Day/swing records: `517`
- Flow-alert history records: `1691`
...
- `data/processed/ai_context_index.json` (35273 bytes): Machine-readable map.
