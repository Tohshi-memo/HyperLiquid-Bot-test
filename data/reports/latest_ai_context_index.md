...
- `data/reports/latest_ai_context_index.md` (2372 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61881 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2679 bytes): Current canary signals.
...
- `data/reports/latest_asset_universe.md` (5736 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2102 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (6196 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3506 bytes): Mechanical relationship candidates.
