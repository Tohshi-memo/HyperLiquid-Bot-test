...
- `data/reports/latest_ai_context_index.md` (2594 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63775 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2639 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2058 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8797 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3529 bytes): Mechanical relationship candidates.
