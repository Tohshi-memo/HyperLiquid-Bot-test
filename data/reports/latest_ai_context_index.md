...
- Day/swing records: `1734`
- Macro indicators: `11`
- Flow-alert history records: `7497`
...
- `data/processed/ai_context_index.json` (74076 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46940 bytes): Compact strategy stats.
