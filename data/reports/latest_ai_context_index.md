...
- Asset price active records: `602`
- Day/swing records: `615`
- Macro indicators: `11`
- Flow-alert history records: `1994`
...
- `data/processed/ai_context_index.json` (52849 bytes): Machine-readable map.
