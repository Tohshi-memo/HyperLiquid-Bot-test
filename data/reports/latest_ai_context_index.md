...
- `data/processed/ai_context_index.json` (71851 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47118 bytes): Compact strategy stats.
...
- `data/reports/latest_relationship_scan.md` (3633 bytes): Mechanical relationship candidates.
