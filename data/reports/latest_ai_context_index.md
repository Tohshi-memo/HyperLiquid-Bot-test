...
- Updated: `2026-07-19T19:58:42.662361+00:00`
- Asset price active records: `672`
- Day/swing records: `6584`
- Macro indicators: `4`
...
- `data/processed/ai_context_index.json` (58860 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48248 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5626 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2276 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8979 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3664 bytes): Mechanical relationship candidates.
