...
- Macro indicators: `11`
- Flow-alert history records: `4981`
...
- `data/processed/ai_context_index.json` (74053 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46361 bytes): Compact strategy stats.
