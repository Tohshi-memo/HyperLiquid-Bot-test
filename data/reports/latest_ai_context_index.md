...
- `data/processed/ai_context_index.json` (74571 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2881 bytes): Current canary signals.
