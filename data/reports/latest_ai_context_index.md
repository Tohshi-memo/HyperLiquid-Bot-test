...
- `data/processed/ai_context_index.json` (63185 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48182 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5603 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2072 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8791 bytes): HIP-4 outcome market overview.
