...
- `data/processed/ai_context_index.json` (64933 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46962 bytes): Compact strategy stats.
