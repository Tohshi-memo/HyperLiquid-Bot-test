...
- Asset price active records: `401`
- Day/swing records: `414`
- Flow-alert history records: `1371`
...
- `data/processed/ai_analysis_pack.json` (44532 bytes): Compact strategy stats.
