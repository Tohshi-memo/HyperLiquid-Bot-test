...
- `data/processed/ai_analysis_pack.json` (48217 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5718 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2298 bytes): Individual asset screen.
