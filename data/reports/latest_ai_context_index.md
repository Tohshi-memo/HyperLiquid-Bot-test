...
- Day/swing records: `866`
- Macro indicators: `11`
- Flow-alert history records: `4769`
...
- `data/processed/ai_context_index.json` (68840 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46055 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5642 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2486 bytes): Individual asset screen.
