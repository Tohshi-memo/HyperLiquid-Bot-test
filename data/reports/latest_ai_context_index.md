...
- Day/swing records: `2004`
- Macro indicators: `11`
- Flow-alert history records: `8334`
...
- `data/processed/ai_context_index.json` (73714 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46992 bytes): Compact strategy stats.
