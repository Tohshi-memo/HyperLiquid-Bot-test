...
- Asset price active records: `577`
- Day/swing records: `590`
- Flow-alert history records: `1916`
...
- `data/processed/ai_context_index.json` (36557 bytes): Machine-readable map.
