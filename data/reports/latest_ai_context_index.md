...
- Asset price active records: `631`
- Day/swing records: `644`
- Macro indicators: `11`
- Flow-alert history records: `2084`
...
- `data/processed/ai_context_index.json` (53195 bytes): Machine-readable map.
