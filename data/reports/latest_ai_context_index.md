...
- `data/processed/ai_context_index.json` (63528 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2648 bytes): Current canary signals.
