...
- Asset price active records: `355`
- Day/swing records: `368`
- Flow-alert history records: `1222`
...
- `data/processed/ai_analysis_pack.json` (43949 bytes): Compact strategy stats.
