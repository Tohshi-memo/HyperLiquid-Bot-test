...
- `data/processed/ai_context_index.json` (60554 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47968 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8848 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3559 bytes): Mechanical relationship candidates.
