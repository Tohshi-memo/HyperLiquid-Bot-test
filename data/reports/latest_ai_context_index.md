...
- Asset price active records: `318`
- Day/swing records: `331`
- Flow-alert history records: `1109`
...
- `data/processed/ai_analysis_pack.json` (43687 bytes): Compact strategy stats.
