...
- `data/processed/ai_context_index.json` (63979 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2628 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47958 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5730 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2121 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8824 bytes): HIP-4 outcome market overview.
