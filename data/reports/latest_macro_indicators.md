...
- Generated: `2026-06-04T14:18:26.455713+00:00`
- Indicators: `11`
...
- `us_pce` US Personal Income and Outlays / PCE: `None` scheduled `None` / UTC `None` (BEA, official_static)
- `us_gdp` US Gross Domestic Product: `None` scheduled `None` / UTC `None` (BEA, official_static)
...
- `us_treasury_avg_marketable_rate` US Treasury Average Total Marketable Rate: `3.373` percent at `2026-04-30` (US Treasury Fiscal Data)
- `us_treasury_avg_note_rate` US Treasury Average Treasury Notes Rate: `3.23` percent at `2026-04-30` (US Treasury Fiscal Data)
