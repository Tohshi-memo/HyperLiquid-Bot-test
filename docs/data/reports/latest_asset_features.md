...
- `@465` unknown price `179.37` 4h `-15.063` vol `0.0` relationship `market_context_high->@465_24h`
...
- `@198` unknown price `0.08007` 4h `-62.2478` vol `0.0` relationship `risk_on_high->@198_24h`
...
- `#2170` unknown price `0.043875` 4h `56.6964` vol `0.0` relationship `risk_on_high->#2170_24h`
