...
- `@465` unknown price `179.02` 4h `-15.2287` vol `0.0` relationship `market_context_high->@465_24h`
...
- `#1990` unknown price `0.03407` 4h `53.6761` vol `0.0` relationship `risk_on_high->#1990_4h`
- `@198` unknown price `0.080445` 4h `-62.071` vol `0.0` relationship `risk_on_high->@198_24h`
