...
- `#5220` unknown price `0.83361` 4h `-0.024` vol `0.0` relationship `market_context_high->#5220_4h`
...
- `#5241` unknown price `0.955585` 4h `0.267` vol `0.0` relationship `market_context_high->#5241_4h`
...
- `xyz:BIRD` equity price `5.09045` 4h `-0.5014` vol `342309.85` relationship `market_context_high->xyz:BIRD_4h`
