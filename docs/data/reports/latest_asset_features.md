...
- `@242` unknown price `0.047571` 4h `0.8629` vol `0.0` relationship `news_risk_high->@242_24h`
- `@132` unknown price `0.002029` 4h `1.197` vol `0.0` relationship `news_risk_high->@132_24h`
