...
- Draw [Yes] symbol `#4590` underlying `n/a` prob `0.9981` price_source `allMids` vol24h `0.0` oi `0.0`
- Belgium [No] symbol `#4541` underlying `n/a` prob `0.998` price_source `allMids` vol24h `0.0` oi `0.0`
