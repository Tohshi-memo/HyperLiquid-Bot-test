...
- template:binaryPrice [template:Yes] symbol `#56950` underlying `n/a` prob `0.9749` price_source `allMids` vol24h `0.0` oi `0.0`
...
- template:priceTouch [template:Yes] symbol `#12090` underlying `n/a` prob `0.328` price_source `allMids` vol24h `0.0` oi `0.0`
- template:priceTouch [template:No] symbol `#12091` underlying `n/a` prob `0.672` price_source `allMids` vol24h `0.0` oi `0.0`
