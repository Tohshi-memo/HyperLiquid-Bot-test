...
- Spain [No] symbol `#2941` underlying `n/a` prob `0.9998` price_source `allMids` vol24h `0.0` oi `0.0`
- Draw [Yes] symbol `#2950` underlying `n/a` prob `0.9997` price_source `allMids` vol24h `0.0` oi `0.0`
