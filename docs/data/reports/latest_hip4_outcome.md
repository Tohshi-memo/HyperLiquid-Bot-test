...
- Draw [No] symbol `#3151` underlying `n/a` prob `0.9986` price_source `allMids` vol24h `0.0` oi `0.0`
...
- Sweden [Yes] symbol `#3140` underlying `n/a` prob `0.9985` price_source `allMids` vol24h `0.0` oi `0.0`
