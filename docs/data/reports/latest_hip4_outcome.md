...
- Egypt [Yes] symbol `#4640` underlying `n/a` prob `0.999` price_source `allMids` vol24h `0.0` oi `0.0`
...
- New Zealand [No] symbol `#4621` underlying `n/a` prob `0.998` price_source `allMids` vol24h `0.0` oi `0.0`
