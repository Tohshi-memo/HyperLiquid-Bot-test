...
- template:sportsTournamentParticipant [Yes] symbol `#49180` underlying `n/a` prob `0.994` price_source `allMids` vol24h `0.0` oi `0.0`
...
- template:priceTouch [template:Yes] symbol `#12090` underlying `n/a` prob `0.2746` price_source `allMids` vol24h `0.0` oi `0.0`
- template:priceTouch [template:No] symbol `#12091` underlying `n/a` prob `0.7254` price_source `allMids` vol24h `0.0` oi `0.0`
