...
- template:sportsContestParticipant2 [No] symbol `#44731` underlying `n/a` prob `0.9977` price_source `allMids` vol24h `0.0` oi `0.0`
...
- template:binaryPrice [template:Yes] symbol `#33260` underlying `n/a` prob `0.9833` price_source `allMids` vol24h `0.0` oi `0.0`
...
- template:priceTouch [template:Yes] symbol `#12090` underlying `n/a` prob `0.2757` price_source `allMids` vol24h `0.0` oi `0.0`
- template:priceTouch [template:No] symbol `#12091` underlying `n/a` prob `0.7243` price_source `allMids` vol24h `0.0` oi `0.0`
