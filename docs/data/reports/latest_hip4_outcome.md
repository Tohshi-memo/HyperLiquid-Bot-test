...
- template:policyRateDecrease [No] symbol `#36011` underlying `n/a` prob `0.9942` price_source `allMids` vol24h `0.0` oi `0.0`
...
- template:binaryPrice [template:Yes] symbol `#33260` underlying `n/a` prob `0.9849` price_source `allMids` vol24h `0.0` oi `0.0`
