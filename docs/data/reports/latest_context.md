...
- crypto: articles `41`, risk hits `5`, risk headline rate `0.122`, policy hits `1`
- macro: articles `26`, risk hits `7`, risk headline rate `0.2308`, policy hits `2`
- policy: articles `2`, risk hits `0`, risk headline rate `0.0`, policy hits `1`

## Headlines

- [crypto] Latest Congressional swing at crypto tax reform would direct IRS to review de minimis exemptions (CoinDesk: Bitcoin, Ethereum, Crypto News and Price Data)
- [crypto] Fairshake PAC’s $20M backing pays off in three US state primaries (Cointelegraph.com News)
