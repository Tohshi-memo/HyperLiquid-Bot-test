...
- Day/swing records: `5646`
- Day/swing latest: `2026-07-09T21:45:00+00:00`

## News Categories

- commodity: articles `4`, risk hits `3`, risk headline rate `0.5`, policy hits `0`
- crypto: articles `33`, risk hits `10`, risk headline rate `0.2424`, policy hits `1`
- macro: articles `18`, risk hits `5`, risk headline rate `0.2778`, policy hits `3`
...
- [macro] Tehran launches more strikes after explosions reported in southern Iran (BBC News)
- [macro] Palestinians mourn Gaza World Cup screenings organiser killed in Israeli strike (BBC News)
- [macro] Ukrainian agent accused of murdering Monaco bomb suspect changes story (BBC News)
- [crypto] Grayscale's CFO exits after 7 years with crypto asset manager (CoinDesk: Bitcoin, Ethereum, Crypto News and Price Data)
