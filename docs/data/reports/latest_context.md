...
- Day/swing latest: `2026-05-26T18:45:00+00:00`

## News Categories

- commodity: articles `4`, risk hits `4`, risk headline rate `0.75`, policy hits `0`
- crypto: articles `38`, risk hits `9`, risk headline rate `0.2368`, policy hits `8`
...
- [macro] South African president mounts legal challenge against report that could lead to impeachment (BBC News)
- [macro] Analyst Report: Alibaba Group Holding Ltd (Yahoo Finance)
- [macro] Analyst Report: AutoNation Inc (Yahoo Finance)
