...
- macro: articles `35`, risk hits `5`, risk headline rate `0.1429`, policy hits `3`
...
- [macro] Nium Partners With Circle (CRCL) to Enable USDC-Based Global Settlement Network (Yahoo Finance)
- [macro] PayPay (PAYP), T&D Holdings Form AI-Driven Insurance and Fintech Alliance (Yahoo Finance)
- [macro] IREN Secures $3.65B GPU Financing Facility for Microsoft AI Cloud Expansion (Yahoo Finance)
