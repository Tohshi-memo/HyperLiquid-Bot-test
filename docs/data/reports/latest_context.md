...
- Day/swing records: `6919`
- Day/swing latest: `2026-07-23T10:45:00+00:00`

## News Categories

- commodity: articles `2`, risk hits `2`, risk headline rate `1.0`, policy hits `0`
- crypto: articles `22`, risk hits `7`, risk headline rate `0.2727`, policy hits `2`
...
- [macro] VAT cut to be applied to Manx electricity bills (BBC News)
- [macro] Why are UK fuel prices rising again? (BBC News)
- [crypto] Crypto catches its breath as bitcoin settles into a holding pattern amid July rally (CoinDesk: Bitcoin, Ethereum, Crypto News and Price Data)
...
- [crypto] Bitcoin may have bottomed before its traditional cycle low: Grayscale’s Pandl (Cointelegraph.com News)
