...
- crypto: articles `31`, risk hits `5`, risk headline rate `0.129`, policy hits `2`
...
- [crypto] Coinbase bulls point to crypto legislation and stablecoins after earnings miss (CoinDesk: Bitcoin, Ethereum, Crypto News and Price Data)
- [macro] Russia and Ukraine accuse each other of breaching Victory Day ceasefire (BBC News)
- [crypto] Stablecoins won’t strengthen global role of euro, ECB’s Lagarde says (Cointelegraph.com News)
