...
- `data/reports/latest_ai_context_index.md` (2695 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64235 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2753 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47941 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5776 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2106 bytes): Individual asset screen.
