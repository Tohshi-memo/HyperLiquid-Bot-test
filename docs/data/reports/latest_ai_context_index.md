...
- Day/swing records: `1001`
- Macro indicators: `11`
- Flow-alert history records: `5191`
...
- `data/processed/ai_context_index.json` (67412 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46656 bytes): Compact strategy stats.
