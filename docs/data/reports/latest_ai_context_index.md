...
- `data/processed/ai_context_index.json` (70932 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47057 bytes): Compact strategy stats.
