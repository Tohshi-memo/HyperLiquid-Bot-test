...
- `data/processed/ai_context_index.json` (64291 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2748 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47951 bytes): Compact strategy stats.
