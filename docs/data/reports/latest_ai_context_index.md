...
- `data/processed/ai_context_index.json` (60547 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3552 bytes): Mechanical relationship candidates.
