...
- Day/swing records: `1510`
- Macro indicators: `11`
- Flow-alert history records: `6785`
...
- `data/processed/ai_context_index.json` (65797 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46954 bytes): Compact strategy stats.
