...
- `data/reports/latest_ai_context_index.md` (2451 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (60876 bytes): Machine-readable map.
