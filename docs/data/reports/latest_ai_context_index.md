...
- Day/swing records: `942`
- Macro indicators: `11`
- Flow-alert history records: `5012`
...
- `data/processed/ai_context_index.json` (73090 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46335 bytes): Compact strategy stats.
