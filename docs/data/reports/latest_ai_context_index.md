...
- `data/reports/latest_ai_context_index.md` (2329 bytes): Human-readable map.
...
- `data/processed/ai_analysis_pack.json` (48201 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5649 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2064 bytes): Individual asset screen.
