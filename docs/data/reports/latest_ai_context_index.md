...
- `data/processed/ai_context_index.json` (61716 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8859 bytes): HIP-4 outcome market overview.
