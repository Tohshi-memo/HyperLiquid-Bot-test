...
- Asset price active records: `558`
- Day/swing records: `571`
- Flow-alert history records: `1857`
...
- `data/processed/ai_context_index.json` (35932 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45745 bytes): Compact strategy stats.
