...
- Flow-alert history records: `1195`
...
- `data/processed/ai_context_index.json` (14624 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43714 bytes): Compact strategy stats.
