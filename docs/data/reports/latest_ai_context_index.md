...
- `data/processed/ai_context_index.json` (61308 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (49362 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (10301 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3544 bytes): Mechanical relationship candidates.
