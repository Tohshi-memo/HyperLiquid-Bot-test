...
- `data/processed/ai_context_index.json` (61912 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3288 bytes): Current canary signals.
