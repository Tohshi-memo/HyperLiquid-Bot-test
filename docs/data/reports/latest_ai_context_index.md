...
- Day/swing records: `1591`
- Macro indicators: `11`
- Flow-alert history records: `7042`
...
- `data/reports/latest_ai_context_index.md` (2249 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (69291 bytes): Machine-readable map.
