...
- Day/swing records: `713`
- Macro indicators: `11`
- Flow-alert history records: `2299`
...
- `data/processed/ai_context_index.json` (60695 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45720 bytes): Compact strategy stats.
