...
- Day/swing records: `1082`
- Macro indicators: `11`
- Flow-alert history records: `5443`
...
- `data/processed/ai_context_index.json` (70801 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46673 bytes): Compact strategy stats.
