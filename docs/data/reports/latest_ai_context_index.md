...
- Asset price active records: `495`
- Day/swing records: `508`
- Flow-alert history records: `1663`
...
- `data/processed/ai_context_index.json` (35276 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45684 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5639 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2054 bytes): Individual asset screen.
