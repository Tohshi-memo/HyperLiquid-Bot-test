...
- Asset price active records: `276`
- Day/swing records: `289`
- Flow-alert history records: `977`
...
- `data/processed/ai_analysis_pack.json` (42803 bytes): Compact strategy stats.
