...
- `data/processed/ai_context_index.json` (60692 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8786 bytes): HIP-4 outcome market overview.
