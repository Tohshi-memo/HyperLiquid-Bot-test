...
- `data/processed/ai_context_index.json` (63471 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47705 bytes): Compact strategy stats.
