...
- `data/processed/ai_context_index.json` (62502 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2366 bytes): Individual asset screen.
