...
- `data/processed/ai_context_index.json` (74351 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2615 bytes): Current canary signals.
