...
- `data/processed/ai_analysis_pack.json` (48180 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5618 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2077 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8798 bytes): HIP-4 outcome market overview.
