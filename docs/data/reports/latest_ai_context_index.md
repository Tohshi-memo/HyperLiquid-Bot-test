...
- `data/reports/latest_ai_context_index.md` (2501 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (74357 bytes): Machine-readable map.
