...
- `data/reports/latest_ai_context_index.md` (2648 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62270 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2812 bytes): Current canary signals.
