...
- Macro indicators: `11`
- Flow-alert history records: `4826`
...
- `data/processed/ai_context_index.json` (72598 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46303 bytes): Compact strategy stats.
