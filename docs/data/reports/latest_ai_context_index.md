...
- Asset price active records: `211`
- Day/swing records: `224`
- Flow-alert history records: `776`
...
- `data/processed/ai_analysis_pack.json` (34959 bytes): Compact strategy stats.
