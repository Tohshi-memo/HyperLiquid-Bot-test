...
- `data/reports/latest_canary_signals.md` (2567 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (49860 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (10438 bytes): HIP-4 outcome market overview.
