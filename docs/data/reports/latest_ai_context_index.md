...
- `data/processed/ai_context_index.json` (63726 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5561 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2118 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8811 bytes): HIP-4 outcome market overview.
