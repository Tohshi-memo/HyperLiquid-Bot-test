...
- `data/processed/ai_context_index.json` (64342 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2397 bytes): Individual asset screen.
