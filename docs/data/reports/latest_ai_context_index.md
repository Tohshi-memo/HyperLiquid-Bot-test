...
- Updated: `2026-07-29T21:52:25.770238+00:00`
- Asset price active records: `672`
- Day/swing records: `7528`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (61439 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48254 bytes): Compact strategy stats.
...
- 4h_crypto_equity_divergence: score `1.8503` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
