...
- Day/swing records: `973`
- Macro indicators: `11`
- Flow-alert history records: `5107`
...
- `data/processed/ai_context_index.json` (71737 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46636 bytes): Compact strategy stats.
