...
- Asset price active records: `151`
- Day/swing records: `164`
- Flow-alert history records: `585`
...
- `data/processed/ai_context_index.json` (13378 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (33604 bytes): Compact strategy stats.
