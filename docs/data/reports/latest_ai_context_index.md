...
- Day/swing records: `1188`
- Macro indicators: `11`
- Flow-alert history records: `5773`
...
- `data/processed/ai_context_index.json` (73869 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46889 bytes): Compact strategy stats.
