...
- Macro indicators: `11`
- Flow-alert history records: `4943`
...
- `data/processed/ai_context_index.json` (69623 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46328 bytes): Compact strategy stats.
