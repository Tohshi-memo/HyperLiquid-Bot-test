...
- `data/processed/ai_context_index.json` (60515 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8853 bytes): HIP-4 outcome market overview.
