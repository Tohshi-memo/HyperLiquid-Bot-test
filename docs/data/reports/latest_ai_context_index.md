...
- `data/reports/latest_ai_context_index.md` (2513 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (69051 bytes): Machine-readable map.
