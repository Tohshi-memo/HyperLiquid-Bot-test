...
- `data/processed/ai_context_index.json` (62052 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48263 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9138 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3662 bytes): Mechanical relationship candidates.
