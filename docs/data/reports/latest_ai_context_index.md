...
- `data/processed/ai_context_index.json` (63422 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5649 bytes): Asset-class overview.
