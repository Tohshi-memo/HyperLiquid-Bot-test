...
- `data/processed/ai_analysis_pack.json` (49338 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5600 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2182 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10389 bytes): HIP-4 outcome market overview.
