...
- `data/processed/ai_context_index.json` (62745 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2689 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (50425 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (10407 bytes): HIP-4 outcome market overview.
