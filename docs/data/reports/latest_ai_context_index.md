...
- Day/swing records: `793`
- Macro indicators: `11`
- Flow-alert history records: `2552`
...
- `data/processed/ai_context_index.json` (68223 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45784 bytes): Compact strategy stats.
