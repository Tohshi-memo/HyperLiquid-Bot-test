...
- Asset price active records: `265`
- Day/swing records: `278`
- Flow-alert history records: `943`
...
- `data/processed/ai_analysis_pack.json` (42589 bytes): Compact strategy stats.
