...
- `data/processed/ai_context_index.json` (63583 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48014 bytes): Compact strategy stats.
