...
- Day/swing records: `1182`
- Macro indicators: `11`
- Flow-alert history records: `5754`
...
- `data/processed/ai_context_index.json` (73851 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46871 bytes): Compact strategy stats.
