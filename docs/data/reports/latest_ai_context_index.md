...
- `data/processed/ai_context_index.json` (63559 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2447 bytes): Current canary signals.
