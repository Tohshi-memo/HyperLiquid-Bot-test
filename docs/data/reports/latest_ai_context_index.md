...
- Day/swing records: `1787`
- Macro indicators: `11`
- Flow-alert history records: `7664`
...
- `data/processed/ai_context_index.json` (65212 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47014 bytes): Compact strategy stats.
