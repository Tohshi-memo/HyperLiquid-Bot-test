...
- `data/processed/ai_context_index.json` (65244 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8899 bytes): HIP-4 outcome market overview.
