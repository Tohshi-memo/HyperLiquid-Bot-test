...
- Asset price active records: `641`
- Day/swing records: `654`
- Macro indicators: `11`
- Flow-alert history records: `2116`
...
- `data/processed/ai_context_index.json` (54285 bytes): Machine-readable map.
