...
- Macro indicators: `11`
- Flow-alert history records: `5748`
...
- `data/processed/ai_context_index.json` (73761 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46885 bytes): Compact strategy stats.
