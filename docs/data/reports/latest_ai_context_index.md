...
- `data/processed/ai_context_index.json` (63574 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47672 bytes): Compact strategy stats.
