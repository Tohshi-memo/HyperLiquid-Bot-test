...
- `data/processed/ai_context_index.json` (63491 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47191 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8952 bytes): HIP-4 outcome market overview.
