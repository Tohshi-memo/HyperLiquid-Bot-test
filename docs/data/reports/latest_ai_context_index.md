...
- `data/processed/ai_context_index.json` (61343 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (49353 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (10420 bytes): HIP-4 outcome market overview.
