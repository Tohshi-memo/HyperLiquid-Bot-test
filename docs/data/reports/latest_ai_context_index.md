...
- `data/processed/ai_context_index.json` (68500 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46976 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9438 bytes): HIP-4 outcome market overview.
