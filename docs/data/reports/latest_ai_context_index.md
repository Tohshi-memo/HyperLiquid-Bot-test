...
- Asset price active records: `379`
- Day/swing records: `392`
- Flow-alert history records: `1304`
...
- `data/processed/ai_analysis_pack.json` (43991 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4666 bytes): Asset-class overview.
