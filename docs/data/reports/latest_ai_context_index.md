...
- `data/reports/latest_ai_context_index.md` (2736 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62410 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2758 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (10307 bytes): HIP-4 outcome market overview.
