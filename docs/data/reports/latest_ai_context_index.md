...
- `data/processed/ai_context_index.json` (65086 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2496 bytes): Current canary signals.
