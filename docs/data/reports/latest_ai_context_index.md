...
- Flow-alert history records: `452`
...
- `data/processed/ai_context_index.json` (13365 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (30452 bytes): Compact strategy stats.
