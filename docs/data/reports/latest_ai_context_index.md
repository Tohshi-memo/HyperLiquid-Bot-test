...
- `data/processed/ai_analysis_pack.json` (48177 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5597 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2108 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8806 bytes): HIP-4 outcome market overview.
