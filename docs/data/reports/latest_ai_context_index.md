...
- `data/processed/ai_context_index.json` (63532 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47198 bytes): Compact strategy stats.
