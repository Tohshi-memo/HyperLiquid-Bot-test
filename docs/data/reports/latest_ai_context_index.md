...
- Day/swing records: `1231`
- Macro indicators: `11`
- Flow-alert history records: `5907`
...
- `data/processed/ai_context_index.json` (67085 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46904 bytes): Compact strategy stats.
