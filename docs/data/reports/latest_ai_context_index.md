...
- `data/processed/ai_context_index.json` (73218 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47024 bytes): Compact strategy stats.
