...
- Macro indicators: `11`
- Flow-alert history records: `2498`
...
- `data/processed/ai_context_index.json` (67167 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45773 bytes): Compact strategy stats.
