...
- `data/processed/ai_context_index.json` (61322 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3500 bytes): Mechanical relationship candidates.
