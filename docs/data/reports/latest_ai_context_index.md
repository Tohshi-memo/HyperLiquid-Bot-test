...
- `data/processed/ai_context_index.json` (61802 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5629 bytes): Asset-class overview.
