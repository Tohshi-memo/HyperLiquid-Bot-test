...
- Updated: `2026-05-19T18:07:16.104436+00:00`
- Asset price active records: `672`
- Day/swing records: `1096`
- Macro indicators: `11`
- Flow-alert history records: `5486`
...
- `data/processed/ai_context_index.json` (73806 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46632 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5785 bytes): Asset-class overview.
...
- 4h_crypto_equity_divergence: score `-2.0325` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
