...
- Macro indicators: `11`
- Flow-alert history records: `4962`
...
- `data/processed/ai_context_index.json` (71661 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46347 bytes): Compact strategy stats.
