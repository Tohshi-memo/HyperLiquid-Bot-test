...
- Updated: `2026-06-15T03:07:29.424784+00:00`
...
- `data/processed/ai_context_index.json` (63520 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47955 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5758 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2104 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8837 bytes): HIP-4 outcome market overview.
...
- polymarket_volume_spike: score `3.96` - Polymarket crypto volume is unusually high.
