...
- Day/swing records: `1733`
- Macro indicators: `11`
- Flow-alert history records: `7494`
...
- `data/processed/ai_context_index.json` (73900 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46949 bytes): Compact strategy stats.
