...
- Day/swing records: `1754`
- Macro indicators: `11`
- Flow-alert history records: `7558`
...
- `data/processed/ai_context_index.json` (74136 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46982 bytes): Compact strategy stats.
