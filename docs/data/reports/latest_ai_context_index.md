...
- Asset price active records: `210`
- Day/swing records: `223`
- Flow-alert history records: `773`
...
- `data/processed/ai_context_index.json` (14679 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (34951 bytes): Compact strategy stats.
