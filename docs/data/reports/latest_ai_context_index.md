...
- `data/reports/latest_ai_context_index.md` (2656 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (65520 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2692 bytes): Current canary signals.
