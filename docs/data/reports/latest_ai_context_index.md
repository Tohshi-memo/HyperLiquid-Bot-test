...
- `data/processed/ai_analysis_pack.json` (47989 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5694 bytes): Asset-class overview.
