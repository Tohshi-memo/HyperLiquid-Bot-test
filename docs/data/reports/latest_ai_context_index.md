...
- `data/reports/latest_ai_context_index.md` (2326 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61586 bytes): Machine-readable map.
