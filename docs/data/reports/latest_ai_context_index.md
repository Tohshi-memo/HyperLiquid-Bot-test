...
- Day/swing records: `805`
- Macro indicators: `11`
- Flow-alert history records: `2591`
...
- `data/processed/ai_context_index.json` (65045 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45812 bytes): Compact strategy stats.
