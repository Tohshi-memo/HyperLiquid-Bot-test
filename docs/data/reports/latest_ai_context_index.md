...
- Day/swing records: `1064`
- Macro indicators: `11`
- Flow-alert history records: `5387`
...
- `data/processed/ai_context_index.json` (65280 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46654 bytes): Compact strategy stats.
