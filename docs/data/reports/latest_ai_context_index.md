...
- `data/processed/ai_context_index.json` (68671 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2561 bytes): Current canary signals.
