...
- `data/reports/latest_canary_signals.md` (2380 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48179 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5637 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2068 bytes): Individual asset screen.
