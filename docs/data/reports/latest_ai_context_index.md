...
- `data/reports/latest_ai_context_index.md` (2715 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64007 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2770 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (8797 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3530 bytes): Mechanical relationship candidates.
