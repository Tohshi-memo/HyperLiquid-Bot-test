...
- `data/reports/latest_ai_context_index.md` (2761 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62643 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2910 bytes): Current canary signals.
