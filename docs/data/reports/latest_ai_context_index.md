...
- `data/processed/ai_analysis_pack.json` (47665 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8941 bytes): HIP-4 outcome market overview.
