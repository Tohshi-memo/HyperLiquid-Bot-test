...
- `data/processed/ai_context_index.json` (61125 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (49348 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5663 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2186 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10401 bytes): HIP-4 outcome market overview.
