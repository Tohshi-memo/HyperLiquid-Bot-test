...
- `data/processed/ai_context_index.json` (63483 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5778 bytes): Asset-class overview.
