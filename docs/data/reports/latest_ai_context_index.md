...
- Macro indicators: `11`
- Flow-alert history records: `4800`
...
- `data/processed/ai_context_index.json` (71784 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2399 bytes): Individual asset screen.
