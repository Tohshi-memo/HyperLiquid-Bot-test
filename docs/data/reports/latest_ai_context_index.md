...
- `data/processed/ai_context_index.json` (65252 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2654 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (8862 bytes): HIP-4 outcome market overview.
