...
- Asset price active records: `218`
- Day/swing records: `231`
- Flow-alert history records: `798`
...
- `data/processed/ai_context_index.json` (14680 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (35533 bytes): Compact strategy stats.
