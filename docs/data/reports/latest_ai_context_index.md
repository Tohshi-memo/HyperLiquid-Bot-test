...
- `data/processed/ai_context_index.json` (65657 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47103 bytes): Compact strategy stats.
