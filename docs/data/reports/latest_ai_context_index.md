...
- `data/reports/latest_asset_universe.md` (5670 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2090 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8757 bytes): HIP-4 outcome market overview.
