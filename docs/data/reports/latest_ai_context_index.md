...
- Updated: `2026-07-28T16:07:33.100412+00:00`
- Asset price active records: `672`
- Day/swing records: `7411`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (64877 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48226 bytes): Compact strategy stats.
...
- 4h_crypto_equity_divergence: score `1.695` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
