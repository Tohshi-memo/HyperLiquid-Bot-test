...
- `data/reports/latest_ai_context_index.md` (2907 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (71727 bytes): Machine-readable map.
