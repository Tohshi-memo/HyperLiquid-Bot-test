...
- `data/processed/ai_context_index.json` (61552 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2373 bytes): Individual asset screen.
