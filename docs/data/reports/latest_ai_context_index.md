...
- Asset price active records: `619`
- Day/swing records: `632`
- Macro indicators: `11`
- Flow-alert history records: `2046`
...
- `data/processed/ai_context_index.json` (52843 bytes): Machine-readable map.
