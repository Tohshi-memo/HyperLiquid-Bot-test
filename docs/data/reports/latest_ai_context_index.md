...
- Day/swing records: `906`
- Macro indicators: `11`
- Flow-alert history records: `4899`
...
- `data/processed/ai_context_index.json` (73720 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46332 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (4122 bytes): HIP-4 outcome market overview.
