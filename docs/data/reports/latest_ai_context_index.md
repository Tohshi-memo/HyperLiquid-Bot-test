...
- Day/swing records: `869`
- Macro indicators: `11`
- Flow-alert history records: `4778`
...
- `data/reports/latest_ai_context_index.md` (2283 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (67413 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46049 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5648 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2402 bytes): Individual asset screen.
