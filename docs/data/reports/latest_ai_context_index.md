...
- Macro indicators: `11`
- Flow-alert history records: `4762`
...
- `data/processed/ai_context_index.json` (68854 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2824 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2485 bytes): Individual asset screen.
