...
- Macro indicators: `11`
- Flow-alert history records: `5635`
...
- `data/processed/ai_context_index.json` (70300 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46611 bytes): Compact strategy stats.
