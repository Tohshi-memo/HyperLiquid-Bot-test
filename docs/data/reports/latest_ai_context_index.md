...
- `data/processed/ai_analysis_pack.json` (48143 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8870 bytes): HIP-4 outcome market overview.
