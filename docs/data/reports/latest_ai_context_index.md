...
- `data/processed/ai_context_index.json` (61485 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3499 bytes): Mechanical relationship candidates.
