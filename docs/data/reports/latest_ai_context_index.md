...
- Asset price active records: `420`
- Day/swing records: `433`
- Flow-alert history records: `1431`
...
- `data/processed/ai_context_index.json` (14641 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45073 bytes): Compact strategy stats.
