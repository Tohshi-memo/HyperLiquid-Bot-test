...
- Asset price active records: `470`
- Day/swing records: `483`
- Flow-alert history records: `1584`
- Correlation status: `ready`
- Asset price archives: `none yet`

## First Read Files

- `data/reports/latest_ai_context_index.md` (2101 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (36148 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2734 bytes): Current canary signals.
