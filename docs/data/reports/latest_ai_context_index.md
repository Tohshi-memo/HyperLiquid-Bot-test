...
- `data/reports/latest_ai_context_index.md` (3038 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (73070 bytes): Machine-readable map.
