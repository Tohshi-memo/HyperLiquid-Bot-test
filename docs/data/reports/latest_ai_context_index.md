...
- Asset price active records: `343`
- Day/swing records: `356`
- Flow-alert history records: `1185`
...
- `data/processed/ai_context_index.json` (14652 bytes): Machine-readable map.
