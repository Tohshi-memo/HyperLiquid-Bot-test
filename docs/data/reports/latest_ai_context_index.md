...
- `data/reports/latest_ai_context_index.md` (2324 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62682 bytes): Machine-readable map.
