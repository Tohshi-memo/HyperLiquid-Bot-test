...
- Day/swing records: `902`
- Macro indicators: `11`
- Flow-alert history records: `4887`
...
- `data/processed/ai_context_index.json` (73792 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46325 bytes): Compact strategy stats.
