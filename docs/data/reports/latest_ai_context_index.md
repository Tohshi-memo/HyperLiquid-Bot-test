...
- Day/swing records: `1508`
- Macro indicators: `11`
- Flow-alert history records: `6779`
...
- `data/processed/ai_context_index.json` (65814 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46935 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (4128 bytes): HIP-4 outcome market overview.
