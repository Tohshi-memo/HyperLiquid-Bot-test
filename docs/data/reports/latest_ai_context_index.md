...
- `data/processed/ai_context_index.json` (74045 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47208 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9246 bytes): HIP-4 outcome market overview.
