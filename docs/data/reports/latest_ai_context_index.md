...
- `data/reports/latest_ai_context_index.md` (2403 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61510 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (49356 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (10390 bytes): HIP-4 outcome market overview.
