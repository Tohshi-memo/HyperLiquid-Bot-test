...
- Day/swing records: `1644`
- Macro indicators: `11`
- Flow-alert history records: `7212`
...
- `data/processed/ai_context_index.json` (73630 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (6794 bytes): HIP-4 outcome market overview.
