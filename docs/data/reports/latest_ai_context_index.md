...
- Day/swing records: `1059`
- Macro indicators: `11`
- Flow-alert history records: `5372`
...
- `data/processed/ai_context_index.json` (65287 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5805 bytes): Asset-class overview.
