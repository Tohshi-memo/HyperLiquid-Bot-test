...
- Updated: `2026-06-24T21:07:46.921207+00:00`
- Asset price active records: `672`
- Day/swing records: `4232`
- Macro indicators: `11`
...
- `data/reports/latest_ai_context_index.md` (2361 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63677 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8805 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_metal_divergence: score `1.7632` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
