...
- `data/processed/ai_context_index.json` (63389 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5784 bytes): Asset-class overview.
