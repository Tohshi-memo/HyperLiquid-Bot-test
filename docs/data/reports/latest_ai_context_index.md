...
- Macro indicators: `11`
- Flow-alert history records: `5557`
...
- `data/processed/ai_context_index.json` (66062 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46628 bytes): Compact strategy stats.
