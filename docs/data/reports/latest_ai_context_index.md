...
- `data/reports/latest_ai_context_index.md` (2892 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62692 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2769 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (10169 bytes): HIP-4 outcome market overview.
