...
- Day/swing records: `1068`
- Macro indicators: `11`
- Flow-alert history records: `5399`
...
- `data/processed/ai_context_index.json` (67499 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5796 bytes): Asset-class overview.
