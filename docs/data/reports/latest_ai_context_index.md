...
- Macro indicators: `11`
- Flow-alert history records: `2546`
...
- `data/processed/ai_context_index.json` (67147 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45776 bytes): Compact strategy stats.
