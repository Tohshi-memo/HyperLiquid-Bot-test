...
- Updated: `2026-05-17T21:22:15.541785+00:00`
- Asset price active records: `672`
- Day/swing records: `917`
- Macro indicators: `11`
- Flow-alert history records: `4934`
...
- `data/processed/ai_context_index.json` (69583 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46310 bytes): Compact strategy stats.
...
- 4h_crypto_metal_divergence: score `1.5971` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
