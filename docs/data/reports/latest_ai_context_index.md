...
- `data/processed/ai_context_index.json` (61764 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (9106 bytes): HIP-4 outcome market overview.
