...
- Asset price active records: `437`
- Day/swing records: `450`
- Flow-alert history records: `1481`
...
- `data/processed/ai_analysis_pack.json` (45634 bytes): Compact strategy stats.
