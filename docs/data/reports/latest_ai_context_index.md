...
- Day/swing records: `1223`
- Macro indicators: `11`
- Flow-alert history records: `5883`
...
- `data/processed/ai_context_index.json` (65996 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46884 bytes): Compact strategy stats.
