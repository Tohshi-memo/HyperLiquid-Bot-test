...
- Updated: `2026-06-05T20:52:24.607427+00:00`
- Asset price active records: `672`
- Day/swing records: `2708`
- Macro indicators: `11`
...
- `data/reports/latest_ai_context_index.md` (2675 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (68184 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2253 bytes): Individual asset screen.
...
- 1h_crypto_equity_divergence: score `1.7612` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
