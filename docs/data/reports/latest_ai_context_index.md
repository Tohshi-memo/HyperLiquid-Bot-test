...
- Asset price active records: `636`
- Day/swing records: `649`
- Macro indicators: `11`
- Flow-alert history records: `2100`
...
- `data/processed/ai_context_index.json` (52908 bytes): Machine-readable map.
