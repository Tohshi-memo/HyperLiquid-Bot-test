...
- `data/processed/ai_context_index.json` (63552 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48000 bytes): Compact strategy stats.
