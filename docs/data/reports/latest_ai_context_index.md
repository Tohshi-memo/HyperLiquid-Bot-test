...
- Day/swing records: `852`
- Macro indicators: `11`
- Flow-alert history records: `2736`
...
- `data/processed/ai_context_index.json` (68473 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2407 bytes): Individual asset screen.
