...
- `data/reports/latest_ai_context_index.md` (3114 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (75262 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2879 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47028 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9483 bytes): HIP-4 outcome market overview.
