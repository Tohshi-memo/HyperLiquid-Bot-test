...
- Day/swing records: `1097`
- Macro indicators: `11`
- Flow-alert history records: `5489`
...
- `data/processed/ai_context_index.json` (73832 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46653 bytes): Compact strategy stats.
