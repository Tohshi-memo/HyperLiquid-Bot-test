...
- Asset price active records: `356`
- Day/swing records: `369`
- Flow-alert history records: `1225`
...
- `data/processed/ai_analysis_pack.json` (43956 bytes): Compact strategy stats.
