...
- `data/reports/latest_ai_context_index.md` (2756 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (74740 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47047 bytes): Compact strategy stats.
