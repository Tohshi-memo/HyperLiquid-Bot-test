...
- Day/swing records: `1000`
- Macro indicators: `11`
- Flow-alert history records: `5188`
...
- `data/processed/ai_context_index.json` (67403 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2389 bytes): Individual asset screen.
