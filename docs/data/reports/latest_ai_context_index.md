...
- `data/reports/latest_canary_signals.md` (2650 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48154 bytes): Compact strategy stats.
