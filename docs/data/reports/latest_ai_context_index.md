...
- `data/processed/ai_context_index.json` (71815 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47089 bytes): Compact strategy stats.
