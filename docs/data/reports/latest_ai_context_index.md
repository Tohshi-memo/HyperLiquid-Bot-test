...
- `data/reports/latest_ai_context_index.md` (2723 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64261 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2644 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48282 bytes): Compact strategy stats.
