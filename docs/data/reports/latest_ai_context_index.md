...
- Asset price active records: `363`
- Day/swing records: `376`
- Flow-alert history records: `1247`
...
- `data/processed/ai_analysis_pack.json` (43962 bytes): Compact strategy stats.
