...
- Day/swing records: `1061`
- Macro indicators: `11`
- Flow-alert history records: `5378`
...
- `data/processed/ai_context_index.json` (65269 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5809 bytes): Asset-class overview.
