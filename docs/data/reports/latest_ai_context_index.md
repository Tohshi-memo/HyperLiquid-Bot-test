...
- `data/processed/ai_context_index.json` (60331 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8814 bytes): HIP-4 outcome market overview.
