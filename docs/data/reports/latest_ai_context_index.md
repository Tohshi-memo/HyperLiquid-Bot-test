...
- `data/processed/ai_context_index.json` (63505 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47178 bytes): Compact strategy stats.
