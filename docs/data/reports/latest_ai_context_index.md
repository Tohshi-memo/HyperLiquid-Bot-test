...
- Asset price active records: `313`
- Day/swing records: `326`
- Flow-alert history records: `1094`
...
- `data/processed/ai_analysis_pack.json` (43690 bytes): Compact strategy stats.
