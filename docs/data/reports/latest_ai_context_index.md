...
- `data/processed/ai_context_index.json` (64145 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2391 bytes): Individual asset screen.
