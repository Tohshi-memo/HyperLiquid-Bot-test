...
- Updated: `2026-05-20T17:37:26.691484+00:00`
- Asset price active records: `672`
- Day/swing records: `1189`
- Macro indicators: `11`
- Flow-alert history records: `5776`
...
- `data/processed/ai_context_index.json` (73849 bytes): Machine-readable map.
...
- 4h_commodity_crypto_divergence: score `3.439` - Commodity perps and crypto are moving differently; check macro-linked stress.
