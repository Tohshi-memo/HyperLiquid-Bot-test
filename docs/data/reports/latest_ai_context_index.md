...
- Day/swing records: `804`
- Macro indicators: `11`
- Flow-alert history records: `2588`
...
- `data/processed/ai_context_index.json` (65038 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45792 bytes): Compact strategy stats.
