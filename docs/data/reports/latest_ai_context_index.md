...
- `data/processed/ai_context_index.json` (63540 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47990 bytes): Compact strategy stats.
