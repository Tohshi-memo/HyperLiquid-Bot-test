...
- Asset price active records: `213`
- Day/swing records: `226`
- Flow-alert history records: `782`
...
- `data/processed/ai_analysis_pack.json` (34988 bytes): Compact strategy stats.
