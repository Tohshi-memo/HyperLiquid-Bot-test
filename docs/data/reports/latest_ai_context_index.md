...
- Flow-alert history records: `1031`
...
- `data/processed/ai_context_index.json` (14663 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43133 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4842 bytes): Asset-class overview.
