...
- Macro indicators: `11`
- Flow-alert history records: `2257`
...
- `data/processed/ai_context_index.json` (65202 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45712 bytes): Compact strategy stats.
