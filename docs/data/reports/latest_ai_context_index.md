...
- Updated: `2026-06-25T06:52:26.340692+00:00`
- Asset price active records: `672`
- Day/swing records: `4271`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63682 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2427 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2207 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8783 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_metal_divergence: score `1.5813` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
