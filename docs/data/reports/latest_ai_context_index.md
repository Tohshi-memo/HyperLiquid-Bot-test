...
- `data/processed/ai_context_index.json` (64534 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8871 bytes): HIP-4 outcome market overview.
