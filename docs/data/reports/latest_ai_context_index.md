...
- `data/processed/ai_context_index.json` (64101 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2394 bytes): Individual asset screen.
