...
- Day/swing records: `806`
- Macro indicators: `11`
- Flow-alert history records: `2594`
...
- `data/processed/ai_context_index.json` (48401 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45821 bytes): Compact strategy stats.
