...
- `data/processed/ai_context_index.json` (64008 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48272 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5713 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2384 bytes): Individual asset screen.
