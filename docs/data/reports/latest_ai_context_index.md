...
- Macro indicators: `11`
- Flow-alert history records: `5015`
...
- `data/processed/ai_context_index.json` (71787 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46322 bytes): Compact strategy stats.
