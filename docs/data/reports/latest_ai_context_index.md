...
- `data/reports/latest_ai_context_index.md` (2760 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62459 bytes): Machine-readable map.
