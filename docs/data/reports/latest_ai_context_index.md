...
- Updated: `2026-08-23T11:52:24.064688+00:00`
- Asset price active records: `672`
- Day/swing records: `9827`
- Macro indicators: `11`
...
- `data/reports/latest_ai_context_index.md` (2481 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61368 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48194 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (6172 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3503 bytes): Mechanical relationship candidates.
...
- 4h_crypto_metal_divergence: score `1.7293` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
