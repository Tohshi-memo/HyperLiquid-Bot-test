...
- Updated: `2026-05-21T23:37:20.132203+00:00`
- Asset price active records: `672`
- Day/swing records: `1308`
- Macro indicators: `5`
- Flow-alert history records: `6147`
...
- `data/processed/ai_context_index.json` (61172 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46916 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5769 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2289 bytes): Individual asset screen.
