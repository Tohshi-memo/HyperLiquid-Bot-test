...
- Day/swing records: `1065`
- Macro indicators: `11`
- Flow-alert history records: `5390`
...
- `data/processed/ai_context_index.json` (65272 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46676 bytes): Compact strategy stats.
