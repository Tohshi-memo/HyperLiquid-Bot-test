...
- Day/swing records: `878`
- Macro indicators: `11`
- Flow-alert history records: `4807`
...
- `data/processed/ai_context_index.json` (73977 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46317 bytes): Compact strategy stats.
