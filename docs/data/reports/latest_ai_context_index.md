...
- `data/processed/ai_context_index.json` (59412 bytes): Machine-readable map.
...
- `data/reports/latest_macro_indicators.md` (1623 bytes): Macro rates, employment, inflation, dollar, and risk overview.
- `data/processed/ai_analysis_pack.json` (48239 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5655 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2340 bytes): Individual asset screen.
