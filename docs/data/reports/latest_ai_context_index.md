...
- Day/swing records: `1003`
- Macro indicators: `11`
- Flow-alert history records: `5197`
...
- `data/processed/ai_context_index.json` (67372 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46669 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5774 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2392 bytes): Individual asset screen.
