...
- Macro indicators: `11`
- Flow-alert history records: `5233`
...
- `data/processed/ai_context_index.json` (66186 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46655 bytes): Compact strategy stats.
