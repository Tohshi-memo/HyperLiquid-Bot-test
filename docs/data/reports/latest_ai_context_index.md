...
- Day/swing records: `976`
- Macro indicators: `11`
- Flow-alert history records: `5116`
...
- `data/processed/ai_context_index.json` (74055 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46590 bytes): Compact strategy stats.
