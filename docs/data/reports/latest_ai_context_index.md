...
- Day/swing records: `847`
- Macro indicators: `11`
- Flow-alert history records: `2721`
...
- `data/processed/ai_context_index.json` (69303 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45774 bytes): Compact strategy stats.
