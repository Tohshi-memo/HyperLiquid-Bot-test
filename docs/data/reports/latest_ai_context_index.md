...
- `data/reports/latest_ai_context_index.md` (2886 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62808 bytes): Machine-readable map.
