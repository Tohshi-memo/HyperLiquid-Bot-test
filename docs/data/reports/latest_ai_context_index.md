...
- Macro indicators: `11`
- Flow-alert history records: `5650`
...
- `data/processed/ai_context_index.json` (70267 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46890 bytes): Compact strategy stats.
