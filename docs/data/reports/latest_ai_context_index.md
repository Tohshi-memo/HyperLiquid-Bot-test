...
- `data/reports/latest_ai_context_index.md` (2473 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63609 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2533 bytes): Current canary signals.
...
- `data/reports/latest_asset_universe.md` (5710 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2065 bytes): Individual asset screen.
