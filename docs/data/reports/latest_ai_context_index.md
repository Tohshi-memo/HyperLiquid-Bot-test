...
- `data/reports/latest_ai_context_index.md` (2351 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61682 bytes): Machine-readable map.
