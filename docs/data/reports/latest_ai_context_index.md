...
- Day/swing records: `1497`
- Macro indicators: `11`
- Flow-alert history records: `6745`
...
- `data/processed/ai_context_index.json` (64746 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46946 bytes): Compact strategy stats.
