...
- Asset price active records: `348`
- Day/swing records: `361`
- Flow-alert history records: `1200`
...
- `data/processed/ai_analysis_pack.json` (43718 bytes): Compact strategy stats.
