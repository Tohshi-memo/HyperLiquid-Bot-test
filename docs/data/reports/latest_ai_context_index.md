...
- `data/processed/ai_context_index.json` (59274 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2343 bytes): Individual asset screen.
