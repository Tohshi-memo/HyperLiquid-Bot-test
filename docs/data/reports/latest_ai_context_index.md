...
- Macro indicators: `11`
- Flow-alert history records: `4848`
...
- `data/processed/ai_context_index.json` (73802 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46346 bytes): Compact strategy stats.
