...
- Asset price active records: `376`
- Day/swing records: `389`
- Flow-alert history records: `1291`
...
- `data/processed/ai_analysis_pack.json` (43979 bytes): Compact strategy stats.
