...
- `data/reports/latest_ai_context_index.md` (2662 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62440 bytes): Machine-readable map.
