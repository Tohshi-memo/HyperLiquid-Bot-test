...
- Day/swing records: `1771`
- Macro indicators: `11`
- Flow-alert history records: `7611`
...
- `data/processed/ai_context_index.json` (65210 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46980 bytes): Compact strategy stats.
