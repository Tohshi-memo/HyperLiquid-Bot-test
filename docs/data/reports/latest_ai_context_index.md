...
- Macro indicators: `11`
- Flow-alert history records: `8419`
...
- `data/processed/ai_context_index.json` (73959 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46978 bytes): Compact strategy stats.
