...
- `data/processed/ai_context_index.json` (59602 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5560 bytes): Asset-class overview.
