...
- Macro indicators: `11`
- Flow-alert history records: `7420`
...
- `data/processed/ai_context_index.json` (69415 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (7530 bytes): HIP-4 outcome market overview.
