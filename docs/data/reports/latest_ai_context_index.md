...
- `data/processed/ai_context_index.json` (63664 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2501 bytes): Current canary signals.
