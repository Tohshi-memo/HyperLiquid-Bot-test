...
- Asset price active records: `292`
- Day/swing records: `305`
- Flow-alert history records: `1028`
...
- `data/processed/ai_context_index.json` (14669 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43114 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4846 bytes): Asset-class overview.
