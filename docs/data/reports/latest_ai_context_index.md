...
- Asset price active records: `493`
- Day/swing records: `506`
- Flow-alert history records: `1657`
...
- `data/processed/ai_context_index.json` (34661 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45662 bytes): Compact strategy stats.
