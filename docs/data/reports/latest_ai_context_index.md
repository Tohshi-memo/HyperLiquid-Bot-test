...
- Updated: `2026-07-30T17:22:31.623587+00:00`
- Asset price active records: `672`
- Day/swing records: `7606`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (62690 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2192 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (6166 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `-2.0998` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
