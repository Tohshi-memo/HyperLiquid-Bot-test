...
- `data/processed/ai_context_index.json` (62467 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2358 bytes): Individual asset screen.
