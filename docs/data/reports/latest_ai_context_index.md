...
- Macro indicators: `11`
- Flow-alert history records: `2556`
...
- `data/processed/ai_context_index.json` (68231 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45780 bytes): Compact strategy stats.
