...
- `data/reports/latest_ai_context_index.md` (2971 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64678 bytes): Machine-readable map.
