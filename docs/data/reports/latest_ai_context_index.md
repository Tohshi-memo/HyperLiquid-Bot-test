...
- Macro indicators: `11`
- Flow-alert history records: `5082`
...
- `data/processed/ai_context_index.json` (66061 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46607 bytes): Compact strategy stats.
