...
- `data/processed/ai_context_index.json` (62080 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2273 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (9104 bytes): HIP-4 outcome market overview.
