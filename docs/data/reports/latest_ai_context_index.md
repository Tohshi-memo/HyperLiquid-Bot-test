...
- Day/swing records: `989`
- Macro indicators: `11`
- Flow-alert history records: `5155`
...
- `data/processed/ai_context_index.json` (70783 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46661 bytes): Compact strategy stats.
