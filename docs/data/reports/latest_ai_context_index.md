...
- Updated: `2026-05-28T15:37:29.411977+00:00`
- Asset price active records: `672`
- Day/swing records: `1927`
- Macro indicators: `11`
- Flow-alert history records: `8098`
...
- `data/processed/ai_context_index.json` (73842 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47000 bytes): Compact strategy stats.
...
- 4h_crypto_equity_divergence: score `-1.6923` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
