...
- Macro indicators: `11`
- Flow-alert history records: `5501`
...
- `data/processed/ai_context_index.json` (71635 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46639 bytes): Compact strategy stats.
