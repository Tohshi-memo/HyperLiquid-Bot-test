...
- `data/processed/ai_context_index.json` (63493 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47692 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5729 bytes): Asset-class overview.
