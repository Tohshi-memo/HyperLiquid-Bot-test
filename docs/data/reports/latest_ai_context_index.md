...
- `data/reports/latest_ai_context_index.md` (2635 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (65551 bytes): Machine-readable map.
