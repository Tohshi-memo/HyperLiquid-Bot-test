...
- Macro indicators: `11`
- Flow-alert history records: `5823`
...
- `data/processed/ai_context_index.json` (73707 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46899 bytes): Compact strategy stats.
