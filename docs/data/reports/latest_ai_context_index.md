...
- `data/processed/ai_context_index.json` (62292 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2396 bytes): Individual asset screen.
