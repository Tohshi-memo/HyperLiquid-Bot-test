...
- `data/processed/ai_context_index.json` (63643 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48278 bytes): Compact strategy stats.
