...
- `data/processed/ai_context_index.json` (63624 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47943 bytes): Compact strategy stats.
