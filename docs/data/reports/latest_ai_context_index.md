...
- `data/processed/ai_context_index.json` (65377 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47045 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5766 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2260 bytes): Individual asset screen.
