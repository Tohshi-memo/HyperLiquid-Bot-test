...
- `data/reports/latest_ai_context_index.md` (2781 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (67408 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2811 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2296 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (9458 bytes): HIP-4 outcome market overview.
