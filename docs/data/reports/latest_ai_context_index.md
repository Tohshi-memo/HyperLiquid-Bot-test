...
- `data/processed/ai_context_index.json` (63607 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48309 bytes): Compact strategy stats.
