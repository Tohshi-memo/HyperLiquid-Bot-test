...
- Flow-alert history records: `1707`
...
- `data/processed/ai_context_index.json` (35112 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45724 bytes): Compact strategy stats.
