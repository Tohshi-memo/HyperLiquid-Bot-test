...
- `data/processed/ai_context_index.json` (63847 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2438 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (8793 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3636 bytes): Mechanical relationship candidates.
