...
- `data/processed/ai_context_index.json` (63456 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2343 bytes): Current canary signals.
