...
- Day/swing records: `1016`
- Macro indicators: `11`
- Flow-alert history records: `5239`
...
- `data/processed/ai_context_index.json` (66181 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46635 bytes): Compact strategy stats.
