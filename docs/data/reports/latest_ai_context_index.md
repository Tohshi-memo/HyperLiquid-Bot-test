...
- `data/processed/ai_context_index.json` (63506 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47719 bytes): Compact strategy stats.
