...
- Asset price active records: `518`
- Day/swing records: `531`
- Flow-alert history records: `1734`
...
- `data/processed/ai_context_index.json` (35191 bytes): Machine-readable map.
