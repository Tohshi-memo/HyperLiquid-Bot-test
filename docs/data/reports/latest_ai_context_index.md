...
- `data/processed/ai_context_index.json` (64834 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3027 bytes): Current canary signals.
