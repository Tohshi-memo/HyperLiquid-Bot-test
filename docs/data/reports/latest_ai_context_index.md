...
- Day/swing records: `1649`
- Macro indicators: `11`
- Flow-alert history records: `7228`
...
- `data/processed/ai_context_index.json` (73634 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46933 bytes): Compact strategy stats.
