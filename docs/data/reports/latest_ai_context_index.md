...
- `data/processed/ai_context_index.json` (63474 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47407 bytes): Compact strategy stats.
