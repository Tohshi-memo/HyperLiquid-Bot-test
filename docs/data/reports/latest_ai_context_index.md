...
- Asset price active records: `126`
- Day/swing records: `139`
- Flow-alert history records: `508`
...
- `data/processed/ai_analysis_pack.json` (32158 bytes): Compact strategy stats.
