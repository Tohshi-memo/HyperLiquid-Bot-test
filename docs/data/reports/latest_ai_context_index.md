...
- Asset price active records: `544`
- Day/swing records: `557`
- Flow-alert history records: `1813`
...
- `data/processed/ai_context_index.json` (35562 bytes): Machine-readable map.
