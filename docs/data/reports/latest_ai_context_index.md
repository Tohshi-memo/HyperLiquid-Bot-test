...
- `data/processed/ai_context_index.json` (61210 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2116 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (6172 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3508 bytes): Mechanical relationship candidates.
