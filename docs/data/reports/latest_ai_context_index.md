...
- Day/swing records: `936`
- Macro indicators: `11`
- Flow-alert history records: `4994`
...
- `data/processed/ai_context_index.json` (74481 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46351 bytes): Compact strategy stats.
