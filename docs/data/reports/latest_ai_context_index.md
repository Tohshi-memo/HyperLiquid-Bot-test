...
- `data/processed/ai_context_index.json` (70381 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46979 bytes): Compact strategy stats.
