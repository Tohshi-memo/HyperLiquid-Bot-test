...
- Asset price active records: `337`
- Day/swing records: `350`
- Flow-alert history records: `1167`
...
- `data/processed/ai_context_index.json` (14650 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43693 bytes): Compact strategy stats.
