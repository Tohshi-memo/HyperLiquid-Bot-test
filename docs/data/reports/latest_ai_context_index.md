...
- Day/swing records: `1121`
- Macro indicators: `11`
- Flow-alert history records: `5564`
...
- `data/processed/ai_context_index.json` (64990 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46650 bytes): Compact strategy stats.
