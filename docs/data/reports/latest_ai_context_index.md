...
- Asset price active records: `244`
- Day/swing records: `257`
- Flow-alert history records: `881`
...
- `data/processed/ai_context_index.json` (14638 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (36105 bytes): Compact strategy stats.
