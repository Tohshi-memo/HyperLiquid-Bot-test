...
- Day/swing records: `2044`
- Macro indicators: `11`
- Flow-alert history records: `8456`
...
- `data/processed/ai_context_index.json` (72702 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46987 bytes): Compact strategy stats.
