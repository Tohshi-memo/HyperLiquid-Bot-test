...
- `data/processed/ai_context_index.json` (67462 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47076 bytes): Compact strategy stats.
