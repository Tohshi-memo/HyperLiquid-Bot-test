...
- Day/swing records: `1806`
- Macro indicators: `11`
- Flow-alert history records: `7721`
...
- `data/processed/ai_context_index.json` (68571 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8287 bytes): HIP-4 outcome market overview.
