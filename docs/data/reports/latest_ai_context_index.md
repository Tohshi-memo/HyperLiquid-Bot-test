...
- `data/reports/latest_ai_context_index.md` (2446 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63845 bytes): Machine-readable map.
