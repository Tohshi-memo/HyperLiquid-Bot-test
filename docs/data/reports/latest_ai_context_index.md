...
- Asset price active records: `632`
- Day/swing records: `645`
- Macro indicators: `11`
- Flow-alert history records: `2087`
...
- `data/processed/ai_context_index.json` (53196 bytes): Machine-readable map.
