...
- `data/processed/ai_context_index.json` (74598 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2882 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47049 bytes): Compact strategy stats.
