...
- Asset price active records: `196`
- Day/swing records: `209`
- Flow-alert history records: `728`
...
- `data/processed/ai_analysis_pack.json` (34418 bytes): Compact strategy stats.
