...
- `data/processed/ai_context_index.json` (60481 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47977 bytes): Compact strategy stats.
