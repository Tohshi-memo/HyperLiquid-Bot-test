...
- `data/processed/ai_context_index.json` (63566 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2653 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2168 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8813 bytes): HIP-4 outcome market overview.
