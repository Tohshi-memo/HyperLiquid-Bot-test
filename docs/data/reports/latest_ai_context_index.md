...
- Updated: `2026-06-23T02:37:25.601814+00:00`
- Asset price active records: `672`
- Day/swing records: `4063`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63490 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2421 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48197 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5715 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2075 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8795 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3524 bytes): Mechanical relationship candidates.
...
- 4h_crypto_equity_divergence: score `1.8882` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
