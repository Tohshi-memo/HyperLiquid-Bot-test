...
- `data/processed/ai_context_index.json` (66289 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47009 bytes): Compact strategy stats.
