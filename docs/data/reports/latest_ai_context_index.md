...
- Day/swing records: `1019`
- Macro indicators: `11`
- Flow-alert history records: `5248`
...
- `data/processed/ai_context_index.json` (64017 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46638 bytes): Compact strategy stats.
