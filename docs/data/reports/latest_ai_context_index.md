...
- Asset price active records: `347`
- Day/swing records: `360`
- Flow-alert history records: `1197`
...
- `data/processed/ai_analysis_pack.json` (43712 bytes): Compact strategy stats.
