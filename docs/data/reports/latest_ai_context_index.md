...
- `data/processed/ai_context_index.json` (65382 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3297 bytes): Current canary signals.
