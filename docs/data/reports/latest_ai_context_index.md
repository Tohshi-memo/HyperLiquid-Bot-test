...
- `data/processed/ai_context_index.json` (63629 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47971 bytes): Compact strategy stats.
