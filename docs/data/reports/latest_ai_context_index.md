...
- `data/reports/latest_canary_signals.md` (2777 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (10254 bytes): HIP-4 outcome market overview.
