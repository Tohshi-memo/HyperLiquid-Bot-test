...
- Asset price active records: `402`
- Day/swing records: `415`
- Flow-alert history records: `1374`
...
- `data/processed/ai_context_index.json` (14639 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (44525 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4659 bytes): Asset-class overview.
