...
- Day/swing records: `1639`
- Macro indicators: `11`
- Flow-alert history records: `7194`
...
- `data/processed/ai_context_index.json` (72395 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (6758 bytes): HIP-4 outcome market overview.
