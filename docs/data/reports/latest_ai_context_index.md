...
- `data/processed/ai_context_index.json` (73582 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46971 bytes): Compact strategy stats.
