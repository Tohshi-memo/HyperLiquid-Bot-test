...
- Updated: `2026-06-16T03:07:36.657787+00:00`
- Asset price active records: `672`
- Day/swing records: `3676`
- Macro indicators: `6`
...
- `data/processed/ai_context_index.json` (60396 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47975 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5763 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2089 bytes): Individual asset screen.
