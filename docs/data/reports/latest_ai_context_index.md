...
- Asset price active records: `205`
- Day/swing records: `218`
- Flow-alert history records: `757`
...
- `data/processed/ai_context_index.json` (14672 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (34675 bytes): Compact strategy stats.
