...
- `data/processed/ai_context_index.json` (58969 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3614 bytes): Mechanical relationship candidates.
