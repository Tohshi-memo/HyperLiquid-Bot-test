...
- `data/processed/ai_context_index.json` (61993 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2161 bytes): Individual asset screen.
