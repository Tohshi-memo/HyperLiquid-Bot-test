...
- Macro indicators: `11`
- Flow-alert history records: `7970`
...
- `data/reports/latest_ai_context_index.md` (2254 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (70619 bytes): Machine-readable map.
