...
- `data/processed/ai_context_index.json` (63400 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47162 bytes): Compact strategy stats.
