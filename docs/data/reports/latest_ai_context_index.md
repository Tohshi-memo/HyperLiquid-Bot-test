...
- Day/swing records: `873`
- Macro indicators: `11`
- Flow-alert history records: `4791`
...
- `data/processed/ai_context_index.json` (71889 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2569 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (46036 bytes): Compact strategy stats.
