...
- `data/processed/ai_context_index.json` (63341 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48185 bytes): Compact strategy stats.
