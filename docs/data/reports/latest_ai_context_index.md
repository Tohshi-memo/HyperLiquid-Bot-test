...
- `data/reports/latest_ai_context_index.md` (2609 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63912 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2540 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2148 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8976 bytes): HIP-4 outcome market overview.
