...
- Asset price active records: `365`
- Day/swing records: `378`
- Flow-alert history records: `1253`
...
- `data/processed/ai_analysis_pack.json` (43953 bytes): Compact strategy stats.
