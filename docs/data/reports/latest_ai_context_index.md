...
- Day/swing records: `1142`
- Macro indicators: `11`
- Flow-alert history records: `5628`
...
- `data/processed/ai_context_index.json` (69211 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46618 bytes): Compact strategy stats.
