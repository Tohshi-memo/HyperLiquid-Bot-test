...
- Asset price active records: `440`
- Day/swing records: `453`
- Flow-alert history records: `1490`
...
- `data/processed/ai_analysis_pack.json` (45638 bytes): Compact strategy stats.
