...
- `data/processed/ai_context_index.json` (61671 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2257 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8988 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3658 bytes): Mechanical relationship candidates.
