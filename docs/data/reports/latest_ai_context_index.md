...
- Asset price active records: `463`
- Day/swing records: `476`
- Flow-alert history records: `1562`
- Correlation status: `ready`
- Asset price archives: `none yet`

## First Read Files

- `data/reports/latest_ai_context_index.md` (1747 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (35360 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45652 bytes): Compact strategy stats.
