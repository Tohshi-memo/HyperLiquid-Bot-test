...
- `data/reports/latest_ai_context_index.md` (2785 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62573 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3047 bytes): Current canary signals.
