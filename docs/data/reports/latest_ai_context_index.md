...
- `data/reports/latest_ai_context_index.md` (2507 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (71285 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47043 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9478 bytes): HIP-4 outcome market overview.
