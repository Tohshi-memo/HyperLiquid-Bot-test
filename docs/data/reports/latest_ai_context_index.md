...
- `data/processed/ai_context_index.json` (63784 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (4745 bytes): Asset-class overview.
