...
- `data/processed/ai_context_index.json` (64157 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (9165 bytes): HIP-4 outcome market overview.
