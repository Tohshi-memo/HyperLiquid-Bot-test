...
- Macro indicators: `11`
- Flow-alert history records: `5162`
...
- `data/processed/ai_context_index.json` (67409 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46666 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5722 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2377 bytes): Individual asset screen.
