...
- Macro indicators: `11`
- Flow-alert history records: `2534`
...
- `data/processed/ai_context_index.json` (68174 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45778 bytes): Compact strategy stats.
