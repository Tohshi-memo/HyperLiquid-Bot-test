...
- `data/processed/ai_context_index.json` (61817 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48181 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9826 bytes): HIP-4 outcome market overview.
