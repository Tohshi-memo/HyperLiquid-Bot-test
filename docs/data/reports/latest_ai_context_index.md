...
- Macro indicators: `11`
- Flow-alert history records: `2639`
...
- `data/processed/ai_context_index.json` (60673 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45788 bytes): Compact strategy stats.
