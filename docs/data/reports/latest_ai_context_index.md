...
- `data/reports/latest_ai_context_index.md` (2443 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63867 bytes): Machine-readable map.
