...
- Macro indicators: `11`
- Flow-alert history records: `5361`
...
- `data/processed/ai_context_index.json` (65305 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5791 bytes): Asset-class overview.
