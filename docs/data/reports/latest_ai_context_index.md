...
- `data/reports/latest_ai_context_index.md` (2647 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (65247 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2167 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8911 bytes): HIP-4 outcome market overview.
