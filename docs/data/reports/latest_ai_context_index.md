...
- `data/processed/ai_context_index.json` (62873 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3022 bytes): Current canary signals.
