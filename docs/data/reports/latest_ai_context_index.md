...
- Macro indicators: `11`
- Flow-alert history records: `5981`
...
- `data/processed/ai_context_index.json` (69290 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46915 bytes): Compact strategy stats.
