...
- Macro indicators: `11`
- Flow-alert history records: `7200`
...
- `data/processed/ai_context_index.json` (71446 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (6547 bytes): HIP-4 outcome market overview.
