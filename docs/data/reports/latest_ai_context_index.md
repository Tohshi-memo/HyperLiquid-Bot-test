...
- Asset price active records: `617`
- Day/swing records: `630`
- Macro indicators: `11`
- Flow-alert history records: `2040`
...
- `data/processed/ai_context_index.json` (52825 bytes): Machine-readable map.
