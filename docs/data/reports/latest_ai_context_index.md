...
- `data/processed/ai_context_index.json` (63430 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5788 bytes): Asset-class overview.
