...
- `data/reports/latest_ai_context_index.md` (2538 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (74672 bytes): Machine-readable map.
