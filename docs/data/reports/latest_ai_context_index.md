...
- Day/swing records: `1017`
- Macro indicators: `11`
- Flow-alert history records: `5242`
...
- `data/processed/ai_context_index.json` (65104 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46622 bytes): Compact strategy stats.
