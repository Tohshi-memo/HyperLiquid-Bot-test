...
- `data/processed/ai_context_index.json` (74725 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2629 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47056 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5767 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2264 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (9474 bytes): HIP-4 outcome market overview.
