...
- Asset price active records: `340`
- Day/swing records: `353`
- Flow-alert history records: `1176`
...
- `data/processed/ai_context_index.json` (14616 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43664 bytes): Compact strategy stats.
