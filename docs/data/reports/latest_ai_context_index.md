...
- `data/processed/ai_context_index.json` (68213 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47185 bytes): Compact strategy stats.
