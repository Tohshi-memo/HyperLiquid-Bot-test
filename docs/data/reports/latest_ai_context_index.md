...
- `data/reports/latest_ai_context_index.md` (2495 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63623 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47138 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5766 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2146 bytes): Individual asset screen.
