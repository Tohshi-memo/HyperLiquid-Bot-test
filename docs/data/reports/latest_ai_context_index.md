...
- Asset price active records: `206`
- Day/swing records: `219`
- Flow-alert history records: `760`
...
- `data/processed/ai_analysis_pack.json` (34704 bytes): Compact strategy stats.
