...
- Asset price active records: `417`
- Day/swing records: `430`
- Flow-alert history records: `1420`
...
- `data/processed/ai_analysis_pack.json` (45072 bytes): Compact strategy stats.
