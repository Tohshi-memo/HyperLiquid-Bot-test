...
- Day/swing records: `1190`
- Macro indicators: `11`
- Flow-alert history records: `5779`
...
- `data/processed/ai_context_index.json` (73786 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46881 bytes): Compact strategy stats.
