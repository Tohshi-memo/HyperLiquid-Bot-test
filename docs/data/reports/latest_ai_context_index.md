...
- `data/processed/ai_context_index.json` (63665 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47960 bytes): Compact strategy stats.
