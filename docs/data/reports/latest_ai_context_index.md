...
- `data/processed/ai_context_index.json` (63638 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2662 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48231 bytes): Compact strategy stats.
...
- `data/reports/latest_relationship_scan.md` (3528 bytes): Mechanical relationship candidates.
