...
- Asset price active records: `525`
- Day/swing records: `538`
- Flow-alert history records: `1755`
...
- `data/processed/ai_context_index.json` (35519 bytes): Machine-readable map.
