...
- Asset price active records: `223`
- Day/swing records: `236`
- Flow-alert history records: `813`
...
- `data/processed/ai_analysis_pack.json` (35525 bytes): Compact strategy stats.
