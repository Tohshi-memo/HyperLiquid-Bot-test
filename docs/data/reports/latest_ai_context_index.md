...
- Updated: `2026-05-21T15:07:19.797330+00:00`
- Asset price active records: `672`
- Day/swing records: `1275`
- Macro indicators: `11`
- Flow-alert history records: `6041`
...
- `data/processed/ai_context_index.json` (73606 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46923 bytes): Compact strategy stats.
...
- polymarket_volume_spike: score `4.15` - Polymarket crypto volume is unusually high.
