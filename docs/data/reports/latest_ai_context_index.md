...
- `data/processed/ai_context_index.json` (63837 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2810 bytes): Current canary signals.
