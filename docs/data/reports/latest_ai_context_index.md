...
- `data/reports/latest_ai_context_index.md` (2479 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63666 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47177 bytes): Compact strategy stats.
