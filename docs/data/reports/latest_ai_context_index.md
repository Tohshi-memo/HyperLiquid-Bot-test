...
- Day/swing records: `1824`
- Macro indicators: `11`
- Flow-alert history records: `7777`
...
- `data/processed/ai_context_index.json` (73746 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46990 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8323 bytes): HIP-4 outcome market overview.
