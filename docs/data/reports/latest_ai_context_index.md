...
- Asset price active records: `422`
- Day/swing records: `435`
- Flow-alert history records: `1435`
...
- `data/processed/ai_analysis_pack.json` (45109 bytes): Compact strategy stats.
