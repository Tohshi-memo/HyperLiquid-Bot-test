...
- `data/reports/latest_ai_context_index.md` (2382 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (72173 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47046 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5767 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2259 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (9466 bytes): HIP-4 outcome market overview.
