...
- `data/processed/ai_context_index.json` (63936 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2542 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2219 bytes): Individual asset screen.
