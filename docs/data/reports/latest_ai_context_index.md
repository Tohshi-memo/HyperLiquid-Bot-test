...
- Macro indicators: `11`
- Flow-alert history records: `7814`
...
- `data/processed/ai_context_index.json` (73721 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46981 bytes): Compact strategy stats.
