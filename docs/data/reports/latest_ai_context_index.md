...
- Asset price active records: `367`
- Day/swing records: `380`
- Flow-alert history records: `1263`
...
- `data/processed/ai_context_index.json` (14642 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (43973 bytes): Compact strategy stats.
