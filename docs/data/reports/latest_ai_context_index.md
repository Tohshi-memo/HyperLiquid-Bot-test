...
- Macro indicators: `11`
- Flow-alert history records: `6112`
...
- `data/processed/ai_context_index.json` (70493 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (4113 bytes): HIP-4 outcome market overview.
