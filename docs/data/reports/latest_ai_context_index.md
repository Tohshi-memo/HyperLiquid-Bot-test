...
- `data/reports/latest_ai_context_index.md` (2498 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62186 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2485 bytes): Current canary signals.
...
- `data/reports/latest_asset_universe.md` (5680 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2086 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10339 bytes): HIP-4 outcome market overview.
