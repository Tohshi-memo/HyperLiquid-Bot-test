...
- `data/processed/ai_context_index.json` (64139 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2804 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (49843 bytes): Compact strategy stats.
