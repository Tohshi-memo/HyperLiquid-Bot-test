...
- `data/processed/ai_context_index.json` (61978 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2919 bytes): Current canary signals.
