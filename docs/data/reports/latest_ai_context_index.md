...
- `data/reports/latest_ai_context_index.md` (2496 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61782 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48273 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5709 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2170 bytes): Individual asset screen.
