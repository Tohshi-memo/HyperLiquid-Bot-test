...
- `data/processed/ai_context_index.json` (63989 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2617 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47964 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5722 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2124 bytes): Individual asset screen.
