...
- `data/processed/ai_context_index.json` (61889 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5628 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2132 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10299 bytes): HIP-4 outcome market overview.
