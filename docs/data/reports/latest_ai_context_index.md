...
- Asset price active records: `268`
- Day/swing records: `281`
- Flow-alert history records: `953`
...
- `data/processed/ai_analysis_pack.json` (42560 bytes): Compact strategy stats.
