...
- `data/reports/latest_ai_context_index.md` (3121 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63027 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3054 bytes): Current canary signals.
