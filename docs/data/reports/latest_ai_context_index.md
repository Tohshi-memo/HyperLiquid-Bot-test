...
- `data/processed/ai_context_index.json` (63466 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2439 bytes): Current canary signals.
