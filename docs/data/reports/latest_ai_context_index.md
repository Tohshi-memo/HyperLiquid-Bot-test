...
- Asset price active records: `404`
- Day/swing records: `417`
- Flow-alert history records: `1380`
...
- `data/processed/ai_context_index.json` (14640 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (44534 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4678 bytes): Asset-class overview.
