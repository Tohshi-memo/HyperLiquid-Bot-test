...
- `data/reports/latest_ai_context_index.md` (2634 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (65236 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2887 bytes): Current canary signals.
...
- `data/reports/latest_hip4_outcome.md` (8868 bytes): HIP-4 outcome market overview.
