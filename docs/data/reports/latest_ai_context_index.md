...
- Day/swing records: `1739`
- Macro indicators: `11`
- Flow-alert history records: `7512`
...
- `data/processed/ai_context_index.json` (73978 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46963 bytes): Compact strategy stats.
