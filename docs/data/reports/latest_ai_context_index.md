...
- `data/reports/latest_ai_context_index.md` (2546 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63906 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2570 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (49853 bytes): Compact strategy stats.
