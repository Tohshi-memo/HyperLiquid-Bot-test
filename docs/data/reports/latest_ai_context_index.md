...
- Day/swing records: `1183`
- Macro indicators: `11`
- Flow-alert history records: `5758`
...
- `data/processed/ai_context_index.json` (73848 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46878 bytes): Compact strategy stats.
