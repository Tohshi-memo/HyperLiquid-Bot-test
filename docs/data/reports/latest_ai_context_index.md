...
- Day/swing records: `914`
- Macro indicators: `11`
- Flow-alert history records: `4925`
...
- `data/processed/ai_context_index.json` (71629 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46319 bytes): Compact strategy stats.
