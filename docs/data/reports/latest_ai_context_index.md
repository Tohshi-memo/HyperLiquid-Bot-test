...
- `data/reports/latest_canary_signals.md` (2796 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (50458 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (10414 bytes): HIP-4 outcome market overview.
