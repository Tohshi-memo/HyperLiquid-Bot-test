...
- `data/reports/latest_ai_context_index.md` (2864 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (74898 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3251 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47041 bytes): Compact strategy stats.
