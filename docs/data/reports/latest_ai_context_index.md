...
- `data/processed/ai_context_index.json` (64018 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2754 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47961 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5771 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2109 bytes): Individual asset screen.
