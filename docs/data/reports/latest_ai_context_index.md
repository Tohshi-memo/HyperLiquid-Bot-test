...
- Asset price active records: `214`
- Day/swing records: `227`
- Flow-alert history records: `785`
...
- `data/processed/ai_analysis_pack.json` (34992 bytes): Compact strategy stats.
