...
- `data/reports/latest_ai_context_index.md` (2724 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64247 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2782 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48280 bytes): Compact strategy stats.
