...
- `data/processed/ai_context_index.json` (63869 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2771 bytes): Current canary signals.
