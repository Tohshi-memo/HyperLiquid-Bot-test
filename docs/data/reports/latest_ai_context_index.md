...
- Asset price active records: `305`
- Day/swing records: `318`
- Flow-alert history records: `1070`
...
- `data/processed/ai_analysis_pack.json` (43402 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4690 bytes): Asset-class overview.
