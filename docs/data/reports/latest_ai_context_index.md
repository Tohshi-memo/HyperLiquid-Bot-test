...
- Macro indicators: `11`
- Flow-alert history records: `4937`
...
- `data/reports/latest_ai_context_index.md` (2247 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (69585 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46300 bytes): Compact strategy stats.
