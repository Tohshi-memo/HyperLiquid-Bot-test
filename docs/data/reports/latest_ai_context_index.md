...
- Asset price active records: `188`
- Day/swing records: `201`
- Flow-alert history records: `703`
...
- `data/processed/ai_analysis_pack.json` (34424 bytes): Compact strategy stats.
