...
- `data/reports/latest_ai_context_index.md` (2765 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62430 bytes): Machine-readable map.
