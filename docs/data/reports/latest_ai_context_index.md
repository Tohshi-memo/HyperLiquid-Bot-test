...
- Day/swing records: `1470`
- Macro indicators: `11`
- Flow-alert history records: `6655`
...
- `data/processed/ai_context_index.json` (71142 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46934 bytes): Compact strategy stats.
