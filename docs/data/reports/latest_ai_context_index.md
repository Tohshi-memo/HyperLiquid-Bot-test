...
- Asset price active records: `634`
- Day/swing records: `647`
- Macro indicators: `11`
- Flow-alert history records: `2093`
...
- `data/processed/ai_context_index.json` (53169 bytes): Machine-readable map.
