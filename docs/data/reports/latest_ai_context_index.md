...
- `data/reports/latest_ai_context_index.md` (2350 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61607 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2562 bytes): Current canary signals.
