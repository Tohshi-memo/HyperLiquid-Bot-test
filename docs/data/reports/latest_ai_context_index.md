...
- `data/reports/latest_ai_context_index.md` (2792 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (65324 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47072 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9423 bytes): HIP-4 outcome market overview.
