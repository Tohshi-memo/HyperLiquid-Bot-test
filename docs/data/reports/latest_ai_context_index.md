...
- `data/processed/ai_context_index.json` (62084 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48150 bytes): Compact strategy stats.
