...
- Day/swing records: `922`
- Macro indicators: `11`
- Flow-alert history records: `4950`
...
- `data/processed/ai_context_index.json` (69581 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46334 bytes): Compact strategy stats.
