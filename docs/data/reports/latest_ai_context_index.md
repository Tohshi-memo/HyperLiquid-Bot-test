...
- `data/processed/ai_context_index.json` (61850 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2163 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10333 bytes): HIP-4 outcome market overview.
