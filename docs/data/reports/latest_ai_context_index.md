...
- Asset price active records: `670`
- Day/swing records: `683`
- Macro indicators: `11`
- Flow-alert history records: `2205`
...
- `data/processed/ai_context_index.json` (58339 bytes): Machine-readable map.
