...
- `data/reports/latest_ai_context_index.md` (2525 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62225 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2547 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48260 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5674 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2181 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10353 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3602 bytes): Mechanical relationship candidates.
