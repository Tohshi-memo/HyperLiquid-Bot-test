...
- Asset price active records: `320`
- Day/swing records: `333`
- Flow-alert history records: `1115`
...
- `data/processed/ai_analysis_pack.json` (43670 bytes): Compact strategy stats.
