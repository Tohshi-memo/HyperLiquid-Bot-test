...
- `data/processed/ai_context_index.json` (63640 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5584 bytes): Asset-class overview.
