...
- `data/processed/ai_context_index.json` (69189 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2790 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47126 bytes): Compact strategy stats.
