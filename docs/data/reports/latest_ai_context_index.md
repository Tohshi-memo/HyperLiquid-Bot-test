...
- `data/reports/latest_ai_context_index.md` (2664 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63745 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (49845 bytes): Compact strategy stats.
