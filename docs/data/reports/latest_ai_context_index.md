...
- `data/processed/ai_context_index.json` (63435 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47167 bytes): Compact strategy stats.
