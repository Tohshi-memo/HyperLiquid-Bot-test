...
- Asset price active records: `296`
- Day/swing records: `309`
- Flow-alert history records: `1041`
...
- `data/processed/ai_analysis_pack.json` (43117 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4692 bytes): Asset-class overview.
