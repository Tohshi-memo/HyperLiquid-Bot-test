...
- `data/processed/ai_context_index.json` (74618 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2891 bytes): Current canary signals.
