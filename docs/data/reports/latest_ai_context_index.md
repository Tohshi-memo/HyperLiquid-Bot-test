...
- `data/reports/latest_ai_context_index.md` (2749 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62432 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2779 bytes): Current canary signals.
