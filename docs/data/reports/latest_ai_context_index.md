...
- Day/swing records: `781`
- Macro indicators: `11`
- Flow-alert history records: `2514`
...
- `data/processed/ai_context_index.json` (67189 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45754 bytes): Compact strategy stats.
