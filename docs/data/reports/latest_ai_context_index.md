...
- `data/processed/ai_context_index.json` (63706 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5611 bytes): Asset-class overview.
