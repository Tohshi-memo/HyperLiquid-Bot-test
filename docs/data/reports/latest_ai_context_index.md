...
- `data/reports/latest_ai_context_index.md` (2906 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62547 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2920 bytes): Current canary signals.
