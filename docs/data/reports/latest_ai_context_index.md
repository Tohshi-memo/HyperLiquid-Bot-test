...
- Macro indicators: `11`
- Flow-alert history records: `2579`
...
- `data/processed/ai_context_index.json` (65046 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45811 bytes): Compact strategy stats.
