...
- `data/processed/ai_context_index.json` (61689 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3487 bytes): Mechanical relationship candidates.
