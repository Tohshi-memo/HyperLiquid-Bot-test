...
- `data/processed/ai_context_index.json` (63722 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2610 bytes): Current canary signals.
