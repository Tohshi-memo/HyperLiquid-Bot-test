...
- Macro indicators: `11`
- Flow-alert history records: `5959`
...
- `data/processed/ai_context_index.json` (68104 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46909 bytes): Compact strategy stats.
