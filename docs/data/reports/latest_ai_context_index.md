...
- `data/processed/ai_context_index.json` (65354 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2559 bytes): Current canary signals.
