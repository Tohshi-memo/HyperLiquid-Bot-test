...
- `data/processed/ai_context_index.json` (60655 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47150 bytes): Compact strategy stats.
