...
- Updated: `2026-05-19T13:37:18.260493+00:00`
- Asset price active records: `672`
- Day/swing records: `1078`
- Macro indicators: `11`
- Flow-alert history records: `5430`
...
- `data/processed/ai_context_index.json` (70686 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2529 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (46641 bytes): Compact strategy stats.
...
- 1h_crypto_metal_divergence: score `1.9043` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
- 4h_crypto_metal_divergence: score `1.8303` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
