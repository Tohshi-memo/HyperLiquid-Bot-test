...
- `data/reports/latest_ai_context_index.md` (2312 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61117 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2249 bytes): Current canary signals.
