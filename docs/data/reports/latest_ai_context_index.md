...
- Day/swing records: `837`
- Macro indicators: `11`
- Flow-alert history records: `2689`
...
- `data/processed/ai_context_index.json` (64902 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2400 bytes): Individual asset screen.
