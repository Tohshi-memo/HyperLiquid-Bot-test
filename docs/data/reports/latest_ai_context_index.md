...
- `data/processed/ai_context_index.json` (61920 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2338 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8958 bytes): HIP-4 outcome market overview.
