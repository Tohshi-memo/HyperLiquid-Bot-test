...
- `data/reports/latest_ai_context_index.md` (2516 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61572 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (49354 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5651 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2211 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10413 bytes): HIP-4 outcome market overview.
