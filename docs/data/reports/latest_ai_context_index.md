...
- Macro indicators: `11`
- Flow-alert history records: `2730`
...
- `data/processed/ai_context_index.json` (69442 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45786 bytes): Compact strategy stats.
