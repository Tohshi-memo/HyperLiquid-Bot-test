...
- `data/reports/latest_ai_context_index.md` (2640 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (65550 bytes): Machine-readable map.
