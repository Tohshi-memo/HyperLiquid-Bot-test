...
- Day/swing records: `1337`
- Macro indicators: `5`
- Flow-alert history records: `6236`
...
- `data/processed/ai_context_index.json` (64363 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46953 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5779 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2228 bytes): Individual asset screen.
