...
- `data/processed/ai_context_index.json` (63832 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48302 bytes): Compact strategy stats.
