...
- `data/reports/latest_ai_context_index.md` (2710 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64294 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48323 bytes): Compact strategy stats.
