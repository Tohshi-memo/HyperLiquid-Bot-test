...
- `data/processed/ai_context_index.json` (61469 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5642 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2151 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10323 bytes): HIP-4 outcome market overview.
