...
- `data/processed/ai_context_index.json` (62026 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48232 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5715 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2275 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (9179 bytes): HIP-4 outcome market overview.
