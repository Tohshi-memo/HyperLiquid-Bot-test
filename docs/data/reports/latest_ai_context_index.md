...
- Day/swing records: `1218`
- Macro indicators: `11`
- Flow-alert history records: `5867`
...
- `data/processed/ai_context_index.json` (66022 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46903 bytes): Compact strategy stats.
