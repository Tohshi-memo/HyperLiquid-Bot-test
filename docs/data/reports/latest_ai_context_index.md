...
- `data/processed/ai_context_index.json` (74681 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2768 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47039 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (9468 bytes): HIP-4 outcome market overview.
