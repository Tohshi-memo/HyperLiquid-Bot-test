...
- `data/reports/latest_ai_context_index.md` (2550 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (68000 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (9469 bytes): HIP-4 outcome market overview.
