...
- Day/swing records: `956`
- Macro indicators: `11`
- Flow-alert history records: `5055`
...
- `data/processed/ai_context_index.json` (65133 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46349 bytes): Compact strategy stats.
