...
- Day/swing records: `1143`
- Macro indicators: `11`
- Flow-alert history records: `5631`
...
- `data/processed/ai_context_index.json` (70283 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46634 bytes): Compact strategy stats.
