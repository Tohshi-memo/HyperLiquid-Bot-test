...
- `data/processed/ai_context_index.json` (62174 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2665 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2322 bytes): Individual asset screen.
