...
- Day/swing records: `1640`
- Macro indicators: `11`
- Flow-alert history records: `7197`
...
- `data/processed/ai_context_index.json` (72550 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (6746 bytes): HIP-4 outcome market overview.
