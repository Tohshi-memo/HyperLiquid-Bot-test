...
- Asset price active records: `271`
- Day/swing records: `284`
- Flow-alert history records: `962`
- Correlation status: `ready`
- Asset price archives: `none yet`

## First Read Files

- `data/reports/latest_ai_context_index.md` (1590 bytes): Human-readable map.
...
- `data/processed/ai_analysis_pack.json` (42582 bytes): Compact strategy stats.
