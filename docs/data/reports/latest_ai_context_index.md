...
- Updated: `2026-09-24T17:07:28.284850+00:00`
...
- `data/reports/latest_ai_context_index.md` (2417 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62203 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2434 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (50444 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5702 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2291 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10443 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_metal_divergence: score `1.6087` - Crypto majors and metals are diverging; useful for risk/hedge regime checks.
