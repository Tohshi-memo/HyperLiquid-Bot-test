...
- `data/reports/latest_ai_context_index.md` (2420 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62295 bytes): Machine-readable map.
