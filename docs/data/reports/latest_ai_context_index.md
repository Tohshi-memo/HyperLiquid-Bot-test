...
- `data/processed/ai_context_index.json` (69645 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47077 bytes): Compact strategy stats.
