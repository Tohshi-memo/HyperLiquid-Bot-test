...
- Day/swing records: `1665`
- Macro indicators: `11`
- Flow-alert history records: `7278`
...
- `data/processed/ai_context_index.json` (73608 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (6788 bytes): HIP-4 outcome market overview.
