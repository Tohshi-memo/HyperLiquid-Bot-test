...
- Updated: `2026-05-28T16:07:35.128560+00:00`
- Asset price active records: `672`
- Day/swing records: `1929`
- Macro indicators: `11`
- Flow-alert history records: `8104`
...
- `data/processed/ai_context_index.json` (73625 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46998 bytes): Compact strategy stats.
...
- 4h_crypto_equity_divergence: score `-1.5657` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
