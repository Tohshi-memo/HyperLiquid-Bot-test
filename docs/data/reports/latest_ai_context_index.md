...
- `data/processed/ai_context_index.json` (64449 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47062 bytes): Compact strategy stats.
