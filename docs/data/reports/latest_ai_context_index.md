...
- `data/processed/ai_context_index.json` (63494 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47680 bytes): Compact strategy stats.
