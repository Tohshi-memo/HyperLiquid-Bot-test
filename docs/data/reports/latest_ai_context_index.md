...
- Asset price active records: `640`
- Day/swing records: `653`
- Macro indicators: `11`
- Flow-alert history records: `2112`
...
- `data/processed/ai_context_index.json` (54293 bytes): Machine-readable map.
