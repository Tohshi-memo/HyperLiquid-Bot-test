...
- Day/swing records: `1959`
- Macro indicators: `11`
- Flow-alert history records: `8196`
...
- `data/processed/ai_context_index.json` (69495 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46993 bytes): Compact strategy stats.
