...
- `data/processed/ai_context_index.json` (66271 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47017 bytes): Compact strategy stats.
