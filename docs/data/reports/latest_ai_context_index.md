...
- Asset price active records: `277`
- Day/swing records: `290`
- Flow-alert history records: `980`
...
- `data/processed/ai_analysis_pack.json` (42826 bytes): Compact strategy stats.
