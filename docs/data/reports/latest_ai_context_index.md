...
- `data/processed/ai_context_index.json` (63835 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3605 bytes): Mechanical relationship candidates.
