...
- Asset price active records: `282`
- Day/swing records: `295`
- Flow-alert history records: `997`
...
- `data/processed/ai_analysis_pack.json` (42816 bytes): Compact strategy stats.
