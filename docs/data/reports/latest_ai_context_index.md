...
- `data/processed/ai_context_index.json` (63515 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47687 bytes): Compact strategy stats.
