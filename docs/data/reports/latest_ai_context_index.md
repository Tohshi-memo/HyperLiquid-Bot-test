...
- Asset price active records: `625`
- Day/swing records: `638`
- Macro indicators: `11`
- Flow-alert history records: `2065`
...
- `data/processed/ai_context_index.json` (53219 bytes): Machine-readable map.
