...
- `data/processed/ai_context_index.json` (63766 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47111 bytes): Compact strategy stats.
