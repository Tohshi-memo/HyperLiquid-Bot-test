...
- `data/processed/ai_context_index.json` (61756 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48271 bytes): Compact strategy stats.
