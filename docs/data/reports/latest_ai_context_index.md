...
- `data/processed/ai_context_index.json` (59172 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2345 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8732 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3612 bytes): Mechanical relationship candidates.
