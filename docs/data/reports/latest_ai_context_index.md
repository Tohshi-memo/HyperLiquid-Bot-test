...
- `data/processed/ai_context_index.json` (61730 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3494 bytes): Mechanical relationship candidates.
