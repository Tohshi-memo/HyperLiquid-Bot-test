...
- Asset price active records: `667`
- Day/swing records: `680`
- Macro indicators: `11`
- Flow-alert history records: `2196`
...
- `data/processed/ai_context_index.json` (58475 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45749 bytes): Compact strategy stats.
