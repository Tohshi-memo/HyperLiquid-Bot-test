...
- Macro indicators: `11`
- Flow-alert history records: `7246`
...
- `data/processed/ai_context_index.json` (73614 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (6776 bytes): HIP-4 outcome market overview.
