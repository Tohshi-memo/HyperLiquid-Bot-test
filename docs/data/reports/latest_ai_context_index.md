...
- Day/swing records: `1043`
- Macro indicators: `11`
- Flow-alert history records: `5323`
...
- `data/processed/ai_analysis_pack.json` (46631 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5793 bytes): Asset-class overview.
