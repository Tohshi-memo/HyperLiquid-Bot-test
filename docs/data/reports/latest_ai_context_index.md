...
- `data/processed/ai_context_index.json` (64280 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2630 bytes): Current canary signals.
...
- `data/reports/latest_asset_universe.md` (5737 bytes): Asset-class overview.
