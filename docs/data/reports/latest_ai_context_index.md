...
- Macro indicators: `11`
- Flow-alert history records: `7461`
...
- `data/processed/ai_context_index.json` (70421 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (7575 bytes): HIP-4 outcome market overview.
