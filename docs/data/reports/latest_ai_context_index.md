...
- `data/processed/ai_context_index.json` (61763 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2524 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2171 bytes): Individual asset screen.
