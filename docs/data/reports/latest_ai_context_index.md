...
- `data/processed/ai_context_index.json` (68240 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (7992 bytes): HIP-4 outcome market overview.
