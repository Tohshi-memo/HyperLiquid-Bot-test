...
- Macro indicators: `11`
- Flow-alert history records: `5118`
...
- `data/processed/ai_context_index.json` (73990 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46624 bytes): Compact strategy stats.
