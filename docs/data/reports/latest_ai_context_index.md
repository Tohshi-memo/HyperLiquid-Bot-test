...
- Asset price active records: `241`
- Day/swing records: `254`
- Flow-alert history records: `868`
...
- `data/processed/ai_analysis_pack.json` (36109 bytes): Compact strategy stats.
