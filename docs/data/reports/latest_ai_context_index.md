...
- `data/processed/ai_context_index.json` (72937 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47029 bytes): Compact strategy stats.
