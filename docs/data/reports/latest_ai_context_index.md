...
- `data/reports/latest_ai_context_index.md` (2358 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (61627 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48173 bytes): Compact strategy stats.
