...
- `data/processed/ai_context_index.json` (74579 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2642 bytes): Current canary signals.
