...
- Macro indicators: `11`
- Flow-alert history records: `8509`
...
- `data/processed/ai_context_index.json` (66312 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46936 bytes): Compact strategy stats.
