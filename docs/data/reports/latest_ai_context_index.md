...
- Day/swing records: `1085`
- Macro indicators: `11`
- Flow-alert history records: `5452`
...
- `data/processed/ai_context_index.json` (72984 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46677 bytes): Compact strategy stats.
