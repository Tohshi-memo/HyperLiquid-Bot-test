...
- Asset price active records: `430`
- Day/swing records: `443`
- Flow-alert history records: `1459`
...
- `data/processed/ai_analysis_pack.json` (45657 bytes): Compact strategy stats.
