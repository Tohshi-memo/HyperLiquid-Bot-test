...
- Day/swing records: `915`
- Macro indicators: `11`
- Flow-alert history records: `4928`
...
- `data/processed/ai_context_index.json` (70553 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46318 bytes): Compact strategy stats.
