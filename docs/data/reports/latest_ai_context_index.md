...
- Asset price active records: `221`
- Day/swing records: `234`
- Flow-alert history records: `807`
...
- `data/processed/ai_context_index.json` (14664 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (35550 bytes): Compact strategy stats.
