...
- `data/processed/ai_context_index.json` (63544 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47698 bytes): Compact strategy stats.
