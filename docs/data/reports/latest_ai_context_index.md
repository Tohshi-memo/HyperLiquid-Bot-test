...
- `data/processed/ai_context_index.json` (61317 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2115 bytes): Individual asset screen.
