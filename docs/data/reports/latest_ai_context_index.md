...
- Updated: `2026-05-29T15:22:19.398536+00:00`
- Asset price active records: `672`
- Day/swing records: `2022`
- Macro indicators: `11`
- Flow-alert history records: `8388`
...
- `data/processed/ai_context_index.json` (73585 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46967 bytes): Compact strategy stats.
...
- 1h_commodity_crypto_divergence: score `2.0281` - Commodity perps and crypto are moving differently; check macro-linked stress.
