...
- Asset price active records: `247`
- Day/swing records: `260`
- Flow-alert history records: `887`
...
- `data/processed/ai_analysis_pack.json` (36113 bytes): Compact strategy stats.
