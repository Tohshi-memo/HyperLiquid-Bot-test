...
- `data/processed/ai_context_index.json` (63799 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2690 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (49847 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5683 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2244 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10398 bytes): HIP-4 outcome market overview.
