...
- Updated: `2026-05-28T15:07:29.445329+00:00`
- Asset price active records: `672`
- Day/swing records: `1925`
- Macro indicators: `11`
- Flow-alert history records: `8092`
...
- `data/processed/ai_context_index.json` (73562 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46973 bytes): Compact strategy stats.
...
- 4h_crypto_equity_divergence: score `-1.6388` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
