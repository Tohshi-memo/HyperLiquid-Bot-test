...
- `data/processed/ai_context_index.json` (64845 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48164 bytes): Compact strategy stats.
...
- `data/reports/latest_hip4_outcome.md` (8723 bytes): HIP-4 outcome market overview.
