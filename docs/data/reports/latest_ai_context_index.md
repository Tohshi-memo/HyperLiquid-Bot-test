...
- Updated: `2026-06-23T03:22:26.901215+00:00`
- Asset price active records: `672`
- Day/swing records: `4066`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63529 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48199 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5719 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2076 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8799 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `2.0205` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
