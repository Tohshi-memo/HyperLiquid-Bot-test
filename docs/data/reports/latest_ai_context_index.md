...
- `data/reports/latest_ai_context_index.md` (2494 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63775 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2674 bytes): Current canary signals.
