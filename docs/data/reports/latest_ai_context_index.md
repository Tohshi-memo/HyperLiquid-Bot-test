...
- `data/reports/latest_ai_context_index.md` (2387 bytes): Human-readable map.
...
- `data/processed/ai_analysis_pack.json` (47060 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5746 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2309 bytes): Individual asset screen.
