...
- Macro indicators: `11`
- Flow-alert history records: `4959`
...
- `data/processed/ai_context_index.json` (71743 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46344 bytes): Compact strategy stats.
