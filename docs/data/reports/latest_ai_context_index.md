...
- `data/processed/ai_context_index.json` (63748 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48288 bytes): Compact strategy stats.
