...
- Macro indicators: `11`
- Flow-alert history records: `5641`
...
- `data/processed/ai_context_index.json` (69221 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46625 bytes): Compact strategy stats.
