...
- `data/processed/ai_context_index.json` (63563 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2383 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48020 bytes): Compact strategy stats.
