...
- `data/processed/ai_context_index.json` (63504 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5744 bytes): Asset-class overview.
