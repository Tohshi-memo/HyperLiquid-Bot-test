...
- `data/reports/latest_ai_context_index.md` (2555 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (66973 bytes): Machine-readable map.
