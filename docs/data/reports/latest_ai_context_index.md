...
- Updated: `2026-06-11T19:43:14.481377+00:00`
- Asset price active records: `672`
- Day/swing records: `3270`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63414 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47112 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5717 bytes): Asset-class overview.
...
- 4h_commodity_crypto_divergence: score `3.4684` - Commodity perps and crypto are moving differently; check macro-linked stress.
