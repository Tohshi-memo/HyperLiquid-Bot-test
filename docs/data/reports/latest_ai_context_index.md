...
- `data/processed/ai_context_index.json` (63501 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47683 bytes): Compact strategy stats.
