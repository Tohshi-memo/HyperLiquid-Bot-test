...
- Updated: `2026-08-18T17:54:34.823248+00:00`
- Asset price active records: `672`
- Day/swing records: `9377`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (62056 bytes): Machine-readable map.
...
- `data/reports/latest_relationship_scan.md` (3610 bytes): Mechanical relationship candidates.
...
- 4h_crypto_equity_divergence: score `1.5606` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
