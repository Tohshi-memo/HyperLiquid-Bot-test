...
- `data/reports/latest_ai_context_index.md` (2599 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64178 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2661 bytes): Current canary signals.
...
- `data/reports/latest_asset_features.md` (2162 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8762 bytes): HIP-4 outcome market overview.
