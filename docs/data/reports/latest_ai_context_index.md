...
- Macro indicators: `11`
- Flow-alert history records: `7960`
...
- `data/reports/latest_ai_context_index.md` (2607 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (71185 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46988 bytes): Compact strategy stats.
