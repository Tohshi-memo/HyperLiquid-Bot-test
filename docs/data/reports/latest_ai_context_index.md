...
- `data/reports/latest_ai_context_index.md` (2580 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (63978 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47982 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5706 bytes): Asset-class overview.
