...
- Asset price active records: `304`
- Day/swing records: `317`
- Flow-alert history records: `1066`
...
- `data/processed/ai_analysis_pack.json` (43390 bytes): Compact strategy stats.
