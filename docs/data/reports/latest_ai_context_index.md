...
- `data/reports/latest_ai_context_index.md` (2360 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (60862 bytes): Machine-readable map.
