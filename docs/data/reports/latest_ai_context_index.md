...
- `data/reports/latest_ai_context_index.md` (2725 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62060 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2902 bytes): Current canary signals.
