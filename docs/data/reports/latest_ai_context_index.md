...
- Macro indicators: `11`
- Flow-alert history records: `4781`
...
- `data/processed/ai_context_index.json` (67587 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46045 bytes): Compact strategy stats.
