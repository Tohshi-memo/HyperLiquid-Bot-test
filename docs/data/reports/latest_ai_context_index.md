...
- Asset price active records: `541`
- Day/swing records: `554`
- Flow-alert history records: `1804`
...
- `data/processed/ai_context_index.json` (35308 bytes): Machine-readable map.
