...
- Asset price active records: `411`
- Day/swing records: `424`
- Flow-alert history records: `1402`
...
- `data/processed/ai_analysis_pack.json` (45079 bytes): Compact strategy stats.
