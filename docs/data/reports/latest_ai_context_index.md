...
- `data/reports/latest_ai_context_index.md` (2853 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62244 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3046 bytes): Current canary signals.
