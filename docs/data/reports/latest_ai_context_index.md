...
- `data/processed/ai_context_index.json` (64046 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2773 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (48234 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5709 bytes): Asset-class overview.
...
- `data/reports/latest_relationship_scan.md` (3525 bytes): Mechanical relationship candidates.
