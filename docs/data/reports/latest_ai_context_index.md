...
- `data/processed/ai_context_index.json` (62503 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2355 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8365 bytes): HIP-4 outcome market overview.
