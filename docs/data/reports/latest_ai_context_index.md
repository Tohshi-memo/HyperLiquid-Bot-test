...
- `data/reports/latest_ai_context_index.md` (2767 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (62548 bytes): Machine-readable map.
