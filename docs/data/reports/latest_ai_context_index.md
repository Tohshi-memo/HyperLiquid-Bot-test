...
- Updated: `2026-06-24T03:52:25.803621+00:00`
- Asset price active records: `672`
- Day/swing records: `4164`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63649 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (8790 bytes): HIP-4 outcome market overview.
...
- 4h_crypto_equity_divergence: score `-4.1073` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
