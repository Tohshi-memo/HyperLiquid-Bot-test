...
- `data/processed/ai_context_index.json` (62810 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46917 bytes): Compact strategy stats.
