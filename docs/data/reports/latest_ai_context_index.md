...
- `data/processed/ai_context_index.json` (61830 bytes): Machine-readable map.
...
- `data/reports/latest_hip4_outcome.md` (10255 bytes): HIP-4 outcome market overview.
