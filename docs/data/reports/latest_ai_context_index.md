...
- Asset price active records: `240`
- Day/swing records: `253`
- Flow-alert history records: `865`
...
- `data/processed/ai_analysis_pack.json` (36096 bytes): Compact strategy stats.
