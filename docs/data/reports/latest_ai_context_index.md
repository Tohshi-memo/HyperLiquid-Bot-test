...
- Asset price active records: `607`
- Day/swing records: `620`
- Macro indicators: `11`
- Flow-alert history records: `2009`
...
- `data/processed/ai_context_index.json` (52877 bytes): Machine-readable map.
