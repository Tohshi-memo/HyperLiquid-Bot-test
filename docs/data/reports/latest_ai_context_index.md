...
- Updated: `2026-07-19T21:37:25.274341+00:00`
- Asset price active records: `672`
- Day/swing records: `6591`
- Macro indicators: `4`
...
- `data/processed/ai_context_index.json` (58885 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (48222 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5681 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2270 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8967 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3668 bytes): Mechanical relationship candidates.
