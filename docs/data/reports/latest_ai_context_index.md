...
- `data/processed/ai_context_index.json` (74503 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2772 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47038 bytes): Compact strategy stats.
