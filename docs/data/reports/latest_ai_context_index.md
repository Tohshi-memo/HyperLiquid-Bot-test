...
- `data/processed/ai_context_index.json` (61273 bytes): Machine-readable map.
...
- `data/reports/latest_macro_indicators.md` (1802 bytes): Macro rates, employment, inflation, dollar, and risk overview.
...
- `data/reports/latest_relationship_scan.md` (3502 bytes): Mechanical relationship candidates.
