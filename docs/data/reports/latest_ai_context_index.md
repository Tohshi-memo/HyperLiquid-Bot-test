...
- Day/swing records: `2000`
- Macro indicators: `11`
- Flow-alert history records: `8322`
...
- `data/processed/ai_context_index.json` (73696 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47006 bytes): Compact strategy stats.
