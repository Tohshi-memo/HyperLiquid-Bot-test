...
- Updated: `2026-06-12T17:52:34.872496+00:00`
- Asset price active records: `672`
- Day/swing records: `3359`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63470 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47142 bytes): Compact strategy stats.
...
- 4h_commodity_crypto_divergence: score `2.0935` - Commodity perps and crypto are moving differently; check macro-linked stress.
