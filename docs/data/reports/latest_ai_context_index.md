...
- `data/processed/ai_context_index.json` (67640 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (3037 bytes): Current canary signals.
