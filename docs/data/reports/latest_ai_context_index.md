...
- Asset price active records: `482`
- Day/swing records: `495`
- Flow-alert history records: `1621`
...
- `data/processed/ai_analysis_pack.json` (45699 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5634 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2032 bytes): Individual asset screen.
