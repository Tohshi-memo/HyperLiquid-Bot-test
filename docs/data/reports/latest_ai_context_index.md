...
- Asset price active records: `291`
- Day/swing records: `304`
- Flow-alert history records: `1025`
...
- `data/processed/ai_analysis_pack.json` (43097 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (4839 bytes): Asset-class overview.
