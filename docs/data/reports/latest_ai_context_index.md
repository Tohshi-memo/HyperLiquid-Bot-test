...
- Day/swing records: `1618`
- Macro indicators: `11`
- Flow-alert history records: `7130`
...
- `data/processed/ai_context_index.json` (64795 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46922 bytes): Compact strategy stats.
