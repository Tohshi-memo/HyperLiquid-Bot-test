...
- Asset price active records: `660`
- Day/swing records: `673`
- Macro indicators: `11`
- Flow-alert history records: `2174`
...
- `data/processed/ai_context_index.json` (57271 bytes): Machine-readable map.
