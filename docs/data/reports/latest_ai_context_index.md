...
- Updated: `2026-06-09T15:37:37.120195+00:00`
- Asset price active records: `672`
- Day/swing records: `3065`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (63406 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2553 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47186 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5759 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2151 bytes): Individual asset screen.
...
- 1h_crypto_equity_divergence: score `2.0327` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
- 4h_crypto_equity_divergence: score `1.7599` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
