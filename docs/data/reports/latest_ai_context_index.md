...
- `data/processed/ai_context_index.json` (61894 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2318 bytes): Individual asset screen.
