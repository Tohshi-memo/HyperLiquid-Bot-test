...
- `data/processed/ai_context_index.json` (61341 bytes): Machine-readable map.
...
- `data/reports/latest_asset_universe.md` (5624 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2202 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (10296 bytes): HIP-4 outcome market overview.
