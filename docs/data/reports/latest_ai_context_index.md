...
- Day/swing records: `947`
- Macro indicators: `11`
- Flow-alert history records: `5027`
...
- `data/processed/ai_context_index.json` (66141 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (46341 bytes): Compact strategy stats.
