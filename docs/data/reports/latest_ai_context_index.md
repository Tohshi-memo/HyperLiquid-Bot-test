...
- Asset price active records: `447`
- Day/swing records: `460`
- Flow-alert history records: `1514`
...
- `data/processed/ai_context_index.json` (14939 bytes): Machine-readable map.
