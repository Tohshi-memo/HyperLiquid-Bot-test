...
- `data/processed/ai_context_index.json` (63854 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2507 bytes): Current canary signals.
...
- `data/processed/ai_analysis_pack.json` (47980 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5768 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2086 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (8830 bytes): HIP-4 outcome market overview.
