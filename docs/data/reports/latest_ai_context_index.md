...
- Updated: `2026-08-20T15:31:02.850375+00:00`
- Asset price active records: `672`
- Day/swing records: `9556`
- Macro indicators: `11`
...
- `data/processed/ai_context_index.json` (61573 bytes): Machine-readable map.
...
- `data/reports/latest_asset_features.md` (2348 bytes): Individual asset screen.
- `data/reports/latest_hip4_outcome.md` (6190 bytes): HIP-4 outcome market overview.
- `data/reports/latest_relationship_scan.md` (3623 bytes): Mechanical relationship candidates.
...
- 4h_crypto_equity_divergence: score `1.705` - Crypto majors and equity perps are diverging; watch lead/lag rotation.
