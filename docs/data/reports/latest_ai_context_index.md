...
- `data/processed/ai_analysis_pack.json` (48204 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5621 bytes): Asset-class overview.
