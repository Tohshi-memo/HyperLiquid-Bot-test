...
- Asset price active records: `136`
- Day/swing records: `149`
- Flow-alert history records: `539`
...
- `data/processed/ai_analysis_pack.json` (33054 bytes): Compact strategy stats.
