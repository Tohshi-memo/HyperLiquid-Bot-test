...
- `data/reports/latest_ai_context_index.md` (2303 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (67621 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (47184 bytes): Compact strategy stats.
