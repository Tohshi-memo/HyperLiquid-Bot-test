...
- `data/reports/latest_ai_context_index.md` (2914 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (64624 bytes): Machine-readable map.
