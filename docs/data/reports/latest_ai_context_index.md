...
- `data/reports/latest_ai_context_index.md` (2502 bytes): Human-readable map.
- `data/processed/ai_context_index.json` (71085 bytes): Machine-readable map.
- `data/reports/latest_canary_signals.md` (2760 bytes): Current canary signals.
