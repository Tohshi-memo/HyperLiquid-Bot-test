...
- Day/swing records: `838`
- Macro indicators: `11`
- Flow-alert history records: `2692`
...
- `data/processed/ai_context_index.json` (64870 bytes): Machine-readable map.
...
- `data/processed/ai_analysis_pack.json` (45733 bytes): Compact strategy stats.
- `data/reports/latest_asset_universe.md` (5604 bytes): Asset-class overview.
- `data/reports/latest_asset_features.md` (2431 bytes): Individual asset screen.
