...
- `news_risk_high->unknown_4h` score `13.7011` n `51` status `ready` deltaP `24.5636` edge `0.9826` maxDD `-0.0348`
- `risk_on_high->unknown_1h` score `4.744` n `33` status `ready` deltaP `-10.1252` edge `0.7206` maxDD `-1.5916`
- `risk_on_and_context->unknown_1h` score `4.744` n `33` status `ready` deltaP `-10.1252` edge `0.7206` maxDD `-1.5916`
- `news_risk_high->unknown_1h` score `3.3208` n `51` status `ready` deltaP `17.6822` edge `0.1893` maxDD `-0.7693`
- `news_risk_high->fx_4h` score `2.9925` n `51` status `ready` deltaP `35.4914` edge `0.0262` maxDD `-0.0746`
- `news_risk_high->equity_4h` score `2.6914` n `51` status `ready` deltaP `23.2694` edge `0.1462` maxDD `-2.164`
...
- `risk_on_high->equity_4h` score `1.5777` n `33` status `ready` deltaP `-1.686` edge `0.2565` maxDD `-0.773`
- `risk_on_and_context->equity_4h` score `1.5777` n `33` status `ready` deltaP `-1.686` edge `0.2565` maxDD `-0.773`
- `news_risk_high->fx_1h` score `1.1643` n `51` status `ready` deltaP `16.0972` edge `0.0067` maxDD `-0.0257`
- `market_context_high->unknown_1h` score `1.1114` n `132` status `ready` deltaP `6.5414` edge `0.0939` maxDD `-1.5916`
- `market_context_high->crypto_alt_4h` score `0.8963` n `128` status `ready` deltaP `8.1936` edge `0.1665` maxDD `-7.0478`
