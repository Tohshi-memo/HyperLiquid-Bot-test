...
- `market_context_high->equity_1h` score `-1.234` n `169` status `ready` deltaP `-1.9062` edge `-0.0031` maxDD `-4.6286`
- `market_context_high->metal_24h` score `-1.2486` n `136` status `ready` deltaP `-2.7742` edge `0.0426` maxDD `-2.9193`
- `market_context_high->equity_24h` score `-1.3498` n `136` status `ready` deltaP `-0.9099` edge `0.2079` maxDD `-21.1456`
...
- `market_context_high->equity_4h` score `-3.051` n `169` status `ready` deltaP `-10.0961` edge `-0.1113` maxDD `-8.0039`
- `market_context_high->crypto_major_1h` score `-3.6222` n `169` status `ready` deltaP `-10.3904` edge `-0.0592` maxDD `-10.5372`
- `market_context_high->crypto_alt_4h` score `-3.8959` n `169` status `ready` deltaP `-11.4489` edge `-0.1474` maxDD `-15.3937`
- `market_context_high->crypto_alt_24h` score `-4.4447` n `136` status `ready` deltaP `-11.9075` edge `-0.1467` maxDD `-4.5445`
