...
- `news_risk_high->fx_24h` score `6.044` n `32` status `ready` deltaP `50.6944` edge `0.1657` maxDD `0.0`
- `news_risk_high->crypto_major_24h` score `4.3653` n `32` status `ready` deltaP `16.6667` edge `0.5265` maxDD `-4.2368`
...
- `news_risk_high->crypto_major_1h` score `1.4982` n `32` status `ready` deltaP `14.8765` edge `0.1396` maxDD `-2.0691`
- `news_risk_high->crypto_alt_1h` score `0.9385` n `32` status `ready` deltaP `11.7702` edge `0.088` maxDD `-1.6923`
- `market_context_high->unknown_1h` score `0.1875` n `208` status `ready` deltaP `-6.2644` edge `0.1582` maxDD `-3.7317`
...
- `market_context_high->metal_1h` score `-0.4052` n `208` status `ready` deltaP `3.5871` edge `0.0019` maxDD `-1.8877`
...
- `news_risk_high->unknown_1h` score `-0.845` n `32` status `ready` deltaP `5.0337` edge `-0.0695` maxDD `-0.7581`
