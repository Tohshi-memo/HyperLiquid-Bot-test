...
- `market_context_high->crypto_major_4h` score `0.8632` n `254` status `ready` deltaP `11.6706` edge `0.2169` maxDD `-13.4882`
- `market_context_high->crypto_alt_4h` score `0.4202` n `254` status `ready` deltaP `8.749` edge `0.1577` maxDD `-9.1473`
...
- `market_context_high->metal_1h` score `-0.4873` n `266` status `ready` deltaP `0.8318` edge `-0.0005` maxDD `-2.0682`
...
- `market_context_high->crypto_major_1h` score `-0.6318` n `266` status `ready` deltaP `4.5147` edge `0.0418` maxDD `-6.9639`
- `market_context_high->commodity_1h` score `-0.9115` n `266` status `ready` deltaP `0.5988` edge `-0.0034` maxDD `-3.7906`
- `market_context_high->fx_24h` score `-1.1331` n `204` status `ready` deltaP `13.9093` edge `0.0471` maxDD `-3.0737`
...
- `market_context_high->index_24h` score `-2.5046` n `204` status `ready` deltaP `6.2091` edge `0.038` maxDD `-17.0396`
...
- `market_context_high->crypto_major_24h` score `-4.8647` n `204` status `ready` deltaP `3.8705` edge `0.0145` maxDD `-29.6555`
- `market_context_high->metal_24h` score `-8.3042` n `204` status `ready` deltaP `-12.3264` edge `-0.2479` maxDD `-32.7652`
- `market_context_high->commodity_24h` score `-12.0376` n `204` status `ready` deltaP `-9.9061` edge `-0.0762` maxDD `-45.8715`
