...
- `market_context_high->equity_4h` score `2.2661` n `96` status `ready` deltaP `11.4583` edge `0.2013` maxDD `-2.4411`
- `market_context_high->equity_1h` score `1.8836` n `96` status `ready` deltaP `15.3007` edge `0.0851` maxDD `-0.4112`
...
- `market_context_high->commodity_24h` score `0.2691` n `96` status `ready` deltaP `6.4236` edge `0.175` maxDD `-4.666`
...
- `market_context_high->crypto_major_24h` score `-0.6049` n `96` status `ready` deltaP `2.9514` edge `0.0507` maxDD `-4.9964`
- `market_context_high->commodity_4h` score `-0.6809` n `96` status `ready` deltaP `-0.94` edge `0.004` maxDD `-2.4692`
- `market_context_high->crypto_alt_1h` score `-0.7292` n `96` status `ready` deltaP `-0.1684` edge `-0.0122` maxDD `-2.413`
- `market_context_high->crypto_major_1h` score `-0.7697` n `96` status `ready` deltaP `1.4845` edge `-0.0241` maxDD `-2.7581`
- `market_context_high->commodity_1h` score `-0.8612` n `96` status `ready` deltaP `-7.2917` edge `-0.0052` maxDD `-1.1941`
- `market_context_high->crypto_major_4h` score `-1.0947` n `96` status `ready` deltaP `6.5803` edge `-0.033` maxDD `-3.1677`
