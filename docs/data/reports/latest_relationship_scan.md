...
- `market_context_high->equity_4h` score `2.1595` n `96` status `ready` deltaP `11.6107` edge `0.1914` maxDD `-2.4411`
- `market_context_high->equity_1h` score `1.7589` n `96` status `ready` deltaP `14.4025` edge `0.0807` maxDD `-0.4112`
- `market_context_high->index_1h` score `0.9498` n `96` status `ready` deltaP `16.0616` edge `0.0108` maxDD `-0.0982`
...
- `market_context_high->crypto_alt_4h` score `-2.1174` n `96` status `ready` deltaP `3.2012` edge `-0.0708` maxDD `-5.4926`
