...
- `risk_on_high->index_1h` score `0.3397` n `32` status `ready` deltaP `10.5539` edge `0.0107` maxDD `-0.3343`
- `risk_on_and_context->index_1h` score `0.3397` n `32` status `ready` deltaP `10.5539` edge `0.0107` maxDD `-0.3343`
- `market_context_high->commodity_24h` score `0.2613` n `145` status `ready` deltaP `7.3651` edge `0.053` maxDD `-2.4263`
...
- `risk_on_high->index_4h` score `-0.2384` n `32` status `ready` deltaP `1.4482` edge `0.018` maxDD `-0.6579`
- `risk_on_and_context->index_4h` score `-0.2384` n `32` status `ready` deltaP `1.4482` edge `0.018` maxDD `-0.6579`
- `risk_on_high->equity_1h` score `-0.6429` n `32` status `ready` deltaP `-3.3121` edge `-0.006` maxDD `-1.6811`
- `risk_on_and_context->equity_1h` score `-0.6429` n `32` status `ready` deltaP `-3.3121` edge `-0.006` maxDD `-1.6811`
