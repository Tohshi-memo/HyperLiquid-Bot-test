...
- `market_context_high->commodity_4h` score `1.5423` n `90` status `ready` deltaP `16.9276` edge `0.1003` maxDD `-2.7703`
...
- `market_context_high->metal_1h` score `-0.5737` n `90` status `ready` deltaP `-1.9062` edge `-0.0114` maxDD `-1.6224`
- `market_context_high->index_1h` score `-0.6663` n `90` status `ready` deltaP `-1.5036` edge `-0.022` maxDD `-1.6054`
...
- `market_context_high->crypto_alt_4h` score `-1.3083` n `90` status `ready` deltaP `1.8089` edge `-0.0408` maxDD `-5.7857`
- `market_context_high->index_24h` score `-1.864` n `88` status `ready` deltaP `-6.3289` edge `0.0227` maxDD `-7.8922`
- `market_context_high->equity_1h` score `-1.884` n `90` status `ready` deltaP `2.5549` edge `-0.105` maxDD `-10.619`
- `market_context_high->index_4h` score `-2.1443` n `90` status `ready` deltaP `-13.0454` edge `-0.0625` maxDD `-4.7021`
- `market_context_high->unknown_1h` score `-3.3364` n `90` status `ready` deltaP `1.8995` edge `-0.246` maxDD `-1.2421`
- `market_context_high->crypto_major_1h` score `-3.3769` n `90` status `ready` deltaP `-11.1111` edge `-0.07` maxDD `-7.6533`
