...
- `risk_on_high->unknown_4h` score `21.13` n `138` status `ready` deltaP `-0.8263` edge `1.9669` maxDD `-7.7112`
- `risk_on_and_context->unknown_4h` score `21.13` n `138` status `ready` deltaP `-0.8263` edge `1.9669` maxDD `-7.7112`
- `market_context_high->unknown_4h` score `8.1962` n `228` status `ready` deltaP `2.0913` edge `0.9159` maxDD `-9.4124`
...
- `news_risk_high->crypto_major_4h` score `3.2699` n `37` status `ready` deltaP `16.5706` edge `0.2033` maxDD `-0.9693`
...
- `news_risk_high->crypto_major_1h` score `1.1031` n `37` status `ready` deltaP `5.717` edge `0.0721` maxDD `-0.4628`
...
- `news_risk_high->crypto_major_24h` score `0.5865` n `37` status `ready` deltaP `16.5776` edge `0.2423` maxDD `-18.2098`
