...
- `market_context_high->metal_24h` score `7.9112` n `86` status `ready` deltaP `35.8752` edge `0.4201` maxDD `0.0`
- `market_context_high->equity_4h` score `6.4141` n `99` status `ready` deltaP `24.9584` edge `0.4574` maxDD `-5.1426`
- `market_context_high->commodity_24h` score `3.1834` n `86` status `ready` deltaP `24.8015` edge `0.2279` maxDD `-6.2367`
...
- `market_context_high->metal_1h` score `0.716` n `99` status `ready` deltaP `10.2311` edge `0.0293` maxDD `-0.6936`
- `market_context_high->crypto_major_4h` score `0.6108` n `99` status `ready` deltaP `9.1202` edge `0.1619` maxDD `-6.7444`
- `market_context_high->crypto_alt_4h` score `0.5958` n `99` status `ready` deltaP `5.785` edge `0.1228` maxDD `-3.9374`
- `market_context_high->crypto_major_1h` score `0.5561` n `99` status `ready` deltaP `11.1671` edge `0.0379` maxDD `-1.6171`
- `market_context_high->crypto_alt_1h` score `-0.0218` n `99` status `ready` deltaP `1.4033` edge `0.0311` maxDD `-1.4603`
