...
- `risk_on_high->commodity_4h` score `2.673` n `32` status `ready` deltaP `18.6738` edge `0.1165` maxDD `-0.1258`
- `risk_on_and_context->commodity_4h` score `2.673` n `32` status `ready` deltaP `18.6738` edge `0.1165` maxDD `-0.1258`
- `news_risk_high->index_4h` score `1.7805` n `36` status `ready` deltaP `20.5284` edge `0.0247` maxDD `-0.0546`
- `market_context_high->commodity_4h` score `1.7252` n `128` status `ready` deltaP `17.1113` edge `0.0768` maxDD `-0.7687`
- `news_risk_high->equity_1h` score `1.7226` n `36` status `ready` deltaP `8.2835` edge `0.1202` maxDD `-0.5496`
