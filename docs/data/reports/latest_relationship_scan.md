...
- `market_context_high->unknown_4h` score `45.891` n `46` status `ready` deltaP `7.0122` edge `3.7775` maxDD `0.0`
- `market_context_high->crypto_major_24h` score `29.6703` n `46` status `ready` deltaP `13.5341` edge `2.3979` maxDD `-0.5817`
...
- `news_risk_high->crypto_major_24h` score `4.9767` n `96` status `ready` deltaP `-9.2014` edge `1.1619` maxDD `-46.1999`
- `news_risk_high->commodity_24h` score `4.6299` n `96` status `ready` deltaP `35.4167` edge `0.2676` maxDD `-2.431`
- `news_risk_high->crypto_major_4h` score `2.9072` n `97` status `ready` deltaP `14.3701` edge `0.2042` maxDD `-2.619`
...
- `news_risk_high->crypto_alt_1h` score `1.7863` n `97` status `ready` deltaP `10.3216` edge `0.1196` maxDD `-1.1645`
- `news_risk_high->fx_4h` score `1.3815` n `97` status `ready` deltaP `20.5086` edge `0.042` maxDD `-0.421`
- `news_risk_high->crypto_major_1h` score `1.3349` n `97` status `ready` deltaP `12.5672` edge `0.0668` maxDD `-1.8141`
