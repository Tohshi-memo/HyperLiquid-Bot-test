...
- `news_risk_high->crypto_alt_24h` score `1.6677` n `30` status `ready` deltaP `26.493` edge `-0.0229` maxDD `-0.5131`
...
- `news_risk_high->crypto_alt_1h` score `0.4211` n `30` status `ready` deltaP `6.6667` edge `0.0557` maxDD `-1.6923`
- `news_risk_high->index_24h` score `0.1148` n `30` status `ready` deltaP `9.2361` edge `0.0403` maxDD `-2.3058`
- `market_context_high->metal_1h` score `-0.4695` n `206` status `ready` deltaP `2.6815` edge `0.0018` maxDD `-2.0564`
- `market_context_high->equity_24h` score `-0.5008` n `190` status `ready` deltaP `25.7456` edge `0.5103` maxDD `-44.3576`
...
- `market_context_high->crypto_alt_1h` score `-0.7854` n `206` status `ready` deltaP `4.8544` edge `0.0422` maxDD `-9.3536`
- `market_context_high->crypto_major_1h` score `-0.7856` n `206` status `ready` deltaP `4.9997` edge `0.0427` maxDD `-9.807`
- `market_context_high->index_24h` score `-1.0365` n `190` status `ready` deltaP `2.7449` edge `0.0665` maxDD `-5.6938`
