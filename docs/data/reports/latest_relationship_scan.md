...
- `market_context_high->crypto_major_1h` score `-1.0522` n `105` status `ready` deltaP `-1.3074` edge `-0.0417` maxDD `-2.7581`
- `market_context_high->crypto_alt_4h` score `-3.0956` n `105` status `ready` deltaP `-0.5967` edge `-0.127` maxDD `-5.4926`
- `market_context_high->fx_24h` score `-3.2937` n `103` status `ready` deltaP `-15.3115` edge `-0.0133` maxDD `-2.0613`
- `market_context_high->crypto_major_4h` score `-3.4008` n `105` status `ready` deltaP `1.4997` edge `-0.1913` maxDD `-3.1677`
- `market_context_high->index_24h` score `-4.0045` n `103` status `ready` deltaP `-2.8452` edge `-0.0442` maxDD `-18.6848`
