...
- Price records: `668`
- Market context records: `781`
- Flow alert records: `2199`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_major_24h` score `13.2937` n `148` status `ready` deltaP `31.426` edge `0.9317` maxDD `-1.3382`
- `market_context_high->crypto_alt_24h` score `6.4121` n `148` status `ready` deltaP `7.1914` edge `0.4912` maxDD `-0.0508`
- `risk_on_high->equity_4h` score `3.6073` n `32` status `ready` deltaP `10.0694` edge `0.27` maxDD `-0.9217`
- `risk_on_and_context->equity_4h` score `3.6073` n `32` status `ready` deltaP `10.0694` edge `0.27` maxDD `-0.9217`
...
- `risk_on_high->crypto_major_4h` score `2.7367` n `32` status `ready` deltaP `20.8589` edge `0.1262` maxDD `-0.9758`
- `risk_on_and_context->crypto_major_4h` score `2.7367` n `32` status `ready` deltaP `20.8589` edge `0.1262` maxDD `-0.9758`
...
- `risk_on_high->crypto_major_1h` score `-0.0997` n `33` status `ready` deltaP `4.5638` edge `-0.0128` maxDD `-1.0995`
