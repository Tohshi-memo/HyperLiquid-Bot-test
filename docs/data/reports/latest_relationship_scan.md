...
- `market_context_high->unknown_1h` score `-1.9624` n `176` status `ready` deltaP `-7.9239` edge `-0.0206` maxDD `-3.2083`
- `market_context_high->crypto_major_4h` score `-2.1497` n `176` status `ready` deltaP `6.0976` edge `0.0152` maxDD `-16.8495`
- `market_context_high->crypto_alt_4h` score `-2.3543` n `176` status `ready` deltaP `3.7416` edge `0.0134` maxDD `-19.2145`
- `market_context_high->metal_4h` score `-2.6066` n `176` status `ready` deltaP `-6.3193` edge `-0.006` maxDD `-5.2172`
- `market_context_high->equity_4h` score `-3.9187` n `176` status `ready` deltaP `5.4462` edge `-0.1118` maxDD `-27.1529`
