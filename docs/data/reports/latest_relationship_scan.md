...
- `market_context_high->commodity_1h` score `-0.5169` n `126` status `ready` deltaP `0.1716` edge `-0.0102` maxDD `-1.5775`
- `market_context_high->crypto_alt_1h` score `-0.5194` n `126` status `ready` deltaP `0.1497` edge `0.0363` maxDD `-5.9775`
...
- `market_context_high->crypto_major_1h` score `-0.9503` n `126` status `ready` deltaP `4.0586` edge `0.0348` maxDD `-7.6171`
- `market_context_high->index_1h` score `-1.2366` n `126` status `ready` deltaP `-4.5688` edge `-0.0084` maxDD `-2.1355`
- `market_context_high->unknown_1h` score `-1.2524` n `126` status `ready` deltaP `0.1639` edge `-0.0993` maxDD `-1.3217`
- `market_context_high->unknown_4h` score `-1.2715` n `122` status `ready` deltaP `6.3625` edge `0.0875` maxDD `-6.2031`
- `market_context_high->metal_1h` score `-1.3337` n `126` status `ready` deltaP `-8.8062` edge `-0.0019` maxDD `-1.4971`
- `market_context_high->crypto_alt_4h` score `-2.1461` n `122` status `ready` deltaP `1.1796` edge `-0.0087` maxDD `-15.2776`
- `market_context_high->metal_4h` score `-2.4087` n `122` status `ready` deltaP `-8.829` edge `-0.0044` maxDD `-4.6441`
- `market_context_high->crypto_major_4h` score `-3.0792` n `122` status `ready` deltaP `1.7343` edge `-0.0169` maxDD `-23.4879`
- `market_context_high->commodity_24h` score `-3.2542` n `118` status `ready` deltaP `-6.5719` edge `-0.1476` maxDD `-2.3815`
- `market_context_high->unknown_24h` score `-3.302` n `119` status `ready` deltaP `-8.5318` edge `-0.0425` maxDD `-13.9168`
- `market_context_high->equity_1h` score `-4.3302` n `126` status `ready` deltaP `-8.5371` edge `-0.0663` maxDD `-14.3442`
