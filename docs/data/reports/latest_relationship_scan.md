...
- `market_context_high->equity_4h` score `2.3489` n `96` status `ready` deltaP `12.3729` edge `0.2021` maxDD `-2.4411`
- `market_context_high->equity_1h` score `1.85` n `96` status `ready` deltaP `15.3007` edge `0.0823` maxDD `-0.4112`
- `market_context_high->crypto_major_24h` score `0.9373` n `96` status `ready` deltaP `4.5139` edge `0.1688` maxDD `-4.9964`
...
- `market_context_high->unknown_1h` score `0.0898` n `96` status `ready` deltaP `7.2605` edge `-0.0182` maxDD `-0.4843`
- `market_context_high->fx_4h` score `0.089` n `96` status `ready` deltaP `8.4095` edge `0.0056` maxDD `-0.3539`
- `market_context_high->crypto_major_4h` score `-0.047` n `96` status `ready` deltaP `8.562` edge `0.0411` maxDD `-3.1677`
...
- `market_context_high->crypto_major_1h` score `-0.6707` n `96` status `ready` deltaP `2.0833` edge `-0.0154` maxDD `-2.7581`
