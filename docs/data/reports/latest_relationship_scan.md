...
- `market_context_high->crypto_major_24h` score `5.0169` n `78` status `ready` deltaP `19.6596` edge `0.4078` maxDD `-4.9964`
- `market_context_high->equity_24h` score `3.1288` n `78` status `ready` deltaP `16.9844` edge `0.1475` maxDD `0.0`
...
- `market_context_high->commodity_4h` score `0.6436` n `127` status `ready` deltaP `13.2995` edge `0.05` maxDD `-2.4692`
- `risk_on_high->commodity_4h` score `0.3369` n `35` status `ready` deltaP `2.2309` edge `0.0761` maxDD `-1.3651`
- `risk_on_and_context->commodity_4h` score `0.3369` n `35` status `ready` deltaP `2.2309` edge `0.0761` maxDD `-1.3651`
...
- `market_context_high->commodity_24h` score `0.1056` n `78` status `ready` deltaP `15.3691` edge `0.0944` maxDD `-4.666`
