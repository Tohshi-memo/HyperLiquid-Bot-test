...
- `news_risk_high->equity_24h` score `11.0476` n `51` status `ready` deltaP `39.5425` edge `0.7501` maxDD `-4.7801`
...
- `news_risk_high->equity_1h` score `0.8033` n `51` status `ready` deltaP `17.1451` edge `0.0251` maxDD `-0.9128`
...
- `market_context_high->metal_4h` score `-0.5619` n `132` status `ready` deltaP `6.7535` edge `-0.0334` maxDD `-2.3425`
