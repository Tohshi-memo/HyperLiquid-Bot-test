...
- `market_context_high->commodity_24h` score `0.0727` n `145` status `ready` deltaP `13.9361` edge `0.0715` maxDD `-7.0012`
- `market_context_high->index_1h` score `0.064` n `146` status `ready` deltaP `6.8123` edge `0.0107` maxDD `-0.8324`
- `market_context_high->crypto_major_1h` score `-0.1978` n `146` status `ready` deltaP `7.5568` edge `0.0203` maxDD `-4.0162`
...
- `market_context_high->unknown_1h` score `-1.4355` n `146` status `ready` deltaP `-0.2358` edge `-0.0557` maxDD `-1.3217`
