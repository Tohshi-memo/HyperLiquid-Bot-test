...
- `market_context_high->unknown_1h` score `2.0768` n `207` status `ready` deltaP `-5.719` edge `0.3013` maxDD `-3.2083`
...
- `market_context_high->crypto_major_1h` score `-0.4314` n `207` status `ready` deltaP `6.8074` edge `0.0259` maxDD `-6.7936`
...
- `market_context_high->crypto_alt_1h` score `-0.667` n `207` status `ready` deltaP `4.2422` edge `0.0175` maxDD `-5.8368`
- `market_context_high->index_4h` score `-0.9174` n `207` status `ready` deltaP `9.2186` edge `0.0089` maxDD `-5.7046`
- `market_context_high->equity_1h` score `-1.1596` n `207` status `ready` deltaP `2.0582` edge `0.0` maxDD `-4.1619`
- `market_context_high->commodity_4h` score `-1.2145` n `207` status `ready` deltaP `-0.1856` edge `-0.005` maxDD `-5.6246`
...
- `market_context_high->crypto_major_4h` score `-1.7547` n `207` status `ready` deltaP `7.183` edge `0.0586` maxDD `-16.8495`
- `market_context_high->crypto_alt_4h` score `-2.1179` n `207` status `ready` deltaP `4.2093` edge `0.0406` maxDD `-19.2145`
- `market_context_high->metal_4h` score `-2.1688` n `207` status `ready` deltaP `-1.545` edge `0.0183` maxDD `-5.2172`
- `market_context_high->equity_4h` score `-3.1623` n `207` status `ready` deltaP `6.9276` edge `-0.0247` maxDD `-27.1529`
- `market_context_high->metal_24h` score `-3.2118` n `168` status `ready` deltaP `-0.0227` edge `0.058` maxDD `-10.9026`
