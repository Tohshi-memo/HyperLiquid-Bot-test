...
- Price records: `672`
- Market context records: `816`
- Flow alert records: `2291`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_alt_24h` score `5.1697` n `149` status `ready` deltaP `7.1414` edge `0.388` maxDD `-0.0508`
...
- `risk_on_high->crypto_major_4h` score `2.7334` n `33` status `ready` deltaP `19.8125` edge `0.1329` maxDD `-0.9758`
- `risk_on_and_context->crypto_major_4h` score `2.7334` n `33` status `ready` deltaP `19.8125` edge `0.1329` maxDD `-0.9758`
