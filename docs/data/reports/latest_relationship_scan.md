...
- `market_context_high->equity_24h` score `7.9434` n `132` status `ready` deltaP `28.5507` edge `0.6058` maxDD `-6.0681`
- `market_context_high->metal_24h` score `1.4921` n `133` status `ready` deltaP `14.0577` edge `0.2397` maxDD `-2.3927`
- `market_context_high->crypto_major_4h` score `1.2374` n `133` status `ready` deltaP `15.033` edge `0.1747` maxDD `-6.7444`
- `market_context_high->equity_4h` score `1.1921` n `133` status `ready` deltaP `4.1887` edge `0.3162` maxDD `-6.9701`
- `market_context_high->crypto_major_1h` score `1.0981` n `133` status `ready` deltaP `13.4573` edge `0.0459` maxDD `-1.5286`
- `market_context_high->crypto_alt_4h` score `0.9603` n `133` status `ready` deltaP `9.0363` edge `0.1315` maxDD `-3.9374`
...
- `market_context_high->commodity_4h` score `0.4006` n `133` status `ready` deltaP `7.9401` edge `0.0398` maxDD `-1.0817`
...
- `market_context_high->metal_4h` score `-1.5535` n `133` status `ready` deltaP `0.2998` edge `0.074` maxDD `-1.4368`
