...
- `market_context_high->equity_4h` score `0.6854` n `105` status `ready` deltaP `8.0938` edge `0.1661` maxDD `-8.3685`
- `market_context_high->equity_1h` score `0.5331` n `105` status `ready` deltaP `9.7676` edge `0.0608` maxDD `-3.1861`
...
- `market_context_high->unknown_1h` score `-0.4661` n `105` status `ready` deltaP `7.0317` edge `-0.063` maxDD `-0.4843`
...
- `market_context_high->crypto_major_4h` score `-1.7703` n `105` status `ready` deltaP `6.8351` edge `-0.091` maxDD `-3.1677`
