...
- `market_context_high->crypto_major_24h` score `2.2467` n `84` status `ready` deltaP `7.8918` edge `0.2554` maxDD `-4.9964`
...
- `market_context_high->metal_4h` score `0.8003` n `96` status `ready` deltaP `15.0406` edge `0.024` maxDD `-1.273`
- `market_context_high->crypto_major_4h` score `0.716` n `96` status `ready` deltaP `9.3242` edge `0.0996` maxDD `-3.1677`
...
- `market_context_high->crypto_alt_4h` score `0.5334` n `96` status `ready` deltaP `10.6707` edge `0.1003` maxDD `-5.4926`
...
- `market_context_high->crypto_alt_1h` score `-0.3652` n `96` status `ready` deltaP `2.2268` edge `0.0185` maxDD `-2.413`
- `market_context_high->commodity_4h` score `-0.3741` n `96` status `ready` deltaP `4.0905` edge `0.0098` maxDD `-2.4692`
- `market_context_high->fx_1h` score `-0.4553` n `96` status `ready` deltaP `-3.5679` edge `0.0013` maxDD `-0.2043`
- `market_context_high->crypto_major_1h` score `-0.471` n `96` status `ready` deltaP `1.4845` edge `0.0142` maxDD `-2.7581`
