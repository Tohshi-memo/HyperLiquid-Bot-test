...
- `market_context_high->crypto_major_1h` score `1.0393` n `133` status `ready` deltaP `13.1579` edge `0.043` maxDD `-1.5286`
...
- `market_context_high->commodity_4h` score `-0.1812` n `133` status `ready` deltaP `4.3285` edge `0.0154` maxDD `-1.0817`
...
- `market_context_high->fx_1h` score `-0.542` n `133` status `ready` deltaP `-0.8275` edge `-0.0009` maxDD `-0.4331`
...
- `market_context_high->unknown_1h` score `-2.1565` n `133` status `ready` deltaP `-0.9747` edge `-0.1142` maxDD `-1.054`
