...
- `market_context_high->crypto_major_24h` score `-2.1596` n `102` status `ready` deltaP `6.638` edge `-0.0717` maxDD `-14.2873`
...
- `market_context_high->crypto_alt_4h` score `-4.3216` n `103` status `ready` deltaP `-11.6461` edge `-0.1173` maxDD `-6.5487`
