...
- `market_context_high->crypto_alt_1h` score `-0.3575` n `237` status `ready` deltaP `2.2803` edge `0.0254` maxDD `-4.5815`
...
- `market_context_high->crypto_major_1h` score `-1.1861` n `237` status `ready` deltaP `2.7294` edge `0.0182` maxDD `-7.1523`
...
- `market_context_high->equity_1h` score `-1.971` n `237` status `ready` deltaP `2.5379` edge `-0.0142` maxDD `-15.7664`
- `market_context_high->metal_4h` score `-2.0346` n `237` status `ready` deltaP `4.871` edge `0.005` maxDD `-5.5324`
- `market_context_high->crypto_alt_4h` score `-3.0862` n `237` status `ready` deltaP `-0.0939` edge `-0.0165` maxDD `-22.2831`
- `market_context_high->unknown_4h` score `-3.2857` n `237` status `ready` deltaP `-8.2581` edge `0.0178` maxDD `-10.2579`
- `market_context_high->crypto_major_4h` score `-3.7537` n `237` status `ready` deltaP `-1.3488` edge `-0.0438` maxDD `-24.6094`
...
- `market_context_high->equity_4h` score `-7.678` n `237` status `ready` deltaP `4.1634` edge `-0.0904` maxDD `-66.7371`
