...
- `market_context_high->unknown_24h` score `5.2939` n `124` status `ready` deltaP `19.8869` edge `0.3414` maxDD `-1.626`
...
- `market_context_high->unknown_4h` score `1.4501` n `136` status `ready` deltaP `9.3885` edge `0.1603` maxDD `-3.4972`
- `market_context_high->crypto_major_1h` score `0.5277` n `147` status `ready` deltaP `7.7681` edge `0.1116` maxDD `-4.2199`
- `market_context_high->crypto_alt_1h` score `0.5025` n `147` status `ready` deltaP `6.707` edge `0.1159` maxDD `-6.1656`
- `market_context_high->index_24h` score `0.046` n `124` status `ready` deltaP `4.3514` edge `0.0729` maxDD `-2.5127`
...
- `market_context_high->index_4h` score `-0.2267` n `136` status `ready` deltaP `5.4878` edge `0.0185` maxDD `-2.3986`
- `market_context_high->fx_1h` score `-0.2815` n `147` status `ready` deltaP `1.9319` edge `0.0045` maxDD `-0.278`
- `market_context_high->unknown_1h` score `-0.4522` n `147` status `ready` deltaP `1.9319` edge `0.0214` maxDD `-3.0902`
- `market_context_high->metal_1h` score `-0.492` n `147` status `ready` deltaP `0.9257` edge `0.0067` maxDD `-3.0759`
- `market_context_high->commodity_1h` score `-0.5361` n `147` status `ready` deltaP `2.7751` edge `0.0006` maxDD `-4.3601`
- `market_context_high->fx_4h` score `-0.5875` n `136` status `ready` deltaP `0.278` edge `0.0088` maxDD `-0.8774`
- `market_context_high->index_1h` score `-0.6126` n `147` status `ready` deltaP `-0.8177` edge `0.0038` maxDD `-1.2855`
