...
- `market_context_high->equity_1h` score `-0.6935` n `286` status `ready` deltaP `2.5052` edge `0.0262` maxDD `-5.0555`
- `market_context_high->crypto_major_1h` score `-0.8709` n `286` status `ready` deltaP `3.1992` edge `0.0382` maxDD `-6.2348`
- `market_context_high->crypto_alt_1h` score `-1.0453` n `286` status `ready` deltaP `1.7012` edge `0.035` maxDD `-6.6758`
- `market_context_high->index_4h` score `-1.2257` n `286` status `ready` deltaP `0.0437` edge `0.0113` maxDD `-3.165`
- `market_context_high->fx_4h` score `-1.4498` n `286` status `ready` deltaP `0.7708` edge `0.0039` maxDD `-2.2593`
- `market_context_high->fx_24h` score `-1.4791` n `248` status `ready` deltaP `9.4422` edge `0.0296` maxDD `-5.5737`
...
- `market_context_high->index_24h` score `-2.8151` n `248` status `ready` deltaP `3.7131` edge `0.0288` maxDD `-18.1572`
- `market_context_high->crypto_alt_4h` score `-4.4193` n `286` status `ready` deltaP `5.4857` edge `0.096` maxDD `-28.7346`
...
- `market_context_high->crypto_major_24h` score `-12.1934` n `248` status `ready` deltaP `-3.3714` edge `-0.2952` maxDD `-36.5416`
