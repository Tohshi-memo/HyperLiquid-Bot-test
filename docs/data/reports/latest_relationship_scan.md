...
- `market_context_high->crypto_major_1h` score `-3.5836` n `149` status `ready` deltaP `-5.2083` edge `-0.1162` maxDD `-7.8171`
...
- `market_context_high->crypto_major_4h` score `-5.6028` n `149` status `ready` deltaP `-0.5412` edge `-0.3303` maxDD `-5.6395`
