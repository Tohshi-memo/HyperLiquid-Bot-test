...
- `news_risk_high->crypto_major_24h` score `51.2941` n `72` status `ready` deltaP `28.125` edge `4.1762` maxDD `-5.8019`
- `market_context_high->unknown_4h` score `48.0184` n `122` status `ready` deltaP `-3.3961` edge `4.0475` maxDD `-0.5326`
- `news_risk_high->crypto_alt_24h` score `44.8263` n `72` status `ready` deltaP `33.6806` edge `3.6489` maxDD `-9.3661`
- `risk_on_high->unknown_4h` score `30.0043` n `32` status `ready` deltaP `-16.9207` edge `2.6357` maxDD `-0.4694`
- `risk_on_and_context->unknown_4h` score `30.0043` n `32` status `ready` deltaP `-16.9207` edge `2.6357` maxDD `-0.4694`
