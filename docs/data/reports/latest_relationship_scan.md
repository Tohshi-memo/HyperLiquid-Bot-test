...
- `market_context_high->equity_24h` score `6.3578` n `81` status `ready` deltaP `2.2955` edge `0.8205` maxDD `-21.1456`
...
- `market_context_high->index_4h` score `-0.5899` n `103` status `ready` deltaP `-0.6616` edge `-0.0107` maxDD `-1.1743`
- `market_context_high->metal_1h` score `-0.6163` n `103` status `ready` deltaP `-3.5608` edge `-0.0057` maxDD `-0.9664`
- `market_context_high->fx_4h` score `-0.9577` n `103` status `ready` deltaP `0.108` edge `-0.0052` maxDD `-1.6928`
...
- `market_context_high->crypto_major_24h` score `-2.3912` n `81` status `ready` deltaP `8.6034` edge `-0.1145` maxDD `-14.2873`
...
- `market_context_high->crypto_major_4h` score `-7.2561` n `103` status `ready` deltaP `-9.6806` edge `-0.201` maxDD `-18.1307`
