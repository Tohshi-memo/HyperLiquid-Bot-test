...
- `news_risk_high->unknown_4h` score `12.9068` n `34` status `ready` deltaP `29.7256` edge `0.8774` maxDD `0.0`
- `news_risk_high->equity_4h` score `6.7037` n `34` status `ready` deltaP `47.2561` edge `0.2436` maxDD `0.0`
- `news_risk_high->unknown_1h` score `5.4278` n `46` status `ready` deltaP `28.5797` edge `0.2736` maxDD `-0.2787`
- `news_risk_high->fx_4h` score `3.1771` n `34` status `ready` deltaP `37.2131` edge `0.0301` maxDD `-0.0746`
- `news_risk_high->metal_4h` score `2.0917` n `34` status `ready` deltaP `26.91` edge `0.0033` maxDD `-0.0045`
- `market_context_high->unknown_1h` score `1.5285` n `135` status `ready` deltaP `6.1643` edge `0.109` maxDD `-0.4843`
- `news_risk_high->fx_1h` score `1.471` n `46` status `ready` deltaP `19.8711` edge `0.0071` maxDD `-0.0257`
- `news_risk_high->equity_1h` score `1.279` n `46` status `ready` deltaP `24.8178` edge `0.0267` maxDD `-0.9204`
- `market_context_high->unknown_4h` score `0.9988` n `135` status `ready` deltaP `20.096` edge `-0.0294` maxDD `-0.3736`
...
- `news_risk_high->metal_1h` score `0.0583` n `46` status `ready` deltaP `5.4738` edge `-0.0067` maxDD `-0.1184`
- `market_context_high->index_1h` score `-0.0703` n `135` status `ready` deltaP `5.9969` edge `0.0041` maxDD `-0.9144`
- `news_risk_high->crypto_major_4h` score `-0.1591` n `34` status `ready` deltaP `-2.4121` edge `0.1395` maxDD `-6.9344`
- `market_context_high->fx_1h` score `-0.1669` n `135` status `ready` deltaP `1.5137` edge `0.0044` maxDD `-0.2043`
- `news_risk_high->commodity_4h` score `-0.2411` n `34` status `ready` deltaP `5.6044` edge `-0.0221` maxDD `-1.0273`
