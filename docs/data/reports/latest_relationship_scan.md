...
- `market_context_high->metal_4h` score `-0.9552` n `125` status `ready` deltaP `7.2183` edge `-0.0132` maxDD `-4.5909`
...
- `market_context_high->crypto_major_1h` score `-1.9762` n `125` status `ready` deltaP `-4.4` edge `-0.03` maxDD `-5.4277`
