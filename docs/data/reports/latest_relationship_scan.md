...
- `market_context_high->crypto_major_24h` score `2.4744` n `92` status `ready` deltaP `8.273` edge `0.2887` maxDD `-5.6792`
...
- `risk_on_high->crypto_major_1h` score `1.0851` n `35` status `ready` deltaP `12.1086` edge `0.0403` maxDD `-1.1144`
- `risk_on_and_context->crypto_major_1h` score `1.0851` n `35` status `ready` deltaP `12.1086` edge `0.0403` maxDD `-1.1144`
...
- `market_context_high->commodity_4h` score `0.3497` n `131` status `ready` deltaP `11.5295` edge `0.053` maxDD `-2.4692`
...
- `risk_on_high->crypto_major_4h` score `0.2148` n `35` status `ready` deltaP `2.9137` edge `0.0793` maxDD `-2.0278`
- `risk_on_and_context->crypto_major_4h` score `0.2148` n `35` status `ready` deltaP `2.9137` edge `0.0793` maxDD `-2.0278`
