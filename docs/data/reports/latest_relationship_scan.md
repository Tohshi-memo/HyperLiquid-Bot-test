...
- `news_risk_high->crypto_alt_24h` score `17.7153` n `82` status `ready` deltaP `31.8851` edge `1.3125` maxDD `-2.2369`
- `news_risk_high->crypto_major_24h` score `17.668` n `82` status `ready` deltaP `37.589` edge `1.3688` maxDD `-9.098`
- `market_context_high->equity_24h` score `11.0373` n `54` status `ready` deltaP `49.8264` edge `0.5876` maxDD `0.0`
- `market_context_high->crypto_alt_24h` score `9.7455` n `54` status `ready` deltaP `19.3287` edge `0.766` maxDD `-3.9523`
- `news_risk_high->equity_24h` score `6.839` n `82` status `ready` deltaP `19.3386` edge `0.619` maxDD `-6.5742`
...
- `risk_on_high->crypto_alt_4h` score `0.3959` n `62` status `ready` deltaP `11.9886` edge `0.1383` maxDD `-6.7304`
- `risk_on_and_context->crypto_alt_4h` score `0.3959` n `62` status `ready` deltaP `11.9886` edge `0.1383` maxDD `-6.7304`
- `news_risk_high->index_4h` score `0.2956` n `82` status `ready` deltaP `10.6707` edge `0.0296` maxDD `-0.6935`
