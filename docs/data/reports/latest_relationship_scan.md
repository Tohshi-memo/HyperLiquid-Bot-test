...
- `news_risk_high->unknown_1h` score `383.2836` n `82` status `ready` deltaP `-3.1547` edge `32.0035` maxDD `-1.7068`
- `risk_on_high->crypto_alt_24h` score `25.1167` n `91` status `ready` deltaP `43.1166` edge `1.8286` maxDD `-0.8386`
- `risk_on_and_context->crypto_alt_24h` score `25.1167` n `91` status `ready` deltaP `43.1166` edge `1.8286` maxDD `-0.8386`
- `news_risk_high->crypto_major_24h` score `22.9246` n `47` status `ready` deltaP `52.7741` edge `1.6486` maxDD `-5.8705`
- `market_context_high->crypto_alt_24h` score `21.8562` n `149` status `ready` deltaP `37.8728` edge `1.6516` maxDD `-3.9523`
- `news_risk_high->crypto_alt_24h` score `14.5638` n `47` status `ready` deltaP `25.2068` edge `1.0944` maxDD `-2.2369`
- `news_risk_high->equity_24h` score `11.0593` n `47` status `ready` deltaP `32.7239` edge `0.7133` maxDD `-0.1212`
