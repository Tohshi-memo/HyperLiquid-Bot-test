...
- `market_context_high->metal_4h` score `2.5875` n `100` status `ready` deltaP `23.6646` edge `0.1201` maxDD `-0.979`
...
- `market_context_high->crypto_alt_4h` score `0.9155` n `100` status `ready` deltaP `8.3415` edge `0.1324` maxDD `-3.9374`
...
- `market_context_high->commodity_4h` score `-1.047` n `100` status `ready` deltaP `0.4085` edge `-0.0017` maxDD `-4.8205`
