...
- `risk_on_high->unknown_4h` score `48.8401` n `72` status `ready` deltaP `8.0284` edge `6.4222` maxDD `-13.467`
- `risk_on_and_context->unknown_4h` score `48.8401` n `72` status `ready` deltaP `8.0284` edge `6.4222` maxDD `-13.467`
...
- `market_context_high->unknown_4h` score `8.1674` n `206` status `ready` deltaP `0.1805` edge `1.5868` maxDD `-35.6052`
- `market_context_high->unknown_24h` score `7.9713` n `129` status `ready` deltaP `-20.0339` edge `4.0037` maxDD `-200.1879`
- `market_context_high->equity_24h` score `6.8044` n `129` status `ready` deltaP `14.8821` edge `0.7708` maxDD `-14.5715`
- `market_context_high->index_24h` score `6.0421` n `129` status `ready` deltaP `25.8236` edge `0.4453` maxDD `-7.1159`
- `risk_on_high->crypto_major_4h` score `5.297` n `72` status `ready` deltaP `18.5467` edge `0.43` maxDD `-5.9781`
- `risk_on_and_context->crypto_major_4h` score `5.297` n `72` status `ready` deltaP `18.5467` edge `0.43` maxDD `-5.9781`
- `market_context_high->metal_24h` score `3.6637` n `129` status `ready` deltaP `20.9222` edge `0.309` maxDD `-9.1203`
- `risk_on_high->equity_4h` score `2.6145` n `72` status `ready` deltaP `25.8638` edge `0.1589` maxDD `-5.7426`
- `risk_on_and_context->equity_4h` score `2.6145` n `72` status `ready` deltaP `25.8638` edge `0.1589` maxDD `-5.7426`
- `market_context_high->crypto_major_24h` score `1.6923` n `129` status `ready` deltaP `0.7187` edge `0.5826` maxDD `-31.0425`
