...
- `news_risk_high->crypto_alt_24h` score `20.8827` n `43` status `ready` deltaP `47.953` edge `1.4794` maxDD `-4.3757`
- `news_risk_high->metal_24h` score `18.1769` n `43` status `ready` deltaP `49.4105` edge `1.2293` maxDD `-3.1836`
- `news_risk_high->equity_24h` score `15.3259` n `43` status `ready` deltaP `29.7925` edge `1.11` maxDD `-2.1831`
- `news_risk_high->crypto_major_24h` score `11.3237` n `43` status `ready` deltaP `19.2466` edge `0.8734` maxDD `-3.3119`
...
- `market_context_high->crypto_major_4h` score `4.9004` n `138` status `ready` deltaP `24.145` edge `0.4284` maxDD `-10.1468`
- `market_context_high->crypto_alt_4h` score `3.6541` n `138` status `ready` deltaP `18.496` edge `0.4491` maxDD `-15.4319`
...
- `market_context_high->crypto_major_24h` score `2.9782` n `115` status `ready` deltaP `13.827` edge `0.6789` maxDD `-25.1408`
...
- `market_context_high->crypto_major_1h` score `1.3076` n `138` status `ready` deltaP `12.6725` edge `0.1439` maxDD `-4.2199`
...
- `market_context_high->crypto_alt_1h` score `0.7889` n `138` status `ready` deltaP `8.0969` edge `0.1305` maxDD `-6.1656`
