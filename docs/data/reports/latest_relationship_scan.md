...
- `market_context_high->crypto_alt_24h` score `-1.4727` n `90` status `ready` deltaP `0.5555` edge `-0.0482` maxDD `-4.5445`
- `market_context_high->crypto_alt_1h` score `-1.6057` n `109` status `ready` deltaP `-5.2876` edge `-0.0275` maxDD `-3.0178`
- `market_context_high->crypto_alt_4h` score `-1.6696` n `105` status `ready` deltaP `-0.7448` edge `-0.0701` maxDD `-5.7857`
- `market_context_high->equity_1h` score `-1.9383` n `109` status `ready` deltaP `0.3709` edge `-0.0974` maxDD `-10.619`
- `market_context_high->index_4h` score `-2.2277` n `105` status `ready` deltaP `-14.004` edge `-0.0668` maxDD `-4.7021`
- `market_context_high->index_24h` score `-2.3683` n `90` status `ready` deltaP `-9.8612` edge `-0.0184` maxDD `-7.8922`
- `market_context_high->crypto_major_1h` score `-3.4782` n `109` status `ready` deltaP `-12.0475` edge `-0.0722` maxDD `-7.6533`
