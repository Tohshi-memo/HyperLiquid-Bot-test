...
- `market_context_high->unknown_24h` score `145.2854` n `125` status `ready` deltaP `-23.7657` edge `12.5568` maxDD `-9.6329`
- `risk_on_high->unknown_24h` score `33.8868` n `32` status `ready` deltaP `-35.4907` edge `4.6561` maxDD `-1.6689`
- `risk_on_and_context->unknown_24h` score `33.8868` n `32` status `ready` deltaP `-35.4907` edge `4.6561` maxDD `-1.6689`
...
- `news_risk_high->equity_1h` score `1.7945` n `36` status `ready` deltaP `8.8823` edge `0.1222` maxDD `-0.5496`
