...
- Price records: `672`
- Market context records: `1865`
- Flow alert records: `7271`
- Minimum samples: `30`
- Pattern count: `48`
...
- `market_context_high->crypto_major_4h` score `6.1562` n `199` status `ready` deltaP `25.4282` edge `0.4681` maxDD `-4.9684`
...
- `market_context_high->index_24h` score `2.3896` n `178` status `ready` deltaP `13.1808` edge `0.2341` maxDD `-4.1604`
- `market_context_high->equity_4h` score `2.1516` n `199` status `ready` deltaP `13.9723` edge `0.1956` maxDD `-5.0894`
- `market_context_high->unknown_24h` score `1.9828` n `178` status `ready` deltaP `12.4766` edge `0.6141` maxDD `-35.8966`
- `market_context_high->index_4h` score `0.4029` n `199` status `ready` deltaP `9.9407` edge `0.0762` maxDD `-3.7119`
- `market_context_high->equity_24h` score `0.3775` n `178` status `ready` deltaP `10.68` edge `0.4501` maxDD `-33.1875`
- `market_context_high->crypto_major_1h` score `0.288` n `199` status `ready` deltaP `5.2975` edge `0.0873` maxDD `-3.2225`
- `market_context_high->crypto_major_24h` score `0.2443` n `178` status `ready` deltaP `19.2065` edge `0.7509` maxDD `-62.3533`
- `market_context_high->fx_24h` score `0.1648` n `178` status `ready` deltaP `13.8655` edge `0.0262` maxDD `-1.3925`
- `market_context_high->crypto_alt_1h` score `-0.044` n `199` status `ready` deltaP `4.2601` edge `0.0793` maxDD `-4.9097`
...
- `market_context_high->unknown_1h` score `-0.6116` n `199` status `ready` deltaP `2.6886` edge `0.0263` maxDD `-3.6151`
