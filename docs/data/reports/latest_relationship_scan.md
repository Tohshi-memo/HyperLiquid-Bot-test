...
- `market_context_high->index_1h` score `-0.7298` n `203` status `ready` deltaP `-0.1261` edge `-0.0016` maxDD `-2.2895`
- `market_context_high->commodity_1h` score `-0.735` n `203` status `ready` deltaP `-2.8347` edge `-0.0137` maxDD `-1.9306`
- `market_context_high->metal_1h` score `-0.7761` n `203` status `ready` deltaP `-3.2123` edge `-0.0013` maxDD `-2.1427`
...
- `market_context_high->equity_1h` score `-1.769` n `203` status `ready` deltaP `4.5441` edge `-0.0148` maxDD `-14.716`
...
- `market_context_high->unknown_24h` score `-2.5257` n `200` status `ready` deltaP `-10.8819` edge `0.252` maxDD `-22.594`
...
- `market_context_high->fx_24h` score `-3.6266` n `200` status `ready` deltaP `-1.3056` edge `-0.0108` maxDD `-3.9503`
- `market_context_high->equity_4h` score `-7.4006` n `203` status `ready` deltaP `4.4906` edge `-0.0917` maxDD `-63.963`
- `market_context_high->metal_24h` score `-14.7884` n `200` status `ready` deltaP `-15.7708` edge `-0.0746` maxDD `-43.8766`
