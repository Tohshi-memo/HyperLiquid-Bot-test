...
- `risk_on_high->equity_24h` score `6.1637` n `107` status `ready` deltaP `27.1742` edge `0.747` maxDD `-19.828`
- `risk_on_and_context->equity_24h` score `6.1637` n `107` status `ready` deltaP `27.1742` edge `0.747` maxDD `-19.828`
- `market_context_high->unknown_4h` score `4.615` n `147` status `ready` deltaP `12.7531` edge `0.3691` maxDD `-2.563`
- `news_risk_high->equity_24h` score `3.1639` n `59` status `ready` deltaP `13.1238` edge `0.4229` maxDD `-15.4056`
- `market_context_high->equity_24h` score `2.3518` n `147` status `ready` deltaP `23.1434` edge `0.6281` maxDD `-24.4698`
...
- `risk_on_high->metal_1h` score `-0.0342` n `107` status `ready` deltaP `10.2986` edge `-0.0018` maxDD `-1.699`
- `risk_on_and_context->metal_1h` score `-0.0342` n `107` status `ready` deltaP `10.2986` edge `-0.0018` maxDD `-1.699`
- `news_risk_high->commodity_1h` score `-0.1886` n `67` status `ready` deltaP `4.6072` edge `-0.0018` maxDD `-0.9036`
- `risk_on_high->commodity_1h` score `-0.191` n `107` status `ready` deltaP `3.2263` edge `0.0062` maxDD `-0.8428`
