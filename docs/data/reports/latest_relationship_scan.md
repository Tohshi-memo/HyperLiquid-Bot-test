...
- `market_context_high->metal_24h` score `12.5415` n `179` status `ready` deltaP `22.9613` edge `0.9921` maxDD `-6.3373`
- `market_context_high->crypto_alt_24h` score `11.5071` n `179` status `ready` deltaP `28.3587` edge `0.9715` maxDD `-15.1306`
- `market_context_high->crypto_major_24h` score `9.6417` n `179` status `ready` deltaP `27.3995` edge `0.734` maxDD `-8.0553`
...
- `market_context_high->crypto_alt_4h` score `-0.4341` n `199` status `ready` deltaP `11.7301` edge `0.1981` maxDD `-19.5565`
- `market_context_high->crypto_major_4h` score `-0.5123` n `199` status `ready` deltaP `7.7552` edge `0.1535` maxDD `-13.3376`
- `market_context_high->crypto_alt_1h` score `-0.5203` n `199` status `ready` deltaP `0.0692` edge `0.0352` maxDD `-4.1892`
...
- `market_context_high->commodity_1h` score `-0.7554` n `199` status `ready` deltaP `-0.6469` edge `-0.0004` maxDD `-4.7041`
...
- `market_context_high->crypto_major_1h` score `-1.0501` n `199` status `ready` deltaP `-1.4917` edge `0.011` maxDD `-6.1883`
