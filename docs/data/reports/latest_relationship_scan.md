...
- `news_risk_high->crypto_alt_1h` score `0.1476` n `30` status `ready` deltaP `4.5709` edge `0.0346` maxDD `-1.6923`
- `market_context_high->equity_1h` score `-0.1938` n `221` status `ready` deltaP `5.0946` edge `0.0332` maxDD `-4.3608`
- `market_context_high->metal_1h` score `-0.3` n `221` status `ready` deltaP `3.71` edge `0.0039` maxDD `-2.0339`
...
- `market_context_high->crypto_alt_1h` score `-0.7212` n `221` status `ready` deltaP `2.2028` edge `0.0263` maxDD `-6.6758`
- `market_context_high->fx_1h` score `-0.7632` n `221` status `ready` deltaP `-2.0464` edge `-0.0011` maxDD `-0.5751`
- `market_context_high->index_1h` score `-0.9693` n `221` status `ready` deltaP `0.0901` edge `0.0034` maxDD `-0.7819`
...
- `market_context_high->equity_24h` score `-1.7158` n `213` status `ready` deltaP `14.8866` edge `0.1884` maxDD `-31.2762`
- `market_context_high->metal_4h` score `-1.8542` n `221` status `ready` deltaP `-4.8428` edge `-0.0422` maxDD `-5.725`
