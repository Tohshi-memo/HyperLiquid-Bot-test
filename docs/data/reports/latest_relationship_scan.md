...
- `market_context_high->unknown_1h` score `-1.6225` n `237` status `ready` deltaP `-2.2803` edge `-0.0299` maxDD `-3.2083`
- `market_context_high->commodity_4h` score `-1.6679` n `237` status `ready` deltaP `-4.4329` edge `-0.0353` maxDD `-5.5853`
- `market_context_high->index_4h` score `-1.8221` n `237` status `ready` deltaP `7.5145` edge `-0.0138` maxDD `-12.2591`
- `market_context_high->equity_1h` score `-1.9492` n `237` status `ready` deltaP `2.8373` edge `-0.0134` maxDD `-15.7664`
- `market_context_high->metal_4h` score `-1.985` n `237` status `ready` deltaP `5.4807` edge `0.0073` maxDD `-5.5324`
- `market_context_high->crypto_alt_4h` score `-2.8926` n `237` status `ready` deltaP `0.9732` edge `0.0012` maxDD `-22.2831`
- `market_context_high->unknown_4h` score `-3.0564` n `237` status `ready` deltaP `-7.191` edge `0.0298` maxDD `-10.2579`
- `market_context_high->crypto_major_4h` score `-3.5375` n `237` status `ready` deltaP `-0.2817` edge `-0.0232` maxDD `-24.6094`
...
- `market_context_high->equity_4h` score `-7.5368` n `237` status `ready` deltaP `5.0781` edge `-0.0784` maxDD `-66.7371`
