...
- `market_context_high->crypto_major_24h` score `7.5056` n `153` status `ready` deltaP `25.7353` edge `0.8689` maxDD `-26.5332`
- `market_context_high->crypto_alt_4h` score `4.314` n `177` status `ready` deltaP `16.962` edge `0.4105` maxDD `-9.46`
- `market_context_high->equity_24h` score `4.0322` n `153` status `ready` deltaP `19.9653` edge `0.7658` maxDD `-40.0306`
- `market_context_high->crypto_major_4h` score `4.0184` n `177` status `ready` deltaP `16.2628` edge `0.4557` maxDD `-14.0065`
...
- `market_context_high->crypto_alt_1h` score `0.4184` n `186` status `ready` deltaP `4.6681` edge `0.0999` maxDD `-5.0257`
- `market_context_high->crypto_major_1h` score `0.2491` n `186` status `ready` deltaP `5.8657` edge `0.1062` maxDD `-6.9639`
- `market_context_high->index_24h` score `0.249` n `153` status `ready` deltaP `20.8231` edge `0.0566` maxDD `-7.413`
- `market_context_high->equity_1h` score `0.1616` n `186` status `ready` deltaP `7.8746` edge `0.0575` maxDD `-5.0555`
...
- `market_context_high->unknown_1h` score `-2.8768` n `186` status `ready` deltaP `7.0376` edge `-0.2225` maxDD `-2.7986`
