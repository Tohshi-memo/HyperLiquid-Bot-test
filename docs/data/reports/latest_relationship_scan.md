...
- `risk_on_high->fx_1h` score `0.1861` n `32` status `ready` deltaP `5.3518` edge `0.0026` maxDD `-0.1547`
- `risk_on_and_context->fx_1h` score `0.1861` n `32` status `ready` deltaP `5.3518` edge `0.0026` maxDD `-0.1547`
