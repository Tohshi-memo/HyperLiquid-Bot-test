...
- `market_context_high->equity_4h` score `0.653` n `266` status `ready` deltaP `7.6792` edge `0.149` maxDD `-6.9958`
- `market_context_high->fx_1h` score `-0.3253` n `266` status `ready` deltaP `1.0547` edge `-0.0002` maxDD `-0.5499`
- `market_context_high->equity_1h` score `-0.408` n `266` status `ready` deltaP `4.1691` edge `0.0389` maxDD `-5.0555`
...
- `market_context_high->equity_24h` score `-0.5787` n `238` status `ready` deltaP `15.8949` edge `0.3537` maxDD `-31.6316`
- `market_context_high->metal_1h` score `-0.6215` n `266` status `ready` deltaP `2.1892` edge `0.0007` maxDD `-2.0339`
- `market_context_high->crypto_major_1h` score `-1.0128` n `266` status `ready` deltaP `2.5652` edge `0.0306` maxDD `-6.2348`
...
- `market_context_high->metal_4h` score `-2.202` n `266` status `ready` deltaP `-5.2035` edge `-0.0445` maxDD `-8.9164`
- `market_context_high->commodity_4h` score `-2.5565` n `266` status `ready` deltaP `-0.9021` edge `-0.0147` maxDD `-8.0531`
...
- `market_context_high->crypto_alt_24h` score `-12.8339` n `238` status `ready` deltaP `-12.2534` edge `-0.533` maxDD `-61.7883`
