...
- `news_risk_high->unknown_4h` score `13.1935` n `51` status `ready` deltaP `23.649` edge `0.9464` maxDD `-0.0348`
- `risk_on_high->unknown_1h` score `3.9348` n `37` status `ready` deltaP `-9.1115` edge `0.6101` maxDD `-1.5916`
- `risk_on_and_context->unknown_1h` score `3.9348` n `37` status `ready` deltaP `-9.1115` edge `0.6101` maxDD `-1.5916`
- `news_risk_high->unknown_1h` score `3.069` n `51` status `ready` deltaP `16.4846` edge `0.1763` maxDD `-0.7693`
...
- `market_context_high->unknown_1h` score `1.4186` n `147` status `ready` deltaP `8.2814` edge `0.1079` maxDD `-1.5916`
- `news_risk_high->fx_1h` score `1.2302` n `51` status `ready` deltaP `16.8457` edge `0.0072` maxDD `-0.0257`
- `market_context_high->unknown_4h` score `1.1497` n `135` status `ready` deltaP `21.1654` edge `-0.0316` maxDD `-0.0956`
- `market_context_high->crypto_alt_4h` score `1.1394` n `135` status `ready` deltaP `10.6617` edge `0.1703` maxDD `-7.0478`
