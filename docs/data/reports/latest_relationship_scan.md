...
- `market_context_high->equity_4h` score `0.1874` n `269` status `ready` deltaP `7.062` edge `0.1324` maxDD `-7.4425`
...
- `market_context_high->crypto_major_24h` score `-4.5443` n `219` status `ready` deltaP `6.2405` edge `0.0254` maxDD `-29.6555`
