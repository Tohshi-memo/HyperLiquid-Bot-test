...
- `market_context_high->crypto_alt_1h` score `-0.4082` n `237` status `ready` deltaP `1.9809` edge `0.0209` maxDD `-4.5815`
...
- `market_context_high->crypto_major_1h` score `-1.2281` n `237` status `ready` deltaP `2.7294` edge `0.0147` maxDD `-7.1523`
...
- `market_context_high->unknown_24h` score `-1.6696` n `224` status `ready` deltaP `-9.2014` edge `0.3023` maxDD `-18.7342`
- `market_context_high->index_4h` score `-1.8561` n `237` status `ready` deltaP `7.0572` edge `-0.0151` maxDD `-12.2591`
- `market_context_high->equity_1h` score `-2.0318` n `237` status `ready` deltaP `1.9391` edge `-0.018` maxDD `-15.7664`
- `market_context_high->metal_4h` score `-2.0662` n `237` status `ready` deltaP `4.4137` edge `0.004` maxDD `-5.5324`
- `market_context_high->crypto_alt_4h` score `-3.1928` n `237` status `ready` deltaP `-0.7036` edge `-0.0261` maxDD `-22.2831`
...
- `market_context_high->crypto_major_4h` score `-3.8673` n `237` status `ready` deltaP `-1.9586` edge `-0.0543` maxDD `-24.6094`
- `market_context_high->fx_24h` score `-4.4269` n `224` status `ready` deltaP `-7.3661` edge `-0.0151` maxDD `-5.7093`
- `market_context_high->equity_4h` score `-7.7361` n `237` status `ready` deltaP `3.7061` edge `-0.0948` maxDD `-66.7371`
