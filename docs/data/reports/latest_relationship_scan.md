...
- Generated: `2026-07-12T12:46:11.310870+00:00`
- Price records: `672`
- Market context records: `6499`
...
- `news_risk_high->crypto_alt_24h` score `12.8563` n `32` status `ready` deltaP `34.6512` edge `0.8551` maxDD `-0.5131`
...
- `news_risk_high->crypto_major_24h` score `4.7217` n `32` status `ready` deltaP `19.3512` edge `0.5543` maxDD `-4.2368`
...
- `market_context_high->crypto_alt_4h` score `0.6569` n `169` status `ready` deltaP `11.3426` edge `0.1345` maxDD `-6.7632`
- `market_context_high->unknown_4h` score `0.616` n `169` status `ready` deltaP `-14.8946` edge `0.3912` maxDD `-10.5788`
- `news_risk_high->crypto_major_1h` score `0.5364` n `38` status `ready` deltaP `4.751` edge `0.0908` maxDD `-2.6299`
- `news_risk_high->crypto_alt_1h` score `0.0407` n `38` status `ready` deltaP `1.2843` edge `0.0476` maxDD `-2.0756`
...
- `market_context_high->crypto_major_1h` score `-0.467` n `180` status `ready` deltaP `7.4119` edge `0.0173` maxDD `-6.7936`
- `market_context_high->fx_1h` score `-0.4802` n `180` status `ready` deltaP `-1.0646` edge `-0.0021` maxDD `-0.8555`
- `market_context_high->metal_4h` score `-0.4883` n `169` status `ready` deltaP `7.6094` edge `0.0424` maxDD `-2.7056`
