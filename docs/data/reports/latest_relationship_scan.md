...
- `market_context_high->unknown_24h` score `2.7496` n `142` status `ready` deltaP `3.9906` edge `0.249` maxDD `-1.7175`
- `market_context_high->unknown_4h` score `1.109` n `142` status `ready` deltaP `7.2526` edge `0.1494` maxDD `-3.7602`
- `market_context_high->crypto_alt_24h` score `1.1038` n `142` status `ready` deltaP `1.3131` edge `0.4749` maxDD `-22.6673`
...
- `market_context_high->crypto_alt_1h` score `-0.7966` n `142` status `ready` deltaP `4.7968` edge `0.0419` maxDD `-10.747`
...
- `market_context_high->equity_4h` score `-1.101` n `142` status `ready` deltaP `2.2673` edge `0.0311` maxDD `-5.7037`
...
- `market_context_high->crypto_alt_4h` score `-1.6999` n `142` status `ready` deltaP `13.7281` edge `0.2009` maxDD `-28.7261`
- `market_context_high->metal_4h` score `-2.0521` n `142` status `ready` deltaP `0.1439` edge `-0.009` maxDD `-11.4038`
