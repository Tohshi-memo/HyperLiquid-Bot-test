...
- `market_context_high->equity_1h` score `-0.3897` n `103` status `ready` deltaP `4.1975` edge `0.0224` maxDD `-4.6286`
...
- `market_context_high->fx_4h` score `-0.8907` n `103` status `ready` deltaP `0.8702` edge `-0.0047` maxDD `-1.6928`
...
- `market_context_high->crypto_major_4h` score `-7.5324` n `103` status `ready` deltaP `-11.8148` edge `-0.2098` maxDD `-18.1307`
