...
- `risk_on_high->index_24h` score `11.7054` n `32` status `ready` deltaP `32.8125` edge `0.7567` maxDD `0.0`
- `risk_on_and_context->index_24h` score `11.7054` n `32` status `ready` deltaP `32.8125` edge `0.7567` maxDD `0.0`
...
- `market_context_high->equity_24h` score `6.6444` n `156` status `ready` deltaP `18.5897` edge `0.6525` maxDD `-12.8184`
- `market_context_high->index_24h` score `4.8885` n `156` status `ready` deltaP `23.8381` edge `0.3624` maxDD `-7.1159`
...
- `risk_on_high->crypto_alt_4h` score `2.0456` n `32` status `ready` deltaP `-0.0762` edge `0.3554` maxDD `-11.7537`
- `risk_on_and_context->crypto_alt_4h` score `2.0456` n `32` status `ready` deltaP `-0.0762` edge `0.3554` maxDD `-11.7537`
