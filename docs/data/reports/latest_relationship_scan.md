...
- `market_context_high->crypto_alt_24h` score `16.9676` n `86` status `ready` deltaP `12.7664` edge `2.5314` maxDD `-26.6275`
...
- `market_context_high->crypto_alt_1h` score `-0.7118` n `124` status `ready` deltaP `4.0661` edge `0.0946` maxDD `-14.7034`
...
- `market_context_high->crypto_major_1h` score `-1.9572` n `124` status `ready` deltaP `0.1931` edge `0.0619` maxDD `-15.1032`
- `market_context_high->metal_1h` score `-2.3818` n `124` status `ready` deltaP `-7.1567` edge `-0.0114` maxDD `-7.4828`
- `market_context_high->crypto_alt_4h` score `-3.2921` n `120` status `ready` deltaP `16.4431` edge `0.2728` maxDD `-58.6918`
