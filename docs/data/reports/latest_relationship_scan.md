...
- `market_context_high->unknown_4h` score `0.8859` n `149` status `ready` deltaP `18.7418` edge `-0.0072` maxDD `-0.5133`
...
- `market_context_high->crypto_major_1h` score `-3.6148` n `149` status `ready` deltaP `-5.358` edge `-0.1178` maxDD `-7.8171`
