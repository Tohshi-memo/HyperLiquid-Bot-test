...
- `market_context_high->unknown_1h` score `2.382` n `198` status `ready` deltaP `-5.1443` edge `0.3229` maxDD `-3.2083`
...
- `market_context_high->crypto_alt_1h` score `0.0167` n `198` status `ready` deltaP `5.3862` edge `0.0419` maxDD `-3.7803`
...
- `market_context_high->equity_1h` score `-0.9274` n `198` status `ready` deltaP `3.3479` edge `0.0031` maxDD `-3.8827`
