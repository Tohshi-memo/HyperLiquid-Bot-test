...
- Price records: `672`
- Market context records: `1772`
- Flow alert records: `7000`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_alt_4h` score `6.1608` n `194` status `ready` deltaP `21.7076` edge `0.5453` maxDD `-9.1295`
- `news_risk_high->commodity_4h` score `5.8458` n `30` status `ready` deltaP `27.124` edge `0.3718` maxDD `-3.5713`
- `market_context_high->crypto_major_4h` score `4.7236` n `194` status `ready` deltaP `22.935` edge `0.4813` maxDD `-10.9117`
- `market_context_high->index_24h` score `3.7579` n `178` status `ready` deltaP `18.6447` edge `0.3117` maxDD `-4.1604`
...
- `market_context_high->index_4h` score `1.0367` n `194` status `ready` deltaP `12.764` edge `0.1102` maxDD `-3.7119`
- `market_context_high->crypto_alt_1h` score `0.8656` n `194` status `ready` deltaP `8.1301` edge `0.1203` maxDD `-4.1892`
...
- `market_context_high->crypto_major_1h` score `0.3143` n `194` status `ready` deltaP `5.2704` edge `0.0984` maxDD `-3.9211`
...
- `market_context_high->index_1h` score `-0.14` n `194` status `ready` deltaP `4.471` edge `0.0217` maxDD `-1.7205`
