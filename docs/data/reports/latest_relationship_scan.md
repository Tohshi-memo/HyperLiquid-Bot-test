...
- `market_context_high->unknown_1h` score `30.1082` n `229` status `ready` deltaP `3.8504` edge `2.6413` maxDD `-9.6361`
...
- `risk_on_high->equity_24h` score `2.0805` n `44` status `ready` deltaP `22.9167` edge `0.0206` maxDD `0.0`
- `risk_on_and_context->equity_24h` score `2.0805` n `44` status `ready` deltaP `22.9167` edge `0.0206` maxDD `0.0`
- `risk_on_high->crypto_major_4h` score `1.6851` n `44` status `ready` deltaP `17.6968` edge `0.089` maxDD `-2.6576`
- `risk_on_and_context->crypto_major_4h` score `1.6851` n `44` status `ready` deltaP `17.6968` edge `0.089` maxDD `-2.6576`
...
- `risk_on_high->crypto_major_1h` score `0.194` n `44` status `ready` deltaP `8.2472` edge `0.0241` maxDD `-2.3372`
- `risk_on_and_context->crypto_major_1h` score `0.194` n `44` status `ready` deltaP `8.2472` edge `0.0241` maxDD `-2.3372`
