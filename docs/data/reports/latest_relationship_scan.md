...
- `news_risk_high->crypto_major_24h` score `4.2872` n `32` status `ready` deltaP `17.5347` edge `0.5107` maxDD `-4.2368`
...
- `news_risk_high->crypto_alt_1h` score `0.8543` n `32` status `ready` deltaP `10.7223` edge `0.0842` maxDD `-1.6923`
...
- `market_context_high->metal_24h` score `-0.232` n `146` status `ready` deltaP `19.6205` edge `0.0963` maxDD `-11.8809`
