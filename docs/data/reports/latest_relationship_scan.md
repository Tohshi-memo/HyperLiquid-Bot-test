...
- `market_context_high->equity_24h` score `2.2187` n `111` status `ready` deltaP `3.4019` edge `0.4682` maxDD `-21.1456`
- `market_context_high->metal_24h` score `1.851` n `111` status `ready` deltaP `8.4366` edge `0.1556` maxDD `-2.2743`
- `market_context_high->commodity_4h` score `1.315` n `143` status `ready` deltaP `16.2716` edge `0.0684` maxDD `-2.7169`
...
- `market_context_high->crypto_alt_4h` score `-4.0632` n `143` status `ready` deltaP `-9.0387` edge `-0.1127` maxDD `-6.585`
- `market_context_high->crypto_major_24h` score `-4.3519` n `111` status `ready` deltaP `0.9244` edge `-0.1194` maxDD `-14.2873`
- `market_context_high->crypto_alt_24h` score `-6.081` n `111` status `ready` deltaP `-17.286` edge `-0.2472` maxDD `-4.5445`
