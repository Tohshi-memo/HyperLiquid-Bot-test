...
- `market_context_high->equity_4h` score `2.3849` n `96` status `ready` deltaP `12.3729` edge `0.2051` maxDD `-2.4411`
- `market_context_high->equity_1h` score `1.8584` n `96` status `ready` deltaP `15.3007` edge `0.083` maxDD `-0.4112`
- `market_context_high->index_1h` score `0.9474` n `96` status `ready` deltaP `16.0616` edge `0.0106` maxDD `-0.0982`
- `market_context_high->metal_4h` score `0.7297` n `96` status `ready` deltaP `15.1931` edge `0.0171` maxDD `-1.273`
- `market_context_high->crypto_major_24h` score `0.7206` n `96` status `ready` deltaP `4.3402` edge `0.1519` maxDD `-4.9964`
...
- `market_context_high->crypto_major_4h` score `-0.2262` n `96` status `ready` deltaP `8.2571` edge `0.0282` maxDD `-3.1677`
- `market_context_high->fx_1h` score `-0.3362` n `96` status `ready` deltaP `-1.4721` edge `0.0026` maxDD `-0.2043`
- `market_context_high->crypto_alt_1h` score `-0.6606` n `96` status `ready` deltaP `0.5801` edge `-0.0084` maxDD `-2.413`
- `market_context_high->crypto_major_1h` score `-0.6684` n `96` status `ready` deltaP `2.0833` edge `-0.0151` maxDD `-2.7581`
- `market_context_high->commodity_4h` score `-0.676` n `96` status `ready` deltaP `-0.6351` edge `0.0026` maxDD `-2.4692`
- `market_context_high->crypto_alt_4h` score `-0.8045` n `96` status `ready` deltaP `6.0976` edge `0.0193` maxDD `-5.4926`
