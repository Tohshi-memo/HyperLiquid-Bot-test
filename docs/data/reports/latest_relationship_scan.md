...
- `market_context_high->crypto_major_1h` score `-0.1337` n `147` status `ready` deltaP `8.204` edge `0.0242` maxDD `-4.0162`
- `market_context_high->commodity_4h` score `-0.1597` n `147` status `ready` deltaP `6.6592` edge `0.0183` maxDD `-2.4139`
- `market_context_high->commodity_1h` score `-0.2271` n `147` status `ready` deltaP `4.1399` edge `0.0005` maxDD `-1.5775`
- `market_context_high->crypto_alt_1h` score `-0.237` n `147` status `ready` deltaP `1.8504` edge `0.0205` maxDD `-2.7243`
- `market_context_high->fx_24h` score `-0.3573` n `146` status `ready` deltaP `8.9686` edge `0.0192` maxDD `-3.0343`
- `market_context_high->equity_1h` score `-0.4767` n `147` status `ready` deltaP `6.2144` edge `0.0537` maxDD `-7.8324`
...
- `market_context_high->crypto_alt_4h` score `-0.9921` n `147` status `ready` deltaP `3.2956` edge `0.0565` maxDD `-9.7866`
- `market_context_high->unknown_1h` score `-1.0215` n `147` status `ready` deltaP `-1.1701` edge `-0.0608` maxDD `-1.3217`
- `market_context_high->crypto_major_4h` score `-1.1041` n `147` status `ready` deltaP `9.3361` edge `0.0682` maxDD `-14.7592`
...
- `market_context_high->fx_4h` score `-2.6103` n `147` status `ready` deltaP `-6.7434` edge `-0.0041` maxDD `-2.1439`
