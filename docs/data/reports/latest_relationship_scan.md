...
- `market_context_high->commodity_4h` score `1.0393` n `169` status `ready` deltaP `13.061` edge `0.071` maxDD `-2.7169`
...
- `market_context_high->crypto_alt_1h` score `-1.5785` n `169` status `ready` deltaP `-9.1282` edge `-0.0394` maxDD `-5.5029`
- `market_context_high->metal_4h` score `-1.9226` n `169` status `ready` deltaP `-6.0002` edge `-0.0301` maxDD `-6.1111`
- `market_context_high->equity_4h` score `-3.2097` n `169` status `ready` deltaP `-11.4059` edge `-0.1238` maxDD `-7.9331`
- `market_context_high->crypto_major_1h` score `-3.633` n `169` status `ready` deltaP `-10.3904` edge `-0.0601` maxDD `-10.5372`
...
- `market_context_high->crypto_major_24h` score `-4.4354` n `136` status `ready` deltaP `-2.0236` edge `-0.1067` maxDD `-14.2873`
