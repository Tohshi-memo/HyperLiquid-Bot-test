...
- `risk_on_high->unknown_4h` score `23.1063` n `133` status `ready` deltaP `10.5229` edge `1.9172` maxDD `-2.2797`
- `risk_on_and_context->unknown_4h` score `23.1063` n `133` status `ready` deltaP `10.5229` edge `1.9172` maxDD `-2.2797`
- `market_context_high->unknown_4h` score `16.3412` n `167` status `ready` deltaP `12.1212` edge `1.3505` maxDD `-2.563`
- `risk_on_high->unknown_1h` score `14.7246` n `133` status `ready` deltaP `-0.0057` edge `1.2848` maxDD `-1.95`
- `risk_on_and_context->unknown_1h` score `14.7246` n `133` status `ready` deltaP `-0.0057` edge `1.2848` maxDD `-1.95`
- `market_context_high->unknown_1h` score `10.2448` n `167` status `ready` deltaP `0.4491` edge `0.9138` maxDD `-2.0446`
...
- `news_risk_high->fx_4h` score `-0.1112` n `67` status `ready` deltaP `7.9746` edge `0.0032` maxDD `-1.2507`
