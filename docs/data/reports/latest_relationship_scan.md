...
- `market_context_high->equity_24h` score `10.7202` n `132` status `ready` deltaP `28.5507` edge `0.8372` maxDD `-6.0681`
- `market_context_high->commodity_24h` score `1.3225` n `132` status `ready` deltaP `21.8182` edge `0.1231` maxDD `-7.0012`
- `market_context_high->equity_4h` score `1.1822` n `133` status `ready` deltaP `3.8042` edge `0.3175` maxDD `-6.9701`
...
- `market_context_high->crypto_alt_4h` score `0.6018` n `133` status `ready` deltaP `7.2849` edge `0.1133` maxDD `-3.9374`
- `market_context_high->index_1h` score `0.3746` n `133` status `ready` deltaP `8.6444` edge `0.0166` maxDD `-0.7743`
- `market_context_high->crypto_alt_1h` score `0.2096` n `133` status `ready` deltaP `4.428` edge `0.0312` maxDD `-1.4603`
...
- `market_context_high->index_24h` score `-1.1955` n `132` status `ready` deltaP `-4.9658` edge `0.0901` maxDD `-2.1544`
...
- `market_context_high->crypto_alt_24h` score `-1.6907` n `133` status `ready` deltaP `15.9563` edge `0.2064` maxDD `-28.3623`
