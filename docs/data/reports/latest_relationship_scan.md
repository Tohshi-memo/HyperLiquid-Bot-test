...
- `market_context_high->crypto_major_1h` score `-0.8863` n `131` status `ready` deltaP `2.3872` edge `0.0115` maxDD `-7.6171`
- `market_context_high->fx_24h` score `-0.9737` n `125` status `ready` deltaP `-0.487` edge `0.0012` maxDD `-2.1564`
- `market_context_high->unknown_1h` score `-1.1506` n `131` status `ready` deltaP `1.1005` edge `-0.0925` maxDD `-1.3212`
...
- `market_context_high->commodity_24h` score `-2.9437` n `125` status `ready` deltaP `-5.4957` edge `-0.1289` maxDD `-2.3815`
- `market_context_high->crypto_alt_4h` score `-3.7826` n `129` status `ready` deltaP `-0.1997` edge `-0.0213` maxDD `-16.7399`
- `market_context_high->equity_1h` score `-4.7264` n `131` status `ready` deltaP `-10.4062` edge `-0.072` maxDD `-15.5328`
- `market_context_high->crypto_major_4h` score `-5.0169` n `129` status `ready` deltaP `-0.2612` edge `-0.0269` maxDD `-23.4879`
