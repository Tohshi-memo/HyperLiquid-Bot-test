...
- `news_risk_high->unknown_24h` score `53.4421` n `50` status `ready` deltaP `11.6118` edge `4.3761` maxDD `0.0`
- `news_risk_high->crypto_alt_24h` score `30.7625` n `50` status `ready` deltaP `40.1941` edge `2.3397` maxDD `-2.8629`
- `news_risk_high->unknown_4h` score `12.9768` n `50` status `ready` deltaP `26.1646` edge `0.9169` maxDD `-0.1279`
- `news_risk_high->equity_24h` score `5.4655` n `50` status `ready` deltaP `30.1005` edge `0.3476` maxDD `-4.7584`
- `news_risk_high->metal_24h` score `4.9008` n `50` status `ready` deltaP `46.7002` edge `0.1013` maxDD `-0.0053`
- `news_risk_high->fx_4h` score `3.9333` n `50` status `ready` deltaP `45.811` edge `0.0314` maxDD `-0.0559`
- `news_risk_high->crypto_major_24h` score `2.8134` n `50` status `ready` deltaP `19.182` edge `0.1559` maxDD `-2.6128`
- `news_risk_high->index_24h` score `2.5595` n `50` status `ready` deltaP `28.9012` edge `0.0357` maxDD `-0.2064`
- `market_context_high->unknown_4h` score `2.2632` n `139` status `ready` deltaP `18.4955` edge `0.106` maxDD `-0.5894`
- `market_context_high->unknown_24h` score `2.2126` n `133` status `ready` deltaP `5.5968` edge `0.2203` maxDD `-3.1917`
- `news_risk_high->unknown_1h` score `2.0933` n `56` status `ready` deltaP `12.2754` edge `0.1283` maxDD `-0.8558`
...
- `market_context_high->unknown_1h` score `0.9413` n `139` status `ready` deltaP `7.779` edge `0.0716` maxDD `-1.6015`
