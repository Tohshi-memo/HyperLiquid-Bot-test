...
- `market_context_high->crypto_major_24h` score `12.2493` n `152` status `ready` deltaP `29.3951` edge `0.8582` maxDD `-1.3382`
- `market_context_high->crypto_alt_24h` score `5.1587` n `152` status `ready` deltaP `7.1546` edge `0.387` maxDD `-0.0508`
...
- `risk_on_high->crypto_major_4h` score `2.3579` n `33` status `ready` deltaP `17.9832` edge `0.1138` maxDD `-0.9758`
- `risk_on_and_context->crypto_major_4h` score `2.3579` n `33` status `ready` deltaP `17.9832` edge `0.1138` maxDD `-0.9758`
- `risk_on_high->crypto_alt_4h` score `2.0066` n `33` status `ready` deltaP `18.0432` edge `0.0674` maxDD `-0.6377`
- `risk_on_and_context->crypto_alt_4h` score `2.0066` n `33` status `ready` deltaP `18.0432` edge `0.0674` maxDD `-0.6377`
...
- `risk_on_high->crypto_major_1h` score `-0.2032` n `33` status `ready` deltaP `3.983` edge `-0.0222` maxDD `-1.0995`
- `risk_on_and_context->crypto_major_1h` score `-0.2032` n `33` status `ready` deltaP `3.983` edge `-0.0222` maxDD `-1.0995`
