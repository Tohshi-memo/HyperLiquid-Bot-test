...
- `risk_on_high->crypto_alt_4h` score `8.0243` n `91` status `ready` deltaP `40.269` edge `0.4374` maxDD `-1.9733`
- `risk_on_and_context->crypto_alt_4h` score `8.0243` n `91` status `ready` deltaP `40.269` edge `0.4374` maxDD `-1.9733`
- `risk_on_high->crypto_major_4h` score `6.295` n `91` status `ready` deltaP `30.0674` edge `0.41` maxDD `-3.8693`
- `risk_on_and_context->crypto_major_4h` score `6.295` n `91` status `ready` deltaP `30.0674` edge `0.41` maxDD `-3.8693`
- `risk_on_high->crypto_major_24h` score `5.7293` n `91` status `ready` deltaP `22.9377` edge `0.9884` maxDD `-24.5429`
- `risk_on_and_context->crypto_major_24h` score `5.7293` n `91` status `ready` deltaP `22.9377` edge `0.9884` maxDD `-24.5429`
...
- `market_context_high->commodity_24h` score `1.828` n `201` status `ready` deltaP `18.2784` edge `0.0444` maxDD `-0.1139`
- `risk_on_high->commodity_24h` score `1.8118` n `91` status `ready` deltaP `17.9449` edge `0.0407` maxDD `-0.0811`
- `risk_on_and_context->commodity_24h` score `1.8118` n `91` status `ready` deltaP `17.9449` edge `0.0407` maxDD `-0.0811`
