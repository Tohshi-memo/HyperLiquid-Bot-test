...
- `market_context_high->unknown_1h` score `-0.4122` n `151` status `ready` deltaP `-2.6986` edge `0.0395` maxDD `-1.4688`
- `market_context_high->crypto_alt_1h` score `-0.6682` n `151` status `ready` deltaP `-0.694` edge `0.022` maxDD `-5.91`
- `market_context_high->crypto_major_1h` score `-0.6965` n `151` status `ready` deltaP `2.6173` edge `0.0343` maxDD `-7.6171`
- `market_context_high->commodity_1h` score `-0.7919` n `151` status `ready` deltaP `-3.112` edge `-0.0187` maxDD `-1.9668`
- `market_context_high->index_1h` score `-0.7972` n `151` status `ready` deltaP `0.7852` edge `-0.0052` maxDD `-2.3175`
...
- `market_context_high->crypto_major_4h` score `-3.1225` n `140` status `ready` deltaP `3.0488` edge `0.0078` maxDD `-24.6094`
