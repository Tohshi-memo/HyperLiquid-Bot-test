...
- `news_risk_high->unknown_24h` score `44.3602` n `51` status `ready` deltaP `5.3819` edge `3.6608` maxDD `0.0`
- `news_risk_high->unknown_4h` score `12.563` n `53` status `ready` deltaP `24.2176` edge `0.8954` maxDD `-0.1281`
- `news_risk_high->equity_24h` score `8.0927` n `51` status `ready` deltaP `31.5564` edge `0.5571` maxDD `-4.7801`
- `news_risk_high->index_24h` score `4.1962` n `51` status `ready` deltaP `41.8301` edge `0.086` maxDD `-0.2147`
- `news_risk_high->unknown_1h` score `3.1574` n `53` status `ready` deltaP `16.0123` edge `0.1919` maxDD `-0.8426`
- `news_risk_high->fx_4h` score `3.0258` n `53` status `ready` deltaP `35.8779` edge `0.0264` maxDD `-0.0746`
- `market_context_high->unknown_4h` score `2.6044` n `133` status `ready` deltaP `22.3592` edge `0.1088` maxDD `-0.5994`
...
- `news_risk_high->equity_1h` score `0.4925` n `53` status `ready` deltaP `14.1227` edge `0.0054` maxDD `-0.9128`
...
- `market_context_high->unknown_1h` score `0.1398` n `133` status `ready` deltaP `11.5719` edge `-0.0206` maxDD `-1.5916`
- `news_risk_high->index_1h` score `-0.0488` n `53` status `ready` deltaP `4.299` edge `0.0004` maxDD `-0.1583`
- `news_risk_high->metal_24h` score `-0.0841` n `51` status `ready` deltaP `24.9489` edge `-0.1691` maxDD `-0.0053`
- `news_risk_high->crypto_alt_24h` score `-0.2816` n `51` status `ready` deltaP `21.875` edge `-0.1693` maxDD `0.0`
