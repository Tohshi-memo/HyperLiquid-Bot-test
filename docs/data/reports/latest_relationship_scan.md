...
- `market_context_high->metal_1h` score `-0.2281` n `105` status `ready` deltaP `2.9384` edge `0.0001` maxDD `-0.4291`
- `market_context_high->unknown_1h` score `-0.435` n `105` status `ready` deltaP `7.6305` edge `-0.0644` maxDD `-0.4843`
- `market_context_high->crypto_alt_1h` score `-0.4979` n `105` status `ready` deltaP `1.4001` edge `0.007` maxDD `-2.413`
- `market_context_high->crypto_major_1h` score `-0.6445` n `105` status `ready` deltaP `1.8363` edge `-0.0104` maxDD `-2.7581`
...
- `market_context_high->crypto_alt_4h` score `-1.517` n `105` status `ready` deltaP `4.5863` edge `-0.03` maxDD `-5.4926`
- `market_context_high->crypto_major_4h` score `-1.9865` n `105` status `ready` deltaP `6.6826` edge `-0.108` maxDD `-3.1677`
