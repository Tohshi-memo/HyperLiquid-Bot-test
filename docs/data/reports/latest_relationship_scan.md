...
- Price records: `672`
- Market context records: `2025`
- Flow alert records: `7721`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_major_4h` score `8.8859` n `205` status `ready` deltaP `30.7927` edge `0.5882` maxDD `-1.9063`
- `market_context_high->crypto_alt_4h` score `8.3742` n `205` status `ready` deltaP `24.5427` edge `0.6487` maxDD `-5.1574`
...
- `market_context_high->index_4h` score `1.433` n `205` status `ready` deltaP `12.9269` edge `0.1016` maxDD `-1.8022`
- `market_context_high->crypto_alt_1h` score `1.2042` n `205` status `ready` deltaP `9.7831` edge `0.1465` maxDD `-4.9097`
...
- `market_context_high->index_24h` score `0.108` n `195` status `ready` deltaP `3.8005` edge `0.1065` maxDD `-4.1604`
...
- `market_context_high->fx_24h` score `-0.3276` n `195` status `ready` deltaP `12.0275` edge `0.0241` maxDD `-2.1934`
- `market_context_high->fx_1h` score `-0.8769` n `205` status `ready` deltaP `-1.5912` edge `0.0003` maxDD `-0.3548`
- `market_context_high->metal_1h` score `-0.8946` n `205` status `ready` deltaP `3.6585` edge `0.0198` maxDD `-5.166`
- `market_context_high->metal_24h` score `-0.9632` n `195` status `ready` deltaP `10.8465` edge `0.1497` maxDD `-17.5156`
- `market_context_high->metal_4h` score `-1.3056` n `205` status `ready` deltaP `8.1098` edge `0.0994` maxDD `-11.9812`
