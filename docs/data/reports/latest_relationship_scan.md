...
- `news_risk_high->unknown_24h` score `44.6574` n `53` status `ready` deltaP `11.6319` edge `3.6439` maxDD `0.0`
- `news_risk_high->unknown_4h` score `11.8936` n `53` status `ready` deltaP `23.4555` edge `0.8447` maxDD `-0.1281`
...
- `news_risk_high->unknown_1h` score `2.7207` n `53` status `ready` deltaP `15.1141` edge `0.1615` maxDD `-0.8426`
- `market_context_high->unknown_4h` score `2.5267` n `136` status `ready` deltaP `21.763` edge `0.1063` maxDD `-0.5994`
...
- `market_context_high->unknown_1h` score `1.0391` n `136` status `ready` deltaP `11.1879` edge `0.0569` maxDD `-1.5916`
