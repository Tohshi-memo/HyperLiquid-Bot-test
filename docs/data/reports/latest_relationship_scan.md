...
- `market_context_high->unknown_1h` score `1.5539` n `149` status `ready` deltaP `6.7074` edge `0.1075` maxDD `-0.4843`
- `market_context_high->unknown_4h` score `0.9903` n `149` status `ready` deltaP `18.7418` edge `0.0015` maxDD `-0.5133`
...
- `market_context_high->crypto_alt_4h` score `-2.4203` n `149` status `ready` deltaP `3.3035` edge `-0.0769` maxDD `-7.0785`
- `market_context_high->crypto_alt_1h` score `-2.5244` n `149` status `ready` deltaP `-2.5338` edge `-0.044` maxDD `-7.9582`
- `market_context_high->crypto_major_1h` score `-3.6028` n `149` status `ready` deltaP `-5.358` edge `-0.1168` maxDD `-7.8171`
...
- `market_context_high->crypto_major_4h` score `-5.6052` n `149` status `ready` deltaP `-0.5412` edge `-0.3305` maxDD `-5.6395`
