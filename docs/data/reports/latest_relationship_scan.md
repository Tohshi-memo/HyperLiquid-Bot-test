...
- `news_risk_high->equity_24h` score `9.6886` n `36` status `ready` deltaP `10.0694` edge `0.7782` maxDD `-1.0358`
- `news_risk_high->equity_4h` score `7.1854` n `36` status `ready` deltaP `38.2622` edge `0.3437` maxDD `0.0`
- `risk_on_high->commodity_24h` score `4.769` n `32` status `ready` deltaP `32.1181` edge `0.1833` maxDD `0.0`
- `risk_on_and_context->commodity_24h` score `4.769` n `32` status `ready` deltaP `32.1181` edge `0.1833` maxDD `0.0`
- `market_context_high->commodity_24h` score `2.8473` n `149` status `ready` deltaP `22.051` edge `0.1706` maxDD `-2.4263`
- `risk_on_high->commodity_4h` score `2.7808` n `32` status `ready` deltaP `19.436` edge `0.1204` maxDD `-0.1258`
- `risk_on_and_context->commodity_4h` score `2.7808` n `32` status `ready` deltaP `19.436` edge `0.1204` maxDD `-0.1258`
...
- `market_context_high->commodity_4h` score `1.3805` n `149` status `ready` deltaP `15.8076` edge `0.0735` maxDD `-2.1077`
