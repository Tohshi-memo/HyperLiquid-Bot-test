...
- `market_context_high->equity_1h` score `1.6067` n `96` status `ready` deltaP `13.3546` edge `0.075` maxDD `-0.4112`
- `market_context_high->equity_4h` score `1.514` n `96` status `ready` deltaP `8.8668` edge `0.1559` maxDD `-2.4411`
...
- `market_context_high->unknown_1h` score `0.3511` n `96` status `ready` deltaP `9.3563` edge `-0.0104` maxDD `-0.4843`
- `market_context_high->crypto_alt_4h` score `0.3498` n `96` status `ready` deltaP `10.6707` edge `0.085` maxDD `-5.4926`
...
- `market_context_high->unknown_24h` score `-0.4661` n `96` status `ready` deltaP `12.6736` edge `-0.0727` maxDD `-1.0505`
...
- `market_context_high->metal_24h` score `-2.2776` n `96` status `ready` deltaP `-3.6458` edge `0.0631` maxDD `-11.4635`
