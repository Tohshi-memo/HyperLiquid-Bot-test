...
- `market_context_high->crypto_major_4h` score `1.204` n `193` status `ready` deltaP `11.2923` edge `0.2543` maxDD `-14.0065`
- `market_context_high->fx_24h` score `0.851` n `174` status `ready` deltaP `17.445` edge `0.052` maxDD `-1.457`
- `market_context_high->crypto_major_24h` score `0.7993` n `174` status `ready` deltaP `13.6255` edge `0.4298` maxDD `-29.6555`
- `market_context_high->crypto_alt_4h` score `0.623` n `193` status `ready` deltaP `6.7499` edge `0.171` maxDD `-9.46`
- `market_context_high->equity_4h` score `0.5868` n `193` status `ready` deltaP `5.5297` edge `0.1759` maxDD `-7.4425`
- `market_context_high->index_1h` score `-0.2107` n `205` status `ready` deltaP `3.5527` edge `0.0081` maxDD `-0.9472`
- `market_context_high->equity_1h` score `-0.2771` n `205` status `ready` deltaP `5.7748` edge `0.0391` maxDD `-5.0555`
...
- `market_context_high->crypto_alt_1h` score `-0.6387` n `205` status `ready` deltaP `0.6645` edge `0.0385` maxDD `-5.0257`
- `market_context_high->crypto_major_1h` score `-0.7948` n `205` status `ready` deltaP `2.2674` edge `0.0432` maxDD `-6.9639`
...
- `market_context_high->crypto_alt_24h` score `-9.2269` n `174` status `ready` deltaP `3.586` edge `0.0769` maxDD `-54.2437`
