...
- `market_context_high->crypto_major_24h` score `3.0757` n `85` status `ready` deltaP `9.6896` edge `0.3125` maxDD `-4.9964`
- `market_context_high->equity_24h` score `1.2291` n `85` status `ready` deltaP `15.1818` edge `0.0108` maxDD `-0.1006`
- `market_context_high->index_24h` score `1.2235` n `85` status `ready` deltaP `18.9236` edge `-0.0242` maxDD `0.0`
...
- `risk_on_high->crypto_major_1h` score `0.9137` n `35` status `ready` deltaP `11.0607` edge `0.033` maxDD `-1.1144`
- `risk_on_and_context->crypto_major_1h` score `0.9137` n `35` status `ready` deltaP `11.0607` edge `0.033` maxDD `-1.1144`
- `risk_on_high->index_1h` score `0.7746` n `35` status `ready` deltaP `13.4945` edge `0.0121` maxDD `-0.3343`
- `risk_on_and_context->index_1h` score `0.7746` n `35` status `ready` deltaP `13.4945` edge `0.0121` maxDD `-0.3343`
- `risk_on_high->equity_1h` score `0.7633` n `35` status `ready` deltaP `12.7588` edge `0.0329` maxDD `-1.6811`
- `risk_on_and_context->equity_1h` score `0.7633` n `35` status `ready` deltaP `12.7588` edge `0.0329` maxDD `-1.6811`
...
- `market_context_high->commodity_24h` score `0.3038` n `85` status `ready` deltaP `17.5612` edge `0.1052` maxDD `-4.666`
