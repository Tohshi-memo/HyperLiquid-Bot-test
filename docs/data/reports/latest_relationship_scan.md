...
- `news_risk_high->crypto_alt_24h` score `12.9094` n `53` status `ready` deltaP `34.0502` edge `0.8929` maxDD `-2.8629`
- `news_risk_high->unknown_4h` score `12.4222` n `53` status `ready` deltaP `26.3578` edge `0.8694` maxDD `-0.1281`
- `news_risk_high->equity_24h` score `6.9332` n `53` status `ready` deltaP `29.6771` edge `0.473` maxDD `-4.7801`
...
- `news_risk_high->unknown_1h` score `2.8586` n `53` status `ready` deltaP `16.162` edge `0.166` maxDD `-0.8426`
- `news_risk_high->metal_24h` score `2.0569` n `53` status `ready` deltaP `30.7557` edge `-0.0294` maxDD `-0.0053`
- `news_risk_high->equity_4h` score `1.8471` n `53` status `ready` deltaP `20.6058` edge `0.0936` maxDD `-2.164`
- `market_context_high->unknown_1h` score `1.171` n `137` status `ready` deltaP `12.4022` edge `0.0598` maxDD `-1.5916`
- `news_risk_high->fx_1h` score `1.1417` n `53` status `ready` deltaP `15.9191` edge `0.006` maxDD `-0.0257`
- `news_risk_high->equity_1h` score `0.5058` n `53` status `ready` deltaP `13.6736` edge `0.0101` maxDD `-0.9128`
- `news_risk_high->commodity_1h` score `0.3948` n `53` status `ready` deltaP `10.5271` edge `-0.006` maxDD `-0.5024`
- `news_risk_high->index_4h` score `0.1384` n `53` status `ready` deltaP `6.7455` edge `0.0063` maxDD `-0.1788`
