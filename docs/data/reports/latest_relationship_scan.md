...
- `news_risk_high->crypto_alt_24h` score `15.4434` n `32` status `ready` deltaP `43.2292` edge `1.0135` maxDD `-0.5131`
- `news_risk_high->fx_24h` score `6.0752` n `32` status `ready` deltaP `50.6944` edge `0.1683` maxDD `0.0`
- `news_risk_high->crypto_major_24h` score `4.4261` n `32` status `ready` deltaP `16.6667` edge `0.5343` maxDD `-4.2368`
...
- `news_risk_high->crypto_alt_1h` score `0.9611` n `32` status `ready` deltaP `11.9199` edge `0.0899` maxDD `-1.6923`
...
- `market_context_high->unknown_1h` score `-0.1299` n `208` status `ready` deltaP `-8.5819` edge `0.1472` maxDD `-3.7317`
