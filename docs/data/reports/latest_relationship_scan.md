...
- `market_context_high->equity_1h` score `0.4631` n `117` status `ready` deltaP `9.7178` edge `0.0553` maxDD `-3.1861`
- `market_context_high->fx_4h` score `0.1507` n `105` status `ready` deltaP `9.1623` edge `0.0085` maxDD `-0.3539`
- `market_context_high->fx_1h` score `-0.0721` n `117` status `ready` deltaP `3.2909` edge `0.0047` maxDD `-0.2043`
...
- `market_context_high->metal_1h` score `-0.3427` n `117` status `ready` deltaP `2.0498` edge `-0.0026` maxDD `-0.503`
- `market_context_high->unknown_1h` score `-0.4283` n `117` status `ready` deltaP `10.0991` edge `-0.0803` maxDD `-0.4843`
- `market_context_high->commodity_24h` score `-0.4432` n `105` status `ready` deltaP `4.5883` edge `0.1158` maxDD `-4.666`
- `market_context_high->commodity_1h` score `-0.7137` n `117` status `ready` deltaP `-5.2805` edge `0.0003` maxDD `-1.1941`
- `market_context_high->commodity_4h` score `-0.7718` n `105` status `ready` deltaP `-2.9573` edge `0.0058` maxDD `-2.4692`
- `market_context_high->crypto_alt_1h` score `-1.2241` n `117` status `ready` deltaP `-1.8667` edge `-0.0094` maxDD `-2.413`
- `market_context_high->crypto_major_1h` score `-1.4257` n `117` status `ready` deltaP `-3.9574` edge `-0.0651` maxDD `-3.3041`
- `market_context_high->fx_24h` score `-3.1236` n `105` status `ready` deltaP `-13.5169` edge `-0.0092` maxDD `-2.2121`
- `market_context_high->crypto_alt_4h` score `-3.761` n `105` status `ready` deltaP `-1.9686` edge `-0.1733` maxDD `-5.4926`
- `market_context_high->crypto_major_4h` score `-4.0211` n `105` status `ready` deltaP `-0.3296` edge `-0.2308` maxDD `-3.1677`
