...
- `market_context_high->equity_24h` score `3.8929` n `189` status `ready` deltaP `14.4759` edge `0.7358` maxDD `-31.6316`
- `market_context_high->crypto_major_4h` score `2.6671` n `192` status `ready` deltaP `13.6814` edge `0.3603` maxDD `-14.0065`
- `market_context_high->crypto_major_24h` score `2.5593` n `189` status `ready` deltaP `16.0797` edge `0.5601` maxDD `-29.6555`
- `market_context_high->crypto_alt_4h` score `2.0343` n `192` status `ready` deltaP `9.286` edge `0.2717` maxDD `-9.46`
- `market_context_high->equity_4h` score `1.7772` n `192` status `ready` deltaP `9.9848` edge `0.2454` maxDD `-7.4425`
...
- `market_context_high->crypto_alt_1h` score `-0.3189` n `192` status `ready` deltaP `1.4066` edge `0.0602` maxDD `-5.0257`
- `market_context_high->fx_1h` score `-0.3777` n `192` status `ready` deltaP `0.1435` edge `-0.0005` maxDD `-0.577`
- `market_context_high->crypto_major_1h` score `-0.4419` n `192` status `ready` deltaP `2.8381` edge `0.0688` maxDD `-6.9639`
...
- `market_context_high->crypto_alt_24h` score `-7.1431` n `189` status `ready` deltaP `7.0437` edge `0.2275` maxDD `-54.2437`
