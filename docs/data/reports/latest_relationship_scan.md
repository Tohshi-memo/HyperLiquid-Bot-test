...
- Price records: `672`
- Market context records: `1662`
- Flow alert records: `6693`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_major_24h` score `0.9931` n `169` status `ready` deltaP `25.7468` edge `0.7697` maxDD `-62.3533`
- `market_context_high->crypto_alt_24h` score `0.7296` n `169` status `ready` deltaP `26.401` edge `1.0657` maxDD `-88.8062`
- `market_context_high->crypto_alt_1h` score `0.5742` n `206` status `ready` deltaP `6.4517` edge `0.1072` maxDD `-4.1892`
...
- `market_context_high->crypto_major_1h` score `-0.3729` n `206` status `ready` deltaP `3.058` edge `0.0592` maxDD `-5.5244`
...
- `market_context_high->metal_1h` score `-0.7235` n `206` status `ready` deltaP `5.1494` edge `0.0065` maxDD `-6.3532`
- `market_context_high->fx_1h` score `-0.8293` n `206` status `ready` deltaP `-0.4171` edge `-0.0031` maxDD `-0.3914`
- `market_context_high->metal_4h` score `-1.2335` n `194` status `ready` deltaP `9.5393` edge `0.1028` maxDD `-12.5349`
- `market_context_high->commodity_1h` score `-1.3787` n `206` status `ready` deltaP `-0.3764` edge `-0.0182` maxDD `-9.8167`
