...
- `news_risk_high->unknown_1h` score `3.3413` n `41` status `ready` deltaP `27.9685` edge `0.1038` maxDD `-0.2787`
- `market_context_high->unknown_1h` score `1.7492` n `135` status `ready` deltaP `6.6135` edge `0.1244` maxDD `-0.4843`
- `news_risk_high->fx_1h` score `1.4416` n `41` status `ready` deltaP `19.5779` edge `0.0066` maxDD `-0.0257`
- `market_context_high->unknown_4h` score `1.2828` n `135` status `ready` deltaP `20.7058` edge `-0.0098` maxDD `-0.3736`
- `news_risk_high->equity_1h` score `1.2602` n `41` status `ready` deltaP `24.456` edge `0.0267` maxDD `-0.9204`
- `news_risk_high->crypto_major_1h` score `0.5587` n `41` status `ready` deltaP `12.6479` edge `0.05` maxDD `-5.0209`
- `news_risk_high->commodity_1h` score `0.2561` n `41` status `ready` deltaP `11.0194` edge `-0.0098` maxDD `-0.4666`
- `news_risk_high->metal_1h` score `0.1398` n `41` status `ready` deltaP `7.0396` edge `-0.0067` maxDD `-0.1184`
...
- `market_context_high->crypto_alt_4h` score `-1.2417` n `135` status `ready` deltaP `8.0465` edge `-0.0103` maxDD `-7.0785`
