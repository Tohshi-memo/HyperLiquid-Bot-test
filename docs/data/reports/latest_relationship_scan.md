...
- `risk_on_high->unknown_4h` score `7.2687` n `107` status `ready` deltaP `20.3727` edge `0.5317` maxDD `-2.2768`
- `risk_on_and_context->unknown_4h` score `7.2687` n `107` status `ready` deltaP `20.3727` edge `0.5317` maxDD `-2.2768`
- `market_context_high->unknown_4h` score `5.8153` n `151` status `ready` deltaP `16.6653` edge `0.443` maxDD `-2.5597`
...
- `risk_on_high->commodity_24h` score `0.3417` n `107` status `ready` deltaP `7.3907` edge `0.078` maxDD `-0.5706`
- `risk_on_and_context->commodity_24h` score `0.3417` n `107` status `ready` deltaP `7.3907` edge `0.078` maxDD `-0.5706`
...
- `news_risk_high->commodity_24h` score `0.0935` n `59` status `ready` deltaP `4.2226` edge `-0.0011` maxDD `-0.2074`
