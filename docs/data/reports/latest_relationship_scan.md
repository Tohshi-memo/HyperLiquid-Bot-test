...
- `market_context_high->unknown_24h` score `8.0751` n `145` status `ready` deltaP `18.2627` edge `0.584` maxDD `-1.626`
- `market_context_high->crypto_alt_4h` score `5.2711` n `146` status `ready` deltaP `25.0439` edge `0.5402` maxDD `-15.4319`
- `market_context_high->crypto_major_4h` score `3.5019` n `146` status `ready` deltaP `14.7636` edge `0.3744` maxDD `-10.1468`
- `market_context_high->crypto_alt_1h` score `1.3676` n `146` status `ready` deltaP `11.4306` edge `0.1565` maxDD `-6.1656`
- `market_context_high->unknown_4h` score `0.9173` n `146` status `ready` deltaP `7.5321` edge `0.1312` maxDD `-3.7312`
- `market_context_high->crypto_alt_24h` score `0.7355` n `145` status `ready` deltaP `2.4185` edge `0.683` maxDD `-39.0265`
- `market_context_high->crypto_major_1h` score `0.7329` n `146` status `ready` deltaP `8.8631` edge `0.1214` maxDD `-4.2199`
- `market_context_high->index_24h` score `0.7067` n `145` status `ready` deltaP `8.6506` edge `0.0993` maxDD `-2.5127`
...
- `market_context_high->unknown_1h` score `-0.4776` n `146` status `ready` deltaP `1.8005` edge `0.0145` maxDD `-2.6375`
...
- `market_context_high->equity_1h` score `-0.7809` n `146` status `ready` deltaP `-0.0779` edge `0.0193` maxDD `-2.7085`
...
- `market_context_high->equity_4h` score `-1.353` n `146` status `ready` deltaP `1.6497` edge `0.0167` maxDD `-5.9024`
