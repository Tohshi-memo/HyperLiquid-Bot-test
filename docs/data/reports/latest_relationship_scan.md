...
- `market_context_high->unknown_1h` score `1.3824` n `133` status `ready` deltaP `8.0884` edge `0.084` maxDD `-0.4843`
- `market_context_high->unknown_4h` score `0.5075` n `133` status `ready` deltaP `20.1758` edge `-0.0483` maxDD `-0.5133`
...
- `market_context_high->index_4h` score `-0.6617` n `133` status `ready` deltaP `1.2494` edge `0.0104` maxDD `-2.618`
- `market_context_high->commodity_4h` score `-0.7131` n `133` status `ready` deltaP `-1.6184` edge `0.0044` maxDD `-2.4692`
- `market_context_high->crypto_alt_1h` score `-0.8778` n `133` status `ready` deltaP `-0.3286` edge `0.0092` maxDD `-2.413`
- `market_context_high->crypto_major_1h` score `-1.4673` n `133` status `ready` deltaP `-2.4481` edge `-0.0693` maxDD `-4.1996`
...
- `market_context_high->crypto_alt_4h` score `-1.9825` n `133` status `ready` deltaP `4.8127` edge `-0.0703` maxDD `-5.4926`
...
- `market_context_high->crypto_major_4h` score `-5.4315` n `133` status `ready` deltaP `-1.9542` edge `-0.3375` maxDD `-3.1677`
