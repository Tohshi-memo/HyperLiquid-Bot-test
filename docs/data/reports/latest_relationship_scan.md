...
- `market_context_high->equity_4h` score `0.7954` n `105` status `ready` deltaP `8.7036` edge `0.1712` maxDD `-8.3685`
- `market_context_high->equity_1h` score `0.5475` n `105` status `ready` deltaP `9.9173` edge `0.061` maxDD `-3.1861`
...
- `market_context_high->unknown_1h` score `-0.4877` n `105` status `ready` deltaP `7.1814` edge `-0.0658` maxDD `-0.4843`
- `market_context_high->crypto_alt_1h` score `-0.494` n `105` status `ready` deltaP `1.4001` edge `0.0075` maxDD `-2.413`
- `market_context_high->crypto_major_1h` score `-0.636` n `105` status `ready` deltaP `1.986` edge `-0.0103` maxDD `-2.7581`
