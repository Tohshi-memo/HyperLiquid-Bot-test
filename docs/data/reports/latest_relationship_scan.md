...
- `market_context_high->equity_24h` score `3.6744` n `103` status `ready` deltaP `4.5729` edge `0.5817` maxDD `-21.1456`
...
- `market_context_high->index_1h` score `-0.4447` n `143` status `ready` deltaP `-1.8424` edge `-0.0058` maxDD `-0.7809`
...
- `market_context_high->crypto_alt_1h` score `-1.942` n `143` status `ready` deltaP `-10.433` edge `-0.0281` maxDD `-2.4677`
- `market_context_high->equity_4h` score `-2.5806` n `140` status `ready` deltaP `-1.9381` edge `-0.0684` maxDD `-7.6983`
- `market_context_high->crypto_major_1h` score `-3.1639` n `143` status `ready` deltaP `-10.6874` edge `-0.0602` maxDD `-7.2436`
- `market_context_high->crypto_major_24h` score `-3.1927` n `103` status `ready` deltaP `6.2197` edge `-0.0581` maxDD `-14.2873`
- `market_context_high->crypto_alt_4h` score `-3.6465` n `140` status `ready` deltaP `-6.8598` edge `-0.0925` maxDD `-6.585`
