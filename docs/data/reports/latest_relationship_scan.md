...
- Price records: `672`
- Market context records: `1501`
- Flow alert records: `6230`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->metal_24h` score `13.1183` n `168` status `ready` deltaP `22.371` edge `1.0441` maxDD `-6.3373`
- `market_context_high->crypto_alt_24h` score `11.1927` n `168` status `ready` deltaP `28.9435` edge `0.9414` maxDD `-15.1306`
- `market_context_high->crypto_major_24h` score `10.2999` n `168` status `ready` deltaP `27.2569` edge `0.7898` maxDD `-8.0553`
...
- `market_context_high->index_1h` score `-0.2351` n `194` status `ready` deltaP `2.8228` edge `0.0081` maxDD `-1.7205`
...
- `market_context_high->crypto_alt_1h` score `-0.5982` n `194` status `ready` deltaP `1.4121` edge `0.0431` maxDD `-4.1892`
- `market_context_high->crypto_alt_4h` score `-0.716` n `194` status `ready` deltaP `9.6131` edge `0.2082` maxDD `-19.5565`
- `market_context_high->metal_1h` score `-0.7265` n `194` status `ready` deltaP `5.7519` edge `0.0021` maxDD `-6.3532`
- `market_context_high->crypto_major_4h` score `-0.9283` n `194` status `ready` deltaP `5.5837` edge `0.1563` maxDD `-13.3376`
- `market_context_high->fx_4h` score `-0.9779` n `194` status `ready` deltaP `-3.4479` edge `-0.0095` maxDD `-1.4313`
...
- `market_context_high->metal_4h` score `-1.1483` n `194` status `ready` deltaP `11.6089` edge `0.0961` maxDD `-12.5349`
