...
- `news_risk_high->equity_4h` score `4.4867` n `61` status `ready` deltaP `15.3838` edge `0.3477` maxDD `-3.4427`
...
- `market_context_high->commodity_1h` score `0.5347` n `41` status `ready` deltaP `10.333` edge `0.0371` maxDD `-1.3282`
- `market_context_high->fx_1h` score `0.4872` n `41` status `ready` deltaP `14.4625` edge `0.0038` maxDD `-0.6874`
- `news_risk_high->equity_1h` score `0.2773` n `61` status `ready` deltaP `6.4641` edge `0.0623` maxDD `-2.916`
- `news_risk_high->fx_1h` score `-0.0334` n `61` status `ready` deltaP `3.5069` edge `0.0046` maxDD `-0.2475`
