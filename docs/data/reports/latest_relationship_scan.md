...
- `market_context_high->crypto_major_1h` score `0.0537` n `168` status `ready` deltaP `7.1322` edge `0.0335` maxDD `-4.1256`
- `market_context_high->crypto_major_4h` score `0.0286` n `168` status `ready` deltaP `8.4567` edge `0.1394` maxDD `-8.3693`
- `market_context_high->metal_1h` score `-0.2196` n `168` status `ready` deltaP `6.8007` edge `-0.0026` maxDD `-2.2164`
