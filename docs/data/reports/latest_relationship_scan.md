...
- `market_context_high->metal_4h` score `0.469` n `96` status `ready` deltaP `13.0589` edge `0.0096` maxDD `-1.273`
...
- `market_context_high->unknown_24h` score `-0.1161` n `96` status `ready` deltaP `17.7083` edge `-0.0771` maxDD `-1.0505`
- `market_context_high->metal_1h` score `-0.1676` n `96` status `ready` deltaP `3.125` edge `0.0039` maxDD `-0.4291`
- `market_context_high->unknown_1h` score `-0.2459` n `96` status `ready` deltaP `5.3144` edge `-0.0332` maxDD `-0.4843`
...
- `market_context_high->crypto_alt_1h` score `-0.8618` n `96` status `ready` deltaP `-0.4678` edge `-0.0272` maxDD `-2.413`
- `market_context_high->commodity_1h` score `-0.8954` n `96` status `ready` deltaP `-7.8905` edge `-0.0056` maxDD `-1.1941`
- `market_context_high->crypto_major_1h` score `-1.0052` n `96` status `ready` deltaP `0.5863` edge `-0.0483` maxDD `-2.7581`
- `market_context_high->crypto_alt_4h` score `-1.9998` n `96` status `ready` deltaP `3.2012` edge `-0.061` maxDD `-5.4926`
- `market_context_high->crypto_major_4h` score `-2.1715` n `96` status `ready` deltaP `5.3607` edge `-0.1146` maxDD `-3.1677`
- `market_context_high->crypto_major_24h` score `-2.8717` n `96` status `ready` deltaP `2.9514` edge `-0.1382` maxDD `-4.9964`
