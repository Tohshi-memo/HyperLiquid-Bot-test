...
- `market_context_high->unknown_1h` score `66.7146` n `157` status `ready` deltaP `6.7347` edge `5.5647` maxDD `-2.3371`
- `market_context_high->unknown_4h` score `3.1467` n `157` status `ready` deltaP `8.0647` edge `0.3295` maxDD `-4.6834`
...
- `market_context_high->equity_1h` score `-0.705` n `157` status `ready` deltaP `-2.4877` edge `0.0249` maxDD `-5.5624`
...
- `market_context_high->unknown_24h` score `-3.225` n `155` status `ready` deltaP `1.5278` edge `-0.1866` maxDD `-4.7201`
- `market_context_high->crypto_alt_1h` score `-5.4824` n `157` status `ready` deltaP `-2.6755` edge `-0.1103` maxDD `-22.2982`
...
- `market_context_high->crypto_major_1h` score `-6.6452` n `157` status `ready` deltaP `-5.4874` edge `-0.1419` maxDD `-27.356`
- `market_context_high->crypto_alt_4h` score `-8.8793` n `157` status `ready` deltaP `-2.273` edge `-0.2575` maxDD `-63.9243`
