...
- `market_context_high->commodity_1h` score `0.7515` n `150` status `ready` deltaP `10.3533` edge `0.0279` maxDD `-0.7439`
...
- `market_context_high->metal_1h` score `-0.5793` n `150` status `ready` deltaP `-2.8183` edge `-0.0059` maxDD `-0.9664`
...
- `market_context_high->equity_1h` score `-0.9748` n `150` status `ready` deltaP `-0.507` edge `0.005` maxDD `-4.6286`
...
- `market_context_high->crypto_major_1h` score `-3.2812` n `150` status `ready` deltaP `-12.0279` edge `-0.0605` maxDD `-7.2865`
- `market_context_high->crypto_alt_4h` score `-4.1304` n `143` status `ready` deltaP `-9.0387` edge `-0.1183` maxDD `-6.585`
- `market_context_high->crypto_major_24h` score `-4.2743` n `117` status `ready` deltaP `1.7896` edge `-0.1187` maxDD `-14.2873`
- `market_context_high->crypto_alt_24h` score `-5.6738` n `117` status `ready` deltaP `-16.3061` edge `-0.2198` maxDD `-4.5445`
- `market_context_high->unknown_1h` score `-7.9104` n `150` status `ready` deltaP `-7.3333` edge `-0.5656` maxDD `-1.2437`
