...
- `market_context_high->unknown_24h` score `137.5865` n `128` status `ready` deltaP `-23.9426` edge `11.9164` maxDD `-9.6329`
- `risk_on_high->unknown_24h` score `33.7101` n `32` status `ready` deltaP `-37.2238` edge `4.645` maxDD `-1.6689`
- `risk_on_and_context->unknown_24h` score `33.7101` n `32` status `ready` deltaP `-37.2238` edge `4.645` maxDD `-1.6689`
- `news_risk_high->equity_24h` score `12.7987` n `36` status `ready` deltaP `25.621` edge `0.9337` maxDD `-1.0358`
- `news_risk_high->equity_4h` score `7.7281` n `36` status `ready` deltaP `40.3963` edge `0.3747` maxDD `0.0`
...
- `risk_on_high->crypto_major_24h` score `4.2331` n `32` status `ready` deltaP `28.2008` edge `0.4703` maxDD `-6.2481`
- `risk_on_and_context->crypto_major_24h` score `4.2331` n `32` status `ready` deltaP `28.2008` edge `0.4703` maxDD `-6.2481`
- `news_risk_high->index_24h` score `3.5944` n `36` status `ready` deltaP `29.8094` edge `0.1008` maxDD `0.0`
...
- `news_risk_high->equity_1h` score `1.7586` n `36` status `ready` deltaP `8.5829` edge `0.1212` maxDD `-0.5496`
...
- `risk_on_high->equity_24h` score `0.673` n `32` status `ready` deltaP `14.1627` edge `0.1698` maxDD `-11.2348`
