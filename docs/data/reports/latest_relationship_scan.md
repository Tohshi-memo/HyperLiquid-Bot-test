...
- `market_context_high->fx_4h` score `0.1034` n `148` status `ready` deltaP `8.0875` edge `0.0096` maxDD `-0.3539`
...
- `market_context_high->metal_4h` score `-0.2974` n `148` status `ready` deltaP `8.071` edge `-0.017` maxDD `-1.5942`
...
- `market_context_high->equity_4h` score `-1.7013` n `148` status `ready` deltaP `-0.9352` edge `0.0694` maxDD `-16.1693`
- `market_context_high->commodity_24h` score `-2.2721` n `133` status `ready` deltaP `-5.9419` edge `0.0336` maxDD `-4.666`
- `market_context_high->crypto_alt_4h` score `-2.4092` n `148` status `ready` deltaP `3.1724` edge `-0.0751` maxDD `-7.0785`
- `market_context_high->crypto_alt_1h` score `-2.4525` n `149` status `ready` deltaP `-2.0847` edge `-0.041` maxDD `-7.9582`
- `market_context_high->crypto_major_1h` score `-3.5153` n `149` status `ready` deltaP `-4.7592` edge `-0.1135` maxDD `-7.8171`
...
- `market_context_high->crypto_major_4h` score `-5.6085` n `148` status `ready` deltaP `-0.6427` edge `-0.3301` maxDD `-5.6395`
