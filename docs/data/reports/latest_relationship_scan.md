...
- `news_risk_high->unknown_24h` score `44.6525` n `51` status `ready` deltaP `6.7708` edge `3.6759` maxDD `0.0`
...
- `news_risk_high->commodity_1h` score `0.3936` n `53` status `ready` deltaP `10.5271` edge `-0.0061` maxDD `-0.5024`
- `news_risk_high->crypto_alt_24h` score `0.3743` n `51` status `ready` deltaP `23.2639` edge `-0.1239` maxDD `0.0`
...
- `news_risk_high->metal_24h` score `0.1028` n `51` status `ready` deltaP `25.4698` edge `-0.157` maxDD `-0.0053`
...
- `news_risk_high->metal_4h` score `-0.6567` n `53` status `ready` deltaP `3.7477` edge `-0.0266` maxDD `-0.249`
- `market_context_high->unknown_24h` score `-0.9547` n `125` status `ready` deltaP `6.7708` edge `-0.1247` maxDD `0.0`
