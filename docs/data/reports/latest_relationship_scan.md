...
- `market_context_high->unknown_1h` score `84.8925` n `47` status `ready` deltaP `8.4693` edge `7.025` maxDD `-0.2334`
- `market_context_high->crypto_major_24h` score `49.8234` n `47` status `ready` deltaP `30.7698` edge `3.9861` maxDD `-2.4756`
...
- `news_risk_high->unknown_1h` score `6.9379` n `115` status `ready` deltaP `4.0289` edge `0.5652` maxDD `-0.4452`
...
- `news_risk_high->crypto_major_1h` score `-0.0015` n `115` status `ready` deltaP `4.0693` edge `0.0483` maxDD `-3.3776`
