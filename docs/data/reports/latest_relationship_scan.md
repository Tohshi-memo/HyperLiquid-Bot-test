...
- `market_context_high->unknown_1h` score `71.4906` n `47` status `ready` deltaP `10.2657` edge `5.8962` maxDD `-0.2334`
- `market_context_high->crypto_major_24h` score `43.5025` n `46` status `ready` deltaP `30.7216` edge `3.436` maxDD `-0.5817`
- `market_context_high->crypto_alt_24h` score `29.3244` n `46` status `ready` deltaP `25.6944` edge `2.2724` maxDD `0.0`
- `market_context_high->equity_24h` score `25.0823` n `46` status `ready` deltaP `28.1175` edge `1.9128` maxDD `-0.1382`
- `news_risk_high->crypto_major_24h` score `9.7613` n `103` status `ready` deltaP `3.0306` edge `1.6975` maxDD `-63.6743`
- `market_context_high->index_24h` score `8.222` n `46` status `ready` deltaP `36.9716` edge `0.4474` maxDD `-0.03`
- `news_risk_high->crypto_alt_24h` score `7.0623` n `103` status `ready` deltaP `0.4517` edge `1.2868` maxDD `-49.7699`
...
- `news_risk_high->crypto_alt_1h` score `2.4117` n `117` status `ready` deltaP `13.262` edge `0.1616` maxDD `-1.5895`
- `news_risk_high->crypto_major_1h` score `2.0157` n `117` status `ready` deltaP `14.6528` edge `0.1138` maxDD `-1.8141`
...
- `news_risk_high->crypto_major_4h` score `0.8474` n `114` status `ready` deltaP `13.091` edge `0.1965` maxDD `-13.719`
- `news_risk_high->metal_1h` score `0.7973` n `117` status `ready` deltaP `16.3916` edge `0.0165` maxDD `-0.7468`
