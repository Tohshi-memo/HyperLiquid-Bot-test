...
- `market_context_high->crypto_major_24h` score `-4.0751` n `103` status `ready` deltaP `1.8794` edge `-0.1027` maxDD `-14.2873`
- `market_context_high->crypto_alt_24h` score `-6.4291` n `103` status `ready` deltaP `-17.8281` edge `-0.2726` maxDD `-4.5445`
