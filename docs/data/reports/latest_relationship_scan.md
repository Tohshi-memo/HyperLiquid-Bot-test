...
- `risk_on_high->unknown_4h` score `19.9399` n `133` status `ready` deltaP `8.9985` edge `1.6635` maxDD `-2.2797`
- `risk_on_and_context->unknown_4h` score `19.9399` n `133` status `ready` deltaP `8.9985` edge `1.6635` maxDD `-2.2797`
- `market_context_high->unknown_4h` score `9.4424` n `217` status `ready` deltaP `9.4351` edge `0.7935` maxDD `-2.563`
- `news_risk_high->crypto_alt_24h` score `4.6309` n `46` status `ready` deltaP `21.5806` edge `0.269` maxDD `-0.8236`
- `news_risk_high->crypto_major_4h` score `2.3411` n `46` status `ready` deltaP `10.1869` edge `0.1755` maxDD `-1.5324`
...
- `risk_on_high->unknown_1h` score `0.9957` n `133` status `ready` deltaP `-1.6524` edge `0.1517` maxDD `-1.95`
- `risk_on_and_context->unknown_1h` score `0.9957` n `133` status `ready` deltaP `-1.6524` edge `0.1517` maxDD `-1.95`
- `news_risk_high->metal_1h` score `0.7652` n `46` status `ready` deltaP `9.8217` edge `0.0176` maxDD `-0.2118`
- `news_risk_high->crypto_alt_1h` score `0.2946` n `46` status `ready` deltaP `4.6538` edge `0.0238` maxDD `-1.0885`
...
- `news_risk_high->crypto_major_1h` score `0.152` n `46` status `ready` deltaP `0.6769` edge `0.0442` maxDD `-1.0047`
