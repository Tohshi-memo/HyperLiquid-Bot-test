...
- `market_context_high->equity_4h` score `0.4483` n `219` status `ready` deltaP `6.0029` edge `0.1612` maxDD `-7.4425`
- `market_context_high->equity_1h` score `-0.3126` n `231` status `ready` deltaP `6.0665` edge `0.0342` maxDD `-5.0555`
- `market_context_high->fx_1h` score `-0.3561` n `231` status `ready` deltaP `0.1841` edge `0.0007` maxDD `-0.4734`
...
- `market_context_high->fx_4h` score `-1.1976` n `219` status `ready` deltaP `1.136` edge `0.0074` maxDD `-1.1476`
...
- `market_context_high->commodity_4h` score `-4.2104` n `219` status `ready` deltaP `-6.0022` edge `-0.0433` maxDD `-14.071`
