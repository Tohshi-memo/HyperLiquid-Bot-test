...
- `market_context_high->unknown_1h` score `31.5807` n `224` status `ready` deltaP `3.657` edge `2.7653` maxDD `-9.6361`
...
- `risk_on_high->crypto_major_4h` score `1.7693` n `44` status `ready` deltaP `17.8493` edge `0.095` maxDD `-2.6576`
- `risk_on_and_context->crypto_major_4h` score `1.7693` n `44` status `ready` deltaP `17.8493` edge `0.095` maxDD `-2.6576`
...
- `risk_on_high->index_24h` score `0.2517` n `44` status `ready` deltaP `19.2708` edge `-0.1075` maxDD `0.0`
- `risk_on_and_context->index_24h` score `0.2517` n `44` status `ready` deltaP `19.2708` edge `-0.1075` maxDD `0.0`
- `risk_on_high->crypto_major_1h` score `0.2501` n `44` status `ready` deltaP `8.3969` edge `0.0303` maxDD `-2.3372`
- `risk_on_and_context->crypto_major_1h` score `0.2501` n `44` status `ready` deltaP `8.3969` edge `0.0303` maxDD `-2.3372`
