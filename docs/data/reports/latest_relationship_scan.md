...
- `news_risk_high->unknown_24h` score `7957.4477` n `43` status `ready` deltaP `38.5417` edge `662.8637` maxDD `0.0`
- `news_risk_high->equity_4h` score `7.4098` n `54` status `ready` deltaP `27.2979` edge `0.4952` maxDD `-3.4427`
...
- `news_risk_high->metal_24h` score `-5.7759` n `43` status `ready` deltaP `-20.9464` edge `-0.0902` maxDD `-10.1184`
- `news_risk_high->commodity_4h` score `-8.9371` n `54` status `ready` deltaP `-32.7913` edge `-0.1954` maxDD `-13.1269`
...
- `news_risk_high->equity_24h` score `-34.1692` n `43` status `ready` deltaP `-23.4415` edge `-1.2122` maxDD `-105.9832`
