...
- `market_context_high->crypto_alt_1h` score `-0.3094` n `181` status `ready` deltaP `1.7948` edge `0.0348` maxDD `-4.5815`
- `market_context_high->crypto_major_1h` score `-0.5735` n `181` status `ready` deltaP `4.051` edge `0.0347` maxDD `-7.1523`
- `market_context_high->unknown_4h` score `-0.7435` n `181` status `ready` deltaP `-4.8469` edge `0.1338` maxDD `-4.742`
- `market_context_high->index_1h` score `-0.7703` n `181` status `ready` deltaP `-1.1712` edge `-0.004` maxDD `-2.2895`
...
- `market_context_high->crypto_major_4h` score `-3.092` n `181` status `ready` deltaP `2.391` edge `0.0161` maxDD `-24.6094`
- `market_context_high->fx_24h` score `-3.6011` n `181` status `ready` deltaP `-0.7021` edge `-0.0127` maxDD `-3.9503`
