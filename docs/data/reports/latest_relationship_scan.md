...
- `market_context_high->crypto_alt_24h` score `16.795` n `53` status `ready` deltaP `54.4979` edge `1.076` maxDD `-2.1786`
...
- `market_context_high->commodity_24h` score `2.1885` n `53` status `ready` deltaP `30.9506` edge `0.2601` maxDD `-10.2019`
- `news_risk_high->crypto_major_4h` score `1.2976` n `60` status `ready` deltaP `7.7439` edge `0.1923` maxDD `-3.5385`
- `news_risk_high->equity_1h` score `1.2536` n `63` status `ready` deltaP `12.1163` edge `0.0822` maxDD `-2.6807`
...
- `news_risk_high->crypto_alt_1h` score `0.3892` n `63` status `ready` deltaP `7.7417` edge `0.0535` maxDD `-2.0834`
...
- `news_risk_high->crypto_major_1h` score `0.1709` n `63` status `ready` deltaP `4.2677` edge `0.0485` maxDD `-2.4034`
...
- `news_risk_high->index_1h` score `0.0934` n `63` status `ready` deltaP `5.1374` edge `0.0094` maxDD `-0.5338`
