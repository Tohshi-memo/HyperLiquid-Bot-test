...
- `news_risk_high->unknown_1h` score `3.2294` n `53` status `ready` deltaP `16.162` edge `0.1969` maxDD `-0.8426`
...
- `news_risk_high->equity_4h` score `1.483` n `53` status `ready` deltaP `18.3646` edge `0.0782` maxDD `-2.164`
...
- `market_context_high->unknown_1h` score `0.2118` n `133` status `ready` deltaP `11.7216` edge `-0.0156` maxDD `-1.5916`
