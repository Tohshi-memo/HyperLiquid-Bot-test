...
- `market_context_high->unknown_4h` score `-0.8724` n `184` status `ready` deltaP `-5.2889` edge `0.126` maxDD `-4.742`
...
- `market_context_high->metal_4h` score `-3.6253` n `184` status `ready` deltaP `-0.0133` edge `-0.0037` maxDD `-5.5324`
