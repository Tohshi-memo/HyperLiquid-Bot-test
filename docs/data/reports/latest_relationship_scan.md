...
- `market_context_high->unknown_1h` score `1.4616` n `133` status `ready` deltaP `8.5375` edge `0.0876` maxDD `-0.4843`
...
- `market_context_high->metal_1h` score `-0.2709` n `133` status `ready` deltaP `1.73` edge `-0.0044` maxDD `-0.6822`
...
- `market_context_high->crypto_major_1h` score `-1.4307` n `133` status `ready` deltaP `-1.999` edge `-0.0676` maxDD `-4.1996`
...
- `market_context_high->crypto_major_4h` score `-5.5539` n `133` status `ready` deltaP `-1.9542` edge `-0.3477` maxDD `-3.1677`
