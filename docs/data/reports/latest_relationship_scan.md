...
- `market_context_high->unknown_1h` score `70.4243` n `146` status `ready` deltaP `8.9082` edge `5.8552` maxDD `-2.0052`
- `market_context_high->unknown_4h` score `5.2219` n `146` status `ready` deltaP `10.8002` edge `0.4842` maxDD `-4.6834`
...
- `market_context_high->equity_1h` score `-0.7456` n `146` status `ready` deltaP `-0.7485` edge `0.0081` maxDD `-5.5624`
- `market_context_high->fx_4h` score `-0.7809` n `146` status `ready` deltaP `1.1444` edge `0.0005` maxDD `-1.9927`
...
- `market_context_high->commodity_24h` score `-4.8587` n `146` status `ready` deltaP `12.8472` edge `0.0599` maxDD `-30.7016`
- `market_context_high->fx_24h` score `-5.1256` n `146` status `ready` deltaP `-9.9006` edge `-0.0099` maxDD `-6.0982`
- `market_context_high->crypto_alt_1h` score `-5.1398` n `146` status `ready` deltaP `-0.7485` edge `-0.0946` maxDD `-22.2982`
- `market_context_high->crypto_major_1h` score `-6.363` n `146` status `ready` deltaP `-4.3454` edge `-0.126` maxDD `-27.356`
- `market_context_high->index_24h` score `-7.3706` n `146` status `ready` deltaP `-6.3951` edge `-0.0341` maxDD `-29.3321`
- `market_context_high->crypto_alt_4h` score `-7.7627` n `146` status `ready` deltaP `0.0` edge `-0.1295` maxDD `-63.9243`
- `market_context_high->metal_4h` score `-9.4736` n `146` status `ready` deltaP `-2.7272` edge `-0.275` maxDD `-67.3775`
- `market_context_high->crypto_major_4h` score `-10.9252` n `146` status `ready` deltaP `-2.2052` edge `-0.2916` maxDD `-82.2164`
