...
- `market_context_high->unknown_1h` score `-0.7367` n `178` status `ready` deltaP `-1.6501` edge `0.0138` maxDD `-1.4688`
...
- `market_context_high->index_1h` score `-0.882` n `178` status `ready` deltaP `-0.4542` edge `-0.004` maxDD `-2.3175`
