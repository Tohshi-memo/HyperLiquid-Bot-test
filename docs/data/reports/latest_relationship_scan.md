...
- `news_risk_high->unknown_24h` score `45.7122` n `52` status `ready` deltaP `11.6319` edge `3.7318` maxDD `0.0`
- `news_risk_high->unknown_4h` score `11.802` n `53` status `ready` deltaP `23.1506` edge `0.8391` maxDD `-0.1281`
- `news_risk_high->crypto_alt_24h` score `9.2916` n `52` status `ready` deltaP `31.4102` edge `0.5874` maxDD `-1.4667`
- `news_risk_high->equity_24h` score `7.0681` n `52` status `ready` deltaP `29.7143` edge `0.484` maxDD `-4.7801`
...
- `market_context_high->unknown_4h` score `2.4351` n `136` status `ready` deltaP `21.4581` edge `0.1007` maxDD `-0.5994`
...
- `news_risk_high->equity_1h` score `0.438` n `53` status `ready` deltaP `12.9251` edge `0.0064` maxDD `-0.9128`
- `news_risk_high->index_4h` score `0.1583` n `53` status `ready` deltaP `6.8138` edge `0.0075` maxDD `-0.1788`
...
- `news_risk_high->metal_4h` score `-0.4694` n `53` status `ready` deltaP `4.8147` edge `-0.0181` maxDD `-0.249`
- `news_risk_high->commodity_4h` score `-0.9622` n `53` status `ready` deltaP `-0.906` edge `0.006` maxDD `-1.1986`
