...
- `market_context_high->crypto_major_4h` score `-3.0155` n `146` status `ready` deltaP `4.3414` edge `0.0129` maxDD `-24.6094`
...
- `market_context_high->crypto_alt_4h` score `-4.6308` n `146` status `ready` deltaP `0.9209` edge `-0.0135` maxDD `-22.2831`
