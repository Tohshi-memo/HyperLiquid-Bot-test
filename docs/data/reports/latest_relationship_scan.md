...
- `news_risk_high->unknown_24h` score `48.0389` n `50` status `ready` deltaP `11.5717` edge `3.9261` maxDD `0.0`
...
- `news_risk_high->equity_24h` score `7.8535` n `50` status `ready` deltaP `34.0864` edge `0.5203` maxDD `-4.7801`
...
- `market_context_high->unknown_24h` score `-0.3766` n `133` status `ready` deltaP `5.5567` edge `0.0043` maxDD `-3.1513`
