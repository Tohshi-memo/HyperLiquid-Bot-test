...
- `market_context_high->unknown_24h` score `25.5386` n `62` status `ready` deltaP `20.9565` edge `1.9928` maxDD `-0.0103`
- `market_context_high->unknown_4h` score `5.4363` n `89` status `ready` deltaP `1.24` edge `0.5443` maxDD `-3.6303`
- `market_context_high->crypto_alt_24h` score `2.0805` n `62` status `ready` deltaP `15.3617` edge `0.1773` maxDD `-3.1736`
...
- `market_context_high->fx_24h` score `-0.1902` n `62` status `ready` deltaP `9.319` edge `0.0426` maxDD `-4.3126`
- `market_context_high->commodity_24h` score `-0.3003` n `62` status `ready` deltaP `18.5596` edge `0.1217` maxDD `-17.3809`
...
- `market_context_high->metal_24h` score `-0.5746` n `62` status `ready` deltaP `-11.2847` edge `0.1184` maxDD `-2.6802`
...
- `market_context_high->index_4h` score `-2.0063` n `89` status `ready` deltaP `-11.6505` edge `-0.0541` maxDD `-4.7021`
- `market_context_high->index_24h` score `-3.2294` n `62` status `ready` deltaP `-15.5018` edge `-0.0912` maxDD `-7.8922`
