...
- `market_context_high->fx_1h` score `-0.3008` n `119` status `ready` deltaP `1.4442` edge `0.0018` maxDD `-0.2527`
- `market_context_high->fx_4h` score `-0.3025` n `117` status `ready` deltaP `4.4338` edge `0.0057` maxDD `-0.504`
...
- `market_context_high->fx_24h` score `-1.7964` n `83` status `ready` deltaP `-11.724` edge `0.0086` maxDD `-1.8596`
- `market_context_high->crypto_major_4h` score `-2.0084` n `117` status `ready` deltaP `0.275` edge `-0.0321` maxDD `-6.6344`
- `market_context_high->metal_24h` score `-2.0642` n `83` status `ready` deltaP `-10.8664` edge `0.059` maxDD `-7.0954`
- `market_context_high->crypto_major_1h` score `-2.2871` n `119` status `ready` deltaP `-5.7616` edge `-0.0373` maxDD `-5.8571`
- `market_context_high->crypto_alt_1h` score `-2.3528` n `119` status `ready` deltaP `-4.9212` edge `-0.0293` maxDD `-7.0497`
