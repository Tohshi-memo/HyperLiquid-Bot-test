...
- `news_risk_high->unknown_24h` score `49.5459` n `51` status `ready` deltaP `17.0139` edge `4.0154` maxDD `0.0`
- `news_risk_high->equity_24h` score `14.1715` n `51` status `ready` deltaP `40.237` edge `1.0058` maxDD `-4.7801`
- `news_risk_high->unknown_4h` score `13.0143` n `51` status `ready` deltaP `24.2587` edge `0.9274` maxDD `-0.0348`
- `news_risk_high->index_24h` score `5.7076` n `51` status `ready` deltaP `48.9481` edge `0.1645` maxDD `-0.2147`
- `news_risk_high->equity_4h` score `3.7704` n `51` status `ready` deltaP `27.2328` edge `0.2097` maxDD `-2.164`
- `news_risk_high->unknown_1h` score `3.6305` n `51` status `ready` deltaP `16.9337` edge `0.2201` maxDD `-0.7693`
- `news_risk_high->fx_4h` score `3.209` n `51` status `ready` deltaP `37.778` edge `0.029` maxDD `-0.0746`
- `market_context_high->unknown_4h` score `1.9766` n `141` status `ready` deltaP `19.8365` edge `0.0733` maxDD `-0.5994`
- `news_risk_high->metal_24h` score `1.5779` n `51` status `ready` deltaP `33.1086` edge `-0.085` maxDD `-0.0053`
- `market_context_high->unknown_24h` score `1.453` n `85` status `ready` deltaP `4.0727` edge `0.1446` maxDD `-1.0533`
- `news_risk_high->fx_1h` score `1.2182` n `51` status `ready` deltaP `16.696` edge `0.0072` maxDD `-0.0257`
- `news_risk_high->equity_1h` score `0.9771` n `51` status `ready` deltaP `18.7918` edge `0.0364` maxDD `-0.9128`
...
- `market_context_high->unknown_1h` score `0.0506` n `141` status `ready` deltaP `11.1765` edge `-0.0254` maxDD `-1.5916`
...
- `news_risk_high->crypto_alt_24h` score `-0.2698` n `51` status `ready` deltaP `22.7431` edge `-0.1741` maxDD `0.0`
