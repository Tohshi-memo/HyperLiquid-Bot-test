...
- Generated: `2026-07-25T15:22:28.853935+00:00`
- Price records: `672`
- Market context records: `7891`
...
- `market_context_high->equity_4h` score `4.9243` n `108` status `ready` deltaP `15.2361` edge `0.4064` maxDD `-5.1426`
- `market_context_high->metal_24h` score `4.7546` n `107` status `ready` deltaP `23.662` edge `0.3169` maxDD `-0.608`
- `market_context_high->commodity_24h` score `1.7808` n `107` status `ready` deltaP `21.9375` edge `0.1605` maxDD `-7.0012`
- `market_context_high->crypto_alt_4h` score `1.7024` n `108` status `ready` deltaP `14.1425` edge `0.1593` maxDD `-3.9374`
- `market_context_high->crypto_major_4h` score `1.5719` n `108` status `ready` deltaP `15.8549` edge `0.1971` maxDD `-6.7444`
...
- `market_context_high->commodity_4h` score `0.7376` n `108` status `ready` deltaP `10.8184` edge `0.0487` maxDD `-1.0817`
...
- `market_context_high->commodity_1h` score `-0.2413` n `113` status `ready` deltaP `3.468` edge `0.0028` maxDD `-1.5486`
...
- `market_context_high->crypto_alt_24h` score `-1.7229` n `107` status `ready` deltaP `11.4365` edge `0.2324` maxDD `-28.3623`
