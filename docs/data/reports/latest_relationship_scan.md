...
- Price records: `672`
- Market context records: `1085`
- Flow alert records: `5027`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->equity_4h` score `1.7135` n `162` status `ready` deltaP `9.7279` edge `0.1526` maxDD `-3.6396`
- `market_context_high->crypto_major_4h` score `1.2992` n `162` status `ready` deltaP `12.5358` edge `0.1933` maxDD `-6.4882`
- `market_context_high->index_4h` score `0.9035` n `162` status `ready` deltaP `7.7086` edge `0.0922` maxDD `-2.1308`
- `market_context_high->index_1h` score `0.6616` n `174` status `ready` deltaP `8.7187` edge `0.0287` maxDD `-0.5353`
- `market_context_high->equity_1h` score `0.4678` n `174` status `ready` deltaP `2.7978` edge `0.0581` maxDD `-1.3546`
...
- `market_context_high->metal_4h` score `-1.9146` n `162` status `ready` deltaP `4.7463` edge `-0.0817` maxDD `-9.2991`
