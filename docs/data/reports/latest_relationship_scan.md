...
- `news_risk_high->equity_24h` score `6.9501` n `51` status `ready` deltaP `29.9939` edge `0.4723` maxDD `-4.7801`
- `news_risk_high->crypto_alt_24h` score `6.6422` n `51` status `ready` deltaP `29.6875` edge `0.3556` maxDD `0.0`
- `news_risk_high->index_24h` score `4.01` n `51` status `ready` deltaP `40.2676` edge `0.0809` maxDD `-0.2147`
...
- `news_risk_high->equity_4h` score `1.6545` n `53` status `ready` deltaP `19.2792` edge `0.0864` maxDD `-2.164`
...
- `news_risk_high->equity_1h` score `0.3577` n `53` status `ready` deltaP `12.3263` edge `0.0001` maxDD `-0.9128`
