...
- `market_context_high->unknown_4h` score `32.7445` n `58` status `ready` deltaP `1.23` edge `2.7355` maxDD `-0.5326`
- `news_risk_high->crypto_major_24h` score `23.5328` n `101` status `ready` deltaP `11.7901` edge `2.5683` maxDD `-46.1999`
- `news_risk_high->crypto_alt_24h` score `18.4196` n `101` status `ready` deltaP `12.1751` edge `1.9419` maxDD `-32.7147`
- `news_risk_high->crypto_alt_4h` score `4.3299` n `101` status `ready` deltaP `19.2239` edge `0.3536` maxDD `-7.675`
- `news_risk_high->crypto_major_4h` score `3.9829` n `101` status `ready` deltaP `21.358` edge `0.3153` maxDD `-8.0625`
