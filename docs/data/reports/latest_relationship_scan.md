...
- Price records: `672`
- Market context records: `1766`
- Flow alert records: `6983`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_alt_4h` score `6.1786` n `195` status `ready` deltaP `21.7949` edge `0.5462` maxDD `-9.1295`
- `market_context_high->crypto_major_4h` score `4.7578` n `195` status `ready` deltaP `23.3615` edge `0.4813` maxDD `-10.9117`
- `market_context_high->index_24h` score `3.8917` n `174` status `ready` deltaP `18.5764` edge `0.3233` maxDD `-4.1604`
...
- `market_context_high->crypto_alt_1h` score `0.8242` n `195` status `ready` deltaP `7.7322` edge `0.1195` maxDD `-4.1892`
- `market_context_high->crypto_major_24h` score `0.4451` n `174` status `ready` deltaP `19.0314` edge `0.7688` maxDD `-62.3533`
- `market_context_high->crypto_major_1h` score `0.3294` n `195` status `ready` deltaP `5.3401` edge `0.0992` maxDD `-3.9211`
...
- `market_context_high->metal_4h` score `-0.2016` n `195` status `ready` deltaP `12.6056` edge `0.1593` maxDD `-12.5349`
