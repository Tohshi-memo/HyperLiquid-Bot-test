...
- `market_context_high->fx_1h` score `-0.217` n `297` status `ready` deltaP `2.862` edge `0.0012` maxDD `-0.5144`
...
- `market_context_high->fx_24h` score `-0.9062` n `228` status `ready` deltaP `14.9488` edge `0.0425` maxDD `-3.6674`
- `market_context_high->crypto_major_1h` score `-0.9399` n `297` status `ready` deltaP `3.1614` edge `0.0327` maxDD `-6.2348`
...
- `market_context_high->crypto_major_4h` score `-2.7082` n `285` status `ready` deltaP `7.8198` edge `0.1541` maxDD `-25.2202`
...
- `market_context_high->crypto_alt_4h` score `-3.8534` n `285` status `ready` deltaP `6.5084` edge `0.1088` maxDD `-26.5313`
