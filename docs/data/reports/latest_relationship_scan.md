...
- Price records: `672`
- Market context records: `2194`
- Flow alert records: `8206`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_alt_4h` score `12.6807` n `132` status `ready` deltaP `36.2343` edge `0.9088` maxDD `-5.1574`
- `market_context_high->crypto_major_4h` score `11.6642` n `132` status `ready` deltaP `41.6713` edge `0.7472` maxDD `-1.9063`
- `market_context_high->unknown_4h` score `5.419` n `132` status `ready` deltaP `21.2214` edge `0.378` maxDD `-2.4317`
- `news_risk_high->commodity_4h` score `3.8214` n `43` status `ready` deltaP `31.8526` edge `0.3447` maxDD `-3.0367`
- `market_context_high->unknown_24h` score `3.5862` n `132` status `ready` deltaP `28.8511` edge `0.588` maxDD `-32.8525`
- `market_context_high->equity_4h` score `3.4946` n `132` status `ready` deltaP `24.0253` edge `0.2405` maxDD `-5.0894`
- `market_context_high->crypto_major_1h` score `3.2134` n `132` status `ready` deltaP `17.5649` edge `0.1984` maxDD `-1.817`
...
- `market_context_high->index_24h` score `2.5676` n `132` status `ready` deltaP `10.9059` edge `0.2641` maxDD `-4.1604`
- `market_context_high->crypto_major_24h` score `2.4736` n `132` status `ready` deltaP `20.0599` edge `1.0116` maxDD `-60.2561`
...
- `news_risk_high->unknown_1h` score `1.418` n `43` status `ready` deltaP `21.1948` edge `0.0238` maxDD `-1.7548`
- `news_risk_high->equity_4h` score `1.289` n `43` status `ready` deltaP `-2.6837` edge `0.3039` maxDD `-4.6598`
- `news_risk_high->unknown_4h` score `1.2554` n `43` status `ready` deltaP `14.3151` edge `0.0815` maxDD `-2.7857`
