...
- `market_context_high->unknown_4h` score `8.5955` n `219` status `ready` deltaP `7.5043` edge `0.7358` maxDD `-2.563`
- `news_risk_high->crypto_alt_24h` score `7.4015` n `37` status `ready` deltaP `25.1783` edge `0.4759` maxDD `-0.8236`
...
- `news_risk_high->equity_1h` score `1.6266` n `37` status `ready` deltaP `13.5338` edge `0.0844` maxDD `-0.7924`
...
- `news_risk_high->crypto_alt_4h` score `0.9582` n `37` status `ready` deltaP `7.9227` edge `0.0599` maxDD `-1.296`
- `news_risk_high->fx_24h` score `0.169` n `37` status `ready` deltaP `11.7961` edge `0.037` maxDD `-3.1244`
- `risk_on_high->metal_1h` score `0.078` n `139` status `ready` deltaP `11.9911` edge `0.0013` maxDD `-1.699`
- `risk_on_and_context->metal_1h` score `0.078` n `139` status `ready` deltaP `11.9911` edge `0.0013` maxDD `-1.699`
...
- `risk_on_high->index_1h` score `-0.1569` n `139` status `ready` deltaP `4.169` edge `-0.0032` maxDD `-0.5764`
