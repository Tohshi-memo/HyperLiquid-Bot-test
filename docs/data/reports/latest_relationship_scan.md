...
- `news_risk_high->unknown_4h` score `13.0511` n `51` status `ready` deltaP `24.8685` edge `0.9264` maxDD `-0.0348`
...
- `market_context_high->unknown_4h` score `1.8466` n `130` status `ready` deltaP `19.9062` edge `0.062` maxDD `-0.5994`
...
- `news_risk_high->index_1h` score `0.2115` n `51` status `ready` deltaP `8.5241` edge `0.0056` maxDD `-0.1583`
...
- `news_risk_high->metal_1h` score `-0.1808` n `51` status `ready` deltaP `0.9951` edge `-0.0075` maxDD `-0.1184`
- `news_risk_high->metal_24h` score `-0.1854` n `51` status `ready` deltaP `22.692` edge `-0.1625` maxDD `-0.0053`
