...
- `news_risk_high->unknown_4h` score `14.6176` n `51` status `ready` deltaP `26.2404` edge `1.0478` maxDD `-0.0347`
- `risk_on_high->unknown_1h` score `4.9735` n `33` status `ready` deltaP `-8.3288` edge `0.738` maxDD `-1.5876`
- `risk_on_and_context->unknown_1h` score `4.9735` n `33` status `ready` deltaP `-8.3288` edge `0.738` maxDD `-1.5876`
- `news_risk_high->unknown_1h` score `3.6892` n `51` status `ready` deltaP `19.4786` edge `0.208` maxDD `-0.7674`
...
- `market_context_high->crypto_alt_4h` score `1.4295` n `126` status `ready` deltaP `8.9915` edge `0.206` maxDD `-7.0785`
- `market_context_high->unknown_1h` score `1.4201` n `128` status `ready` deltaP `7.4382` edge `0.1136` maxDD `-1.5876`
- `news_risk_high->fx_1h` score `1.1871` n `51` status `ready` deltaP `16.3966` edge `0.0066` maxDD `-0.0257`
- `market_context_high->unknown_4h` score `1.1389` n `126` status `ready` deltaP `21.852` edge `-0.0336` maxDD `-0.3736`
- `market_context_high->commodity_24h` score `0.9169` n `108` status `ready` deltaP `1.4468` edge `0.1141` maxDD `-0.7869`
- `news_risk_high->equity_1h` score `0.7753` n `51` status `ready` deltaP `17.1451` edge `0.0216` maxDD `-0.9204`
