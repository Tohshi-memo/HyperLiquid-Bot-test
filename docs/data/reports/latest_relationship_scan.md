...
- `market_context_high->equity_4h` score `0.6454` n `105` status `ready` deltaP `7.7889` edge `0.1648` maxDD `-8.3685`
- `market_context_high->equity_1h` score `0.5151` n `105` status `ready` deltaP `9.6179` edge `0.0603` maxDD `-3.1861`
...
- `market_context_high->unknown_1h` score `-0.4289` n `105` status `ready` deltaP `7.0317` edge `-0.0599` maxDD `-0.4843`
...
- `market_context_high->crypto_alt_4h` score `-1.4178` n `105` status `ready` deltaP `4.2814` edge `-0.0197` maxDD `-5.4926`
- `market_context_high->crypto_major_4h` score `-1.6719` n `105` status `ready` deltaP `6.8351` edge `-0.0828` maxDD `-3.1677`
- `market_context_high->unknown_24h` score `-1.8369` n `96` status `ready` deltaP `17.7083` edge `-0.2205` maxDD `-1.0505`
