...
- `market_context_high->commodity_4h` score `2.1565` n `103` status `ready` deltaP `19.5181` edge `0.0967` maxDD `-0.7687`
...
- `market_context_high->commodity_1h` score `0.0359` n `115` status `ready` deltaP `3.2283` edge `0.0226` maxDD `-0.624`
...
- `market_context_high->fx_4h` score `-0.0436` n `103` status `ready` deltaP `6.7606` edge `0.0098` maxDD `-0.504`
...
- `market_context_high->metal_1h` score `-0.6392` n `115` status `ready` deltaP `-0.4921` edge `-0.0071` maxDD `-1.7257`
