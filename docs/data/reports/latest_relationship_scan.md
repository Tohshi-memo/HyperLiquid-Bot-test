...
- `market_context_high->crypto_alt_24h` score `16.3935` n `40` status `ready` deltaP `55.1042` edge `1.0385` maxDD `-2.1786`
...
- `market_context_high->crypto_alt_4h` score `0.7093` n `40` status `ready` deltaP `8.3537` edge `0.1258` maxDD `-4.9116`
- `market_context_high->commodity_1h` score `0.67` n `40` status `ready` deltaP `12.3952` edge `0.0407` maxDD `-1.3282`
- `news_risk_high->equity_1h` score `0.6612` n `67` status `ready` deltaP `9.9875` edge `0.0708` maxDD `-2.916`
- `market_context_high->fx_4h` score `0.6527` n `40` status `ready` deltaP `20.4573` edge `0.0269` maxDD `-1.3685`
- `market_context_high->fx_1h` score `0.4606` n `40` status `ready` deltaP `14.1467` edge `0.0025` maxDD `-0.6874`
- `news_risk_high->fx_4h` score `0.3858` n `67` status `ready` deltaP `15.1961` edge `0.0266` maxDD `-0.6604`
- `news_risk_high->metal_4h` score `0.1457` n `67` status `ready` deltaP `5.9224` edge `0.0268` maxDD `-0.8085`
- `news_risk_high->crypto_alt_1h` score `0.0926` n `67` status `ready` deltaP `6.2673` edge `0.0383` maxDD `-3.1233`
...
- `news_risk_high->metal_1h` score `-0.0958` n `67` status `ready` deltaP `3.2778` edge `0.0062` maxDD `-0.5599`
- `news_risk_high->crypto_major_1h` score `-0.2028` n `67` status `ready` deltaP `2.6879` edge `0.0281` maxDD `-3.762`
- `market_context_high->crypto_alt_1h` score `-0.472` n `40` status `ready` deltaP `-0.4491` edge `0.0052` maxDD `-3.0178`
