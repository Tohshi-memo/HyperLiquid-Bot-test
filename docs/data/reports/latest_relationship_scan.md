...
- `risk_on_high->unknown_4h` score `131.0214` n `44` status `ready` deltaP `-3.2705` edge `11.1221` maxDD `-10.8809`
- `risk_on_and_context->unknown_4h` score `131.0214` n `44` status `ready` deltaP `-3.2705` edge `11.1221` maxDD `-10.8809`
- `market_context_high->unknown_1h` score `26.8996` n `227` status `ready` deltaP `1.9178` edge `2.3868` maxDD `-9.6361`
- `market_context_high->unknown_4h` score `7.7853` n `219` status `ready` deltaP `-2.077` edge `1.2056` maxDD `-35.7719`
...
- `risk_on_high->fx_4h` score `0.0391` n `44` status `ready` deltaP `8.9385` edge `0.0045` maxDD `-0.3925`
- `risk_on_and_context->fx_4h` score `0.0391` n `44` status `ready` deltaP `8.9385` edge `0.0045` maxDD `-0.3925`
