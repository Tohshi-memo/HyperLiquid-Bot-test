...
- `market_context_high->fx_24h` score `-1.454` n `83` status `ready` deltaP `-7.5991` edge `0.025` maxDD `-1.8596`
- `market_context_high->equity_1h` score `-1.7052` n `123` status `ready` deltaP `-10.266` edge `-0.0462` maxDD `-4.9849`
...
- `market_context_high->crypto_alt_1h` score `-2.1854` n `123` status `ready` deltaP `-3.594` edge `-0.0242` maxDD `-7.0497`
...
- `market_context_high->crypto_alt_4h` score `-7.6138` n `120` status `ready` deltaP `-10.0711` edge `-0.0959` maxDD `-25.0488`
