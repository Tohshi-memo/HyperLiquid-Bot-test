...
- `market_context_high->crypto_alt_1h` score `-0.8261` n `120` status `ready` deltaP `-3.4431` edge `-0.0119` maxDD `-3.0178`
...
- `market_context_high->crypto_alt_4h` score `-2.0941` n `120` status `ready` deltaP `1.0467` edge `-0.0425` maxDD `-5.7857`
- `market_context_high->crypto_major_1h` score `-2.6777` n `120` status `ready` deltaP `-6.6018` edge `-0.0418` maxDD `-7.6533`
