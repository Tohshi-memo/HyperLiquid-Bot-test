...
- `market_context_high->equity_4h` score `0.0289` n `105` status `ready` deltaP `4.2828` edge `0.1368` maxDD `-8.3685`
...
- `market_context_high->commodity_4h` score `-0.6575` n `105` status `ready` deltaP `-1.5854` edge `0.0113` maxDD `-2.4692`
- `market_context_high->commodity_1h` score `-0.7471` n `105` status `ready` deltaP `-5.7285` edge `-0.001` maxDD `-1.1941`
- `market_context_high->crypto_alt_1h` score `-0.748` n `105` status `ready` deltaP `-1.1448` edge `-0.0081` maxDD `-2.413`
- `market_context_high->crypto_major_1h` score `-0.8924` n `105` status `ready` deltaP `-0.4092` edge `-0.0272` maxDD `-2.7581`
- `market_context_high->crypto_alt_4h` score `-2.4599` n `105` status `ready` deltaP `1.0802` edge `-0.0852` maxDD `-5.4926`
- `market_context_high->crypto_major_4h` score `-2.8584` n `105` status `ready` deltaP `3.329` edge `-0.1583` maxDD `-3.1677`
