...
- `market_context_high->unknown_1h` score `15.2323` n `93` status `ready` deltaP `3.9679` edge `1.293` maxDD `-1.674`
- `market_context_high->unknown_4h` score `9.0141` n `93` status `ready` deltaP `21.4496` edge `0.7104` maxDD `-5.5109`
- `market_context_high->crypto_major_4h` score `5.5615` n `93` status `ready` deltaP `17.0994` edge `0.5079` maxDD `-8.3416`
- `market_context_high->crypto_alt_4h` score `5.3651` n `93` status `ready` deltaP `14.7883` edge `0.4879` maxDD `-7.8181`
- `market_context_high->metal_4h` score `1.283` n `93` status `ready` deltaP `13.6965` edge `0.1235` maxDD `-1.9651`
- `market_context_high->equity_1h` score `0.862` n `93` status `ready` deltaP `8.1868` edge `0.0746` maxDD `-2.5875`
- `market_context_high->crypto_major_1h` score `0.7709` n `93` status `ready` deltaP `6.1039` edge `0.1153` maxDD `-4.6734`
...
- `market_context_high->crypto_alt_1h` score `0.1898` n `93` status `ready` deltaP `5.2604` edge `0.0915` maxDD `-5.5126`
...
- `market_context_high->unknown_24h` score `-2.6846` n `74` status `ready` deltaP `27.0364` edge `-0.3697` maxDD `-1.4072`
