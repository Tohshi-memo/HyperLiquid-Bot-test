...
- `market_context_high->unknown_1h` score `69.2482` n `47` status `ready` deltaP `8.1698` edge `5.7233` maxDD `-0.2334`
- `market_context_high->crypto_major_24h` score `46.9505` n `47` status `ready` deltaP `22.2628` edge `3.8034` maxDD `-2.4756`
- `market_context_high->crypto_alt_24h` score `26.7457` n `47` status `ready` deltaP `17.1431` edge `2.1525` maxDD `-2.7051`
...
- `news_risk_high->crypto_alt_24h` score `2.5066` n `85` status `ready` deltaP `11.0355` edge `0.5305` maxDD `-29.2814`
