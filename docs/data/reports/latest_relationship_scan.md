...
- `market_context_high->equity_24h` score `3.5671` n `98` status `ready` deltaP `3.6813` edge `0.5787` maxDD `-21.1456`
...
- `market_context_high->fx_24h` score `1.1263` n `98` status `ready` deltaP `26.0487` edge `0.0574` maxDD `-1.9329`
...
- `market_context_high->fx_4h` score `-0.8771` n `103` status `ready` deltaP `1.1751` edge `-0.0056` maxDD `-1.6928`
...
- `market_context_high->crypto_major_24h` score `-2.429` n `98` status `ready` deltaP `5.4776` edge `-0.0985` maxDD `-14.2873`
- `market_context_high->crypto_major_1h` score `-2.5416` n `103` status `ready` deltaP `-8.4835` edge `-0.0556` maxDD `-4.6382`
- `market_context_high->crypto_alt_24h` score `-2.8352` n `98` status `ready` deltaP `-14.4274` edge `-0.123` maxDD `-4.5445`
