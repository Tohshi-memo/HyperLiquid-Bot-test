...
- `market_context_high->equity_24h` score `0.1961` n `248` status `ready` deltaP `15.3954` edge `0.4216` maxDD `-31.6316`
...
- `market_context_high->commodity_1h` score `-0.6278` n `291` status `ready` deltaP `-1.5124` edge `-0.0033` maxDD `-2.7017`
...
- `market_context_high->crypto_alt_1h` score `-1.0976` n `291` status `ready` deltaP `1.407` edge `0.0326` maxDD `-6.6758`
- `market_context_high->index_4h` score `-1.248` n `291` status `ready` deltaP `-0.1613` edge `0.0098` maxDD `-3.165`
- `market_context_high->fx_24h` score `-1.3749` n `248` status `ready` deltaP `10.5903` edge `0.0325` maxDD `-5.3495`
- `market_context_high->fx_4h` score `-1.4129` n `291` status `ready` deltaP `1.4353` edge `0.0042` maxDD `-2.2593`
- `market_context_high->metal_4h` score `-2.2363` n `291` status `ready` deltaP `-4.3987` edge `-0.0445` maxDD `-9.6969`
- `market_context_high->crypto_major_4h` score `-2.7201` n `291` status `ready` deltaP `8.0499` edge `0.1569` maxDD `-25.6458`
...
- `market_context_high->crypto_alt_4h` score `-4.3855` n `291` status `ready` deltaP `5.7581` edge `0.097` maxDD `-28.7346`
...
- `market_context_high->crypto_major_24h` score `-11.2066` n `248` status `ready` deltaP `-2.2234` edge `-0.257` maxDD `-35.2981`
