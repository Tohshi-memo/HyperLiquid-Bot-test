...
- `news_risk_high->unknown_24h` score `4749.0098` n `64` status `ready` deltaP `35.0694` edge `395.5591` maxDD `-2.0332`
...
- `news_risk_high->metal_4h` score `0.0721` n `64` status `ready` deltaP `3.6966` edge `0.0322` maxDD `-0.8085`
