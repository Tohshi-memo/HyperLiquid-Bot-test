...
- `news_risk_high->equity_4h` score `5.9414` n `64` status `ready` deltaP `21.7226` edge `0.41` maxDD `-3.4427`
...
- `news_risk_high->crypto_alt_1h` score `0.4531` n `64` status `ready` deltaP `8.2616` edge `0.0557` maxDD `-1.8813`
...
- `market_context_high->crypto_alt_1h` score `-0.5236` n `62` status `ready` deltaP `-2.7767` edge `0.0141` maxDD `-3.0178`
