...
- `market_context_high->equity_4h` score `1.4387` n `234` status `ready` deltaP `8.2226` edge `0.1751` maxDD `-4.1352`
- `news_risk_high->crypto_major_1h` score `0.9252` n `30` status `ready` deltaP `11.8363` edge `0.0864` maxDD `-2.0691`
- `news_risk_high->crypto_alt_1h` score `0.2801` n `30` status `ready` deltaP `5.4691` edge `0.0456` maxDD `-1.6923`
- `news_risk_high->metal_1h` score `-0.4196` n `30` status `ready` deltaP `1.6866` edge `-0.0284` maxDD `-1.2643`
- `market_context_high->equity_1h` score `-0.4364` n `238` status `ready` deltaP `4.7288` edge `0.0328` maxDD `-5.0555`
...
- `market_context_high->crypto_major_1h` score `-0.8432` n `238` status `ready` deltaP `3.545` edge `0.0382` maxDD `-6.2348`
- `market_context_high->crypto_alt_1h` score `-0.9387` n `238` status `ready` deltaP `2.5839` edge `0.038` maxDD `-6.6758`
...
- `market_context_high->crypto_major_4h` score `-2.1553` n `234` status `ready` deltaP `9.5593` edge `0.1939` maxDD `-25.6458`
