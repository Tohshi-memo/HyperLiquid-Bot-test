...
- `market_context_high->equity_1h` score `1.2172` n `96` status `ready` deltaP `10.0612` edge `0.0645` maxDD `-0.4112`
- `market_context_high->metal_4h` score `0.8261` n `96` status `ready` deltaP `14.5833` edge `0.0292` maxDD `-1.273`
- `market_context_high->equity_4h` score `0.7953` n `96` status `ready` deltaP `5.2083` edge `0.1204` maxDD `-2.4411`
...
- `market_context_high->unknown_24h` score `-0.0643` n `91` status `ready` deltaP `13.6085` edge `-0.0747` maxDD `-0.3771`
