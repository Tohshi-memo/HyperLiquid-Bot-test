...
- `market_context_high->equity_4h` score `1.6313` n `206` status `ready` deltaP `9.0989` edge `0.167` maxDD `-2.671`
- `news_risk_high->crypto_major_1h` score `1.2035` n `32` status `ready` deltaP `13.8286` edge `0.1088` maxDD `-2.0691`
- `news_risk_high->commodity_24h` score `1.1089` n `30` status `ready` deltaP `20.3473` edge `-0.0227` maxDD `-0.3101`
...
- `market_context_high->crypto_major_1h` score `-0.7833` n `206` status `ready` deltaP `4.9997` edge `0.043` maxDD `-9.807`
- `market_context_high->commodity_1h` score `-0.8177` n `206` status `ready` deltaP `-2.5812` edge `-0.0063` maxDD `-0.5708`
- `market_context_high->equity_1h` score `-0.8442` n `206` status `ready` deltaP `1.6787` edge `0.0313` maxDD `-4.3608`
