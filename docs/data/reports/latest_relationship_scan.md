...
- `market_context_high->fx_24h` score `0.4628` n `112` status `ready` deltaP `19.6965` edge `0.0486` maxDD `-4.3126`
- `market_context_high->metal_24h` score `0.292` n `112` status `ready` deltaP `0.7452` edge `0.1362` maxDD `-2.6802`
...
- `market_context_high->crypto_alt_1h` score `-0.8456` n `120` status `ready` deltaP `-3.7425` edge `-0.0124` maxDD `-3.0178`
...
- `market_context_high->crypto_alt_4h` score `-2.1003` n `120` status `ready` deltaP `0.8943` edge `-0.042` maxDD `-5.7857`
...
- `market_context_high->commodity_24h` score `-6.051` n `112` status `ready` deltaP `11.2106` edge `0.026` maxDD `-52.7876`
