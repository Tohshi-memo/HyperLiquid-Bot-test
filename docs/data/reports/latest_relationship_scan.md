...
- `market_context_high->unknown_24h` score `137.7007` n `128` status `ready` deltaP `-23.2493` edge `11.9213` maxDD `-9.6329`
- `risk_on_high->unknown_24h` score `33.7844` n `32` status `ready` deltaP `-36.5305` edge `4.6499` maxDD `-1.6689`
- `risk_on_and_context->unknown_24h` score `33.7844` n `32` status `ready` deltaP `-36.5305` edge `4.6499` maxDD `-1.6689`
