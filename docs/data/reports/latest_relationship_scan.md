...
- Price records: `672`
- Market context records: `1724`
- Flow alert records: `6868`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->unknown_24h` score `5.9854` n `143` status `ready` deltaP `16.9683` edge `0.9177` maxDD `-35.8966`
- `market_context_high->crypto_alt_4h` score `5.9511` n `196` status `ready` deltaP `21.2762` edge `0.5307` maxDD `-9.1295`
- `market_context_high->crypto_major_4h` score `4.467` n `196` status `ready` deltaP `23.1769` edge `0.4583` maxDD `-10.9117`
- `market_context_high->index_24h` score `3.9324` n `143` status `ready` deltaP `17.2563` edge `0.3355` maxDD `-4.1604`
- `market_context_high->unknown_4h` score `3.0473` n `196` status `ready` deltaP `13.7941` edge `0.3891` maxDD `-11.1695`
...
- `market_context_high->index_4h` score `0.5372` n `196` status `ready` deltaP `8.6642` edge `0.0959` maxDD `-3.7119`
...
- `market_context_high->metal_4h` score `-0.3297` n `196` status `ready` deltaP `11.9867` edge `0.147` maxDD `-12.5349`
...
- `market_context_high->fx_24h` score `-0.788` n `143` status `ready` deltaP `4.8504` edge `0.0069` maxDD `-1.3925`
- `market_context_high->crypto_major_24h` score `-0.7891` n `143` status `ready` deltaP `21.077` edge `0.6169` maxDD `-62.3533`
- `market_context_high->unknown_1h` score `-1.4773` n `196` status `ready` deltaP `1.8361` edge `0.0116` maxDD `-7.7558`
