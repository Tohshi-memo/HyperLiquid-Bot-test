...
- `market_context_high->equity_4h` score `2.2941` n `96` status `ready` deltaP `11.7632` edge `0.2016` maxDD `-2.4411`
...
- `market_context_high->unknown_1h` score `-0.0109` n `96` status `ready` deltaP `6.8114` edge `-0.0236` maxDD `-0.4843`
- `market_context_high->metal_1h` score `-0.0693` n `96` status `ready` deltaP `4.1729` edge `0.0051` maxDD `-0.4291`
- `market_context_high->fx_1h` score `-0.3284` n `96` status `ready` deltaP `-1.3224` edge `0.0026` maxDD `-0.2043`
- `market_context_high->crypto_major_24h` score `-0.4705` n `96` status `ready` deltaP `2.9514` edge `0.0619` maxDD `-4.9964`
- `market_context_high->commodity_4h` score `-0.684` n `96` status `ready` deltaP `-0.94` edge `0.0036` maxDD `-2.4692`
- `market_context_high->crypto_alt_1h` score `-0.712` n `96` status `ready` deltaP `-0.0187` edge `-0.011` maxDD `-2.413`
- `market_context_high->crypto_major_1h` score `-0.7409` n `96` status `ready` deltaP `1.6342` edge `-0.0214` maxDD `-2.7581`
- `market_context_high->commodity_1h` score `-0.8612` n `96` status `ready` deltaP `-7.2917` edge `-0.0052` maxDD `-1.1941`
- `market_context_high->crypto_major_4h` score `-1.0369` n `96` status `ready` deltaP `6.7327` edge `-0.0292` maxDD `-3.1677`
- `market_context_high->crypto_alt_4h` score `-1.375` n `96` status `ready` deltaP `4.7256` edge `-0.0191` maxDD `-5.4926`
