...
- `news_risk_high->unknown_24h` score `4848.5179` n `63` status `ready` deltaP `26.8105` edge `403.9065` maxDD `-2.0332`
- `market_context_high->crypto_alt_24h` score `17.489` n `40` status `ready` deltaP `58.4028` edge `1.1078` maxDD `-2.1786`
...
- `news_risk_high->index_1h` score `-0.0583` n `68` status `ready` deltaP `2.6154` edge `0.0074` maxDD `-0.5845`
