...
- `market_context_high->commodity_1h` score `-0.385` n `147` status `ready` deltaP `2.9268` edge `0.028` maxDD `-2.0345`
...
- `market_context_high->equity_1h` score `-0.9339` n `147` status `ready` deltaP `-2.7353` edge `-0.0028` maxDD `-5.5624`
...
- `market_context_high->metal_1h` score `-2.9735` n `147` status `ready` deltaP `-4.4483` edge `-0.0864` maxDD `-17.8795`
...
- `market_context_high->crypto_alt_1h` score `-5.7139` n `147` status `ready` deltaP `-3.0347` edge `-0.1272` maxDD `-22.2982`
- `market_context_high->crypto_major_1h` score `-6.9537` n `147` status `ready` deltaP `-6.7487` edge `-0.1592` maxDD `-27.356`
- `market_context_high->index_24h` score `-8.2467` n `145` status `ready` deltaP `-8.3166` edge `-0.0943` maxDD `-29.3321`
- `market_context_high->crypto_alt_4h` score `-9.2922` n `147` status `ready` deltaP `-4.3035` edge `-0.2969` maxDD `-63.9243`
- `market_context_high->metal_4h` score `-10.3336` n `147` status `ready` deltaP `-7.1905` edge `-0.3555` maxDD `-67.3775`
- `market_context_high->crypto_major_4h` score `-12.4355` n `147` status `ready` deltaP `-6.333` edge `-0.4577` maxDD `-82.2164`
