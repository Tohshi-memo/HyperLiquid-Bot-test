...
- `risk_on_high->crypto_major_4h` score `6.9701` n `32` status `ready` deltaP `38.4909` edge `0.3435` maxDD `-0.8742`
- `risk_on_and_context->crypto_major_4h` score `6.9701` n `32` status `ready` deltaP `38.4909` edge `0.3435` maxDD `-0.8742`
- `risk_on_high->crypto_alt_4h` score `5.7195` n `32` status `ready` deltaP `31.7835` edge `0.2891` maxDD `-0.9492`
- `risk_on_and_context->crypto_alt_4h` score `5.7195` n `32` status `ready` deltaP `31.7835` edge `0.2891` maxDD `-0.9492`
...
- `risk_on_high->crypto_major_1h` score `1.2191` n `32` status `ready` deltaP `19.9289` edge `0.0479` maxDD `-0.957`
- `risk_on_and_context->crypto_major_1h` score `1.2191` n `32` status `ready` deltaP `19.9289` edge `0.0479` maxDD `-0.957`
...
- `risk_on_high->crypto_alt_1h` score `0.1141` n `32` status `ready` deltaP `0.5988` edge `0.0477` maxDD `-0.9651`
- `risk_on_and_context->crypto_alt_1h` score `0.1141` n `32` status `ready` deltaP `0.5988` edge `0.0477` maxDD `-0.9651`
...
- `market_context_high->fx_1h` score `-0.1793` n `129` status `ready` deltaP `3.9389` edge `-0.0003` maxDD `-0.5821`
