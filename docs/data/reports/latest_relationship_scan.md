...
- `risk_on_high->index_24h` score `11.5024` n `32` status `ready` deltaP `31.25` edge `0.7502` maxDD `0.0`
- `risk_on_and_context->index_24h` score `11.5024` n `32` status `ready` deltaP `31.25` edge `0.7502` maxDD `0.0`
...
- `market_context_high->index_24h` score `5.4158` n `160` status `ready` deltaP `26.875` edge `0.3861` maxDD `-7.1159`
...
- `risk_on_high->crypto_alt_4h` score `1.3865` n `32` status `ready` deltaP `-1.2957` edge `0.3086` maxDD `-11.7537`
- `risk_on_and_context->crypto_alt_4h` score `1.3865` n `32` status `ready` deltaP `-1.2957` edge `0.3086` maxDD `-11.7537`
