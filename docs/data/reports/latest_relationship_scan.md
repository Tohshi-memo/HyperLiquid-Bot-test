...
- `risk_on_high->unknown_4h` score `27.7166` n `133` status `ready` deltaP `11.4375` edge `2.2953` maxDD `-2.2797`
- `risk_on_and_context->unknown_4h` score `27.7166` n `133` status `ready` deltaP `11.4375` edge `2.2953` maxDD `-2.2797`
- `market_context_high->unknown_4h` score `20.9516` n `167` status `ready` deltaP `13.0358` edge `1.7286` maxDD `-2.563`
- `risk_on_high->unknown_1h` score `15.3533` n `133` status `ready` deltaP `0.7428` edge `1.3322` maxDD `-1.95`
- `risk_on_and_context->unknown_1h` score `15.3533` n `133` status `ready` deltaP `0.7428` edge `1.3322` maxDD `-1.95`
- `market_context_high->unknown_1h` score `10.8735` n `167` status `ready` deltaP `1.1976` edge `0.9612` maxDD `-2.0446`
...
- `news_risk_high->crypto_alt_24h` score `0.4652` n `67` status `ready` deltaP `16.5734` edge `0.2426` maxDD `-19.4761`
