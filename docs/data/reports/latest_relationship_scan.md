...
- `market_context_high->unknown_4h` score `15.7037` n `55` status `ready` deltaP `11.5882` edge `1.2771` maxDD `-1.3238`
...
- `market_context_high->commodity_4h` score `0.7823` n `55` status `ready` deltaP `9.1075` edge `0.0891` maxDD `-2.7703`
...
- `market_context_high->fx_4h` score `-0.1469` n `55` status `ready` deltaP `11.4385` edge `-0.0025` maxDD `-1.8797`
- `market_context_high->crypto_alt_4h` score `-0.2212` n `55` status `ready` deltaP `5.4601` edge `0.0258` maxDD `-4.9116`
- `news_risk_high->fx_1h` score `-0.3175` n `31` status `ready` deltaP `-1.7626` edge `0.0022` maxDD `-0.1588`
- `market_context_high->crypto_alt_1h` score `-0.3498` n `67` status `ready` deltaP `1.3406` edge `0.0131` maxDD `-3.0178`
- `market_context_high->index_1h` score `-0.3895` n `67` status `ready` deltaP `2.679` edge `-0.0144` maxDD `-1.6054`
