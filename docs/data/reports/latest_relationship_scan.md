...
- `risk_on_high->equity_24h` score `0.9645` n `31` status `ready` deltaP `13.0996` edge `0.2644` maxDD `-19.375`
- `risk_on_and_context->equity_24h` score `0.9645` n `31` status `ready` deltaP `13.0996` edge `0.2644` maxDD `-19.375`
