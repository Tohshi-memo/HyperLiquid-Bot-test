...
- `news_risk_high->crypto_major_1h` score `1.2363` n `32` status `ready` deltaP `13.5292` edge `0.115` maxDD `-2.0691`
...
- `market_context_high->crypto_major_1h` score `-0.9617` n `195` status `ready` deltaP `4.3145` edge `0.0247` maxDD `-9.807`
