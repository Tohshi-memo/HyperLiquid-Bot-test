...
- `market_context_high->crypto_major_24h` score `3.122` n `85` status `ready` deltaP `9.8632` edge `0.3152` maxDD `-4.9964`
- `market_context_high->equity_24h` score `1.2603` n `85` status `ready` deltaP `15.1818` edge `0.0134` maxDD `-0.1006`
...
- `risk_on_high->equity_1h` score `0.7765` n `35` status `ready` deltaP `12.9085` edge `0.033` maxDD `-1.6811`
- `risk_on_and_context->equity_1h` score `0.7765` n `35` status `ready` deltaP `12.9085` edge `0.033` maxDD `-1.6811`
...
- `market_context_high->commodity_24h` score `0.3007` n `85` status `ready` deltaP `17.5612` edge `0.1048` maxDD `-4.666`
