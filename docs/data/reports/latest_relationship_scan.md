...
- `news_risk_high->crypto_alt_24h` score `14.7156` n `50` status `ready` deltaP `36.9326` edge `1.0242` maxDD `-2.8629`
- `news_risk_high->unknown_4h` score `12.2475` n `50` status `ready` deltaP `25.4024` edge `0.8612` maxDD `-0.1276`
- `news_risk_high->equity_24h` score `6.0751` n `50` status `ready` deltaP `28.7323` edge `0.408` maxDD `-4.7964`
...
- `news_risk_high->metal_24h` score `2.9485` n `50` status `ready` deltaP `37.8964` edge `-0.0027` maxDD `-0.0053`
- `news_risk_high->unknown_1h` score `2.6976` n `50` status `ready` deltaP `15.7784` edge `0.1552` maxDD `-0.8474`
- `news_risk_high->fx_1h` score `1.4306` n `50` status `ready` deltaP `19.3054` edge `0.0075` maxDD `-0.0257`
- `market_context_high->unknown_1h` score `1.3296` n `137` status `ready` deltaP `13.1507` edge `0.0681` maxDD `-1.5974`
- `news_risk_high->equity_4h` score `1.3029` n `50` status `ready` deltaP `20.0549` edge `0.0514` maxDD `-2.1218`
- `news_risk_high->equity_1h` score `1.2468` n `50` status `ready` deltaP `16.6647` edge `0.0207` maxDD `-0.2319`
