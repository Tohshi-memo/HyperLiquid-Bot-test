...
- `market_context_high->unknown_4h` score `0.4642` n `133` status `ready` deltaP `22.9197` edge `-0.0702` maxDD `-0.5133`
...
- `market_context_high->equity_4h` score `-1.8169` n `133` status `ready` deltaP `-1.6677` edge `0.0587` maxDD `-16.1079`
- `market_context_high->crypto_alt_4h` score `-1.9924` n `133` status `ready` deltaP `3.5932` edge `-0.063` maxDD `-5.4926`
...
- `market_context_high->crypto_major_4h` score `-4.7451` n `133` status `ready` deltaP `-0.1249` edge `-0.2925` maxDD `-3.1677`
