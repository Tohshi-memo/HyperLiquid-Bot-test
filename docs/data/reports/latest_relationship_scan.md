...
- `news_risk_high->unknown_4h` score `12.8747` n `51` status `ready` deltaP `24.8685` edge `0.9117` maxDD `-0.0348`
- `news_risk_high->equity_24h` score `10.692` n `51` status `ready` deltaP `38.8481` edge `0.7251` maxDD `-4.7801`
...
- `market_context_high->unknown_4h` score `1.8805` n `133` status `ready` deltaP `19.3105` edge `0.0688` maxDD `-0.5994`
- `news_risk_high->fx_1h` score `1.1559` n `51` status `ready` deltaP `15.9475` edge `0.007` maxDD `-0.0257`
- `news_risk_high->equity_1h` score `0.7628` n `51` status `ready` deltaP `16.696` edge `0.0229` maxDD `-0.9128`
...
- `news_risk_high->metal_1h` score `-0.2112` n `51` status `ready` deltaP `0.3963` edge `-0.0074` maxDD `-0.1184`
...
- `news_risk_high->metal_24h` score `-0.6012` n `51` status `ready` deltaP `21.6503` edge `-0.1902` maxDD `-0.0053`
