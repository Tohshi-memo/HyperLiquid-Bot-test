...
- `market_context_high->crypto_alt_24h` score `2.3069` n `137` status `ready` deltaP `4.2947` edge `0.6588` maxDD `-22.6673`
...
- `market_context_high->index_4h` score `0.1062` n `142` status `ready` deltaP `11.3192` edge `0.0223` maxDD `-2.3986`
- `market_context_high->unknown_1h` score `-0.0301` n `142` status `ready` deltaP `4.0314` edge `0.0437` maxDD `-3.1801`
- `market_context_high->index_1h` score `-0.1623` n `142` status `ready` deltaP `3.2998` edge `0.0066` maxDD `-1.2855`
...
- `market_context_high->crypto_alt_1h` score `-0.6929` n `142` status `ready` deltaP `5.2459` edge `0.0522` maxDD `-10.747`
...
- `market_context_high->crypto_alt_4h` score `-1.3863` n `142` status `ready` deltaP `14.0329` edge `0.225` maxDD `-28.7261`
- `market_context_high->fx_24h` score `-1.4149` n `137` status `ready` deltaP `-1.5182` edge `-0.0206` maxDD `-0.6418`
- `market_context_high->commodity_4h` score `-1.5494` n `142` status `ready` deltaP `0.161` edge `-0.0077` maxDD `-10.0279`
...
- `market_context_high->crypto_major_4h` score `-2.6077` n `142` status `ready` deltaP `5.1249` edge `0.1221` maxDD `-32.2466`
