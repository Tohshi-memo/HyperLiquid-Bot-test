...
- `news_risk_high->crypto_major_24h` score `41.0599` n `81` status `ready` deltaP `17.2839` edge `3.4732` maxDD `-10.3413`
- `news_risk_high->crypto_alt_24h` score `37.3646` n `81` status `ready` deltaP `28.6844` edge `3.0604` maxDD `-9.3661`
- `market_context_high->commodity_24h` score `6.9935` n `74` status `ready` deltaP `35.7921` edge `0.3967` maxDD `-0.8682`
- `news_risk_high->crypto_alt_4h` score `6.2626` n `98` status `ready` deltaP `23.4476` edge `0.4865` maxDD `-7.675`
- `news_risk_high->equity_24h` score `6.1528` n `81` status `ready` deltaP `33.2755` edge `0.3045` maxDD `-0.4217`
- `news_risk_high->crypto_major_4h` score `4.8312` n `98` status `ready` deltaP `23.1427` edge `0.3741` maxDD `-8.0625`
- `market_context_high->commodity_4h` score `4.038` n `77` status `ready` deltaP `35.7935` edge `0.1112` maxDD `-0.0659`
- `news_risk_high->crypto_alt_1h` score `3.414` n `98` status `ready` deltaP `18.9234` edge `0.2049` maxDD `-2.058`
- `news_risk_high->crypto_major_1h` score `2.6069` n `98` status `ready` deltaP `21.0192` edge `0.1294` maxDD `-2.8494`
...
- `market_context_high->commodity_1h` score `1.8862` n `77` status `ready` deltaP `21.1817` edge `0.037` maxDD `-0.3491`
...
- `news_risk_high->commodity_24h` score `0.3528` n `81` status `ready` deltaP `17.2068` edge `0.0611` maxDD `-3.4467`
