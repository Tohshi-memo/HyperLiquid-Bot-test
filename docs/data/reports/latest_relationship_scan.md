...
- `market_context_high->equity_4h` score `1.6819` n `206` status `ready` deltaP `9.2514` edge `0.1702` maxDD `-2.671`
- `market_context_high->equity_24h` score `1.6475` n `180` status `ready` deltaP `29.7223` edge `0.5582` maxDD `-31.6107`
- `news_risk_high->crypto_major_1h` score `0.8403` n `30` status `ready` deltaP `10.3393` edge `0.0855` maxDD `-2.0691`
- `news_risk_high->crypto_alt_1h` score `0.2325` n `30` status `ready` deltaP `5.4691` edge `0.0395` maxDD `-1.6923`
...
- `news_risk_high->crypto_alt_24h` score `-0.64` n `30` status `ready` deltaP `22.8472` edge `-0.1909` maxDD `-0.5131`
...
- `market_context_high->equity_1h` score `-0.9366` n `206` status `ready` deltaP `1.2296` edge `0.0266` maxDD `-4.3608`
- `market_context_high->crypto_alt_1h` score `-0.974` n `206` status `ready` deltaP `3.6568` edge `0.026` maxDD `-9.3536`
- `market_context_high->crypto_major_1h` score `-0.9774` n `206` status `ready` deltaP `3.8021` edge `0.0261` maxDD `-9.807`
