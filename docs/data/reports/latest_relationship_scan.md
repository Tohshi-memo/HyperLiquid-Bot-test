...
- `risk_on_high->unknown_4h` score `21.8177` n `145` status `ready` deltaP `-3.4651` edge `2.0418` maxDD `-7.7112`
- `risk_on_and_context->unknown_4h` score `21.8177` n `145` status `ready` deltaP `-3.4651` edge `2.0418` maxDD `-7.7112`
- `market_context_high->unknown_4h` score `8.3505` n `245` status `ready` deltaP `1.0951` edge `0.9354` maxDD `-9.4124`
- `news_risk_high->crypto_alt_24h` score `4.2239` n `37` status `ready` deltaP `21.5325` edge `0.2354` maxDD `-0.8236`
...
- `risk_on_high->crypto_major_24h` score `1.3492` n `84` status `ready` deltaP `11.6071` edge `0.8282` maxDD `-47.9416`
- `risk_on_and_context->crypto_major_24h` score `1.3492` n `84` status `ready` deltaP `11.6071` edge `0.8282` maxDD `-47.9416`
...
- `news_risk_high->crypto_alt_1h` score `0.8014` n `37` status `ready` deltaP `8.4278` edge `0.0371` maxDD `-0.7867`
