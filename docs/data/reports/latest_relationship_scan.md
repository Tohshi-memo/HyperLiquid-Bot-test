...
- `market_context_high->crypto_major_24h` score `2.6637` n `91` status `ready` deltaP `10.0294` edge `0.2759` maxDD `-4.9964`
- `market_context_high->commodity_24h` score `1.6854` n `91` status `ready` deltaP `19.2899` edge `0.2708` maxDD `-4.666`
- `market_context_high->equity_1h` score `1.198` n `96` status `ready` deltaP `9.9115` edge `0.0639` maxDD `-0.4112`
- `market_context_high->metal_4h` score `0.7751` n `96` status `ready` deltaP `14.126` edge `0.028` maxDD `-1.273`
- `market_context_high->equity_4h` score `0.6939` n `96` status `ready` deltaP `4.751` edge `0.115` maxDD `-2.4411`
- `market_context_high->index_1h` score `0.6443` n `96` status `ready` deltaP `12.6185` edge `0.0083` maxDD `-0.0982`
- `market_context_high->crypto_major_4h` score `0.473` n `96` status `ready` deltaP `7.9522` edge `0.0885` maxDD `-3.1677`
- `market_context_high->unknown_1h` score `0.4543` n `96` status `ready` deltaP `9.3563` edge `-0.0018` maxDD `-0.4843`
- `market_context_high->crypto_alt_4h` score `-0.0084` n `96` status `ready` deltaP `8.3841` edge `0.0704` maxDD `-5.4926`
...
- `market_context_high->crypto_major_1h` score `-0.5543` n `96` status `ready` deltaP `0.5863` edge `0.0095` maxDD `-2.7581`
