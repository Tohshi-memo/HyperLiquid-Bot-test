...
- `market_context_high->crypto_major_1h` score `1.0945` n `133` status `ready` deltaP `13.1579` edge `0.0476` maxDD `-1.5286`
...
- `market_context_high->unknown_1h` score `-1.3033` n `133` status `ready` deltaP `-0.5256` edge `-0.0461` maxDD `-1.054`
