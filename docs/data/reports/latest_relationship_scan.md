...
- `market_context_high->unknown_4h` score `45.5626` n `46` status `ready` deltaP `6.4024` edge `3.7542` maxDD `0.0`
- `market_context_high->crypto_major_24h` score `29.677` n `46` status `ready` deltaP `13.7078` edge `2.3973` maxDD `-0.5817`
- `market_context_high->equity_24h` score `16.2385` n `46` status `ready` deltaP `12.1453` edge `1.2823` maxDD `-0.1382`
- `market_context_high->crypto_alt_24h` score `13.3392` n `46` status `ready` deltaP `10.5903` edge `1.041` maxDD `0.0`
- `market_context_high->index_24h` score `5.5035` n `46` status `ready` deltaP `19.6105` edge `0.3366` maxDD `-0.03`
- `news_risk_high->crypto_major_24h` score `4.9834` n `96` status `ready` deltaP `-9.0277` edge `1.1613` maxDD `-46.1999`
...
- `news_risk_high->crypto_alt_4h` score `2.5543` n `96` status `ready` deltaP `9.9085` edge `0.2466` maxDD `-5.9838`
- `news_risk_high->crypto_alt_1h` score `1.9505` n `97` status `ready` deltaP `11.0702` edge `0.1283` maxDD `-1.1645`
- `market_context_high->index_4h` score `1.8218` n `46` status `ready` deltaP `21.7921` edge `0.0199` maxDD `-0.0692`
- `news_risk_high->crypto_major_1h` score `1.4224` n `97` status `ready` deltaP `12.8666` edge `0.0721` maxDD `-1.8141`
...
- `market_context_high->index_1h` score `0.6064` n `46` status `ready` deltaP `9.9063` edge `0.0098` maxDD `-0.0249`
- `news_risk_high->crypto_alt_24h` score `0.4483` n `96` status `ready` deltaP `-9.2014` edge `0.5868` maxDD `-32.7147`
