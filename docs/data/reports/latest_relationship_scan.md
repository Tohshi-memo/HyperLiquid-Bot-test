...
- `news_risk_high->unknown_24h` score `46.9948` n `51` status `ready` deltaP `14.9306` edge `3.8167` maxDD `0.0`
- `news_risk_high->equity_24h` score `13.6519` n `51` status `ready` deltaP `40.237` edge `0.9625` maxDD `-4.7801`
...
- `market_context_high->unknown_24h` score `4.8456` n `80` status `ready` deltaP `8.6806` edge `0.3752` maxDD `-0.6752`
- `news_risk_high->equity_4h` score `4.105` n `51` status `ready` deltaP `27.995` edge `0.2325` maxDD `-2.164`
- `news_risk_high->unknown_1h` score `3.603` n `51` status `ready` deltaP `16.4846` edge `0.2208` maxDD `-0.7693`
...
- `news_risk_high->equity_1h` score `1.0613` n `51` status `ready` deltaP `19.0912` edge `0.0452` maxDD `-0.9128`
...
- `market_context_high->unknown_1h` score `0.06` n `130` status `ready` deltaP `11.0548` edge `-0.0238` maxDD `-1.5916`
