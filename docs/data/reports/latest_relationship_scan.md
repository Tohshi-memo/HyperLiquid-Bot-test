...
- `risk_on_high->unknown_4h` score `4.9027` n `32` status `ready` deltaP `15.3963` edge `0.3489` maxDD `-0.4384`
- `risk_on_and_context->unknown_4h` score `4.9027` n `32` status `ready` deltaP `15.3963` edge `0.3489` maxDD `-0.4384`
- `risk_on_high->crypto_alt_4h` score `4.6722` n `32` status `ready` deltaP `27.3628` edge `0.2313` maxDD `-0.9492`
- `risk_on_and_context->crypto_alt_4h` score `4.6722` n `32` status `ready` deltaP `27.3628` edge `0.2313` maxDD `-0.9492`
...
- `risk_on_high->crypto_alt_1h` score `0.0089` n `32` status `ready` deltaP `0.0` edge `0.0382` maxDD `-0.9651`
- `risk_on_and_context->crypto_alt_1h` score `0.0089` n `32` status `ready` deltaP `0.0` edge `0.0382` maxDD `-0.9651`
...
- `market_context_high->unknown_4h` score `-0.8561` n `129` status `ready` deltaP `3.3323` edge `0.1039` maxDD `-6.2031`
