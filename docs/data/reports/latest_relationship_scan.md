...
- `market_context_high->equity_24h` score `23.0452` n `79` status `ready` deltaP `44.2137` edge `1.7167` maxDD `-4.9489`
- `market_context_high->equity_4h` score `10.0608` n `80` status `ready` deltaP `37.1951` edge `0.6139` maxDD `-0.5442`
- `market_context_high->metal_24h` score `8.8973` n `79` status `ready` deltaP `38.5417` edge `0.4845` maxDD `0.0`
- `news_risk_high->equity_4h` score `8.2462` n `43` status `ready` deltaP `31.8172` edge `0.4956` maxDD `-0.6428`
- `news_risk_high->crypto_major_4h` score `4.995` n `43` status `ready` deltaP `18.509` edge `0.3534` maxDD `-2.1767`
...
- `news_risk_high->equity_1h` score `3.7967` n `43` status `ready` deltaP `29.3796` edge `0.1514` maxDD `-1.1366`
- `market_context_high->equity_1h` score `3.4213` n `80` status `ready` deltaP `18.1587` edge `0.189` maxDD `-0.9962`
...
- `market_context_high->crypto_major_4h` score `2.3093` n `80` status `ready` deltaP `13.5671` edge `0.2738` maxDD `-6.7444`
- `market_context_high->fx_24h` score `2.1739` n `79` status `ready` deltaP `29.3864` edge `0.0556` maxDD `-0.6283`
- `market_context_high->commodity_24h` score `1.819` n `79` status `ready` deltaP `32.9158` edge `0.3023` maxDD `-15.7497`
- `market_context_high->index_1h` score `1.6346` n `80` status `ready` deltaP `19.2515` edge `0.0275` maxDD `-0.2368`
