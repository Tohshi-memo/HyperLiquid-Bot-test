...
- `market_context_high->crypto_major_4h` score `0.9573` n `249` status `ready` deltaP `11.7213` edge `0.2244` maxDD `-13.4882`
...
- `market_context_high->crypto_alt_1h` score `-0.4601` n `261` status `ready` deltaP `2.6275` edge `0.0403` maxDD `-5.0257`
...
- `market_context_high->crypto_major_1h` score `-0.6393` n `261` status `ready` deltaP `4.2564` edge `0.0429` maxDD `-6.9639`
...
- `market_context_high->index_24h` score `-2.5099` n `199` status `ready` deltaP `6.2352` edge `0.0363` maxDD `-16.9723`
...
- `market_context_high->crypto_major_24h` score `-4.6723` n `199` status `ready` deltaP `4.1597` edge `0.0286` maxDD `-29.6555`
- `market_context_high->metal_24h` score `-8.3485` n `199` status `ready` deltaP `-12.924` edge `-0.2496` maxDD `-32.7652`
- `market_context_high->commodity_24h` score `-12.2629` n `199` status `ready` deltaP `-11.5072` edge `-0.0843` maxDD `-45.8715`
