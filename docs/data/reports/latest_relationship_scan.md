...
- `market_context_high->commodity_4h` score `2.0694` n `109` status `ready` deltaP `19.4339` edge `0.09` maxDD `-0.7687`
...
- `market_context_high->commodity_1h` score `0.0893` n `121` status `ready` deltaP `4.0308` edge `0.0217` maxDD `-0.624`
