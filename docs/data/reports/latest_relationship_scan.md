...
- Price records: `672`
- Market context records: `903`
- Flow alert records: `2533`
- Minimum samples: `30`
- Pattern count: `96`
...
- `risk_on_high->crypto_alt_4h` score `3.4733` n `32` status `ready` deltaP `24.4665` edge `0.1468` maxDD `-0.6377`
- `risk_on_and_context->crypto_alt_4h` score `3.4733` n `32` status `ready` deltaP `24.4665` edge `0.1468` maxDD `-0.6377`
