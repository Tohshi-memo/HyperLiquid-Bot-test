...
- `market_context_high->equity_4h` score `2.2454` n `196` status `ready` deltaP `12.4626` edge `0.2679` maxDD `-7.4425`
- `market_context_high->crypto_alt_4h` score `1.9462` n `196` status `ready` deltaP `10.1045` edge `0.2589` maxDD `-9.46`
- `market_context_high->equity_24h` score `0.659` n `193` status `ready` deltaP `9.3012` edge `0.5008` maxDD `-31.6316`
...
- `market_context_high->metal_1h` score `-0.4011` n `196` status `ready` deltaP `3.0887` edge `0.0135` maxDD `-2.0682`
...
- `market_context_high->index_4h` score `-0.857` n `196` status `ready` deltaP `7.3357` edge `0.0406` maxDD `-2.874`
...
- `market_context_high->metal_24h` score `-7.0818` n `193` status `ready` deltaP `-3.3543` edge `-0.1478` maxDD `-33.021`
