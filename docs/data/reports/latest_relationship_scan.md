...
- `market_context_high->metal_24h` score `2.6107` n `103` status `ready` deltaP `12.0382` edge `0.1949` maxDD `-2.2743`
- `market_context_high->commodity_4h` score `1.1122` n `143` status `ready` deltaP `14.4423` edge `0.0637` maxDD `-2.7169`
