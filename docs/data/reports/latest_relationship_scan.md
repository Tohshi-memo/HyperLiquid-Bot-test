...
- `market_context_high->fx_1h` score `-0.288` n `165` status `ready` deltaP `3.0267` edge `0.0019` maxDD `-0.3529`
- `market_context_high->unknown_1h` score `-0.5692` n `165` status `ready` deltaP `-1.7157` edge `0.0282` maxDD `-1.4688`
- `market_context_high->crypto_alt_1h` score `-0.6602` n `165` status `ready` deltaP `-0.7739` edge `0.0244` maxDD `-5.9775`
- `market_context_high->commodity_1h` score `-0.6798` n `165` status `ready` deltaP `-1.3146` edge `-0.0163` maxDD `-1.9668`
- `market_context_high->crypto_major_1h` score `-0.685` n `165` status `ready` deltaP `2.8697` edge `0.0341` maxDD `-7.6171`
...
- `market_context_high->equity_1h` score `-3.6022` n `165` status `ready` deltaP `-1.1387` edge `-0.0407` maxDD `-15.4849`
...
- `market_context_high->crypto_major_4h` score `-4.9382` n `156` status `ready` deltaP `2.3139` edge `0.0084` maxDD `-25.1605`
