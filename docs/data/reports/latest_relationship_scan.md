...
- `market_context_high->unknown_1h` score `13.1431` n `97` status `ready` deltaP `2.8428` edge `1.1264` maxDD `-1.674`
- `market_context_high->unknown_4h` score `9.0818` n `97` status `ready` deltaP `20.7207` edge `0.7209` maxDD `-5.5109`
- `market_context_high->crypto_alt_4h` score `6.2328` n `97` status `ready` deltaP `18.4546` edge `0.5183` maxDD `-6.4213`
- `market_context_high->crypto_major_4h` score `5.5574` n `97` status `ready` deltaP `17.0025` edge `0.5082` maxDD `-8.3416`
- `market_context_high->crypto_major_1h` score `1.1647` n `97` status `ready` deltaP `8.5483` edge `0.1217` maxDD `-3.8637`
...
- `market_context_high->crypto_alt_1h` score `0.6331` n `97` status `ready` deltaP `6.5853` edge `0.1012` maxDD `-4.7207`
- `market_context_high->metal_1h` score `0.4424` n `97` status `ready` deltaP `7.3677` edge `0.0374` maxDD `-1.3057`
...
- `market_context_high->commodity_4h` score `-0.8577` n `97` status `ready` deltaP `7.1426` edge `0.0058` maxDD `-4.9914`
...
- `market_context_high->unknown_24h` score `-3.0494` n `74` status `ready` deltaP `27.0364` edge `-0.4001` maxDD `-1.4072`
