...
- `market_context_high->crypto_major_24h` score `0.9905` n `176` status `ready` deltaP `14.1256` edge `0.4424` maxDD `-29.6555`
...
- `market_context_high->index_1h` score `-0.183` n `201` status `ready` deltaP `3.8237` edge `0.0086` maxDD `-0.9472`
...
- `market_context_high->crypto_alt_1h` score `-0.5414` n `201` status `ready` deltaP `1.0852` edge `0.0438` maxDD `-5.0257`
- `market_context_high->crypto_major_1h` score `-0.652` n `201` status `ready` deltaP `2.9873` edge `0.0503` maxDD `-6.9639`
- `market_context_high->commodity_1h` score `-1.355` n `201` status `ready` deltaP `-4.0307` edge `-0.0095` maxDD `-3.7906`
- `market_context_high->index_4h` score `-1.5346` n `190` status `ready` deltaP `2.4358` edge `0.0168` maxDD `-2.874`
...
- `market_context_high->commodity_4h` score `-4.5438` n `190` status `ready` deltaP `-8.2799` edge `-0.0559` maxDD `-14.071`
- `market_context_high->metal_24h` score `-7.8348` n `176` status `ready` deltaP `-7.5758` edge `-0.217` maxDD `-32.9569`
- `market_context_high->crypto_alt_24h` score `-8.8994` n `176` status `ready` deltaP `4.2298` edge `0.0999` maxDD `-54.2437`
