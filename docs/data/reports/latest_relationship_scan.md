...
- `risk_on_high->equity_4h` score `3.0037` n `32` status `ready` deltaP `4.0396` edge `0.2599` maxDD `-0.9217`
- `risk_on_and_context->equity_4h` score `3.0037` n `32` status `ready` deltaP `4.0396` edge `0.2599` maxDD `-0.9217`
