...
- `news_risk_high->unknown_24h` score `49.2087` n `51` status `ready` deltaP `17.0139` edge `3.9873` maxDD `0.0`
...
- `market_context_high->unknown_24h` score `2.0727` n `82` status `ready` deltaP `3.5993` edge `0.1994` maxDD `-1.0533`
- `market_context_high->unknown_4h` score `1.7807` n `138` status `ready` deltaP `19.6978` edge `0.0579` maxDD `-0.5994`
- `news_risk_high->metal_24h` score `1.511` n `51` status `ready` deltaP `32.5878` edge `-0.0871` maxDD `-0.0053`
...
- `market_context_high->unknown_1h` score `0.0715` n `138` status `ready` deltaP `11.2427` edge `-0.0241` maxDD `-1.5916`
