...
- `market_context_high->commodity_4h` score `1.281` n `143` status `ready` deltaP `15.9667` edge `0.0676` maxDD `-2.7169`
- `market_context_high->commodity_1h` score `0.8504` n `143` status `ready` deltaP `11.4401` edge `0.0289` maxDD `-0.7439`
...
- `market_context_high->fx_1h` score `-0.4451` n `143` status `ready` deltaP `2.4989` edge `-0.0042` maxDD `-0.9639`
...
- `market_context_high->equity_1h` score `-1.0031` n `143` status `ready` deltaP `-1.0856` edge `0.0065` maxDD `-4.6286`
- `market_context_high->metal_4h` score `-1.0264` n `143` status `ready` deltaP `-1.9657` edge `-0.0176` maxDD `-2.7373`
- `market_context_high->crypto_alt_1h` score `-2.1038` n `143` status `ready` deltaP `-11.6306` edge `-0.0336` maxDD `-2.4677`
- `market_context_high->equity_4h` score `-2.6202` n `143` status `ready` deltaP `-2.0286` edge `-0.0711` maxDD `-7.6983`
...
- `market_context_high->unknown_1h` score `-7.8424` n `143` status `ready` deltaP `-6.3932` edge `-0.5662` maxDD `-1.2437`
