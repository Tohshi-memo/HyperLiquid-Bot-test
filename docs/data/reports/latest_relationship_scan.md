...
- `market_context_high->crypto_major_4h` score `5.5155` n `93` status `ready` deltaP `16.7946` edge `0.5061` maxDD `-8.3416`
- `market_context_high->crypto_alt_4h` score `5.36` n `93` status `ready` deltaP `14.4834` edge `0.4895` maxDD `-7.8181`
- `market_context_high->metal_4h` score `1.2014` n `93` status `ready` deltaP `12.7819` edge `0.1228` maxDD `-1.9651`
- `market_context_high->equity_1h` score `0.7326` n `101` status `ready` deltaP `7.4835` edge `0.0685` maxDD `-2.5875`
...
- `market_context_high->crypto_alt_1h` score `0.1548` n `101` status `ready` deltaP `4.9623` edge `0.089` maxDD `-5.5126`
...
- `market_context_high->crypto_major_24h` score `-6.0228` n `74` status `ready` deltaP `14.9822` edge `0.4075` maxDD `-90.3633`
