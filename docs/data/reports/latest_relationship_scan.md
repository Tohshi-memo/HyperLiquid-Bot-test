...
- `market_context_high->commodity_24h` score `0.6971` n `73` status `ready` deltaP `12.6469` edge `0.1571` maxDD `-4.666`
- `market_context_high->metal_24h` score `0.6006` n `73` status `ready` deltaP `4.8384` edge `0.0741` maxDD `-1.5045`
- `market_context_high->commodity_4h` score `0.4116` n `104` status `ready` deltaP `10.5652` edge `0.0489` maxDD `-2.4692`
...
- `market_context_high->unknown_1h` score `-0.0055` n `104` status `ready` deltaP `7.0705` edge `-0.0217` maxDD `-0.7386`
- `market_context_high->crypto_major_4h` score `-0.0615` n `104` status `ready` deltaP `5.2533` edge `0.0647` maxDD `-3.6083`
- `market_context_high->equity_1h` score `-0.1189` n `104` status `ready` deltaP `3.1956` edge `0.0237` maxDD `-1.8201`
...
- `market_context_high->index_24h` score `-0.8948` n `73` status `ready` deltaP `6.9253` edge `-0.0605` maxDD `-1.8187`
...
- `market_context_high->crypto_alt_1h` score `-1.2672` n `104` status `ready` deltaP `-3.2474` edge `0.0049` maxDD `-3.1082`
- `market_context_high->crypto_alt_4h` score `-1.3545` n `104` status `ready` deltaP `3.4944` edge `0.0415` maxDD `-10.0758`
- `market_context_high->equity_4h` score `-1.4036` n `104` status `ready` deltaP `-7.2585` edge `-0.0166` maxDD `-4.53`
