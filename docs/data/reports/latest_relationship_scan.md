...
- `risk_on_high->unknown_4h` score `20.4792` n `133` status `ready` deltaP `-2.7061` edge `1.9252` maxDD `-7.7112`
- `risk_on_and_context->unknown_4h` score `20.4792` n `133` status `ready` deltaP `-2.7061` edge `1.9252` maxDD `-7.7112`
- `market_context_high->unknown_4h` score `8.081` n `228` status `ready` deltaP `1.8052` edge `0.9082` maxDD `-9.4124`
...
- `news_risk_high->crypto_major_4h` score `3.2467` n `37` status `ready` deltaP `16.2657` edge `0.2034` maxDD `-0.9693`
...
- `news_risk_high->commodity_4h` score `1.577` n `37` status `ready` deltaP `7.7703` edge `0.0997` maxDD `-0.2737`
...
- `news_risk_high->crypto_major_1h` score `1.1127` n `37` status `ready` deltaP `5.8667` edge `0.0719` maxDD `-0.4628`
- `news_risk_high->fx_24h` score `0.9202` n `37` status `ready` deltaP `19.9559` edge `0.0452` maxDD `-3.1244`
- `news_risk_high->crypto_alt_1h` score `0.829` n `37` status `ready` deltaP `8.2781` edge `0.0404` maxDD `-0.7867`
- `news_risk_high->crypto_major_24h` score `0.2727` n `37` status `ready` deltaP `15.8831` edge `0.2067` maxDD `-18.2098`
