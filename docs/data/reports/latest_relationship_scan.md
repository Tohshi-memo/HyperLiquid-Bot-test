...
- Price records: `672`
- Market context records: `1573`
- Flow alert records: `6441`
- Minimum samples: `30`
- Pattern count: `96`
...
- `market_context_high->crypto_alt_24h` score `11.3598` n `182` status `ready` deltaP `26.9974` edge `0.9683` maxDD `-15.1306`
- `market_context_high->crypto_major_24h` score `9.8469` n `182` status `ready` deltaP `26.7399` edge `0.7555` maxDD `-8.0553`
- `market_context_high->index_24h` score `4.0104` n `182` status `ready` deltaP `20.7799` edge `0.3043` maxDD `-5.3574`
...
- `market_context_high->crypto_alt_4h` score `0.1958` n `199` status `ready` deltaP `13.2545` edge `0.2687` maxDD `-19.5565`
- `market_context_high->crypto_major_4h` score `0.024` n `199` status `ready` deltaP `9.2796` edge `0.2121` maxDD `-13.3376`
...
- `market_context_high->commodity_1h` score `-0.7336` n `199` status `ready` deltaP `-0.3475` edge `0.0004` maxDD `-4.7041`
- `market_context_high->crypto_major_1h` score `-0.8755` n `199` status `ready` deltaP `-0.4438` edge `0.0264` maxDD `-6.1883`
- `market_context_high->index_4h` score `-1.2036` n `199` status `ready` deltaP `-2.6106` edge `0.026` maxDD `-3.7119`
...
- `market_context_high->commodity_4h` score `-5.1178` n `199` status `ready` deltaP `-13.9379` edge `-0.1005` maxDD `-24.683`
