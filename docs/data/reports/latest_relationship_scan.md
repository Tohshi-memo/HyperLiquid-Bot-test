...
- `market_context_high->unknown_24h` score `5.894` n `189` status `ready` deltaP `16.9478` edge `0.3912` maxDD `-0.3748`
- `market_context_high->crypto_major_24h` score `5.3733` n `189` status `ready` deltaP `22.9498` edge `0.7488` maxDD `-29.6555`
- `market_context_high->crypto_major_4h` score `3.5383` n `205` status `ready` deltaP `15.0915` edge `0.4235` maxDD `-14.0065`
- `market_context_high->crypto_alt_4h` score `3.0362` n `205` status `ready` deltaP `12.2256` edge `0.3356` maxDD `-9.46`
- `market_context_high->equity_4h` score `2.2873` n `205` status `ready` deltaP `10.9757` edge `0.2813` maxDD `-7.4425`
- `market_context_high->equity_24h` score `1.3833` n `189` status `ready` deltaP `10.1191` edge `0.6107` maxDD `-40.0306`
- `market_context_high->equity_1h` score `0.4117` n `205` status `ready` deltaP `7.4602` edge `0.0811` maxDD `-5.0555`
- `market_context_high->crypto_major_1h` score `0.1005` n `205` status `ready` deltaP `4.7736` edge `0.1011` maxDD `-6.9639`
...
- `market_context_high->fx_24h` score `-0.2095` n `189` status `ready` deltaP `6.4319` edge `0.0292` maxDD `-0.8294`
- `market_context_high->unknown_4h` score `-0.4365` n `205` status `ready` deltaP `8.1402` edge `0.0278` maxDD `-6.1421`
...
- `market_context_high->index_24h` score `-0.8167` n `189` status `ready` deltaP `14.6412` edge `0.0808` maxDD `-10.0505`
...
- `market_context_high->crypto_alt_24h` score `-3.1243` n `189` status `ready` deltaP `13.9137` edge `0.3764` maxDD `-54.2437`
