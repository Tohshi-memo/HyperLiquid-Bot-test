...
- `market_context_high->unknown_24h` score `0.8758` n `176` status `ready` deltaP `-1.1995` edge `0.4955` maxDD `-12.3511`
- `market_context_high->commodity_24h` score `0.121` n `176` status `ready` deltaP `8.4912` edge `0.1403` maxDD `-5.2791`
- `market_context_high->crypto_major_1h` score `-0.2695` n `185` status `ready` deltaP `6.4986` edge `0.0202` maxDD `-4.2122`
- `market_context_high->fx_1h` score `-0.3943` n `185` status `ready` deltaP `-0.3366` edge `0.0002` maxDD `-0.5468`
- `market_context_high->crypto_alt_1h` score `-0.4297` n `185` status `ready` deltaP `3.4965` edge `0.0173` maxDD `-3.7803`
...
- `market_context_high->fx_4h` score `-1.3395` n `176` status `ready` deltaP `5.5571` edge `-0.0024` maxDD `-2.1765`
...
- `market_context_high->unknown_1h` score `-1.5958` n `185` status `ready` deltaP `-5.5923` edge `-0.0056` maxDD `-3.2083`
- `market_context_high->metal_4h` score `-2.5273` n `176` status `ready` deltaP `-4.7949` edge `-0.006` maxDD `-5.2172`
- `market_context_high->crypto_major_4h` score `-3.0264` n `176` status `ready` deltaP `1.372` edge `-0.0657` maxDD `-16.8495`
- `market_context_high->crypto_alt_4h` score `-3.0275` n `176` status `ready` deltaP `0.8453` edge `-0.0536` maxDD `-19.2145`
- `market_context_high->unknown_4h` score `-3.3057` n `176` status `ready` deltaP `-14.3432` edge `0.0567` maxDD `-10.2579`
