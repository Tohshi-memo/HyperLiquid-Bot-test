...
- `risk_on_high->unknown_4h` score `123.966` n `49` status `ready` deltaP `3.2634` edge `10.4918` maxDD `-10.9781`
- `risk_on_and_context->unknown_4h` score `123.966` n `49` status `ready` deltaP `3.2634` edge `10.4918` maxDD `-10.9781`
- `market_context_high->unknown_1h` score `31.4227` n `233` status `ready` deltaP `3.0005` edge `2.7491` maxDD `-9.7103`
- `market_context_high->unknown_4h` score `14.1533` n `233` status `ready` deltaP `4.0517` edge `1.6989` maxDD `-36.0512`
...
- `risk_on_high->crypto_major_4h` score `2.3028` n `49` status `ready` deltaP `19.7175` edge `0.127` maxDD `-2.6576`
- `risk_on_and_context->crypto_major_4h` score `2.3028` n `49` status `ready` deltaP `19.7175` edge `0.127` maxDD `-2.6576`
