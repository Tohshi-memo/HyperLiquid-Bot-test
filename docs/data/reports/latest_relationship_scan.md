...
- `market_context_high->unknown_1h` score `19.9426` n `94` status `ready` deltaP `10.2211` edge `1.6355` maxDD `-1.674`
- `market_context_high->unknown_4h` score `12.5576` n `91` status `ready` deltaP `28.4224` edge `0.9084` maxDD `-1.7801`
- `market_context_high->crypto_major_4h` score `7.4339` n `91` status `ready` deltaP `22.0065` edge `0.5952` maxDD `-7.1265`
- `market_context_high->crypto_alt_4h` score `7.1983` n `91` status `ready` deltaP `22.5275` edge `0.5849` maxDD `-7.8181`
- `market_context_high->unknown_24h` score `5.8823` n `91` status `ready` deltaP `27.6671` edge `0.34` maxDD `-1.4072`
- `market_context_high->equity_4h` score `1.8551` n `91` status `ready` deltaP `15.0513` edge `0.1924` maxDD `-6.3852`
...
- `market_context_high->crypto_major_1h` score `0.9818` n `94` status `ready` deltaP `9.6764` edge `0.1652` maxDD `-5.6406`
- `market_context_high->crypto_alt_1h` score `0.7611` n `94` status `ready` deltaP `10.4886` edge `0.1299` maxDD `-5.5126`
...
- `market_context_high->fx_4h` score `-1.1999` n `91` status `ready` deltaP `-7.7845` edge `-0.0049` maxDD `-1.0967`
- `market_context_high->fx_24h` score `-1.4057` n `91` status `ready` deltaP `-0.7822` edge `-0.0109` maxDD `-2.749`
