...
- `news_risk_high->unknown_24h` score `51.8638` n `51` status `ready` deltaP `17.1875` edge `4.2074` maxDD `0.0`
...
- `news_risk_high->equity_4h` score `3.2853` n `51` status `ready` deltaP `25.0986` edge `0.1835` maxDD `-2.164`
- `news_risk_high->fx_4h` score `3.2115` n `51` status `ready` deltaP `37.778` edge `0.0292` maxDD `-0.0746`
- `news_risk_high->unknown_1h` score `2.9287` n `51` status `ready` deltaP `15.7361` edge `0.1696` maxDD `-0.7693`
- `market_context_high->unknown_4h` score `2.1808` n `145` status `ready` deltaP `21.3194` edge `0.0533` maxDD `-0.0956`
- `news_risk_high->metal_24h` score `2.0141` n `51` status `ready` deltaP `36.5809` edge `-0.0718` maxDD `-0.0053`
- `news_risk_high->crypto_alt_24h` score `1.9604` n `51` status `ready` deltaP `26.2153` edge `-0.0114` maxDD `0.0`
- `market_context_high->unknown_1h` score `1.6326` n `157` status `ready` deltaP `9.8163` edge `0.1155` maxDD `-1.5916`
- `news_risk_high->fx_1h` score `1.2566` n `51` status `ready` deltaP `17.1451` edge `0.0074` maxDD `-0.0257`
- `news_risk_high->equity_1h` score `0.8844` n `51` status `ready` deltaP `17.5942` edge `0.0325` maxDD `-0.9128`
- `news_risk_high->index_4h` score `0.8001` n `51` status `ready` deltaP `12.482` edge `0.0232` maxDD `-0.1788`
- `news_risk_high->index_1h` score `0.2232` n `51` status `ready` deltaP `8.9732` edge `0.0041` maxDD `-0.1583`
- `news_risk_high->commodity_1h` score `0.2063` n `51` status `ready` deltaP `8.6885` edge `-0.0099` maxDD `-0.4666`
- `market_context_high->commodity_24h` score `0.0736` n `92` status `ready` deltaP `-3.3967` edge `0.0897` maxDD `-1.6092`
