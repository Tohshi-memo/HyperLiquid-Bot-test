...
- `news_risk_high->commodity_24h` score `2.6978` n `30` status `ready` deltaP `26.4236` edge `0.0692` maxDD `-0.3101`
- `news_risk_high->fx_1h` score `2.2693` n `30` status `ready` deltaP `27.2255` edge `0.0215` maxDD `-0.1113`
- `market_context_high->equity_24h` score `1.7309` n `180` status `ready` deltaP `29.7223` edge `0.5689` maxDD `-31.6107`
- `market_context_high->equity_4h` score `1.6009` n `206` status `ready` deltaP `8.7941` edge `0.1665` maxDD `-2.671`
...
- `news_risk_high->crypto_alt_24h` score `0.0752` n `30` status `ready` deltaP `24.0625` edge `-0.1394` maxDD `-0.5131`
- `market_context_high->metal_1h` score `-0.4204` n `206` status `ready` deltaP `3.2803` edge `0.0041` maxDD `-2.0564`
- `market_context_high->index_24h` score `-0.4413` n `180` status `ready` deltaP `5.3472` edge `0.0778` maxDD `-5.6021`
