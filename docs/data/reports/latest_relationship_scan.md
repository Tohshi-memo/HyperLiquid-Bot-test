...
- `market_context_high->unknown_24h` score `29.9336` n `132` status `ready` deltaP `-19.4882` edge `2.8698` maxDD `-9.6329`
- `risk_on_high->commodity_4h` score `3.025` n `32` status `ready` deltaP `19.8933` edge `0.1377` maxDD `-0.1258`
- `risk_on_and_context->commodity_4h` score `3.025` n `32` status `ready` deltaP `19.8933` edge `0.1377` maxDD `-0.1258`
...
- `market_context_high->commodity_4h` score `1.0315` n `182` status `ready` deltaP `12.6474` edge `0.0731` maxDD `-2.7169`
- `market_context_high->commodity_24h` score `0.9718` n `132` status `ready` deltaP `10.2411` edge `0.1014` maxDD `-3.0953`
- `market_context_high->commodity_1h` score `0.8423` n `182` status `ready` deltaP `10.8443` edge `0.0316` maxDD `-0.6965`
- `market_context_high->fx_24h` score `0.3474` n `132` status `ready` deltaP `14.52` edge `0.0285` maxDD `-1.4613`
