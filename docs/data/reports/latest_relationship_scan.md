...
- `news_risk_high->unknown_24h` score `44.9383` n `51` status `ready` deltaP `9.5486` edge `3.6812` maxDD `0.0`
- `news_risk_high->unknown_4h` score `12.9217` n `51` status `ready` deltaP `24.1063` edge `0.9207` maxDD `-0.0348`
- `news_risk_high->equity_24h` score `12.4411` n `51` status `ready` deltaP `40.237` edge `0.8616` maxDD `-4.7801`
- `news_risk_high->index_24h` score `5.2744` n `51` status `ready` deltaP `48.9481` edge `0.1284` maxDD `-0.2147`
- `news_risk_high->equity_4h` score `3.933` n `51` status `ready` deltaP `27.6901` edge `0.2202` maxDD `-2.164`
- `news_risk_high->unknown_1h` score `3.5682` n `51` status `ready` deltaP `16.4846` edge `0.2179` maxDD `-0.7693`
...
- `market_context_high->unknown_24h` score `1.045` n `110` status `ready` deltaP `5.0031` edge `0.083` maxDD `-0.6752`
...
- `market_context_high->unknown_1h` score `0.0252` n `130` status `ready` deltaP `11.0548` edge `-0.0267` maxDD `-1.5916`
