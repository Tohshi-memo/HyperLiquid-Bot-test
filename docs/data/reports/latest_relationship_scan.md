...
- `market_context_high->equity_1h` score `1.0926` n `97` status `ready` deltaP `9.4744` edge `0.0583` maxDD `-0.4329`
...
- `market_context_high->index_1h` score `0.6818` n `97` status `ready` deltaP `13.1011` edge `0.0082` maxDD `-0.0982`
...
- `market_context_high->equity_4h` score `-0.0636` n `97` status `ready` deltaP `1.8827` edge `0.0726` maxDD `-2.5696`
- `market_context_high->unknown_24h` score `-0.1114` n `85` status `ready` deltaP `13.4754` edge `-0.0803` maxDD `-0.1719`
...
- `market_context_high->crypto_major_1h` score `-0.4203` n `97` status `ready` deltaP `1.9785` edge `0.0174` maxDD `-2.7581`
