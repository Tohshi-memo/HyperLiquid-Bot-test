...
- `market_context_high->equity_4h` score `1.1762` n `220` status `ready` deltaP `7.5693` edge `0.157` maxDD `-4.0887`
- `news_risk_high->crypto_major_1h` score `0.767` n `30` status `ready` deltaP `10.0399` edge `0.0781` maxDD `-2.0691`
- `news_risk_high->crypto_alt_1h` score `0.1693` n `30` status `ready` deltaP `5.3194` edge `0.0324` maxDD `-1.6923`
- `market_context_high->equity_24h` score `0.1532` n `194` status `ready` deltaP `24.2698` edge `0.3961` maxDD `-31.6107`
...
- `market_context_high->equity_1h` score `-0.5871` n `220` status `ready` deltaP `2.006` edge `0.0242` maxDD `-4.3608`
...
- `market_context_high->crypto_major_1h` score `-1.1852` n `220` status `ready` deltaP `2.1611` edge `0.0104` maxDD `-9.807`
- `market_context_high->crypto_alt_1h` score `-1.218` n `220` status `ready` deltaP `1.38` edge `0.0099` maxDD `-9.3536`
