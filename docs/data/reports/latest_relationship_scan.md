...
- `market_context_high->equity_24h` score `2.7427` n `175` status `ready` deltaP `14.0783` edge `0.6426` maxDD `-31.6316`
- `market_context_high->fx_24h` score `1.3269` n `175` status `ready` deltaP `21.7252` edge `0.0632` maxDD `-1.4633`
- `market_context_high->crypto_major_4h` score `0.6204` n `237` status `ready` deltaP `9.9374` edge `0.2147` maxDD `-14.0065`
...
- `market_context_high->crypto_major_1h` score `-0.6253` n `237` status `ready` deltaP `4.131` edge `0.0449` maxDD `-6.9639`
