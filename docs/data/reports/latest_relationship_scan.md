...
- `market_context_high->commodity_1h` score `0.5172` n `119` status `ready` deltaP `8.3405` edge `0.0291` maxDD `-1.3282`
...
- `market_context_high->fx_1h` score `0.1139` n `119` status `ready` deltaP `7.8335` edge `-0.0026` maxDD `-0.8012`
- `market_context_high->fx_4h` score `-0.1519` n `119` status `ready` deltaP `9.2732` edge `0.0047` maxDD `-1.8797`
- `market_context_high->metal_1h` score `-0.6003` n `119` status `ready` deltaP `-2.8393` edge `-0.0095` maxDD `-1.5489`
- `market_context_high->crypto_alt_1h` score `-0.8019` n `119` status `ready` deltaP `-3.1726` edge `-0.0106` maxDD `-3.0178`
- `market_context_high->index_1h` score `-0.9952` n `119` status `ready` deltaP `-2.6896` edge `-0.0116` maxDD `-1.6054`
- `market_context_high->equity_1h` score `-1.2351` n `119` status `ready` deltaP `4.3086` edge `-0.0306` maxDD `-10.5179`
- `market_context_high->crypto_alt_4h` score `-1.391` n `119` status `ready` deltaP `0.4278` edge `-0.0422` maxDD `-5.7857`
...
- `market_context_high->crypto_alt_24h` score `-3.7202` n `112` status `ready` deltaP `-10.1717` edge `-0.0979` maxDD `-4.5445`
