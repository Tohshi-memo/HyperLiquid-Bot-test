...
- Price records: `672`
- Market context records: `1937`
- Flow alert records: `7473`
- Minimum samples: `30`
- Pattern count: `80`
...
- `market_context_high->crypto_alt_4h` score `7.0031` n `215` status `ready` deltaP `22.1788` edge `0.5502` maxDD `-5.1574`
- `market_context_high->crypto_major_4h` score `6.3964` n `215` status `ready` deltaP `26.0756` edge `0.4838` maxDD `-4.9684`
- `market_context_high->unknown_4h` score `3.0376` n `215` status `ready` deltaP `15.4991` edge `0.3522` maxDD `-9.8581`
...
- `market_context_high->crypto_major_1h` score `0.5696` n `227` status `ready` deltaP `7.5424` edge `0.0958` maxDD `-3.2225`
- `market_context_high->crypto_alt_1h` score `0.4528` n `227` status `ready` deltaP `7.2002` edge `0.1011` maxDD `-4.9097`
...
- `market_context_high->unknown_1h` score `-1.4573` n `227` status `ready` deltaP `0.7419` edge `-0.0312` maxDD `-3.6151`
- `market_context_high->commodity_1h` score `-1.9786` n `227` status `ready` deltaP `1.2339` edge `-0.0061` maxDD `-15.7972`
