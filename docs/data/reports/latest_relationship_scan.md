...
- `market_context_high->crypto_alt_24h` score `18.0779` n `44` status `ready` deltaP `52.9542` edge `1.1932` maxDD `-2.1786`
- `news_risk_high->equity_4h` score `6.1737` n `60` status `ready` deltaP `20.9513` edge `0.4345` maxDD `-3.4427`
- `news_risk_high->index_4h` score `2.4568` n `60` status `ready` deltaP `21.1035` edge `0.0831` maxDD `-0.191`
...
- `market_context_high->fx_24h` score `1.0096` n `44` status `ready` deltaP `20.2497` edge `0.0581` maxDD `-1.4261`
...
- `market_context_high->crypto_alt_1h` score `-0.5266` n `61` status `ready` deltaP `-2.6087` edge `0.0126` maxDD `-3.0178`
