...
- `market_context_high->unknown_1h` score `2.385` n `188` status `ready` deltaP `-5.437` edge `0.3251` maxDD `-3.2083`
...
- `market_context_high->commodity_24h` score `1.6682` n `144` status `ready` deltaP `14.6905` edge `0.2279` maxDD `-5.2791`
...
- `market_context_high->crypto_major_4h` score `-0.3991` n `177` status `ready` deltaP `12.8377` edge `0.0923` maxDD `-12.6576`
...
- `market_context_high->crypto_major_1h` score `-0.5672` n `188` status `ready` deltaP `6.1154` edge `0.0131` maxDD `-6.7936`
