...
- `risk_on_high->commodity_1h` score `1.2731` n `32` status `ready` deltaP `13.6602` edge `0.0383` maxDD `-0.1957`
- `risk_on_and_context->commodity_1h` score `1.2731` n `32` status `ready` deltaP `13.6602` edge `0.0383` maxDD `-0.1957`
