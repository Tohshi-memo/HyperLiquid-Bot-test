...
- `market_context_high->crypto_major_4h` score `0.9109` n `238` status `ready` deltaP `11.3484` edge `0.2295` maxDD `-14.0065`
...
- `market_context_high->crypto_major_1h` score `-0.8305` n `250` status `ready` deltaP `2.9006` edge `0.036` maxDD `-6.9639`
