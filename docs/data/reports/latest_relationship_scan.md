...
- `news_risk_high->unknown_24h` score `46.3122` n `51` status `ready` deltaP `11.6319` edge `3.7818` maxDD `0.0`
- `news_risk_high->unknown_4h` score `12.4756` n `53` status `ready` deltaP `23.4555` edge `0.8932` maxDD `-0.1281`
- `news_risk_high->equity_24h` score `6.9477` n `51` status `ready` deltaP `29.9939` edge `0.4721` maxDD `-4.7801`
- `news_risk_high->crypto_alt_24h` score `6.1049` n `51` status `ready` deltaP `29.1667` edge `0.3143` maxDD `0.0`
...
- `market_context_high->unknown_4h` score `2.5171` n `133` status `ready` deltaP `21.5971` edge `0.1066` maxDD `-0.5994`
- `news_risk_high->equity_4h` score `1.6197` n `53` status `ready` deltaP `19.2792` edge `0.0835` maxDD `-2.164`
- `news_risk_high->metal_24h` score `1.2129` n `51` status `ready` deltaP `29.1156` edge `-0.0888` maxDD `-0.0053`
...
- `news_risk_high->equity_1h` score `0.3741` n `53` status `ready` deltaP `12.476` edge `0.0012` maxDD `-0.9128`
- `market_context_high->unknown_1h` score `0.3529` n `134` status `ready` deltaP `11.7459` edge `-0.004` maxDD `-1.5916`
- `news_risk_high->index_4h` score `0.0125` n `53` status `ready` deltaP `5.4418` edge `0.0045` maxDD `-0.1788`
