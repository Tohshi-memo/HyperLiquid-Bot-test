...
- `news_risk_high->crypto_major_4h` score `2.3367` n `54` status `ready` deltaP `11.3934` edge `0.293` maxDD `-2.8833`
...
- `news_risk_high->commodity_4h` score `-8.8843` n `54` status `ready` deltaP `-32.7913` edge `-0.191` maxDD `-13.1269`
- `news_risk_high->index_24h` score `-11.6995` n `43` status `ready` deltaP `-23.9624` edge `-0.3574` maxDD `-24.2912`
- `news_risk_high->commodity_24h` score `-14.5817` n `43` status `ready` deltaP `-21.2169` edge `-0.4906` maxDD `-32.9813`
- `news_risk_high->equity_24h` score `-34.5232` n `43` status `ready` deltaP `-23.4415` edge `-1.2417` maxDD `-105.9832`
