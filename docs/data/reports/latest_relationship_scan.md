...
- `market_context_high->unknown_1h` score `63.9586` n `47` status `ready` deltaP `7.7207` edge `5.2855` maxDD `-0.2334`
- `market_context_high->crypto_major_24h` score `50.6197` n `47` status `ready` deltaP `30.9434` edge `4.0513` maxDD `-2.4756`
- `market_context_high->crypto_alt_24h` score `32.0908` n `47` status `ready` deltaP `24.782` edge `2.547` maxDD `-2.7051`
...
- `market_context_high->equity_4h` score `2.6989` n `47` status `ready` deltaP `17.2969` edge `0.1514` maxDD `-1.3444`
...
- `market_context_high->crypto_alt_4h` score `1.4893` n `47` status `ready` deltaP `11.5172` edge `0.1141` maxDD `-3.3417`
...
- `market_context_high->crypto_major_4h` score `0.4556` n `47` status `ready` deltaP `5.1472` edge `0.0941` maxDD `-5.2359`
- `market_context_high->crypto_major_1h` score `0.2811` n `47` status `ready` deltaP `4.9019` edge `0.0725` maxDD `-4.5405`
- `news_risk_high->crypto_major_1h` score `0.0603` n `111` status `ready` deltaP `4.2119` edge `0.0525` maxDD `-3.3776`
