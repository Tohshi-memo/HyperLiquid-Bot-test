...
- `news_risk_high->crypto_alt_24h` score `12.6458` n `32` status `ready` deltaP `42.2194` edge `0.7871` maxDD `-0.5131`
...
- `news_risk_high->crypto_major_24h` score `2.0226` n `32` status `ready` deltaP `15.625` edge `0.2331` maxDD `-4.2368`
...
- `news_risk_high->commodity_24h` score `-0.0907` n `32` status `ready` deltaP `15.8376` edge `-0.0926` maxDD `-0.3101`
- `news_risk_high->index_24h` score `-0.1525` n `32` status `ready` deltaP `9.4813` edge `0.0044` maxDD `-2.3058`
- `market_context_high->equity_4h` score `-0.1673` n `192` status `ready` deltaP `2.2321` edge `0.0629` maxDD `-2.671`
