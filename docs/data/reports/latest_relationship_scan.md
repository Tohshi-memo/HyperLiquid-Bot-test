...
- `news_risk_high->crypto_alt_24h` score `24.0018` n `50` status `ready` deltaP `37.8403` edge `1.792` maxDD `-2.8629`
...
- `news_risk_high->equity_24h` score `4.945` n `50` status `ready` deltaP `27.75` edge `0.3199` maxDD `-4.7584`
...
- `news_risk_high->unknown_1h` score `2.9564` n `50` status `ready` deltaP `16.3772` edge `0.1728` maxDD `-0.8495`
...
- `news_risk_high->equity_1h` score `1.2829` n `50` status `ready` deltaP `17.8623` edge `0.0157` maxDD `-0.2301`
- `news_risk_high->equity_4h` score `1.1248` n `50` status `ready` deltaP `20.5122` edge `0.0333` maxDD `-2.105`
- `market_context_high->unknown_1h` score `0.8329` n `148` status `ready` deltaP `8.6745` edge `0.0566` maxDD `-1.6015`
- `news_risk_high->commodity_1h` score `0.5082` n `50` status `ready` deltaP `14.1497` edge `0.0021` maxDD `-0.5024`
- `news_risk_high->index_1h` score `0.153` n `50` status `ready` deltaP `7.9581` edge `0.0005` maxDD `-0.0486`
