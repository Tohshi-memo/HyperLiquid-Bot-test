...
- `risk_on_high->commodity_24h` score `1.7398` n `32` status `ready` deltaP `15.9722` edge `0.0385` maxDD `0.0`
- `risk_on_and_context->commodity_24h` score `1.7398` n `32` status `ready` deltaP `15.9722` edge `0.0385` maxDD `0.0`
