...
- `risk_on_high->unknown_1h` score `7.1164` n `35` status `ready` deltaP `1.8905` edge `0.6199` maxDD `-0.8243`
- `risk_on_and_context->unknown_1h` score `7.1164` n `35` status `ready` deltaP `1.8905` edge `0.6199` maxDD `-0.8243`
- `market_context_high->crypto_major_24h` score `2.4365` n `92` status `ready` deltaP `8.0993` edge `0.2867` maxDD `-5.6792`
...
- `risk_on_high->crypto_major_1h` score `1.1031` n `35` status `ready` deltaP `12.2583` edge `0.0408` maxDD `-1.1144`
- `risk_on_and_context->crypto_major_1h` score `1.1031` n `35` status `ready` deltaP `12.2583` edge `0.0408` maxDD `-1.1144`
...
- `market_context_high->equity_24h` score `0.4282` n `92` status `ready` deltaP `12.7491` edge `-0.0284` maxDD `-0.6726`
...
- `risk_on_high->crypto_major_4h` score `0.1968` n `35` status `ready` deltaP `2.7613` edge `0.078` maxDD `-2.0278`
- `risk_on_and_context->crypto_major_4h` score `0.1968` n `35` status `ready` deltaP `2.7613` edge `0.078` maxDD `-2.0278`
