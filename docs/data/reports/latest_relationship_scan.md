...
- `news_risk_high->unknown_1h` score `421.8187` n `79` status `ready` deltaP `-3.1608` edge `35.2148` maxDD `-1.7068`
- `risk_on_high->crypto_alt_24h` score `24.7207` n `91` status `ready` deltaP `43.1166` edge `1.7956` maxDD `-0.8386`
- `risk_on_and_context->crypto_alt_24h` score `24.7207` n `91` status `ready` deltaP `43.1166` edge `1.7956` maxDD `-0.8386`
- `news_risk_high->crypto_major_24h` score `22.1717` n `38` status `ready` deltaP `50.7584` edge `1.5993` maxDD `-5.8705`
- `market_context_high->crypto_alt_24h` score `21.8112` n `151` status `ready` deltaP `38.0151` edge `1.6469` maxDD `-3.9523`
- `news_risk_high->crypto_alt_24h` score `12.7068` n `38` status `ready` deltaP `19.6637` edge `0.9766` maxDD `-2.2369`
...
- `news_risk_high->metal_24h` score `8.0073` n `38` status `ready` deltaP `51.0417` edge `0.327` maxDD `0.0`
