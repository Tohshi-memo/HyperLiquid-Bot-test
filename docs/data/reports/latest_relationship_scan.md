...
- `market_context_high->unknown_1h` score `40.2566` n `203` status `ready` deltaP `3.4299` edge `3.4824` maxDD `-9.7103`
...
- `risk_on_high->crypto_major_4h` score `3.9084` n `49` status `ready` deltaP `24.4431` edge `0.2293` maxDD `-2.6576`
- `risk_on_and_context->crypto_major_4h` score `3.9084` n `49` status `ready` deltaP `24.4431` edge `0.2293` maxDD `-2.6576`
...
- `risk_on_high->metal_4h` score `2.0247` n `49` status `ready` deltaP `15.7634` edge `0.0972` maxDD `-1.3516`
- `risk_on_and_context->metal_4h` score `2.0247` n `49` status `ready` deltaP `15.7634` edge `0.0972` maxDD `-1.3516`
...
- `risk_on_high->equity_1h` score `1.3507` n `49` status `ready` deltaP `16.0394` edge `0.0399` maxDD `-0.7415`
- `risk_on_and_context->equity_1h` score `1.3507` n `49` status `ready` deltaP `16.0394` edge `0.0399` maxDD `-0.7415`
- `risk_on_high->index_24h` score `0.9378` n `49` status `ready` deltaP `20.0042` edge `-0.0035` maxDD `-2.4702`
- `risk_on_and_context->index_24h` score `0.9378` n `49` status `ready` deltaP `20.0042` edge `-0.0035` maxDD `-2.4702`
