...
- `market_context_high->index_1h` score `-0.7362` n `109` status `ready` deltaP `-3.2069` edge `-0.0196` maxDD `-1.6054`
- `market_context_high->metal_4h` score `-0.972` n `109` status `ready` deltaP `0.8028` edge `-0.0065` maxDD `-3.211`
- `market_context_high->crypto_alt_24h` score `-1.325` n `90` status `ready` deltaP `0.0347` edge `-0.0258` maxDD `-4.5445`
- `market_context_high->crypto_alt_1h` score `-1.5109` n `109` status `ready` deltaP `-5.2876` edge `-0.0196` maxDD `-3.0178`
- `market_context_high->index_24h` score `-1.5259` n `90` status `ready` deltaP `-4.132` edge `0.0514` maxDD `-7.8922`
- `market_context_high->equity_1h` score `-1.8642` n `109` status `ready` deltaP `0.9697` edge `-0.0919` maxDD `-10.619`
...
- `market_context_high->crypto_major_1h` score `-3.339` n `109` status `ready` deltaP `-11.7481` edge `-0.0626` maxDD `-7.6533`
